...
namespace PMS.UnitTests
{
    ...
    {    	
		/// <summary>
		/// Creates a new <see cref="SdhPhanNhomMonHocTest"/> instance.
		/// </summary>	
		public SdhPhanNhomMonHocTest()
		{				
		}
		...
		/// <summary>
		/// Selects a sample of  SdhPhanNhomMonHoc objects of the database.
		/// </summary>
		[NUnit.Framework.Test]
        ...
        ///</summary>
        static public SdhPhanNhomMonHoc CreateMockInstance(TransactionManager tm)
        {
            // get the default mock instance
            SdhPhanNhomMonHoc mock = SdhPhanNhomMonHocTest.CreateMockInstance_Generated(tm);
        ...
        ///</summary>
        static public void UpdateMockInstance(TransactionManager tm, SdhPhanNhomMonHoc mock)
        {
            SdhPhanNhomMonHocTest.UpdateMockInstance_Generated(tm, mock);
        ...
        static private void SetSpecialTestData(SdhPhanNhomMonHoc mock)
        {
