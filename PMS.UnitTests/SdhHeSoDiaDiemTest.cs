...
namespace PMS.UnitTests
{
    ...
    {    	
		/// <summary>
		/// Creates a new <see cref="SdhHeSoDiaDiemTest"/> instance.
		/// </summary>	
		public SdhHeSoDiaDiemTest()
		{				
		}
		...
		/// <summary>
		/// Selects a sample of  SdhHeSoDiaDiem objects of the database.
		/// </summary>
		[NUnit.Framework.Test]
        ...
        ///</summary>
        static public SdhHeSoDiaDiem CreateMockInstance(TransactionManager tm)
        {
            // get the default mock instance
            SdhHeSoDiaDiem mock = SdhHeSoDiaDiemTest.CreateMockInstance_Generated(tm);
        ...
        ///</summary>
        static public void UpdateMockInstance(TransactionManager tm, SdhHeSoDiaDiem mock)
        {
            SdhHeSoDiaDiemTest.UpdateMockInstance_Generated(tm, mock);
        ...
        static private void SetSpecialTestData(SdhHeSoDiaDiem mock)
        {
