...
namespace PMS.UnitTests
{
    ...
    {    	
		/// <summary>
		/// Creates a new <see cref="GiangVienChoDuyetHoSoTest"/> instance.
		/// </summary>	
		public GiangVienChoDuyetHoSoTest()
		{				
		}
		...
		/// <summary>
		/// Selects a sample of  GiangVienChoDuyetHoSo objects of the database.
		/// </summary>
		[NUnit.Framework.Test]
        ...
        ///</summary>
        static public GiangVienChoDuyetHoSo CreateMockInstance(TransactionManager tm)
        {
            // get the default mock instance
            GiangVienChoDuyetHoSo mock = GiangVienChoDuyetHoSoTest.CreateMockInstance_Generated(tm);
        ...
        ///</summary>
        static public void UpdateMockInstance(TransactionManager tm, GiangVienChoDuyetHoSo mock)
        {
            GiangVienChoDuyetHoSoTest.UpdateMockInstance_Generated(tm, mock);
        ...
        static private void SetSpecialTestData(GiangVienChoDuyetHoSo mock)
        {
