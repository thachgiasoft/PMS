...
namespace PMS.UnitTests
{
    ...
    {    	
		/// <summary>
		/// Creates a new <see cref="NgonNguGiangDayTest"/> instance.
		/// </summary>	
		public NgonNguGiangDayTest()
		{				
		}
		...
		/// <summary>
		/// Selects a sample of  NgonNguGiangDay objects of the database.
		/// </summary>
		[NUnit.Framework.Test]
        ...
        ///</summary>
        static public NgonNguGiangDay CreateMockInstance(TransactionManager tm)
        {
            // get the default mock instance
            NgonNguGiangDay mock = NgonNguGiangDayTest.CreateMockInstance_Generated(tm);
        ...
        ///</summary>
        static public void UpdateMockInstance(TransactionManager tm, NgonNguGiangDay mock)
        {
            NgonNguGiangDayTest.UpdateMockInstance_Generated(tm, mock);
        ...
        static private void SetSpecialTestData(NgonNguGiangDay mock)
        {
