...
namespace PMS.UnitTests
{
    ...
    {    	
		/// <summary>
		/// Creates a new <see cref="SdhUteThanhToanThuLaoTest"/> instance.
		/// </summary>	
		public SdhUteThanhToanThuLaoTest()
		{				
		}
		...
		/// <summary>
		/// Selects a sample of  SdhUteThanhToanThuLao objects of the database.
		/// </summary>
		[NUnit.Framework.Test]
        ...
        ///</summary>
        static public SdhUteThanhToanThuLao CreateMockInstance(TransactionManager tm)
        {
            // get the default mock instance
            SdhUteThanhToanThuLao mock = SdhUteThanhToanThuLaoTest.CreateMockInstance_Generated(tm);
        ...
        ///</summary>
        static public void UpdateMockInstance(TransactionManager tm, SdhUteThanhToanThuLao mock)
        {
            SdhUteThanhToanThuLaoTest.UpdateMockInstance_Generated(tm, mock);
        ...
        static private void SetSpecialTestData(SdhUteThanhToanThuLao mock)
        {
