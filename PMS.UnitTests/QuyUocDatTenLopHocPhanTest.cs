...
namespace PMS.UnitTests
{
    ...
    {    	
		/// <summary>
		/// Creates a new <see cref="QuyUocDatTenLopHocPhanTest"/> instance.
		/// </summary>	
		public QuyUocDatTenLopHocPhanTest()
		{				
		}
		...
		/// <summary>
		/// Selects a sample of  QuyUocDatTenLopHocPhan objects of the database.
		/// </summary>
		[NUnit.Framework.Test]
        ...
        ///</summary>
        static public QuyUocDatTenLopHocPhan CreateMockInstance(TransactionManager tm)
        {
            // get the default mock instance
            QuyUocDatTenLopHocPhan mock = QuyUocDatTenLopHocPhanTest.CreateMockInstance_Generated(tm);
        ...
        ///</summary>
        static public void UpdateMockInstance(TransactionManager tm, QuyUocDatTenLopHocPhan mock)
        {
            QuyUocDatTenLopHocPhanTest.UpdateMockInstance_Generated(tm, mock);
        ...
        static private void SetSpecialTestData(QuyUocDatTenLopHocPhan mock)
        {
