...
namespace PMS.UnitTests
{
    ...
    {    	
		/// <summary>
		/// Creates a new <see cref="PhanLoaiGiangVienTest"/> instance.
		/// </summary>	
		public PhanLoaiGiangVienTest()
		{				
		}
		...
		/// <summary>
		/// Selects a sample of  PhanLoaiGiangVien objects of the database.
		/// </summary>
		[NUnit.Framework.Test]
        ...
        ///</summary>
        static public PhanLoaiGiangVien CreateMockInstance(TransactionManager tm)
        {
            // get the default mock instance
            PhanLoaiGiangVien mock = PhanLoaiGiangVienTest.CreateMockInstance_Generated(tm);
        ...
        ///</summary>
        static public void UpdateMockInstance(TransactionManager tm, PhanLoaiGiangVien mock)
        {
            PhanLoaiGiangVienTest.UpdateMockInstance_Generated(tm, mock);
        ...
        static private void SetSpecialTestData(PhanLoaiGiangVien mock)
        {
