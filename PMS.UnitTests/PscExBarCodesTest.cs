...
namespace PMS.UnitTests
{
    ...
    {    	
		/// <summary>
		/// Creates a new <see cref="PscExBarCodesTest"/> instance.
		/// </summary>	
		public PscExBarCodesTest()
		{				
		}
		...
		/// <summary>
		/// Selects a sample of  PscExBarCodes objects of the database.
		/// </summary>
		[NUnit.Framework.Test]
        ...
        ///</summary>
        static public PscExBarCodes CreateMockInstance(TransactionManager tm)
        {
            // get the default mock instance
            PscExBarCodes mock = PscExBarCodesTest.CreateMockInstance_Generated(tm);
        ...
        ///</summary>
        static public void UpdateMockInstance(TransactionManager tm, PscExBarCodes mock)
        {
            PscExBarCodesTest.UpdateMockInstance_Generated(tm, mock);
        ...
        static private void SetSpecialTestData(PscExBarCodes mock)
        {
