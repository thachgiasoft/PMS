...
namespace PMS.UnitTests
{
    ...
    {    	
		/// <summary>
		/// Creates a new <see cref="DanhMucChotGioDayTest"/> instance.
		/// </summary>	
		public DanhMucChotGioDayTest()
		{				
		}
		...
		/// <summary>
		/// Selects a sample of  DanhMucChotGioDay objects of the database.
		/// </summary>
		[NUnit.Framework.Test]
        ...
        ///</summary>
        static public DanhMucChotGioDay CreateMockInstance(TransactionManager tm)
        {
            // get the default mock instance
            DanhMucChotGioDay mock = DanhMucChotGioDayTest.CreateMockInstance_Generated(tm);
        ...
        ///</summary>
        static public void UpdateMockInstance(TransactionManager tm, DanhMucChotGioDay mock)
        {
            DanhMucChotGioDayTest.UpdateMockInstance_Generated(tm, mock);
        ...
        static private void SetSpecialTestData(DanhMucChotGioDay mock)
        {
