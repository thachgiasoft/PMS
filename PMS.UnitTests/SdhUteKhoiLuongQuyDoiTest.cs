...
namespace PMS.UnitTests
{
    ...
    {    	
		/// <summary>
		/// Creates a new <see cref="SdhUteKhoiLuongQuyDoiTest"/> instance.
		/// </summary>	
		public SdhUteKhoiLuongQuyDoiTest()
		{				
		}
		...
		/// <summary>
		/// Selects a sample of  SdhUteKhoiLuongQuyDoi objects of the database.
		/// </summary>
		[NUnit.Framework.Test]
        ...
        ///</summary>
        static public SdhUteKhoiLuongQuyDoi CreateMockInstance(TransactionManager tm)
        {
            // get the default mock instance
            SdhUteKhoiLuongQuyDoi mock = SdhUteKhoiLuongQuyDoiTest.CreateMockInstance_Generated(tm);
        ...
        ///</summary>
        static public void UpdateMockInstance(TransactionManager tm, SdhUteKhoiLuongQuyDoi mock)
        {
            SdhUteKhoiLuongQuyDoiTest.UpdateMockInstance_Generated(tm, mock);
        ...
        static private void SetSpecialTestData(SdhUteKhoiLuongQuyDoi mock)
        {
