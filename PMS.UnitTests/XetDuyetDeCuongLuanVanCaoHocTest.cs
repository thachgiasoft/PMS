...
namespace PMS.UnitTests
{
    ...
    {    	
		/// <summary>
		/// Creates a new <see cref="XetDuyetDeCuongLuanVanCaoHocTest"/> instance.
		/// </summary>	
		public XetDuyetDeCuongLuanVanCaoHocTest()
		{				
		}
		...
		/// <summary>
		/// Selects a sample of  XetDuyetDeCuongLuanVanCaoHoc objects of the database.
		/// </summary>
		[NUnit.Framework.Test]
        ...
        ///</summary>
        static public XetDuyetDeCuongLuanVanCaoHoc CreateMockInstance(TransactionManager tm)
        {
            // get the default mock instance
            XetDuyetDeCuongLuanVanCaoHoc mock = XetDuyetDeCuongLuanVanCaoHocTest.CreateMockInstance_Generated(tm);
        ...
        ///</summary>
        static public void UpdateMockInstance(TransactionManager tm, XetDuyetDeCuongLuanVanCaoHoc mock)
        {
            XetDuyetDeCuongLuanVanCaoHocTest.UpdateMockInstance_Generated(tm, mock);
        ...
        static private void SetSpecialTestData(XetDuyetDeCuongLuanVanCaoHoc mock)
        {
