...
namespace PMS.UnitTests
{
    ...
    {    	
		/// <summary>
		/// Creates a new <see cref="TrinhDoQuanLyNhaNuocTest"/> instance.
		/// </summary>	
		public TrinhDoQuanLyNhaNuocTest()
		{				
		}
		...
		/// <summary>
		/// Selects a sample of  TrinhDoQuanLyNhaNuoc objects of the database.
		/// </summary>
		[NUnit.Framework.Test]
        ...
        ///</summary>
        static public TrinhDoQuanLyNhaNuoc CreateMockInstance(TransactionManager tm)
        {
            // get the default mock instance
            TrinhDoQuanLyNhaNuoc mock = TrinhDoQuanLyNhaNuocTest.CreateMockInstance_Generated(tm);
        ...
        ///</summary>
        static public void UpdateMockInstance(TransactionManager tm, TrinhDoQuanLyNhaNuoc mock)
        {
            TrinhDoQuanLyNhaNuocTest.UpdateMockInstance_Generated(tm, mock);
        ...
        static private void SetSpecialTestData(TrinhDoQuanLyNhaNuoc mock)
        {
