...
namespace PMS.UnitTests
{
    ...
    {    	
		/// <summary>
		/// Creates a new <see cref="ThanhTraCoiThiTest"/> instance.
		/// </summary>	
		public ThanhTraCoiThiTest()
		{				
		}
		...
		/// <summary>
		/// Selects a sample of  ThanhTraCoiThi objects of the database.
		/// </summary>
		[NUnit.Framework.Test]
        ...
        ///</summary>
        static public ThanhTraCoiThi CreateMockInstance(TransactionManager tm)
        {
            // get the default mock instance
            ThanhTraCoiThi mock = ThanhTraCoiThiTest.CreateMockInstance_Generated(tm);
        ...
        ///</summary>
        static public void UpdateMockInstance(TransactionManager tm, ThanhTraCoiThi mock)
        {
            ThanhTraCoiThiTest.UpdateMockInstance_Generated(tm, mock);
        ...
        static private void SetSpecialTestData(ThanhTraCoiThi mock)
        {
