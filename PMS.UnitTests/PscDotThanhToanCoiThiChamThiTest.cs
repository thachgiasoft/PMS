...
namespace PMS.UnitTests
{
    ...
    {    	
		/// <summary>
		/// Creates a new <see cref="PscDotThanhToanCoiThiChamThiTest"/> instance.
		/// </summary>	
		public PscDotThanhToanCoiThiChamThiTest()
		{				
		}
		...
		/// <summary>
		/// Selects a sample of  PscDotThanhToanCoiThiChamThi objects of the database.
		/// </summary>
		[NUnit.Framework.Test]
        ...
        ///</summary>
        static public PscDotThanhToanCoiThiChamThi CreateMockInstance(TransactionManager tm)
        {
            // get the default mock instance
            PscDotThanhToanCoiThiChamThi mock = PscDotThanhToanCoiThiChamThiTest.CreateMockInstance_Generated(tm);
        ...
        ///</summary>
        static public void UpdateMockInstance(TransactionManager tm, PscDotThanhToanCoiThiChamThi mock)
        {
            PscDotThanhToanCoiThiChamThiTest.UpdateMockInstance_Generated(tm, mock);
        ...
        static private void SetSpecialTestData(PscDotThanhToanCoiThiChamThi mock)
        {
