...
namespace PMS.UnitTests
{
    ...
    {    	
		/// <summary>
		/// Creates a new <see cref="DotChiTraTest"/> instance.
		/// </summary>	
		public DotChiTraTest()
		{				
		}
		...
		/// <summary>
		/// Selects a sample of  DotChiTra objects of the database.
		/// </summary>
		[NUnit.Framework.Test]
        ...
        ///</summary>
        static public DotChiTra CreateMockInstance(TransactionManager tm)
        {
            // get the default mock instance
            DotChiTra mock = DotChiTraTest.CreateMockInstance_Generated(tm);
        ...
        ///</summary>
        static public void UpdateMockInstance(TransactionManager tm, DotChiTra mock)
        {
            DotChiTraTest.UpdateMockInstance_Generated(tm, mock);
        ...
        static private void SetSpecialTestData(DotChiTra mock)
        {
