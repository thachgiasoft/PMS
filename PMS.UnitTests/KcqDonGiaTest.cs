...
namespace PMS.UnitTests
{
    ...
    {    	
		/// <summary>
		/// Creates a new <see cref="KcqDonGiaTest"/> instance.
		/// </summary>	
		public KcqDonGiaTest()
		{				
		}
		...
		/// <summary>
		/// Selects a sample of  KcqDonGia objects of the database.
		/// </summary>
		[NUnit.Framework.Test]
        ...
        ///</summary>
        static public KcqDonGia CreateMockInstance(TransactionManager tm)
        {
            // get the default mock instance
            KcqDonGia mock = KcqDonGiaTest.CreateMockInstance_Generated(tm);
        ...
        ///</summary>
        static public void UpdateMockInstance(TransactionManager tm, KcqDonGia mock)
        {
            KcqDonGiaTest.UpdateMockInstance_Generated(tm, mock);
        ...
        static private void SetSpecialTestData(KcqDonGia mock)
        {
