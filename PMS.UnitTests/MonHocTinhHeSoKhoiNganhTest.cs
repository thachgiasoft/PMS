...
namespace PMS.UnitTests
{
    ...
    {    	
		/// <summary>
		/// Creates a new <see cref="MonHocTinhHeSoKhoiNganhTest"/> instance.
		/// </summary>	
		public MonHocTinhHeSoKhoiNganhTest()
		{				
		}
		...
		/// <summary>
		/// Selects a sample of  MonHocTinhHeSoKhoiNganh objects of the database.
		/// </summary>
		[NUnit.Framework.Test]
        ...
        ///</summary>
        static public MonHocTinhHeSoKhoiNganh CreateMockInstance(TransactionManager tm)
        {
            // get the default mock instance
            MonHocTinhHeSoKhoiNganh mock = MonHocTinhHeSoKhoiNganhTest.CreateMockInstance_Generated(tm);
        ...
        ///</summary>
        static public void UpdateMockInstance(TransactionManager tm, MonHocTinhHeSoKhoiNganh mock)
        {
            MonHocTinhHeSoKhoiNganhTest.UpdateMockInstance_Generated(tm, mock);
        ...
        static private void SetSpecialTestData(MonHocTinhHeSoKhoiNganh mock)
        {
