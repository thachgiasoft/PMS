...
namespace PMS.UnitTests
{
    ...
    {    	
		/// <summary>
		/// Creates a new <see cref="DanhMucHoatDongQuanLyTest"/> instance.
		/// </summary>	
		public DanhMucHoatDongQuanLyTest()
		{				
		}
		...
		/// <summary>
		/// Selects a sample of  DanhMucHoatDongQuanLy objects of the database.
		/// </summary>
		[NUnit.Framework.Test]
        ...
        ///</summary>
        static public DanhMucHoatDongQuanLy CreateMockInstance(TransactionManager tm)
        {
            // get the default mock instance
            DanhMucHoatDongQuanLy mock = DanhMucHoatDongQuanLyTest.CreateMockInstance_Generated(tm);
        ...
        ///</summary>
        static public void UpdateMockInstance(TransactionManager tm, DanhMucHoatDongQuanLy mock)
        {
            DanhMucHoatDongQuanLyTest.UpdateMockInstance_Generated(tm, mock);
        ...
        static private void SetSpecialTestData(DanhMucHoatDongQuanLy mock)
        {
