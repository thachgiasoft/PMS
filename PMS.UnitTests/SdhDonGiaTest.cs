...
namespace PMS.UnitTests
{
    ...
    {    	
		/// <summary>
		/// Creates a new <see cref="SdhDonGiaTest"/> instance.
		/// </summary>	
		public SdhDonGiaTest()
		{				
		}
		...
		/// <summary>
		/// Selects a sample of  SdhDonGia objects of the database.
		/// </summary>
		[NUnit.Framework.Test]
        ...
        ///</summary>
        static public SdhDonGia CreateMockInstance(TransactionManager tm)
        {
            // get the default mock instance
            SdhDonGia mock = SdhDonGiaTest.CreateMockInstance_Generated(tm);
        ...
        ///</summary>
        static public void UpdateMockInstance(TransactionManager tm, SdhDonGia mock)
        {
            SdhDonGiaTest.UpdateMockInstance_Generated(tm, mock);
        ...
        static private void SetSpecialTestData(SdhDonGia mock)
        {
