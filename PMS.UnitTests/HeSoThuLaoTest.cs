...
namespace PMS.UnitTests
{
    ...
    {    	
		/// <summary>
		/// Creates a new <see cref="HeSoThuLaoTest"/> instance.
		/// </summary>	
		public HeSoThuLaoTest()
		{				
		}
		...
		/// <summary>
		/// Selects a sample of  HeSoThuLao objects of the database.
		/// </summary>
		[NUnit.Framework.Test]
        ...
        ///</summary>
        static public HeSoThuLao CreateMockInstance(TransactionManager tm)
        {
            // get the default mock instance
            HeSoThuLao mock = HeSoThuLaoTest.CreateMockInstance_Generated(tm);
        ...
        ///</summary>
        static public void UpdateMockInstance(TransactionManager tm, HeSoThuLao mock)
        {
            HeSoThuLaoTest.UpdateMockInstance_Generated(tm, mock);
        ...
        static private void SetSpecialTestData(HeSoThuLao mock)
        {
