...
namespace PMS.UnitTests
{
    ...
    {    	
		/// <summary>
		/// Creates a new <see cref="CongThucTest"/> instance.
		/// </summary>	
		public CongThucTest()
		{				
		}
		...
		/// <summary>
		/// Selects a sample of  CongThuc objects of the database.
		/// </summary>
		[NUnit.Framework.Test]
        ...
        ///</summary>
        static public CongThuc CreateMockInstance(TransactionManager tm)
        {
            // get the default mock instance
            CongThuc mock = CongThucTest.CreateMockInstance_Generated(tm);
        ...
        ///</summary>
        static public void UpdateMockInstance(TransactionManager tm, CongThuc mock)
        {
            CongThucTest.UpdateMockInstance_Generated(tm, mock);
        ...
        static private void SetSpecialTestData(CongThuc mock)
        {
