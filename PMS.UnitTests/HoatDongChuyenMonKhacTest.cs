...
namespace PMS.UnitTests
{
    ...
    {    	
		/// <summary>
		/// Creates a new <see cref="HoatDongChuyenMonKhacTest"/> instance.
		/// </summary>	
		public HoatDongChuyenMonKhacTest()
		{				
		}
		...
		/// <summary>
		/// Selects a sample of  HoatDongChuyenMonKhac objects of the database.
		/// </summary>
		[NUnit.Framework.Test]
        ...
        ///</summary>
        static public HoatDongChuyenMonKhac CreateMockInstance(TransactionManager tm)
        {
            // get the default mock instance
            HoatDongChuyenMonKhac mock = HoatDongChuyenMonKhacTest.CreateMockInstance_Generated(tm);
        ...
        ///</summary>
        static public void UpdateMockInstance(TransactionManager tm, HoatDongChuyenMonKhac mock)
        {
            HoatDongChuyenMonKhacTest.UpdateMockInstance_Generated(tm, mock);
        ...
        static private void SetSpecialTestData(HoatDongChuyenMonKhac mock)
        {
