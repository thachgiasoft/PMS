...
namespace PMS.UnitTests
{
    ...
    {    	
		/// <summary>
		/// Creates a new <see cref="TongTienLuongTrongNamCuaGiangVienTest"/> instance.
		/// </summary>	
		public TongTienLuongTrongNamCuaGiangVienTest()
		{				
		}
		...
		/// <summary>
		/// Selects a sample of  TongTienLuongTrongNamCuaGiangVien objects of the database.
		/// </summary>
		[NUnit.Framework.Test]
        ...
        ///</summary>
        static public TongTienLuongTrongNamCuaGiangVien CreateMockInstance(TransactionManager tm)
        {
            // get the default mock instance
            TongTienLuongTrongNamCuaGiangVien mock = TongTienLuongTrongNamCuaGiangVienTest.CreateMockInstance_Generated(tm);
        ...
        ///</summary>
        static public void UpdateMockInstance(TransactionManager tm, TongTienLuongTrongNamCuaGiangVien mock)
        {
            TongTienLuongTrongNamCuaGiangVienTest.UpdateMockInstance_Generated(tm, mock);
        ...
        static private void SetSpecialTestData(TongTienLuongTrongNamCuaGiangVien mock)
        {
