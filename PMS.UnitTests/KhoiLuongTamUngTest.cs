...
namespace PMS.UnitTests
{
    ...
    {    	
		/// <summary>
		/// Creates a new <see cref="KhoiLuongTamUngTest"/> instance.
		/// </summary>	
		public KhoiLuongTamUngTest()
		{				
		}
		...
		/// <summary>
		/// Selects a sample of  KhoiLuongTamUng objects of the database.
		/// </summary>
		[NUnit.Framework.Test]
        ...
        ///</summary>
        static public KhoiLuongTamUng CreateMockInstance(TransactionManager tm)
        {
            // get the default mock instance
            KhoiLuongTamUng mock = KhoiLuongTamUngTest.CreateMockInstance_Generated(tm);
        ...
        ///</summary>
        static public void UpdateMockInstance(TransactionManager tm, KhoiLuongTamUng mock)
        {
            KhoiLuongTamUngTest.UpdateMockInstance_Generated(tm, mock);
        ...
        static private void SetSpecialTestData(KhoiLuongTamUng mock)
        {
