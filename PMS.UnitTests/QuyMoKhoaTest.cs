...
namespace PMS.UnitTests
{
    ...
    {    	
		/// <summary>
		/// Creates a new <see cref="QuyMoKhoaTest"/> instance.
		/// </summary>	
		public QuyMoKhoaTest()
		{				
		}
		...
		/// <summary>
		/// Selects a sample of  QuyMoKhoa objects of the database.
		/// </summary>
		[NUnit.Framework.Test]
        ...
        ///</summary>
        static public QuyMoKhoa CreateMockInstance(TransactionManager tm)
        {
            // get the default mock instance
            QuyMoKhoa mock = QuyMoKhoaTest.CreateMockInstance_Generated(tm);
        ...
        ///</summary>
        static public void UpdateMockInstance(TransactionManager tm, QuyMoKhoa mock)
        {
            QuyMoKhoaTest.UpdateMockInstance_Generated(tm, mock);
        ...
        static private void SetSpecialTestData(QuyMoKhoa mock)
        {
