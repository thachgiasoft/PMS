...
namespace PMS.UnitTests
{
    ...
    {    	
		/// <summary>
		/// Creates a new <see cref="ThueThanhToanBoSungTest"/> instance.
		/// </summary>	
		public ThueThanhToanBoSungTest()
		{				
		}
		...
		/// <summary>
		/// Selects a sample of  ThueThanhToanBoSung objects of the database.
		/// </summary>
		[NUnit.Framework.Test]
        ...
        ///</summary>
        static public ThueThanhToanBoSung CreateMockInstance(TransactionManager tm)
        {
            // get the default mock instance
            ThueThanhToanBoSung mock = ThueThanhToanBoSungTest.CreateMockInstance_Generated(tm);
        ...
        ///</summary>
        static public void UpdateMockInstance(TransactionManager tm, ThueThanhToanBoSung mock)
        {
            ThueThanhToanBoSungTest.UpdateMockInstance_Generated(tm, mock);
        ...
        static private void SetSpecialTestData(ThueThanhToanBoSung mock)
        {
