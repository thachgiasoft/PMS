...
{
    /// <summary>
    /// Provides tests for the <see cref="ViewChiTietGiangVien"/> objects (entity, collection and repository).
    /// </summary>
	/// <remarks>
    ...
    {
		/// <summary>
		/// Creates a new <see cref="ViewChiTietGiangVienTest"/> instance.
		/// </summary>	
		public ViewChiTietGiangVienTest()
		{			
		}
		...
		/// <summary>
		/// Selects all ViewChiTietGiangVien objects of the database.
		/// </summary>
