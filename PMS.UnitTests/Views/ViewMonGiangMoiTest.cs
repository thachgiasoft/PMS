...
{
    /// <summary>
    /// Provides tests for the <see cref="ViewMonGiangMoi"/> objects (entity, collection and repository).
    /// </summary>
	/// <remarks>
    ...
    {
		/// <summary>
		/// Creates a new <see cref="ViewMonGiangMoiTest"/> instance.
		/// </summary>	
		public ViewMonGiangMoiTest()
		{			
		}
		...
		/// <summary>
		/// Selects all ViewMonGiangMoi objects of the database.
		/// </summary>
