...
{
    /// <summary>
    /// Provides tests for the <see cref="ViewBangTienDoGiangDay"/> objects (entity, collection and repository).
    /// </summary>
	/// <remarks>
    ...
    {
		/// <summary>
		/// Creates a new <see cref="ViewBangTienDoGiangDayTest"/> instance.
		/// </summary>	
		public ViewBangTienDoGiangDayTest()
		{			
		}
		...
		/// <summary>
		/// Selects all ViewBangTienDoGiangDay objects of the database.
		/// </summary>
