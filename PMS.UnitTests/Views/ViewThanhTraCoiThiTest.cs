...
{
    /// <summary>
    /// Provides tests for the <see cref="ViewThanhTraCoiThi"/> objects (entity, collection and repository).
    /// </summary>
	/// <remarks>
    ...
    {
		/// <summary>
		/// Creates a new <see cref="ViewThanhTraCoiThiTest"/> instance.
		/// </summary>	
		public ViewThanhTraCoiThiTest()
		{			
		}
		...
		/// <summary>
		/// Selects all ViewThanhTraCoiThi objects of the database.
		/// </summary>
