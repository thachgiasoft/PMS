...
{
    /// <summary>
    /// Provides tests for the <see cref="ViewLopDaiDien"/> objects (entity, collection and repository).
    /// </summary>
	/// <remarks>
    ...
    {
		/// <summary>
		/// Creates a new <see cref="ViewLopDaiDienTest"/> instance.
		/// </summary>	
		public ViewLopDaiDienTest()
		{			
		}
		...
		/// <summary>
		/// Selects all ViewLopDaiDien objects of the database.
		/// </summary>
