...
{
    /// <summary>
    /// Provides tests for the <see cref="ViewThongKeChucVuChiTiet"/> objects (entity, collection and repository).
    /// </summary>
	/// <remarks>
    ...
    {
		/// <summary>
		/// Creates a new <see cref="ViewThongKeChucVuChiTietTest"/> instance.
		/// </summary>	
		public ViewThongKeChucVuChiTietTest()
		{			
		}
		...
		/// <summary>
		/// Selects all ViewThongKeChucVuChiTiet objects of the database.
		/// </summary>
