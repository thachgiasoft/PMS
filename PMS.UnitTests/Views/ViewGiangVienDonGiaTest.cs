...
{
    /// <summary>
    /// Provides tests for the <see cref="ViewGiangVienDonGia"/> objects (entity, collection and repository).
    /// </summary>
	/// <remarks>
    ...
    {
		/// <summary>
		/// Creates a new <see cref="ViewGiangVienDonGiaTest"/> instance.
		/// </summary>	
		public ViewGiangVienDonGiaTest()
		{			
		}
		...
		/// <summary>
		/// Selects all ViewGiangVienDonGia objects of the database.
		/// </summary>
