...
{
    /// <summary>
    /// Provides tests for the <see cref="ViewXetDuyetDeCuongLuanVanCaoHoc"/> objects (entity, collection and repository).
    /// </summary>
	/// <remarks>
    ...
    {
		/// <summary>
		/// Creates a new <see cref="ViewXetDuyetDeCuongLuanVanCaoHocTest"/> instance.
		/// </summary>	
		public ViewXetDuyetDeCuongLuanVanCaoHocTest()
		{			
		}
		...
		/// <summary>
		/// Selects all ViewXetDuyetDeCuongLuanVanCaoHoc objects of the database.
		/// </summary>
