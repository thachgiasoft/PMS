...
{
    /// <summary>
    /// Provides tests for the <see cref="ViewPhanNhomLopHocPhan"/> objects (entity, collection and repository).
    /// </summary>
	/// <remarks>
    ...
    {
		/// <summary>
		/// Creates a new <see cref="ViewPhanNhomLopHocPhanTest"/> instance.
		/// </summary>	
		public ViewPhanNhomLopHocPhanTest()
		{			
		}
		...
		/// <summary>
		/// Selects all ViewPhanNhomLopHocPhan objects of the database.
		/// </summary>
