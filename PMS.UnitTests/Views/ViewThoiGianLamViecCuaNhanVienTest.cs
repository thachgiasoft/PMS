...
{
    /// <summary>
    /// Provides tests for the <see cref="ViewThoiGianLamViecCuaNhanVien"/> objects (entity, collection and repository).
    /// </summary>
	/// <remarks>
    ...
    {
		/// <summary>
		/// Creates a new <see cref="ViewThoiGianLamViecCuaNhanVienTest"/> instance.
		/// </summary>	
		public ViewThoiGianLamViecCuaNhanVienTest()
		{			
		}
		...
		/// <summary>
		/// Selects all ViewThoiGianLamViecCuaNhanVien objects of the database.
		/// </summary>
