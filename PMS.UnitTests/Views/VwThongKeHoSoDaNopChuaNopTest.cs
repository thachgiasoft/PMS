...
{
    /// <summary>
    /// Provides tests for the <see cref="VwThongKeHoSoDaNopChuaNop"/> objects (entity, collection and repository).
    /// </summary>
	/// <remarks>
    ...
    {
		/// <summary>
		/// Creates a new <see cref="VwThongKeHoSoDaNopChuaNopTest"/> instance.
		/// </summary>	
		public VwThongKeHoSoDaNopChuaNopTest()
		{			
		}
		...
		/// <summary>
		/// Selects all VwThongKeHoSoDaNopChuaNop objects of the database.
		/// </summary>
