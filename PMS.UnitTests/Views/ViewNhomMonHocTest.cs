...
{
    /// <summary>
    /// Provides tests for the <see cref="ViewNhomMonHoc"/> objects (entity, collection and repository).
    /// </summary>
	/// <remarks>
    ...
    {
		/// <summary>
		/// Creates a new <see cref="ViewNhomMonHocTest"/> instance.
		/// </summary>	
		public ViewNhomMonHocTest()
		{			
		}
		...
		/// <summary>
		/// Selects all ViewNhomMonHoc objects of the database.
		/// </summary>
