...
{
    /// <summary>
    /// Provides tests for the <see cref="ViewLuongGiangVien"/> objects (entity, collection and repository).
    /// </summary>
	/// <remarks>
    ...
    {
		/// <summary>
		/// Creates a new <see cref="ViewLuongGiangVienTest"/> instance.
		/// </summary>	
		public ViewLuongGiangVienTest()
		{			
		}
		...
		/// <summary>
		/// Selects all ViewLuongGiangVien objects of the database.
		/// </summary>
