...
{
    /// <summary>
    /// Provides tests for the <see cref="ViewHinhThucThi"/> objects (entity, collection and repository).
    /// </summary>
	/// <remarks>
    ...
    {
		/// <summary>
		/// Creates a new <see cref="ViewHinhThucThiTest"/> instance.
		/// </summary>	
		public ViewHinhThucThiTest()
		{			
		}
		...
		/// <summary>
		/// Selects all ViewHinhThucThi objects of the database.
		/// </summary>
