...
namespace PMS.UnitTests
{
    ...
    {    	
		/// <summary>
		/// Creates a new <see cref="GiangVienTamUngChiTietTest"/> instance.
		/// </summary>	
		public GiangVienTamUngChiTietTest()
		{				
		}
		...
		/// <summary>
		/// Selects a sample of  GiangVienTamUngChiTiet objects of the database.
		/// </summary>
		[NUnit.Framework.Test]
        ...
        ///</summary>
        static public GiangVienTamUngChiTiet CreateMockInstance(TransactionManager tm)
        {
            // get the default mock instance
            GiangVienTamUngChiTiet mock = GiangVienTamUngChiTietTest.CreateMockInstance_Generated(tm);
        ...
        ///</summary>
        static public void UpdateMockInstance(TransactionManager tm, GiangVienTamUngChiTiet mock)
        {
            GiangVienTamUngChiTietTest.UpdateMockInstance_Generated(tm, mock);
        ...
        static private void SetSpecialTestData(GiangVienTamUngChiTiet mock)
        {
