...
namespace PMS.UnitTests
{
    ...
    {    	
		/// <summary>
		/// Creates a new <see cref="ThuLaoRaDeThiVhuexTest"/> instance.
		/// </summary>	
		public ThuLaoRaDeThiVhuexTest()
		{				
		}
		...
		/// <summary>
		/// Selects a sample of  ThuLaoRaDeThiVhuex objects of the database.
		/// </summary>
		[NUnit.Framework.Test]
        ...
        ///</summary>
        static public ThuLaoRaDeThiVhuex CreateMockInstance(TransactionManager tm)
        {
            // get the default mock instance
            ThuLaoRaDeThiVhuex mock = ThuLaoRaDeThiVhuexTest.CreateMockInstance_Generated(tm);
        ...
        ///</summary>
        static public void UpdateMockInstance(TransactionManager tm, ThuLaoRaDeThiVhuex mock)
        {
            ThuLaoRaDeThiVhuexTest.UpdateMockInstance_Generated(tm, mock);
        ...
        static private void SetSpecialTestData(ThuLaoRaDeThiVhuex mock)
        {
