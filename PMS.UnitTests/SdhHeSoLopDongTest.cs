...
namespace PMS.UnitTests
{
    ...
    {    	
		/// <summary>
		/// Creates a new <see cref="SdhHeSoLopDongTest"/> instance.
		/// </summary>	
		public SdhHeSoLopDongTest()
		{				
		}
		...
		/// <summary>
		/// Selects a sample of  SdhHeSoLopDong objects of the database.
		/// </summary>
		[NUnit.Framework.Test]
        ...
        ///</summary>
        static public SdhHeSoLopDong CreateMockInstance(TransactionManager tm)
        {
            // get the default mock instance
            SdhHeSoLopDong mock = SdhHeSoLopDongTest.CreateMockInstance_Generated(tm);
        ...
        ///</summary>
        static public void UpdateMockInstance(TransactionManager tm, SdhHeSoLopDong mock)
        {
            SdhHeSoLopDongTest.UpdateMockInstance_Generated(tm, mock);
        ...
        static private void SetSpecialTestData(SdhHeSoLopDong mock)
        {
