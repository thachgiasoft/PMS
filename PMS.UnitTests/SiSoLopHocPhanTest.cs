...
namespace PMS.UnitTests
{
    ...
    {    	
		/// <summary>
		/// Creates a new <see cref="SiSoLopHocPhanTest"/> instance.
		/// </summary>	
		public SiSoLopHocPhanTest()
		{				
		}
		...
		/// <summary>
		/// Selects a sample of  SiSoLopHocPhan objects of the database.
		/// </summary>
		[NUnit.Framework.Test]
        ...
        ///</summary>
        static public SiSoLopHocPhan CreateMockInstance(TransactionManager tm)
        {
            // get the default mock instance
            SiSoLopHocPhan mock = SiSoLopHocPhanTest.CreateMockInstance_Generated(tm);
        ...
        ///</summary>
        static public void UpdateMockInstance(TransactionManager tm, SiSoLopHocPhan mock)
        {
            SiSoLopHocPhanTest.UpdateMockInstance_Generated(tm, mock);
        ...
        static private void SetSpecialTestData(SiSoLopHocPhan mock)
        {
