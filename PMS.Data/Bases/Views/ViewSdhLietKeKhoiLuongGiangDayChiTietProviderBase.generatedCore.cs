...
{	
	///<summary>
	/// This class is the base class for any <see cref="ViewSdhLietKeKhoiLuongGiangDayChiTietProviderBase"/> implementation.
	/// It exposes CRUD methods as well as selecting on index, foreign keys and custom stored procedures.
	///</summary>
	public abstract class ViewSdhLietKeKhoiLuongGiangDayChiTietProviderBaseCore : EntityViewProviderBase<ViewSdhLietKeKhoiLuongGiangDayChiTiet>
	{
		#region Custom Methods
		
		
		#region cust_View_SdhLietKeKhoiLuongGiangDayChiTiet_GetByNamHocHocKy
		
		/// <summary>
		///	This method wrap the 'cust_View_SdhLietKeKhoiLuongGiangDayChiTiet_GetByNamHocHocKy' stored procedure. 
		/// </summary>
		/// <param name="namHoc"> A <c>System.String</c> instance.</param>
		/// <param name="hocKy"> A <c>System.String</c> instance.</param>
		/// <remark>This method is generate from a stored procedure.</remark>
		/// <returns>A <see cref="VList&lt;ViewSdhLietKeKhoiLuongGiangDayChiTiet&gt;"/> instance.</returns>
		public VList<ViewSdhLietKeKhoiLuongGiangDayChiTiet> GetByNamHocHocKy(System.String namHoc, System.String hocKy)
		{
		...
		/// <remark>This method is generate from a stored procedure.</remark>
		/// <returns>A <see cref="VList&lt;ViewSdhLietKeKhoiLuongGiangDayChiTiet&gt;"/> instance.</returns>
		public VList<ViewSdhLietKeKhoiLuongGiangDayChiTiet> GetByNamHocHocKy(int start, int pageLength, System.String namHoc, System.String hocKy)
		{
		...
		/// <returns>A <see cref="VList&lt;ViewSdhLietKeKhoiLuongGiangDayChiTiet&gt;"/> instance.</returns>
		public VList<ViewSdhLietKeKhoiLuongGiangDayChiTiet> GetByNamHocHocKy(TransactionManager transactionManager, System.String namHoc, System.String hocKy)
		{
		...
		/// <remark>This method is generate from a stored procedure.</remark>
		/// <returns>A <see cref="VList&lt;ViewSdhLietKeKhoiLuongGiangDayChiTiet&gt;"/> instance.</returns>
		public abstract VList<ViewSdhLietKeKhoiLuongGiangDayChiTiet> GetByNamHocHocKy(TransactionManager transactionManager, int start, int pageLength, System.String namHoc, System.String hocKy);
		...
		/*
		///<summary>
		/// Fill an VList&lt;ViewSdhLietKeKhoiLuongGiangDayChiTiet&gt; From a DataSet
		///</summary>
		/// <param name="dataSet">the DataSet</param>
		/// <param name="rows">The collection to fill</param>
		/// <param name="start">Start row</param>
		/// <param name="pagelen">number of row.</param>
		///<returns><see chref="VList&lt;ViewSdhLietKeKhoiLuongGiangDayChiTiet&gt;"/></returns>
		protected static VList&lt;ViewSdhLietKeKhoiLuongGiangDayChiTiet&gt; Fill(DataSet dataSet, VList<ViewSdhLietKeKhoiLuongGiangDayChiTiet> rows, int start, int pagelen)
		{
			...
			{
				return new VList<ViewSdhLietKeKhoiLuongGiangDayChiTiet>();
			}	
		}
		
		
		///<summary>
		/// Fill an VList&lt;ViewSdhLietKeKhoiLuongGiangDayChiTiet&gt; From a DataTable
		///</summary>
		...
		/// <param name="pagelen">number of row.</param>
		///<returns><see chref="VList<ViewSdhLietKeKhoiLuongGiangDayChiTiet>"/></returns>
		protected static VList&lt;ViewSdhLietKeKhoiLuongGiangDayChiTiet&gt; Fill(DataTable dataTable, VList<ViewSdhLietKeKhoiLuongGiangDayChiTiet> rows, int start, int pagelen)
		{
			int recordnum = 0;
			...
			while (dataRows.MoveNext() && (pagelen != 0))
			{
				if(recordnum >= start)
				{
					...
					ViewSdhLietKeKhoiLuongGiangDayChiTiet c = new ViewSdhLietKeKhoiLuongGiangDayChiTiet();
					...
					c.DonGiaQuyDoi = (Convert.IsDBNull(row["DonGiaQuyDoi"]))?0.0m:(System.Decimal?)row["DonGiaQuyDoi"];
					c.TienChamBai = (Convert.IsDBNull(row["TienChamBai"]))?0.0m:(System.Decimal?)row["TienChamBai"];
		...
		*/	
		...
		///<summary>
		/// Fill an <see cref="VList&lt;ViewSdhLietKeKhoiLuongGiangDayChiTiet&gt;"/> From a DataReader.
		///</summary>
		/// <param name="reader">Datareader</param>
		/// <param name="rows">The collection to fill</param>
		/// <param name="start">Start row</param>
		/// <param name="pageLength">number of row.</param>
		///<returns>a <see cref="VList&lt;ViewSdhLietKeKhoiLuongGiangDayChiTiet&gt;"/></returns>
		protected VList<ViewSdhLietKeKhoiLuongGiangDayChiTiet> Fill(IDataReader reader, VList<ViewSdhLietKeKhoiLuongGiangDayChiTiet> rows, int start, int pageLength)
		{
			int recordnum = 0;
			while (reader.Read() && (pageLength != 0))
			{
				if(recordnum >= start)
				{
					ViewSdhLietKeKhoiLuongGiangDayChiTiet entity = null;
					if (DataRepository.Provider.UseEntityFactory)
					{
						entity = EntityManager.CreateViewEntity<ViewSdhLietKeKhoiLuongGiangDayChiTiet>("ViewSdhLietKeKhoiLuongGiangDayChiTiet",  DataRepository.Provider.EntityCreationalFactoryType); 
					}
					else
					{
						entity = new ViewSdhLietKeKhoiLuongGiangDayChiTiet();
					}
					...
					entity.DonGiaQuyDoi = reader.IsDBNull(reader.GetOrdinal("DonGiaQuyDoi")) ? null : (System.Decimal?)reader["DonGiaQuyDoi"];
					//entity.DonGiaQuyDoi = (Convert.IsDBNull(reader["DonGiaQuyDoi"]))?0.0m:(System.Decimal?)reader["DonGiaQuyDoi"];
					entity.TienChamBai = reader.IsDBNull(reader.GetOrdinal("TienChamBai")) ? null : (System.Decimal?)reader["TienChamBai"];
					//entity.TienChamBai = (Convert.IsDBNull(reader["TienChamBai"]))?0.0m:(System.Decimal?)reader["TienChamBai"];
		...
		/// <summary>
		/// Refreshes the <see cref="ViewSdhLietKeKhoiLuongGiangDayChiTiet"/> object from the <see cref="IDataReader"/>.
		/// </summary>
		/// <param name="reader">The <see cref="IDataReader"/> to read from.</param>
		/// <param name="entity">The <see cref="ViewSdhLietKeKhoiLuongGiangDayChiTiet"/> object to refresh.</param>
		protected void RefreshEntity(IDataReader reader, ViewSdhLietKeKhoiLuongGiangDayChiTiet entity)
		{
			reader.Read();
			entity.MaQuanLy = reader.IsDBNull(reader.GetOrdinal("MaQuanLy")) ? null : (System.String)reader["MaQuanLy"];
			//entity.MaQuanLy = (Convert.IsDBNull(reader["MaQuanLy"]))?string.Empty:(System.String)reader["MaQuanLy"];
		...
		/*
		/// <summary>
		/// Refreshes the <see cref="ViewSdhLietKeKhoiLuongGiangDayChiTiet"/> object from the <see cref="DataSet"/>.
		/// </summary>
		/// <param name="dataSet">The <see cref="DataSet"/> to read from.</param>
		/// <param name="entity">The <see cref="ViewSdhLietKeKhoiLuongGiangDayChiTiet"/> object.</param>
		protected static void RefreshEntity(DataSet dataSet, ViewSdhLietKeKhoiLuongGiangDayChiTiet entity)
		{
			...
			entity.DonGiaQuyDoi = (Convert.IsDBNull(dataRow["DonGiaQuyDoi"]))?0.0m:(System.Decimal?)dataRow["DonGiaQuyDoi"];
			entity.TienChamBai = (Convert.IsDBNull(dataRow["TienChamBai"]))?0.0m:(System.Decimal?)dataRow["TienChamBai"];
	...
	#region ViewSdhLietKeKhoiLuongGiangDayChiTietFilterBuilder
	...
	/// </summary>
	[CLSCompliant(true)]
	public class ViewSdhLietKeKhoiLuongGiangDayChiTietFilterBuilder : SqlFilterBuilder<ViewSdhLietKeKhoiLuongGiangDayChiTietColumn>
	{
		#region Constructors

		/// <summary>
		/// Initializes a new instance of the ViewSdhLietKeKhoiLuongGiangDayChiTietFilterBuilder class.
		/// </summary>
		public ViewSdhLietKeKhoiLuongGiangDayChiTietFilterBuilder() : base() { }

		/// <summary>
		/// Initializes a new instance of the ViewSdhLietKeKhoiLuongGiangDayChiTietFilterBuilder class.
		/// </summary>
		/// <param name="ignoreCase">Specifies whether to create case-insensitive statements.</param>
		public ViewSdhLietKeKhoiLuongGiangDayChiTietFilterBuilder(bool ignoreCase) : base(ignoreCase) { }
		...
		public ViewSdhLietKeKhoiLuongGiangDayChiTietFilterBuilder(bool ignoreCase, bool useAnd) : base(ignoreCase, useAnd) { }

		#endregion Constructors
	}

	#endregion ViewSdhLietKeKhoiLuongGiangDayChiTietFilterBuilder

	#region ViewSdhLietKeKhoiLuongGiangDayChiTietParameterBuilder
	...
	/// </summary>
	[CLSCompliant(true)]
	public class ViewSdhLietKeKhoiLuongGiangDayChiTietParameterBuilder : ParameterizedSqlFilterBuilder<ViewSdhLietKeKhoiLuongGiangDayChiTietColumn>
	{
		#region Constructors

		/// <summary>
		/// Initializes a new instance of the ViewSdhLietKeKhoiLuongGiangDayChiTietParameterBuilder class.
		/// </summary>
		public ViewSdhLietKeKhoiLuongGiangDayChiTietParameterBuilder() : base() { }

		/// <summary>
		/// Initializes a new instance of the ViewSdhLietKeKhoiLuongGiangDayChiTietParameterBuilder class.
		/// </summary>
		/// <param name="ignoreCase">Specifies whether to create case-insensitive statements.</param>
		public ViewSdhLietKeKhoiLuongGiangDayChiTietParameterBuilder(bool ignoreCase) : base(ignoreCase) { }
		...
		/// <param name="ignoreCase">Specifies whether to create case-insensitive statements.</param>
		/// <param name="useAnd">Specifies whether to combine statements using AND or OR.</param>
		public ViewSdhLietKeKhoiLuongGiangDayChiTietParameterBuilder(bool ignoreCase, bool useAnd) : base(ignoreCase, useAnd) { }

		#endregion Constructors
	}

	#endregion ViewSdhLietKeKhoiLuongGiangDayChiTietParameterBuilder
	
	#region ViewSdhLietKeKhoiLuongGiangDayChiTietSortBuilder
    ...
    /// </summary>
    [CLSCompliant(true)]
    public class ViewSdhLietKeKhoiLuongGiangDayChiTietSortBuilder : SqlSortBuilder<ViewSdhLietKeKhoiLuongGiangDayChiTietColumn>
    {
		#region Constructors

		/// <summary>
		/// Initializes a new instance of the ViewSdhLietKeKhoiLuongGiangDayChiTietSqlSortBuilder class.
		/// </summary>
		public ViewSdhLietKeKhoiLuongGiangDayChiTietSortBuilder() : base() { }

		#endregion Constructors

    }    
    #endregion ViewSdhLietKeKhoiLuongGiangDayChiTietSortBuilder
