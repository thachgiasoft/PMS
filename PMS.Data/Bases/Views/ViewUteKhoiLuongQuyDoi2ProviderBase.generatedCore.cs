...
{	
	///<summary>
	/// This class is the base class for any <see cref="ViewUteKhoiLuongQuyDoi2ProviderBase"/> implementation.
	/// It exposes CRUD methods as well as selecting on index, foreign keys and custom stored procedures.
	///</summary>
	public abstract class ViewUteKhoiLuongQuyDoi2ProviderBaseCore : EntityViewProviderBase<ViewUteKhoiLuongQuyDoi2>
	{
		...
		public VList<ViewUteKhoiLuongQuyDoi2> GetByNamHocHocKy(System.String namHoc, System.String hocKy)
		{
		...
		/// <remark>This method is generate from a stored procedure.</remark>
		/// <returns>A <see cref="VList&lt;ViewUteKhoiLuongQuyDoi2&gt;"/> instance.</returns>
		public VList<ViewUteKhoiLuongQuyDoi2> GetByNamHocHocKy(int start, int pageLength, System.String namHoc, System.String hocKy)
		{
		...
		/// <returns>A <see cref="VList&lt;ViewUteKhoiLuongQuyDoi2&gt;"/> instance.</returns>
		public VList<ViewUteKhoiLuongQuyDoi2> GetByNamHocHocKy(TransactionManager transactionManager, System.String namHoc, System.String hocKy)
		{
		...
		/// <remark>This method is generate from a stored procedure.</remark>
		/// <returns>A <see cref="VList&lt;ViewUteKhoiLuongQuyDoi2&gt;"/> instance.</returns>
		public abstract VList<ViewUteKhoiLuongQuyDoi2> GetByNamHocHocKy(TransactionManager transactionManager, int start, int pageLength, System.String namHoc, System.String hocKy);
		...
		/*
		///<summary>
		/// Fill an VList&lt;ViewUteKhoiLuongQuyDoi2&gt; From a DataSet
		///</summary>
		/// <param name="dataSet">the DataSet</param>
		/// <param name="rows">The collection to fill</param>
		/// <param name="start">Start row</param>
		/// <param name="pagelen">number of row.</param>
		///<returns><see chref="VList&lt;ViewUteKhoiLuongQuyDoi2&gt;"/></returns>
		protected static VList&lt;ViewUteKhoiLuongQuyDoi2&gt; Fill(DataSet dataSet, VList<ViewUteKhoiLuongQuyDoi2> rows, int start, int pagelen)
		{
			...
			{
				return new VList<ViewUteKhoiLuongQuyDoi2>();
			}	
		}
		
		
		///<summary>
		/// Fill an VList&lt;ViewUteKhoiLuongQuyDoi2&gt; From a DataTable
		///</summary>
		...
		/// <param name="pagelen">number of row.</param>
		///<returns><see chref="VList<ViewUteKhoiLuongQuyDoi2>"/></returns>
		protected static VList&lt;ViewUteKhoiLuongQuyDoi2&gt; Fill(DataTable dataTable, VList<ViewUteKhoiLuongQuyDoi2> rows, int start, int pagelen)
		{
			int recordnum = 0;
			...
			while (dataRows.MoveNext() && (pagelen != 0))
			{
				if(recordnum >= start)
				{
					...
					ViewUteKhoiLuongQuyDoi2 c = new ViewUteKhoiLuongQuyDoi2();
		...
		*/	
		...
		///<summary>
		/// Fill an <see cref="VList&lt;ViewUteKhoiLuongQuyDoi2&gt;"/> From a DataReader.
		///</summary>
		/// <param name="reader">Datareader</param>
		/// <param name="rows">The collection to fill</param>
		/// <param name="start">Start row</param>
		/// <param name="pageLength">number of row.</param>
		///<returns>a <see cref="VList&lt;ViewUteKhoiLuongQuyDoi2&gt;"/></returns>
		protected VList<ViewUteKhoiLuongQuyDoi2> Fill(IDataReader reader, VList<ViewUteKhoiLuongQuyDoi2> rows, int start, int pageLength)
		{
			int recordnum = 0;
			while (reader.Read() && (pageLength != 0))
			{
				if(recordnum >= start)
				{
					ViewUteKhoiLuongQuyDoi2 entity = null;
					if (DataRepository.Provider.UseEntityFactory)
					{
						entity = EntityManager.CreateViewEntity<ViewUteKhoiLuongQuyDoi2>("ViewUteKhoiLuongQuyDoi2",  DataRepository.Provider.EntityCreationalFactoryType); 
					}
					else
					{
						entity = new ViewUteKhoiLuongQuyDoi2();
					}
		...
		/// <summary>
		/// Refreshes the <see cref="ViewUteKhoiLuongQuyDoi2"/> object from the <see cref="IDataReader"/>.
		/// </summary>
		/// <param name="reader">The <see cref="IDataReader"/> to read from.</param>
		/// <param name="entity">The <see cref="ViewUteKhoiLuongQuyDoi2"/> object to refresh.</param>
		protected void RefreshEntity(IDataReader reader, ViewUteKhoiLuongQuyDoi2 entity)
		{
			reader.Read();
			entity.Id = (System.Int32)reader["Id"];
			//entity.Id = (Convert.IsDBNull(reader["Id"]))?(int)0:(System.Int32)reader["Id"];
		...
		/*
		/// <summary>
		/// Refreshes the <see cref="ViewUteKhoiLuongQuyDoi2"/> object from the <see cref="DataSet"/>.
		/// </summary>
		/// <param name="dataSet">The <see cref="DataSet"/> to read from.</param>
		/// <param name="entity">The <see cref="ViewUteKhoiLuongQuyDoi2"/> object.</param>
		protected static void RefreshEntity(DataSet dataSet, ViewUteKhoiLuongQuyDoi2 entity)
		{
	...
	#region ViewUteKhoiLuongQuyDoi2FilterBuilder
	...
	/// </summary>
	[CLSCompliant(true)]
	public class ViewUteKhoiLuongQuyDoi2FilterBuilder : SqlFilterBuilder<ViewUteKhoiLuongQuyDoi2Column>
	{
		#region Constructors

		/// <summary>
		/// Initializes a new instance of the ViewUteKhoiLuongQuyDoi2FilterBuilder class.
		/// </summary>
		public ViewUteKhoiLuongQuyDoi2FilterBuilder() : base() { }

		/// <summary>
		/// Initializes a new instance of the ViewUteKhoiLuongQuyDoi2FilterBuilder class.
		/// </summary>
		/// <param name="ignoreCase">Specifies whether to create case-insensitive statements.</param>
		public ViewUteKhoiLuongQuyDoi2FilterBuilder(bool ignoreCase) : base(ignoreCase) { }
		...
		public ViewUteKhoiLuongQuyDoi2FilterBuilder(bool ignoreCase, bool useAnd) : base(ignoreCase, useAnd) { }

		#endregion Constructors
	}

	#endregion ViewUteKhoiLuongQuyDoi2FilterBuilder

	#region ViewUteKhoiLuongQuyDoi2ParameterBuilder
	...
	/// </summary>
	[CLSCompliant(true)]
	public class ViewUteKhoiLuongQuyDoi2ParameterBuilder : ParameterizedSqlFilterBuilder<ViewUteKhoiLuongQuyDoi2Column>
	{
		#region Constructors

		/// <summary>
		/// Initializes a new instance of the ViewUteKhoiLuongQuyDoi2ParameterBuilder class.
		/// </summary>
		public ViewUteKhoiLuongQuyDoi2ParameterBuilder() : base() { }

		/// <summary>
		/// Initializes a new instance of the ViewUteKhoiLuongQuyDoi2ParameterBuilder class.
		/// </summary>
		/// <param name="ignoreCase">Specifies whether to create case-insensitive statements.</param>
		public ViewUteKhoiLuongQuyDoi2ParameterBuilder(bool ignoreCase) : base(ignoreCase) { }
		...
		/// <param name="ignoreCase">Specifies whether to create case-insensitive statements.</param>
		/// <param name="useAnd">Specifies whether to combine statements using AND or OR.</param>
		public ViewUteKhoiLuongQuyDoi2ParameterBuilder(bool ignoreCase, bool useAnd) : base(ignoreCase, useAnd) { }

		#endregion Constructors
	}

	#endregion ViewUteKhoiLuongQuyDoi2ParameterBuilder
	
	#region ViewUteKhoiLuongQuyDoi2SortBuilder
    ...
    /// </summary>
    [CLSCompliant(true)]
    public class ViewUteKhoiLuongQuyDoi2SortBuilder : SqlSortBuilder<ViewUteKhoiLuongQuyDoi2Column>
    {
		#region Constructors

		/// <summary>
		/// Initializes a new instance of the ViewUteKhoiLuongQuyDoi2SqlSortBuilder class.
		/// </summary>
		public ViewUteKhoiLuongQuyDoi2SortBuilder() : base() { }

		#endregion Constructors

    }    
    #endregion ViewUteKhoiLuongQuyDoi2SortBuilder
