...
{	
	///<summary>
	/// This class is the base class for any <see cref="ViewThongTinChiTietGiangVienChoDuyetHoSoProviderBase"/> implementation.
	/// It exposes CRUD methods as well as selecting on index, foreign keys and custom stored procedures.
	///</summary>
	public abstract class ViewThongTinChiTietGiangVienChoDuyetHoSoProviderBaseCore : EntityViewProviderBase<ViewThongTinChiTietGiangVienChoDuyetHoSo>
	{
		...
		public VList<ViewThongTinChiTietGiangVienChoDuyetHoSo> GetByMaDonViMaHocHamMaHocViMaTinhTrang(System.String maDonVi, System.Int32 maHocHam, System.Int32 maHocVi, System.String maTinhTrang)
		{
		...
		/// <remark>This method is generate from a stored procedure.</remark>
		/// <returns>A <see cref="VList&lt;ViewThongTinChiTietGiangVienChoDuyetHoSo&gt;"/> instance.</returns>
		public VList<ViewThongTinChiTietGiangVienChoDuyetHoSo> GetByMaDonViMaHocHamMaHocViMaTinhTrang(int start, int pageLength, System.String maDonVi, System.Int32 maHocHam, System.Int32 maHocVi, System.String maTinhTrang)
		{
		...
		/// <returns>A <see cref="VList&lt;ViewThongTinChiTietGiangVienChoDuyetHoSo&gt;"/> instance.</returns>
		public VList<ViewThongTinChiTietGiangVienChoDuyetHoSo> GetByMaDonViMaHocHamMaHocViMaTinhTrang(TransactionManager transactionManager, System.String maDonVi, System.Int32 maHocHam, System.Int32 maHocVi, System.String maTinhTrang)
		{
		...
		/// <remark>This method is generate from a stored procedure.</remark>
		/// <returns>A <see cref="VList&lt;ViewThongTinChiTietGiangVienChoDuyetHoSo&gt;"/> instance.</returns>
		public abstract VList<ViewThongTinChiTietGiangVienChoDuyetHoSo> GetByMaDonViMaHocHamMaHocViMaTinhTrang(TransactionManager transactionManager, int start, int pageLength, System.String maDonVi, System.Int32 maHocHam, System.Int32 maHocVi, System.String maTinhTrang);
		...
		/*
		///<summary>
		/// Fill an VList&lt;ViewThongTinChiTietGiangVienChoDuyetHoSo&gt; From a DataSet
		///</summary>
		/// <param name="dataSet">the DataSet</param>
		/// <param name="rows">The collection to fill</param>
		/// <param name="start">Start row</param>
		/// <param name="pagelen">number of row.</param>
		///<returns><see chref="VList&lt;ViewThongTinChiTietGiangVienChoDuyetHoSo&gt;"/></returns>
		protected static VList&lt;ViewThongTinChiTietGiangVienChoDuyetHoSo&gt; Fill(DataSet dataSet, VList<ViewThongTinChiTietGiangVienChoDuyetHoSo> rows, int start, int pagelen)
		{
			...
			{
				return new VList<ViewThongTinChiTietGiangVienChoDuyetHoSo>();
			}	
		}
		
		
		///<summary>
		/// Fill an VList&lt;ViewThongTinChiTietGiangVienChoDuyetHoSo&gt; From a DataTable
		///</summary>
		...
		/// <param name="pagelen">number of row.</param>
		///<returns><see chref="VList<ViewThongTinChiTietGiangVienChoDuyetHoSo>"/></returns>
		protected static VList&lt;ViewThongTinChiTietGiangVienChoDuyetHoSo&gt; Fill(DataTable dataTable, VList<ViewThongTinChiTietGiangVienChoDuyetHoSo> rows, int start, int pagelen)
		{
			int recordnum = 0;
			...
			while (dataRows.MoveNext() && (pagelen != 0))
			{
				if(recordnum >= start)
				{
					...
					ViewThongTinChiTietGiangVienChoDuyetHoSo c = new ViewThongTinChiTietGiangVienChoDuyetHoSo();
					...
					c.DaDuyet = (Convert.IsDBNull(row["DaDuyet"]))?false:(System.Boolean?)row["DaDuyet"];
					c.AcceptChanges();
					rows.Add(c);
					pagelen -= 1;
				}
		...
		*/	
		...
		///<summary>
		/// Fill an <see cref="VList&lt;ViewThongTinChiTietGiangVienChoDuyetHoSo&gt;"/> From a DataReader.
		///</summary>
		/// <param name="reader">Datareader</param>
		/// <param name="rows">The collection to fill</param>
		/// <param name="start">Start row</param>
		/// <param name="pageLength">number of row.</param>
		///<returns>a <see cref="VList&lt;ViewThongTinChiTietGiangVienChoDuyetHoSo&gt;"/></returns>
		protected VList<ViewThongTinChiTietGiangVienChoDuyetHoSo> Fill(IDataReader reader, VList<ViewThongTinChiTietGiangVienChoDuyetHoSo> rows, int start, int pageLength)
		{
			int recordnum = 0;
			while (reader.Read() && (pageLength != 0))
			{
				if(recordnum >= start)
				{
					ViewThongTinChiTietGiangVienChoDuyetHoSo entity = null;
					if (DataRepository.Provider.UseEntityFactory)
					{
						entity = EntityManager.CreateViewEntity<ViewThongTinChiTietGiangVienChoDuyetHoSo>("ViewThongTinChiTietGiangVienChoDuyetHoSo",  DataRepository.Provider.EntityCreationalFactoryType); 
					}
					else
					{
						entity = new ViewThongTinChiTietGiangVienChoDuyetHoSo();
					}
					...
					entity.DaDuyet = reader.IsDBNull(reader.GetOrdinal("DaDuyet")) ? null : (System.Boolean?)reader["DaDuyet"];
					//entity.DaDuyet = (Convert.IsDBNull(reader["DaDuyet"]))?false:(System.Boolean?)reader["DaDuyet"];
		...
		/// <summary>
		/// Refreshes the <see cref="ViewThongTinChiTietGiangVienChoDuyetHoSo"/> object from the <see cref="IDataReader"/>.
		/// </summary>
		/// <param name="reader">The <see cref="IDataReader"/> to read from.</param>
		/// <param name="entity">The <see cref="ViewThongTinChiTietGiangVienChoDuyetHoSo"/> object to refresh.</param>
		protected void RefreshEntity(IDataReader reader, ViewThongTinChiTietGiangVienChoDuyetHoSo entity)
		{
			reader.Read();
			entity.MaQuanLy = reader.IsDBNull(reader.GetOrdinal("MaQuanLy")) ? null : (System.String)reader["MaQuanLy"];
			//entity.MaQuanLy = (Convert.IsDBNull(reader["MaQuanLy"]))?string.Empty:(System.String)reader["MaQuanLy"];
		...
		/*
		/// <summary>
		/// Refreshes the <see cref="ViewThongTinChiTietGiangVienChoDuyetHoSo"/> object from the <see cref="DataSet"/>.
		/// </summary>
		/// <param name="dataSet">The <see cref="DataSet"/> to read from.</param>
		/// <param name="entity">The <see cref="ViewThongTinChiTietGiangVienChoDuyetHoSo"/> object.</param>
		protected static void RefreshEntity(DataSet dataSet, ViewThongTinChiTietGiangVienChoDuyetHoSo entity)
		{
			...
			entity.DaDuyet = (Convert.IsDBNull(dataRow["DaDuyet"]))?false:(System.Boolean?)dataRow["DaDuyet"];
			entity.AcceptChanges();
		}
		*/
	...
	#region ViewThongTinChiTietGiangVienChoDuyetHoSoFilterBuilder
	...
	/// </summary>
	[CLSCompliant(true)]
	public class ViewThongTinChiTietGiangVienChoDuyetHoSoFilterBuilder : SqlFilterBuilder<ViewThongTinChiTietGiangVienChoDuyetHoSoColumn>
	{
		#region Constructors

		/// <summary>
		/// Initializes a new instance of the ViewThongTinChiTietGiangVienChoDuyetHoSoFilterBuilder class.
		/// </summary>
		public ViewThongTinChiTietGiangVienChoDuyetHoSoFilterBuilder() : base() { }

		/// <summary>
		/// Initializes a new instance of the ViewThongTinChiTietGiangVienChoDuyetHoSoFilterBuilder class.
		/// </summary>
		/// <param name="ignoreCase">Specifies whether to create case-insensitive statements.</param>
		public ViewThongTinChiTietGiangVienChoDuyetHoSoFilterBuilder(bool ignoreCase) : base(ignoreCase) { }
		...
		public ViewThongTinChiTietGiangVienChoDuyetHoSoFilterBuilder(bool ignoreCase, bool useAnd) : base(ignoreCase, useAnd) { }

		#endregion Constructors
	}

	#endregion ViewThongTinChiTietGiangVienChoDuyetHoSoFilterBuilder

	#region ViewThongTinChiTietGiangVienChoDuyetHoSoParameterBuilder
	...
	/// </summary>
	[CLSCompliant(true)]
	public class ViewThongTinChiTietGiangVienChoDuyetHoSoParameterBuilder : ParameterizedSqlFilterBuilder<ViewThongTinChiTietGiangVienChoDuyetHoSoColumn>
	{
		#region Constructors

		/// <summary>
		/// Initializes a new instance of the ViewThongTinChiTietGiangVienChoDuyetHoSoParameterBuilder class.
		/// </summary>
		public ViewThongTinChiTietGiangVienChoDuyetHoSoParameterBuilder() : base() { }

		/// <summary>
		/// Initializes a new instance of the ViewThongTinChiTietGiangVienChoDuyetHoSoParameterBuilder class.
		/// </summary>
		/// <param name="ignoreCase">Specifies whether to create case-insensitive statements.</param>
		public ViewThongTinChiTietGiangVienChoDuyetHoSoParameterBuilder(bool ignoreCase) : base(ignoreCase) { }
		...
		/// <param name="ignoreCase">Specifies whether to create case-insensitive statements.</param>
		/// <param name="useAnd">Specifies whether to combine statements using AND or OR.</param>
		public ViewThongTinChiTietGiangVienChoDuyetHoSoParameterBuilder(bool ignoreCase, bool useAnd) : base(ignoreCase, useAnd) { }

		#endregion Constructors
	}

	#endregion ViewThongTinChiTietGiangVienChoDuyetHoSoParameterBuilder
	
	#region ViewThongTinChiTietGiangVienChoDuyetHoSoSortBuilder
    ...
    /// </summary>
    [CLSCompliant(true)]
    public class ViewThongTinChiTietGiangVienChoDuyetHoSoSortBuilder : SqlSortBuilder<ViewThongTinChiTietGiangVienChoDuyetHoSoColumn>
    {
		#region Constructors

		/// <summary>
		/// Initializes a new instance of the ViewThongTinChiTietGiangVienChoDuyetHoSoSqlSortBuilder class.
		/// </summary>
		public ViewThongTinChiTietGiangVienChoDuyetHoSoSortBuilder() : base() { }

		#endregion Constructors

    }    
    #endregion ViewThongTinChiTietGiangVienChoDuyetHoSoSortBuilder
