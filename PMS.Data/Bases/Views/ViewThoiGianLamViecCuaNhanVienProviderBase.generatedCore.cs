...
{	
	///<summary>
	/// This class is the base class for any <see cref="ViewThoiGianLamViecCuaNhanVienProviderBase"/> implementation.
	/// It exposes CRUD methods as well as selecting on index, foreign keys and custom stored procedures.
	///</summary>
	public abstract class ViewThoiGianLamViecCuaNhanVienProviderBaseCore : EntityViewProviderBase<ViewThoiGianLamViecCuaNhanVien>
	{
		#region Custom Methods
		
		
		#region cust_View_ThoiGianLamViecCuaNhanVien_GetByNamHoc
		
		/// <summary>
		///	This method wrap the 'cust_View_ThoiGianLamViecCuaNhanVien_GetByNamHoc' stored procedure. 
		/// </summary>
		/// <param name="namHoc"> A <c>System.String</c> instance.</param>
		/// <remark>This method is generate from a stored procedure.</remark>
		/// <returns>A <see cref="VList&lt;ViewThoiGianLamViecCuaNhanVien&gt;"/> instance.</returns>
		public VList<ViewThoiGianLamViecCuaNhanVien> GetByNamHoc(System.String namHoc)
		{
		...
		/// <remark>This method is generate from a stored procedure.</remark>
		/// <returns>A <see cref="VList&lt;ViewThoiGianLamViecCuaNhanVien&gt;"/> instance.</returns>
		public VList<ViewThoiGianLamViecCuaNhanVien> GetByNamHoc(int start, int pageLength, System.String namHoc)
		{
		...
		/// <returns>A <see cref="VList&lt;ViewThoiGianLamViecCuaNhanVien&gt;"/> instance.</returns>
		public VList<ViewThoiGianLamViecCuaNhanVien> GetByNamHoc(TransactionManager transactionManager, System.String namHoc)
		{
		...
		/// <remark>This method is generate from a stored procedure.</remark>
		/// <returns>A <see cref="VList&lt;ViewThoiGianLamViecCuaNhanVien&gt;"/> instance.</returns>
		public abstract VList<ViewThoiGianLamViecCuaNhanVien> GetByNamHoc(TransactionManager transactionManager, int start, int pageLength, System.String namHoc);
		
		#endregion

		
		#region cust_View_ThoiGianLamViecCuaNhanVien_GetByNamHocHocKy
		
		/// <summary>
		///	This method wrap the 'cust_View_ThoiGianLamViecCuaNhanVien_GetByNamHocHocKy' stored procedure. 
		/// </summary>
		/// <param name="namHoc"> A <c>System.String</c> instance.</param>
		/// <param name="hocKy"> A <c>System.String</c> instance.</param>
		/// <remark>This method is generate from a stored procedure.</remark>
		/// <returns>A <see cref="VList&lt;ViewThoiGianLamViecCuaNhanVien&gt;"/> instance.</returns>
		public VList<ViewThoiGianLamViecCuaNhanVien> GetByNamHocHocKy(System.String namHoc, System.String hocKy)
		{
		...
		/// <remark>This method is generate from a stored procedure.</remark>
		/// <returns>A <see cref="VList&lt;ViewThoiGianLamViecCuaNhanVien&gt;"/> instance.</returns>
		public VList<ViewThoiGianLamViecCuaNhanVien> GetByNamHocHocKy(int start, int pageLength, System.String namHoc, System.String hocKy)
		{
		...
		/// <param name="transactionManager"><see cref="TransactionManager"/> object</param>
		/// <returns>A <see cref="VList&lt;ViewThoiGianLamViecCuaNhanVien&gt;"/> instance.</returns>
		public VList<ViewThoiGianLamViecCuaNhanVien> GetByNamHocHocKy(TransactionManager transactionManager, System.String namHoc, System.String hocKy)
		{
		...
		/// <remark>This method is generate from a stored procedure.</remark>
		/// <returns>A <see cref="VList&lt;ViewThoiGianLamViecCuaNhanVien&gt;"/> instance.</returns>
		public abstract VList<ViewThoiGianLamViecCuaNhanVien> GetByNamHocHocKy(TransactionManager transactionManager, int start, int pageLength, System.String namHoc, System.String hocKy);
		...
		/*
		///<summary>
		/// Fill an VList&lt;ViewThoiGianLamViecCuaNhanVien&gt; From a DataSet
		///</summary>
		/// <param name="dataSet">the DataSet</param>
		/// <param name="rows">The collection to fill</param>
		/// <param name="start">Start row</param>
		/// <param name="pagelen">number of row.</param>
		///<returns><see chref="VList&lt;ViewThoiGianLamViecCuaNhanVien&gt;"/></returns>
		protected static VList&lt;ViewThoiGianLamViecCuaNhanVien&gt; Fill(DataSet dataSet, VList<ViewThoiGianLamViecCuaNhanVien> rows, int start, int pagelen)
		{
			...
			{
				return new VList<ViewThoiGianLamViecCuaNhanVien>();
			}	
		}
		
		
		///<summary>
		/// Fill an VList&lt;ViewThoiGianLamViecCuaNhanVien&gt; From a DataTable
		///</summary>
		...
		/// <param name="pagelen">number of row.</param>
		///<returns><see chref="VList<ViewThoiGianLamViecCuaNhanVien>"/></returns>
		protected static VList&lt;ViewThoiGianLamViecCuaNhanVien&gt; Fill(DataTable dataTable, VList<ViewThoiGianLamViecCuaNhanVien> rows, int start, int pagelen)
		{
			int recordnum = 0;
			...
			while (dataRows.MoveNext() && (pagelen != 0))
			{
				if(recordnum >= start)
				{
					...
					ViewThoiGianLamViecCuaNhanVien c = new ViewThoiGianLamViecCuaNhanVien();
		...
		*/	
		...
		///<summary>
		/// Fill an <see cref="VList&lt;ViewThoiGianLamViecCuaNhanVien&gt;"/> From a DataReader.
		///</summary>
		/// <param name="reader">Datareader</param>
		/// <param name="rows">The collection to fill</param>
		/// <param name="start">Start row</param>
		/// <param name="pageLength">number of row.</param>
		///<returns>a <see cref="VList&lt;ViewThoiGianLamViecCuaNhanVien&gt;"/></returns>
		protected VList<ViewThoiGianLamViecCuaNhanVien> Fill(IDataReader reader, VList<ViewThoiGianLamViecCuaNhanVien> rows, int start, int pageLength)
		{
			int recordnum = 0;
			while (reader.Read() && (pageLength != 0))
			{
				if(recordnum >= start)
				{
					ViewThoiGianLamViecCuaNhanVien entity = null;
					if (DataRepository.Provider.UseEntityFactory)
					{
						entity = EntityManager.CreateViewEntity<ViewThoiGianLamViecCuaNhanVien>("ViewThoiGianLamViecCuaNhanVien",  DataRepository.Provider.EntityCreationalFactoryType); 
					}
					else
					{
						entity = new ViewThoiGianLamViecCuaNhanVien();
					}
		...
		/// <summary>
		/// Refreshes the <see cref="ViewThoiGianLamViecCuaNhanVien"/> object from the <see cref="IDataReader"/>.
		/// </summary>
		/// <param name="reader">The <see cref="IDataReader"/> to read from.</param>
		/// <param name="entity">The <see cref="ViewThoiGianLamViecCuaNhanVien"/> object to refresh.</param>
		protected void RefreshEntity(IDataReader reader, ViewThoiGianLamViecCuaNhanVien entity)
		{
			reader.Read();
			entity.Id = (System.Int32)reader["Id"];
			//entity.Id = (Convert.IsDBNull(reader["Id"]))?(int)0:(System.Int32)reader["Id"];
		...
		/*
		/// <summary>
		/// Refreshes the <see cref="ViewThoiGianLamViecCuaNhanVien"/> object from the <see cref="DataSet"/>.
		/// </summary>
		/// <param name="dataSet">The <see cref="DataSet"/> to read from.</param>
		/// <param name="entity">The <see cref="ViewThoiGianLamViecCuaNhanVien"/> object.</param>
		protected static void RefreshEntity(DataSet dataSet, ViewThoiGianLamViecCuaNhanVien entity)
		{
	...
	#region ViewThoiGianLamViecCuaNhanVienFilterBuilder
	...
	/// </summary>
	[CLSCompliant(true)]
	public class ViewThoiGianLamViecCuaNhanVienFilterBuilder : SqlFilterBuilder<ViewThoiGianLamViecCuaNhanVienColumn>
	{
		#region Constructors

		/// <summary>
		/// Initializes a new instance of the ViewThoiGianLamViecCuaNhanVienFilterBuilder class.
		/// </summary>
		public ViewThoiGianLamViecCuaNhanVienFilterBuilder() : base() { }

		/// <summary>
		/// Initializes a new instance of the ViewThoiGianLamViecCuaNhanVienFilterBuilder class.
		/// </summary>
		/// <param name="ignoreCase">Specifies whether to create case-insensitive statements.</param>
		public ViewThoiGianLamViecCuaNhanVienFilterBuilder(bool ignoreCase) : base(ignoreCase) { }
		...
		public ViewThoiGianLamViecCuaNhanVienFilterBuilder(bool ignoreCase, bool useAnd) : base(ignoreCase, useAnd) { }

		#endregion Constructors
	}

	#endregion ViewThoiGianLamViecCuaNhanVienFilterBuilder

	#region ViewThoiGianLamViecCuaNhanVienParameterBuilder
	...
	/// </summary>
	[CLSCompliant(true)]
	public class ViewThoiGianLamViecCuaNhanVienParameterBuilder : ParameterizedSqlFilterBuilder<ViewThoiGianLamViecCuaNhanVienColumn>
	{
		#region Constructors

		/// <summary>
		/// Initializes a new instance of the ViewThoiGianLamViecCuaNhanVienParameterBuilder class.
		/// </summary>
		public ViewThoiGianLamViecCuaNhanVienParameterBuilder() : base() { }

		/// <summary>
		/// Initializes a new instance of the ViewThoiGianLamViecCuaNhanVienParameterBuilder class.
		/// </summary>
		/// <param name="ignoreCase">Specifies whether to create case-insensitive statements.</param>
		public ViewThoiGianLamViecCuaNhanVienParameterBuilder(bool ignoreCase) : base(ignoreCase) { }
		...
		/// <param name="ignoreCase">Specifies whether to create case-insensitive statements.</param>
		/// <param name="useAnd">Specifies whether to combine statements using AND or OR.</param>
		public ViewThoiGianLamViecCuaNhanVienParameterBuilder(bool ignoreCase, bool useAnd) : base(ignoreCase, useAnd) { }

		#endregion Constructors
	}

	#endregion ViewThoiGianLamViecCuaNhanVienParameterBuilder
	
	#region ViewThoiGianLamViecCuaNhanVienSortBuilder
    ...
    /// </summary>
    [CLSCompliant(true)]
    public class ViewThoiGianLamViecCuaNhanVienSortBuilder : SqlSortBuilder<ViewThoiGianLamViecCuaNhanVienColumn>
    {
		#region Constructors

		/// <summary>
		/// Initializes a new instance of the ViewThoiGianLamViecCuaNhanVienSqlSortBuilder class.
		/// </summary>
		public ViewThoiGianLamViecCuaNhanVienSortBuilder() : base() { }

		#endregion Constructors

    }    
    #endregion ViewThoiGianLamViecCuaNhanVienSortBuilder
