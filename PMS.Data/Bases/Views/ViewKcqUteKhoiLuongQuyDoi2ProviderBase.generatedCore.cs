...
{	
	///<summary>
	/// This class is the base class for any <see cref="ViewKcqUteKhoiLuongQuyDoi2ProviderBase"/> implementation.
	/// It exposes CRUD methods as well as selecting on index, foreign keys and custom stored procedures.
	///</summary>
	public abstract class ViewKcqUteKhoiLuongQuyDoi2ProviderBaseCore : EntityViewProviderBase<ViewKcqUteKhoiLuongQuyDoi2>
	{
		...
		public VList<ViewKcqUteKhoiLuongQuyDoi2> GetByNamHocHocKyDot(System.String namHoc, System.String hocKy, System.String dot)
		{
		...
		/// <remark>This method is generate from a stored procedure.</remark>
		/// <returns>A <see cref="VList&lt;ViewKcqUteKhoiLuongQuyDoi2&gt;"/> instance.</returns>
		public VList<ViewKcqUteKhoiLuongQuyDoi2> GetByNamHocHocKyDot(int start, int pageLength, System.String namHoc, System.String hocKy, System.String dot)
		{
		...
		/// <returns>A <see cref="VList&lt;ViewKcqUteKhoiLuongQuyDoi2&gt;"/> instance.</returns>
		public VList<ViewKcqUteKhoiLuongQuyDoi2> GetByNamHocHocKyDot(TransactionManager transactionManager, System.String namHoc, System.String hocKy, System.String dot)
		{
		...
		/// <remark>This method is generate from a stored procedure.</remark>
		/// <returns>A <see cref="VList&lt;ViewKcqUteKhoiLuongQuyDoi2&gt;"/> instance.</returns>
		public abstract VList<ViewKcqUteKhoiLuongQuyDoi2> GetByNamHocHocKyDot(TransactionManager transactionManager, int start, int pageLength, System.String namHoc, System.String hocKy, System.String dot);
		...
		/// <remark>This method is generate from a stored procedure.</remark>
		/// <returns>A <see cref="VList&lt;ViewKcqUteKhoiLuongQuyDoi2&gt;"/> instance.</returns>
		public VList<ViewKcqUteKhoiLuongQuyDoi2> GetByNamHocHocKy(System.String namHoc, System.String hocKy)
		{
		...
		/// <remark>This method is generate from a stored procedure.</remark>
		/// <returns>A <see cref="VList&lt;ViewKcqUteKhoiLuongQuyDoi2&gt;"/> instance.</returns>
		public VList<ViewKcqUteKhoiLuongQuyDoi2> GetByNamHocHocKy(int start, int pageLength, System.String namHoc, System.String hocKy)
		{
		...
		/// <param name="transactionManager"><see cref="TransactionManager"/> object</param>
		/// <returns>A <see cref="VList&lt;ViewKcqUteKhoiLuongQuyDoi2&gt;"/> instance.</returns>
		public VList<ViewKcqUteKhoiLuongQuyDoi2> GetByNamHocHocKy(TransactionManager transactionManager, System.String namHoc, System.String hocKy)
		{
		...
		/// <remark>This method is generate from a stored procedure.</remark>
		/// <returns>A <see cref="VList&lt;ViewKcqUteKhoiLuongQuyDoi2&gt;"/> instance.</returns>
		public abstract VList<ViewKcqUteKhoiLuongQuyDoi2> GetByNamHocHocKy(TransactionManager transactionManager, int start, int pageLength, System.String namHoc, System.String hocKy);
		...
		/*
		///<summary>
		/// Fill an VList&lt;ViewKcqUteKhoiLuongQuyDoi2&gt; From a DataSet
		///</summary>
		/// <param name="dataSet">the DataSet</param>
		/// <param name="rows">The collection to fill</param>
		/// <param name="start">Start row</param>
		/// <param name="pagelen">number of row.</param>
		///<returns><see chref="VList&lt;ViewKcqUteKhoiLuongQuyDoi2&gt;"/></returns>
		protected static VList&lt;ViewKcqUteKhoiLuongQuyDoi2&gt; Fill(DataSet dataSet, VList<ViewKcqUteKhoiLuongQuyDoi2> rows, int start, int pagelen)
		{
			...
			{
				return new VList<ViewKcqUteKhoiLuongQuyDoi2>();
			}	
		}
		
		
		///<summary>
		/// Fill an VList&lt;ViewKcqUteKhoiLuongQuyDoi2&gt; From a DataTable
		///</summary>
		...
		/// <param name="pagelen">number of row.</param>
		///<returns><see chref="VList<ViewKcqUteKhoiLuongQuyDoi2>"/></returns>
		protected static VList&lt;ViewKcqUteKhoiLuongQuyDoi2&gt; Fill(DataTable dataTable, VList<ViewKcqUteKhoiLuongQuyDoi2> rows, int start, int pagelen)
		{
			int recordnum = 0;
			...
			while (dataRows.MoveNext() && (pagelen != 0))
			{
				if(recordnum >= start)
				{
					...
					ViewKcqUteKhoiLuongQuyDoi2 c = new ViewKcqUteKhoiLuongQuyDoi2();
		...
		*/	
		...
		///<summary>
		/// Fill an <see cref="VList&lt;ViewKcqUteKhoiLuongQuyDoi2&gt;"/> From a DataReader.
		///</summary>
		/// <param name="reader">Datareader</param>
		/// <param name="rows">The collection to fill</param>
		/// <param name="start">Start row</param>
		/// <param name="pageLength">number of row.</param>
		///<returns>a <see cref="VList&lt;ViewKcqUteKhoiLuongQuyDoi2&gt;"/></returns>
		protected VList<ViewKcqUteKhoiLuongQuyDoi2> Fill(IDataReader reader, VList<ViewKcqUteKhoiLuongQuyDoi2> rows, int start, int pageLength)
		{
			int recordnum = 0;
			while (reader.Read() && (pageLength != 0))
			{
				if(recordnum >= start)
				{
					ViewKcqUteKhoiLuongQuyDoi2 entity = null;
					if (DataRepository.Provider.UseEntityFactory)
					{
						entity = EntityManager.CreateViewEntity<ViewKcqUteKhoiLuongQuyDoi2>("ViewKcqUteKhoiLuongQuyDoi2",  DataRepository.Provider.EntityCreationalFactoryType); 
					}
					else
					{
						entity = new ViewKcqUteKhoiLuongQuyDoi2();
					}
		...
		/// <summary>
		/// Refreshes the <see cref="ViewKcqUteKhoiLuongQuyDoi2"/> object from the <see cref="IDataReader"/>.
		/// </summary>
		/// <param name="reader">The <see cref="IDataReader"/> to read from.</param>
		/// <param name="entity">The <see cref="ViewKcqUteKhoiLuongQuyDoi2"/> object to refresh.</param>
		protected void RefreshEntity(IDataReader reader, ViewKcqUteKhoiLuongQuyDoi2 entity)
		{
			reader.Read();
			entity.Id = (System.Int32)reader["Id"];
			//entity.Id = (Convert.IsDBNull(reader["Id"]))?(int)0:(System.Int32)reader["Id"];
		...
		/*
		/// <summary>
		/// Refreshes the <see cref="ViewKcqUteKhoiLuongQuyDoi2"/> object from the <see cref="DataSet"/>.
		/// </summary>
		/// <param name="dataSet">The <see cref="DataSet"/> to read from.</param>
		/// <param name="entity">The <see cref="ViewKcqUteKhoiLuongQuyDoi2"/> object.</param>
		protected static void RefreshEntity(DataSet dataSet, ViewKcqUteKhoiLuongQuyDoi2 entity)
		{
	...
	#region ViewKcqUteKhoiLuongQuyDoi2FilterBuilder
	...
	/// </summary>
	[CLSCompliant(true)]
	public class ViewKcqUteKhoiLuongQuyDoi2FilterBuilder : SqlFilterBuilder<ViewKcqUteKhoiLuongQuyDoi2Column>
	{
		#region Constructors

		/// <summary>
		/// Initializes a new instance of the ViewKcqUteKhoiLuongQuyDoi2FilterBuilder class.
		/// </summary>
		public ViewKcqUteKhoiLuongQuyDoi2FilterBuilder() : base() { }

		/// <summary>
		/// Initializes a new instance of the ViewKcqUteKhoiLuongQuyDoi2FilterBuilder class.
		/// </summary>
		/// <param name="ignoreCase">Specifies whether to create case-insensitive statements.</param>
		public ViewKcqUteKhoiLuongQuyDoi2FilterBuilder(bool ignoreCase) : base(ignoreCase) { }
		...
		public ViewKcqUteKhoiLuongQuyDoi2FilterBuilder(bool ignoreCase, bool useAnd) : base(ignoreCase, useAnd) { }

		#endregion Constructors
	}

	#endregion ViewKcqUteKhoiLuongQuyDoi2FilterBuilder

	#region ViewKcqUteKhoiLuongQuyDoi2ParameterBuilder
	...
	/// </summary>
	[CLSCompliant(true)]
	public class ViewKcqUteKhoiLuongQuyDoi2ParameterBuilder : ParameterizedSqlFilterBuilder<ViewKcqUteKhoiLuongQuyDoi2Column>
	{
		#region Constructors

		/// <summary>
		/// Initializes a new instance of the ViewKcqUteKhoiLuongQuyDoi2ParameterBuilder class.
		/// </summary>
		public ViewKcqUteKhoiLuongQuyDoi2ParameterBuilder() : base() { }

		/// <summary>
		/// Initializes a new instance of the ViewKcqUteKhoiLuongQuyDoi2ParameterBuilder class.
		/// </summary>
		/// <param name="ignoreCase">Specifies whether to create case-insensitive statements.</param>
		public ViewKcqUteKhoiLuongQuyDoi2ParameterBuilder(bool ignoreCase) : base(ignoreCase) { }
		...
		/// <param name="ignoreCase">Specifies whether to create case-insensitive statements.</param>
		/// <param name="useAnd">Specifies whether to combine statements using AND or OR.</param>
		public ViewKcqUteKhoiLuongQuyDoi2ParameterBuilder(bool ignoreCase, bool useAnd) : base(ignoreCase, useAnd) { }

		#endregion Constructors
	}

	#endregion ViewKcqUteKhoiLuongQuyDoi2ParameterBuilder
	
	#region ViewKcqUteKhoiLuongQuyDoi2SortBuilder
    ...
    /// </summary>
    [CLSCompliant(true)]
    public class ViewKcqUteKhoiLuongQuyDoi2SortBuilder : SqlSortBuilder<ViewKcqUteKhoiLuongQuyDoi2Column>
    {
		#region Constructors

		/// <summary>
		/// Initializes a new instance of the ViewKcqUteKhoiLuongQuyDoi2SqlSortBuilder class.
		/// </summary>
		public ViewKcqUteKhoiLuongQuyDoi2SortBuilder() : base() { }

		#endregion Constructors

    }    
    #endregion ViewKcqUteKhoiLuongQuyDoi2SortBuilder
