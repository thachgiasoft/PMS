...
{	
	///<summary>
	/// This class is the base class for any <see cref="ViewKcqDonGiaNgoaiQuyCheProviderBase"/> implementation.
	/// It exposes CRUD methods as well as selecting on index, foreign keys and custom stored procedures.
	///</summary>
	public abstract class ViewKcqDonGiaNgoaiQuyCheProviderBaseCore : EntityViewProviderBase<ViewKcqDonGiaNgoaiQuyChe>
	{
		...
		public VList<ViewKcqDonGiaNgoaiQuyChe> GetByNamHocHocKy(System.String namHoc, System.String hocKy)
		{
		...
		/// <remark>This method is generate from a stored procedure.</remark>
		/// <returns>A <see cref="VList&lt;ViewKcqDonGiaNgoaiQuyChe&gt;"/> instance.</returns>
		public VList<ViewKcqDonGiaNgoaiQuyChe> GetByNamHocHocKy(int start, int pageLength, System.String namHoc, System.String hocKy)
		{
		...
		/// <returns>A <see cref="VList&lt;ViewKcqDonGiaNgoaiQuyChe&gt;"/> instance.</returns>
		public VList<ViewKcqDonGiaNgoaiQuyChe> GetByNamHocHocKy(TransactionManager transactionManager, System.String namHoc, System.String hocKy)
		{
		...
		/// <remark>This method is generate from a stored procedure.</remark>
		/// <returns>A <see cref="VList&lt;ViewKcqDonGiaNgoaiQuyChe&gt;"/> instance.</returns>
		public abstract VList<ViewKcqDonGiaNgoaiQuyChe> GetByNamHocHocKy(TransactionManager transactionManager, int start, int pageLength, System.String namHoc, System.String hocKy);
		...
		/*
		///<summary>
		/// Fill an VList&lt;ViewKcqDonGiaNgoaiQuyChe&gt; From a DataSet
		///</summary>
		/// <param name="dataSet">the DataSet</param>
		/// <param name="rows">The collection to fill</param>
		/// <param name="start">Start row</param>
		/// <param name="pagelen">number of row.</param>
		///<returns><see chref="VList&lt;ViewKcqDonGiaNgoaiQuyChe&gt;"/></returns>
		protected static VList&lt;ViewKcqDonGiaNgoaiQuyChe&gt; Fill(DataSet dataSet, VList<ViewKcqDonGiaNgoaiQuyChe> rows, int start, int pagelen)
		{
			...
			{
				return new VList<ViewKcqDonGiaNgoaiQuyChe>();
			}	
		}
		
		
		///<summary>
		/// Fill an VList&lt;ViewKcqDonGiaNgoaiQuyChe&gt; From a DataTable
		///</summary>
		...
		/// <param name="pagelen">number of row.</param>
		///<returns><see chref="VList<ViewKcqDonGiaNgoaiQuyChe>"/></returns>
		protected static VList&lt;ViewKcqDonGiaNgoaiQuyChe&gt; Fill(DataTable dataTable, VList<ViewKcqDonGiaNgoaiQuyChe> rows, int start, int pagelen)
		{
			int recordnum = 0;
			...
			while (dataRows.MoveNext() && (pagelen != 0))
			{
				if(recordnum >= start)
				{
					...
					ViewKcqDonGiaNgoaiQuyChe c = new ViewKcqDonGiaNgoaiQuyChe();
		...
		*/	
		...
		///<summary>
		/// Fill an <see cref="VList&lt;ViewKcqDonGiaNgoaiQuyChe&gt;"/> From a DataReader.
		///</summary>
		/// <param name="reader">Datareader</param>
		/// <param name="rows">The collection to fill</param>
		/// <param name="start">Start row</param>
		/// <param name="pageLength">number of row.</param>
		///<returns>a <see cref="VList&lt;ViewKcqDonGiaNgoaiQuyChe&gt;"/></returns>
		protected VList<ViewKcqDonGiaNgoaiQuyChe> Fill(IDataReader reader, VList<ViewKcqDonGiaNgoaiQuyChe> rows, int start, int pageLength)
		{
			int recordnum = 0;
			while (reader.Read() && (pageLength != 0))
			{
				if(recordnum >= start)
				{
					ViewKcqDonGiaNgoaiQuyChe entity = null;
					if (DataRepository.Provider.UseEntityFactory)
					{
						entity = EntityManager.CreateViewEntity<ViewKcqDonGiaNgoaiQuyChe>("ViewKcqDonGiaNgoaiQuyChe",  DataRepository.Provider.EntityCreationalFactoryType); 
					}
					else
					{
						entity = new ViewKcqDonGiaNgoaiQuyChe();
					}
		...
		/// <summary>
		/// Refreshes the <see cref="ViewKcqDonGiaNgoaiQuyChe"/> object from the <see cref="IDataReader"/>.
		/// </summary>
		/// <param name="reader">The <see cref="IDataReader"/> to read from.</param>
		/// <param name="entity">The <see cref="ViewKcqDonGiaNgoaiQuyChe"/> object to refresh.</param>
		protected void RefreshEntity(IDataReader reader, ViewKcqDonGiaNgoaiQuyChe entity)
		{
			reader.Read();
			entity.MaGiangVien = (System.Int32)reader["MaGiangVien"];
			//entity.MaGiangVien = (Convert.IsDBNull(reader["MaGiangVien"]))?(int)0:(System.Int32)reader["MaGiangVien"];
		...
		/*
		/// <summary>
		/// Refreshes the <see cref="ViewKcqDonGiaNgoaiQuyChe"/> object from the <see cref="DataSet"/>.
		/// </summary>
		/// <param name="dataSet">The <see cref="DataSet"/> to read from.</param>
		/// <param name="entity">The <see cref="ViewKcqDonGiaNgoaiQuyChe"/> object.</param>
		protected static void RefreshEntity(DataSet dataSet, ViewKcqDonGiaNgoaiQuyChe entity)
		{
	...
	#region ViewKcqDonGiaNgoaiQuyCheFilterBuilder
	...
	/// </summary>
	[CLSCompliant(true)]
	public class ViewKcqDonGiaNgoaiQuyCheFilterBuilder : SqlFilterBuilder<ViewKcqDonGiaNgoaiQuyCheColumn>
	{
		#region Constructors

		/// <summary>
		/// Initializes a new instance of the ViewKcqDonGiaNgoaiQuyCheFilterBuilder class.
		/// </summary>
		public ViewKcqDonGiaNgoaiQuyCheFilterBuilder() : base() { }

		/// <summary>
		/// Initializes a new instance of the ViewKcqDonGiaNgoaiQuyCheFilterBuilder class.
		/// </summary>
		/// <param name="ignoreCase">Specifies whether to create case-insensitive statements.</param>
		public ViewKcqDonGiaNgoaiQuyCheFilterBuilder(bool ignoreCase) : base(ignoreCase) { }
		...
		public ViewKcqDonGiaNgoaiQuyCheFilterBuilder(bool ignoreCase, bool useAnd) : base(ignoreCase, useAnd) { }

		#endregion Constructors
	}

	#endregion ViewKcqDonGiaNgoaiQuyCheFilterBuilder

	#region ViewKcqDonGiaNgoaiQuyCheParameterBuilder
	...
	/// </summary>
	[CLSCompliant(true)]
	public class ViewKcqDonGiaNgoaiQuyCheParameterBuilder : ParameterizedSqlFilterBuilder<ViewKcqDonGiaNgoaiQuyCheColumn>
	{
		#region Constructors

		/// <summary>
		/// Initializes a new instance of the ViewKcqDonGiaNgoaiQuyCheParameterBuilder class.
		/// </summary>
		public ViewKcqDonGiaNgoaiQuyCheParameterBuilder() : base() { }

		/// <summary>
		/// Initializes a new instance of the ViewKcqDonGiaNgoaiQuyCheParameterBuilder class.
		/// </summary>
		/// <param name="ignoreCase">Specifies whether to create case-insensitive statements.</param>
		public ViewKcqDonGiaNgoaiQuyCheParameterBuilder(bool ignoreCase) : base(ignoreCase) { }
		...
		/// <param name="ignoreCase">Specifies whether to create case-insensitive statements.</param>
		/// <param name="useAnd">Specifies whether to combine statements using AND or OR.</param>
		public ViewKcqDonGiaNgoaiQuyCheParameterBuilder(bool ignoreCase, bool useAnd) : base(ignoreCase, useAnd) { }

		#endregion Constructors
	}

	#endregion ViewKcqDonGiaNgoaiQuyCheParameterBuilder
	
	#region ViewKcqDonGiaNgoaiQuyCheSortBuilder
    ...
    /// </summary>
    [CLSCompliant(true)]
    public class ViewKcqDonGiaNgoaiQuyCheSortBuilder : SqlSortBuilder<ViewKcqDonGiaNgoaiQuyCheColumn>
    {
		#region Constructors

		/// <summary>
		/// Initializes a new instance of the ViewKcqDonGiaNgoaiQuyCheSqlSortBuilder class.
		/// </summary>
		public ViewKcqDonGiaNgoaiQuyCheSortBuilder() : base() { }

		#endregion Constructors

    }    
    #endregion ViewKcqDonGiaNgoaiQuyCheSortBuilder
