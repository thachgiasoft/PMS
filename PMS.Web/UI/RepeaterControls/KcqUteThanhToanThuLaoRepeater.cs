...
{
    /// <summary>
    /// A designer class for a strongly typed repeater <c>KcqUteThanhToanThuLaoRepeater</c>
    /// </summary>
	public class KcqUteThanhToanThuLaoRepeaterDesigner : System.Web.UI.Design.ControlDesigner
	{
	    /// <summary>
        /// Initializes a new instance of the <see cref="T:KcqUteThanhToanThuLaoRepeaterDesigner"/> class.
        /// </summary>
		public KcqUteThanhToanThuLaoRepeaterDesigner()
		{
		}
		...
		{
			if (!(component is KcqUteThanhToanThuLaoRepeater))
			{ 
				throw new ArgumentException("Component is not a KcqUteThanhToanThuLaoRepeater."); 
			} 
		...
		public override string GetDesignTimeHtml()
		{
			...
			//
			KcqUteThanhToanThuLaoRepeater z = (KcqUteThanhToanThuLaoRepeater)Component;
			z.DataBind();
    ...
    /// <summary>
    /// A strongly typed repeater control for the <see cref="KcqUteThanhToanThuLaoRepeater"/> Type.
    /// </summary>
	[Designer(typeof(KcqUteThanhToanThuLaoRepeaterDesigner))]
	[ParseChildren(true)]
	[ToolboxData("<{0}:KcqUteThanhToanThuLaoRepeater runat=\"server\"></{0}:KcqUteThanhToanThuLaoRepeater>")]
	public class KcqUteThanhToanThuLaoRepeater : CompositeDataBoundControl, System.Web.UI.INamingContainer
	{
	    /// <summary>
        /// Initializes a new instance of the <see cref="T:KcqUteThanhToanThuLaoRepeater"/> class.
        /// </summary>
		public KcqUteThanhToanThuLaoRepeater()
		{
		}
		...
		[Browsable(false)]
		[TemplateContainer(typeof(KcqUteThanhToanThuLaoItem))]
...
//      }
		...
		protected override int CreateChildControls(System.Collections.IEnumerable dataSource, bool dataBinding)
         ...
         if (dataBinding)
         {
			...
			if (dataSource != null)
			{
				...
				{
						PMS.Entities.KcqUteThanhToanThuLao entity = o as PMS.Entities.KcqUteThanhToanThuLao;
						KcqUteThanhToanThuLaoItem container = new KcqUteThanhToanThuLaoItem(entity);
	...
	public class KcqUteThanhToanThuLaoItem : System.Web.UI.Control, System.Web.UI.INamingContainer
	{
		private PMS.Entities.KcqUteThanhToanThuLao _entity;

        /// <summary>
        /// Initializes a new instance of the <see cref="T:KcqUteThanhToanThuLaoItem"/> class.
        /// </summary>
		public KcqUteThanhToanThuLaoItem()
			: base()
		{ }
        ...
        /// Initializes a new instance of the <see cref="T:KcqUteThanhToanThuLaoItem"/> class.
        /// </summary>
		public KcqUteThanhToanThuLaoItem(PMS.Entities.KcqUteThanhToanThuLao entity)
			: base()
		{
			_entity = entity;
		}
        ...
        /// <summary>
        /// Gets a <see cref="T:PMS.Entities.KcqUteThanhToanThuLao"></see> object
        /// </summary>
        /// <value></value>
        [System.ComponentModel.Bindable(true)]
        public PMS.Entities.KcqUteThanhToanThuLao Entity
        {
            get { return _entity; }
        }
	}
