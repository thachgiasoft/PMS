...
{
    /// <summary>
    /// A designer class for a strongly typed repeater <c>KhoiLuongGiangDayRepeater</c>
    /// </summary>
	public class KhoiLuongGiangDayRepeaterDesigner : System.Web.UI.Design.ControlDesigner
	{
	    /// <summary>
        /// Initializes a new instance of the <see cref="T:KhoiLuongGiangDayRepeaterDesigner"/> class.
        /// </summary>
		public KhoiLuongGiangDayRepeaterDesigner()
		{
		}
		...
		{
			if (!(component is KhoiLuongGiangDayRepeater))
			{ 
				throw new ArgumentException("Component is not a KhoiLuongGiangDayRepeater."); 
			} 
		...
		public override string GetDesignTimeHtml()
		{
			...
			//
			KhoiLuongGiangDayRepeater z = (KhoiLuongGiangDayRepeater)Component;
			z.DataBind();
    ...
    /// <summary>
    /// A strongly typed repeater control for the <see cref="KhoiLuongGiangDayRepeater"/> Type.
    /// </summary>
	[Designer(typeof(KhoiLuongGiangDayRepeaterDesigner))]
	[ParseChildren(true)]
	[ToolboxData("<{0}:KhoiLuongGiangDayRepeater runat=\"server\"></{0}:KhoiLuongGiangDayRepeater>")]
	public class KhoiLuongGiangDayRepeater : CompositeDataBoundControl, System.Web.UI.INamingContainer
	{
	    /// <summary>
        /// Initializes a new instance of the <see cref="T:KhoiLuongGiangDayRepeater"/> class.
        /// </summary>
		public KhoiLuongGiangDayRepeater()
		{
		}
		...
		[Browsable(false)]
		[TemplateContainer(typeof(KhoiLuongGiangDayItem))]
...
//      }
		...
		protected override int CreateChildControls(System.Collections.IEnumerable dataSource, bool dataBinding)
         ...
         if (dataBinding)
         {
			...
			if (dataSource != null)
			{
				...
				{
						PMS.Entities.KhoiLuongGiangDay entity = o as PMS.Entities.KhoiLuongGiangDay;
						KhoiLuongGiangDayItem container = new KhoiLuongGiangDayItem(entity);
	...
	public class KhoiLuongGiangDayItem : System.Web.UI.Control, System.Web.UI.INamingContainer
	{
		private PMS.Entities.KhoiLuongGiangDay _entity;

        /// <summary>
        /// Initializes a new instance of the <see cref="T:KhoiLuongGiangDayItem"/> class.
        /// </summary>
		public KhoiLuongGiangDayItem()
			: base()
		{ }
        ...
        /// Initializes a new instance of the <see cref="T:KhoiLuongGiangDayItem"/> class.
        /// </summary>
		public KhoiLuongGiangDayItem(PMS.Entities.KhoiLuongGiangDay entity)
			: base()
		{
			_entity = entity;
		}
        ...
        /// <summary>
        /// Gets a <see cref="T:PMS.Entities.KhoiLuongGiangDay"></see> object
        /// </summary>
        /// <value></value>
        [System.ComponentModel.Bindable(true)]
        public PMS.Entities.KhoiLuongGiangDay Entity
        {
            get { return _entity; }
        }
	}
