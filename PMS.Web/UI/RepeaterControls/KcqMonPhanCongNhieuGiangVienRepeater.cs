...
{
    /// <summary>
    /// A designer class for a strongly typed repeater <c>KcqMonPhanCongNhieuGiangVienRepeater</c>
    /// </summary>
	public class KcqMonPhanCongNhieuGiangVienRepeaterDesigner : System.Web.UI.Design.ControlDesigner
	{
	    /// <summary>
        /// Initializes a new instance of the <see cref="T:KcqMonPhanCongNhieuGiangVienRepeaterDesigner"/> class.
        /// </summary>
		public KcqMonPhanCongNhieuGiangVienRepeaterDesigner()
		{
		}
		...
		{
			if (!(component is KcqMonPhanCongNhieuGiangVienRepeater))
			{ 
				throw new ArgumentException("Component is not a KcqMonPhanCongNhieuGiangVienRepeater."); 
			} 
		...
		public override string GetDesignTimeHtml()
		{
			...
			//
			KcqMonPhanCongNhieuGiangVienRepeater z = (KcqMonPhanCongNhieuGiangVienRepeater)Component;
			z.DataBind();
    ...
    /// <summary>
    /// A strongly typed repeater control for the <see cref="KcqMonPhanCongNhieuGiangVienRepeater"/> Type.
    /// </summary>
	[Designer(typeof(KcqMonPhanCongNhieuGiangVienRepeaterDesigner))]
	[ParseChildren(true)]
	[ToolboxData("<{0}:KcqMonPhanCongNhieuGiangVienRepeater runat=\"server\"></{0}:KcqMonPhanCongNhieuGiangVienRepeater>")]
	public class KcqMonPhanCongNhieuGiangVienRepeater : CompositeDataBoundControl, System.Web.UI.INamingContainer
	{
	    /// <summary>
        /// Initializes a new instance of the <see cref="T:KcqMonPhanCongNhieuGiangVienRepeater"/> class.
        /// </summary>
		public KcqMonPhanCongNhieuGiangVienRepeater()
		{
		}
		...
		[Browsable(false)]
		[TemplateContainer(typeof(KcqMonPhanCongNhieuGiangVienItem))]
...
//      }
		...
		protected override int CreateChildControls(System.Collections.IEnumerable dataSource, bool dataBinding)
         ...
         if (dataBinding)
         {
			...
			if (dataSource != null)
			{
				...
				{
						PMS.Entities.KcqMonPhanCongNhieuGiangVien entity = o as PMS.Entities.KcqMonPhanCongNhieuGiangVien;
						KcqMonPhanCongNhieuGiangVienItem container = new KcqMonPhanCongNhieuGiangVienItem(entity);
	...
	public class KcqMonPhanCongNhieuGiangVienItem : System.Web.UI.Control, System.Web.UI.INamingContainer
	{
		private PMS.Entities.KcqMonPhanCongNhieuGiangVien _entity;

        /// <summary>
        /// Initializes a new instance of the <see cref="T:KcqMonPhanCongNhieuGiangVienItem"/> class.
        /// </summary>
		public KcqMonPhanCongNhieuGiangVienItem()
			: base()
		{ }
        ...
        /// Initializes a new instance of the <see cref="T:KcqMonPhanCongNhieuGiangVienItem"/> class.
        /// </summary>
		public KcqMonPhanCongNhieuGiangVienItem(PMS.Entities.KcqMonPhanCongNhieuGiangVien entity)
			: base()
		{
			_entity = entity;
		}
        ...
        /// <summary>
        /// Gets a <see cref="T:PMS.Entities.KcqMonPhanCongNhieuGiangVien"></see> object
        /// </summary>
        /// <value></value>
        [System.ComponentModel.Bindable(true)]
        public PMS.Entities.KcqMonPhanCongNhieuGiangVien Entity
        {
            get { return _entity; }
        }
	}
