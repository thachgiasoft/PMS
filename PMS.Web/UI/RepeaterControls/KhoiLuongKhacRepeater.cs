...
{
    /// <summary>
    /// A designer class for a strongly typed repeater <c>KhoiLuongKhacRepeater</c>
    /// </summary>
	public class KhoiLuongKhacRepeaterDesigner : System.Web.UI.Design.ControlDesigner
	{
	    /// <summary>
        /// Initializes a new instance of the <see cref="T:KhoiLuongKhacRepeaterDesigner"/> class.
        /// </summary>
		public KhoiLuongKhacRepeaterDesigner()
		{
		}
		...
		{
			if (!(component is KhoiLuongKhacRepeater))
			{ 
				throw new ArgumentException("Component is not a KhoiLuongKhacRepeater."); 
			} 
		...
		public override string GetDesignTimeHtml()
		{
			...
			//
			KhoiLuongKhacRepeater z = (KhoiLuongKhacRepeater)Component;
			z.DataBind();
    ...
    /// <summary>
    /// A strongly typed repeater control for the <see cref="KhoiLuongKhacRepeater"/> Type.
    /// </summary>
	[Designer(typeof(KhoiLuongKhacRepeaterDesigner))]
	[ParseChildren(true)]
	[ToolboxData("<{0}:KhoiLuongKhacRepeater runat=\"server\"></{0}:KhoiLuongKhacRepeater>")]
	public class KhoiLuongKhacRepeater : CompositeDataBoundControl, System.Web.UI.INamingContainer
	{
	    /// <summary>
        /// Initializes a new instance of the <see cref="T:KhoiLuongKhacRepeater"/> class.
        /// </summary>
		public KhoiLuongKhacRepeater()
		{
		}
		...
		[Browsable(false)]
		[TemplateContainer(typeof(KhoiLuongKhacItem))]
...
//      }
		...
		protected override int CreateChildControls(System.Collections.IEnumerable dataSource, bool dataBinding)
         ...
         if (dataBinding)
         {
			...
			if (dataSource != null)
			{
				...
				{
						PMS.Entities.KhoiLuongKhac entity = o as PMS.Entities.KhoiLuongKhac;
						KhoiLuongKhacItem container = new KhoiLuongKhacItem(entity);
	...
	public class KhoiLuongKhacItem : System.Web.UI.Control, System.Web.UI.INamingContainer
	{
		private PMS.Entities.KhoiLuongKhac _entity;

        /// <summary>
        /// Initializes a new instance of the <see cref="T:KhoiLuongKhacItem"/> class.
        /// </summary>
		public KhoiLuongKhacItem()
			: base()
		{ }
        ...
        /// Initializes a new instance of the <see cref="T:KhoiLuongKhacItem"/> class.
        /// </summary>
		public KhoiLuongKhacItem(PMS.Entities.KhoiLuongKhac entity)
			: base()
		{
			_entity = entity;
		}
        ...
        /// <summary>
        /// Gets a <see cref="T:PMS.Entities.KhoiLuongKhac"></see> object
        /// </summary>
        /// <value></value>
        [System.ComponentModel.Bindable(true)]
        public PMS.Entities.KhoiLuongKhac Entity
        {
            get { return _entity; }
        }
	}
