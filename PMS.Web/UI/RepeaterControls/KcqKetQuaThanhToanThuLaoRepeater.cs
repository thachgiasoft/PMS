...
{
    /// <summary>
    /// A designer class for a strongly typed repeater <c>KcqKetQuaThanhToanThuLaoRepeater</c>
    /// </summary>
	public class KcqKetQuaThanhToanThuLaoRepeaterDesigner : System.Web.UI.Design.ControlDesigner
	{
	    /// <summary>
        /// Initializes a new instance of the <see cref="T:KcqKetQuaThanhToanThuLaoRepeaterDesigner"/> class.
        /// </summary>
		public KcqKetQuaThanhToanThuLaoRepeaterDesigner()
		{
		}
		...
		{
			if (!(component is KcqKetQuaThanhToanThuLaoRepeater))
			{ 
				throw new ArgumentException("Component is not a KcqKetQuaThanhToanThuLaoRepeater."); 
			} 
		...
		public override string GetDesignTimeHtml()
		{
			...
			//
			KcqKetQuaThanhToanThuLaoRepeater z = (KcqKetQuaThanhToanThuLaoRepeater)Component;
			z.DataBind();
    ...
    /// <summary>
    /// A strongly typed repeater control for the <see cref="KcqKetQuaThanhToanThuLaoRepeater"/> Type.
    /// </summary>
	[Designer(typeof(KcqKetQuaThanhToanThuLaoRepeaterDesigner))]
	[ParseChildren(true)]
	[ToolboxData("<{0}:KcqKetQuaThanhToanThuLaoRepeater runat=\"server\"></{0}:KcqKetQuaThanhToanThuLaoRepeater>")]
	public class KcqKetQuaThanhToanThuLaoRepeater : CompositeDataBoundControl, System.Web.UI.INamingContainer
	{
	    /// <summary>
        /// Initializes a new instance of the <see cref="T:KcqKetQuaThanhToanThuLaoRepeater"/> class.
        /// </summary>
		public KcqKetQuaThanhToanThuLaoRepeater()
		{
		}
		...
		[Browsable(false)]
		[TemplateContainer(typeof(KcqKetQuaThanhToanThuLaoItem))]
...
//      }
		...
		protected override int CreateChildControls(System.Collections.IEnumerable dataSource, bool dataBinding)
         ...
         if (dataBinding)
         {
			...
			if (dataSource != null)
			{
				...
				{
						PMS.Entities.KcqKetQuaThanhToanThuLao entity = o as PMS.Entities.KcqKetQuaThanhToanThuLao;
						KcqKetQuaThanhToanThuLaoItem container = new KcqKetQuaThanhToanThuLaoItem(entity);
	...
	public class KcqKetQuaThanhToanThuLaoItem : System.Web.UI.Control, System.Web.UI.INamingContainer
	{
		private PMS.Entities.KcqKetQuaThanhToanThuLao _entity;

        /// <summary>
        /// Initializes a new instance of the <see cref="T:KcqKetQuaThanhToanThuLaoItem"/> class.
        /// </summary>
		public KcqKetQuaThanhToanThuLaoItem()
			: base()
		{ }
        ...
        /// Initializes a new instance of the <see cref="T:KcqKetQuaThanhToanThuLaoItem"/> class.
        /// </summary>
		public KcqKetQuaThanhToanThuLaoItem(PMS.Entities.KcqKetQuaThanhToanThuLao entity)
			: base()
		{
			_entity = entity;
		}
        ...
        /// <summary>
        /// Gets a <see cref="T:PMS.Entities.KcqKetQuaThanhToanThuLao"></see> object
        /// </summary>
        /// <value></value>
        [System.ComponentModel.Bindable(true)]
        public PMS.Entities.KcqKetQuaThanhToanThuLao Entity
        {
            get { return _entity; }
        }
	}
