...
{
    /// <summary>
    /// A designer class for a strongly typed repeater <c>SdhKetQuaThanhToanThuLaoRepeater</c>
    /// </summary>
	public class SdhKetQuaThanhToanThuLaoRepeaterDesigner : System.Web.UI.Design.ControlDesigner
	{
	    /// <summary>
        /// Initializes a new instance of the <see cref="T:SdhKetQuaThanhToanThuLaoRepeaterDesigner"/> class.
        /// </summary>
		public SdhKetQuaThanhToanThuLaoRepeaterDesigner()
		{
		}
		...
		{
			if (!(component is SdhKetQuaThanhToanThuLaoRepeater))
			{ 
				throw new ArgumentException("Component is not a SdhKetQuaThanhToanThuLaoRepeater."); 
			} 
		...
		public override string GetDesignTimeHtml()
		{
			...
			//
			SdhKetQuaThanhToanThuLaoRepeater z = (SdhKetQuaThanhToanThuLaoRepeater)Component;
			z.DataBind();
    ...
    /// <summary>
    /// A strongly typed repeater control for the <see cref="SdhKetQuaThanhToanThuLaoRepeater"/> Type.
    /// </summary>
	[Designer(typeof(SdhKetQuaThanhToanThuLaoRepeaterDesigner))]
	[ParseChildren(true)]
	[ToolboxData("<{0}:SdhKetQuaThanhToanThuLaoRepeater runat=\"server\"></{0}:SdhKetQuaThanhToanThuLaoRepeater>")]
	public class SdhKetQuaThanhToanThuLaoRepeater : CompositeDataBoundControl, System.Web.UI.INamingContainer
	{
	    /// <summary>
        /// Initializes a new instance of the <see cref="T:SdhKetQuaThanhToanThuLaoRepeater"/> class.
        /// </summary>
		public SdhKetQuaThanhToanThuLaoRepeater()
		{
		}
		...
		[Browsable(false)]
		[TemplateContainer(typeof(SdhKetQuaThanhToanThuLaoItem))]
...
//      }
		...
		protected override int CreateChildControls(System.Collections.IEnumerable dataSource, bool dataBinding)
         ...
         if (dataBinding)
         {
			...
			if (dataSource != null)
			{
				...
				{
						PMS.Entities.SdhKetQuaThanhToanThuLao entity = o as PMS.Entities.SdhKetQuaThanhToanThuLao;
						SdhKetQuaThanhToanThuLaoItem container = new SdhKetQuaThanhToanThuLaoItem(entity);
	...
	public class SdhKetQuaThanhToanThuLaoItem : System.Web.UI.Control, System.Web.UI.INamingContainer
	{
		private PMS.Entities.SdhKetQuaThanhToanThuLao _entity;

        /// <summary>
        /// Initializes a new instance of the <see cref="T:SdhKetQuaThanhToanThuLaoItem"/> class.
        /// </summary>
		public SdhKetQuaThanhToanThuLaoItem()
			: base()
		{ }
        ...
        /// Initializes a new instance of the <see cref="T:SdhKetQuaThanhToanThuLaoItem"/> class.
        /// </summary>
		public SdhKetQuaThanhToanThuLaoItem(PMS.Entities.SdhKetQuaThanhToanThuLao entity)
			: base()
		{
			_entity = entity;
		}
        ...
        /// <summary>
        /// Gets a <see cref="T:PMS.Entities.SdhKetQuaThanhToanThuLao"></see> object
        /// </summary>
        /// <value></value>
        [System.ComponentModel.Bindable(true)]
        public PMS.Entities.SdhKetQuaThanhToanThuLao Entity
        {
            get { return _entity; }
        }
	}
