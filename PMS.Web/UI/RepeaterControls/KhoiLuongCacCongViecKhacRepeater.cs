...
{
    /// <summary>
    /// A designer class for a strongly typed repeater <c>KhoiLuongCacCongViecKhacRepeater</c>
    /// </summary>
	public class KhoiLuongCacCongViecKhacRepeaterDesigner : System.Web.UI.Design.ControlDesigner
	{
	    /// <summary>
        /// Initializes a new instance of the <see cref="T:KhoiLuongCacCongViecKhacRepeaterDesigner"/> class.
        /// </summary>
		public KhoiLuongCacCongViecKhacRepeaterDesigner()
		{
		}
		...
		{
			if (!(component is KhoiLuongCacCongViecKhacRepeater))
			{ 
				throw new ArgumentException("Component is not a KhoiLuongCacCongViecKhacRepeater."); 
			} 
		...
		public override string GetDesignTimeHtml()
		{
			...
			//
			KhoiLuongCacCongViecKhacRepeater z = (KhoiLuongCacCongViecKhacRepeater)Component;
			z.DataBind();
    ...
    /// <summary>
    /// A strongly typed repeater control for the <see cref="KhoiLuongCacCongViecKhacRepeater"/> Type.
    /// </summary>
	[Designer(typeof(KhoiLuongCacCongViecKhacRepeaterDesigner))]
	[ParseChildren(true)]
	[ToolboxData("<{0}:KhoiLuongCacCongViecKhacRepeater runat=\"server\"></{0}:KhoiLuongCacCongViecKhacRepeater>")]
	public class KhoiLuongCacCongViecKhacRepeater : CompositeDataBoundControl, System.Web.UI.INamingContainer
	{
	    /// <summary>
        /// Initializes a new instance of the <see cref="T:KhoiLuongCacCongViecKhacRepeater"/> class.
        /// </summary>
		public KhoiLuongCacCongViecKhacRepeater()
		{
		}
		...
		[Browsable(false)]
		[TemplateContainer(typeof(KhoiLuongCacCongViecKhacItem))]
...
//      }
		...
		protected override int CreateChildControls(System.Collections.IEnumerable dataSource, bool dataBinding)
         ...
         if (dataBinding)
         {
			...
			if (dataSource != null)
			{
				...
				{
						PMS.Entities.KhoiLuongCacCongViecKhac entity = o as PMS.Entities.KhoiLuongCacCongViecKhac;
						KhoiLuongCacCongViecKhacItem container = new KhoiLuongCacCongViecKhacItem(entity);
	...
	public class KhoiLuongCacCongViecKhacItem : System.Web.UI.Control, System.Web.UI.INamingContainer
	{
		private PMS.Entities.KhoiLuongCacCongViecKhac _entity;

        /// <summary>
        /// Initializes a new instance of the <see cref="T:KhoiLuongCacCongViecKhacItem"/> class.
        /// </summary>
		public KhoiLuongCacCongViecKhacItem()
			: base()
		{ }
        ...
        /// Initializes a new instance of the <see cref="T:KhoiLuongCacCongViecKhacItem"/> class.
        /// </summary>
		public KhoiLuongCacCongViecKhacItem(PMS.Entities.KhoiLuongCacCongViecKhac entity)
			: base()
		{
			_entity = entity;
		}
        ...
        /// <summary>
        /// Gets a <see cref="T:PMS.Entities.KhoiLuongCacCongViecKhac"></see> object
        /// </summary>
        /// <value></value>
        [System.ComponentModel.Bindable(true)]
        public PMS.Entities.KhoiLuongCacCongViecKhac Entity
        {
            get { return _entity; }
        }
	}
