...
{
    /// <summary>
    /// A designer class for a strongly typed repeater <c>KhoiLuongGiangDayTungTuanRepeater</c>
    /// </summary>
	public class KhoiLuongGiangDayTungTuanRepeaterDesigner : System.Web.UI.Design.ControlDesigner
	{
	    /// <summary>
        /// Initializes a new instance of the <see cref="T:KhoiLuongGiangDayTungTuanRepeaterDesigner"/> class.
        /// </summary>
		public KhoiLuongGiangDayTungTuanRepeaterDesigner()
		{
		}
		...
		{
			if (!(component is KhoiLuongGiangDayTungTuanRepeater))
			{ 
				throw new ArgumentException("Component is not a KhoiLuongGiangDayTungTuanRepeater."); 
			} 
		...
		public override string GetDesignTimeHtml()
		{
			...
			//
			KhoiLuongGiangDayTungTuanRepeater z = (KhoiLuongGiangDayTungTuanRepeater)Component;
			z.DataBind();
    ...
    /// <summary>
    /// A strongly typed repeater control for the <see cref="KhoiLuongGiangDayTungTuanRepeater"/> Type.
    /// </summary>
	[Designer(typeof(KhoiLuongGiangDayTungTuanRepeaterDesigner))]
	[ParseChildren(true)]
	[ToolboxData("<{0}:KhoiLuongGiangDayTungTuanRepeater runat=\"server\"></{0}:KhoiLuongGiangDayTungTuanRepeater>")]
	public class KhoiLuongGiangDayTungTuanRepeater : CompositeDataBoundControl, System.Web.UI.INamingContainer
	{
	    /// <summary>
        /// Initializes a new instance of the <see cref="T:KhoiLuongGiangDayTungTuanRepeater"/> class.
        /// </summary>
		public KhoiLuongGiangDayTungTuanRepeater()
		{
		}
		...
		[Browsable(false)]
		[TemplateContainer(typeof(KhoiLuongGiangDayTungTuanItem))]
...
//      }
		...
		protected override int CreateChildControls(System.Collections.IEnumerable dataSource, bool dataBinding)
         ...
         if (dataBinding)
         {
			...
			if (dataSource != null)
			{
				...
				{
						PMS.Entities.KhoiLuongGiangDayTungTuan entity = o as PMS.Entities.KhoiLuongGiangDayTungTuan;
						KhoiLuongGiangDayTungTuanItem container = new KhoiLuongGiangDayTungTuanItem(entity);
	...
	public class KhoiLuongGiangDayTungTuanItem : System.Web.UI.Control, System.Web.UI.INamingContainer
	{
		private PMS.Entities.KhoiLuongGiangDayTungTuan _entity;

        /// <summary>
        /// Initializes a new instance of the <see cref="T:KhoiLuongGiangDayTungTuanItem"/> class.
        /// </summary>
		public KhoiLuongGiangDayTungTuanItem()
			: base()
		{ }
        ...
        /// Initializes a new instance of the <see cref="T:KhoiLuongGiangDayTungTuanItem"/> class.
        /// </summary>
		public KhoiLuongGiangDayTungTuanItem(PMS.Entities.KhoiLuongGiangDayTungTuan entity)
			: base()
		{
			_entity = entity;
		}
        ...
        /// <summary>
        /// Gets a <see cref="T:PMS.Entities.KhoiLuongGiangDayTungTuan"></see> object
        /// </summary>
        /// <value></value>
        [System.ComponentModel.Bindable(true)]
        public PMS.Entities.KhoiLuongGiangDayTungTuan Entity
        {
            get { return _entity; }
        }
	}
