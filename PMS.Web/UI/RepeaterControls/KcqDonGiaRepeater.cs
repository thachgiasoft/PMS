...
{
    /// <summary>
    /// A designer class for a strongly typed repeater <c>KcqDonGiaRepeater</c>
    /// </summary>
	public class KcqDonGiaRepeaterDesigner : System.Web.UI.Design.ControlDesigner
	{
	    /// <summary>
        /// Initializes a new instance of the <see cref="T:KcqDonGiaRepeaterDesigner"/> class.
        /// </summary>
		public KcqDonGiaRepeaterDesigner()
		{
		}
		...
		{
			if (!(component is KcqDonGiaRepeater))
			{ 
				throw new ArgumentException("Component is not a KcqDonGiaRepeater."); 
			} 
		...
		public override string GetDesignTimeHtml()
		{
			...
			//
			KcqDonGiaRepeater z = (KcqDonGiaRepeater)Component;
			z.DataBind();
    ...
    /// <summary>
    /// A strongly typed repeater control for the <see cref="KcqDonGiaRepeater"/> Type.
    /// </summary>
	[Designer(typeof(KcqDonGiaRepeaterDesigner))]
	[ParseChildren(true)]
	[ToolboxData("<{0}:KcqDonGiaRepeater runat=\"server\"></{0}:KcqDonGiaRepeater>")]
	public class KcqDonGiaRepeater : CompositeDataBoundControl, System.Web.UI.INamingContainer
	{
	    /// <summary>
        /// Initializes a new instance of the <see cref="T:KcqDonGiaRepeater"/> class.
        /// </summary>
		public KcqDonGiaRepeater()
		{
		}
		...
		[Browsable(false)]
		[TemplateContainer(typeof(KcqDonGiaItem))]
...
//      }
		...
		protected override int CreateChildControls(System.Collections.IEnumerable dataSource, bool dataBinding)
         ...
         if (dataBinding)
         {
			...
			if (dataSource != null)
			{
				...
				{
						PMS.Entities.KcqDonGia entity = o as PMS.Entities.KcqDonGia;
						KcqDonGiaItem container = new KcqDonGiaItem(entity);
	...
	public class KcqDonGiaItem : System.Web.UI.Control, System.Web.UI.INamingContainer
	{
		private PMS.Entities.KcqDonGia _entity;

        /// <summary>
        /// Initializes a new instance of the <see cref="T:KcqDonGiaItem"/> class.
        /// </summary>
		public KcqDonGiaItem()
			: base()
		{ }
        ...
        /// Initializes a new instance of the <see cref="T:KcqDonGiaItem"/> class.
        /// </summary>
		public KcqDonGiaItem(PMS.Entities.KcqDonGia entity)
			: base()
		{
			_entity = entity;
		}
        ...
        /// <summary>
        /// Gets the HeSoQuyDoiChatLuong
        /// </summary>
        /// <value>The HeSoQuyDoiChatLuong.</value>
		[System.ComponentModel.Bindable(true)]
		public System.Decimal? HeSoQuyDoiChatLuong
		{
			get { return _entity.HeSoQuyDoiChatLuong; }
		}
        /// <summary>
        ...
        /// <summary>
        /// Gets a <see cref="T:PMS.Entities.KcqDonGia"></see> object
        /// </summary>
        /// <value></value>
        [System.ComponentModel.Bindable(true)]
        public PMS.Entities.KcqDonGia Entity
        {
            get { return _entity; }
        }
	}
