...
{
    /// <summary>
    /// A designer class for a strongly typed repeater <c>MonPhanCongNhieuGiangVienRepeater</c>
    /// </summary>
	public class MonPhanCongNhieuGiangVienRepeaterDesigner : System.Web.UI.Design.ControlDesigner
	{
	    /// <summary>
        /// Initializes a new instance of the <see cref="T:MonPhanCongNhieuGiangVienRepeaterDesigner"/> class.
        /// </summary>
		public MonPhanCongNhieuGiangVienRepeaterDesigner()
		{
		}
		...
		{
			if (!(component is MonPhanCongNhieuGiangVienRepeater))
			{ 
				throw new ArgumentException("Component is not a MonPhanCongNhieuGiangVienRepeater."); 
			} 
		...
		public override string GetDesignTimeHtml()
		{
			...
			//
			MonPhanCongNhieuGiangVienRepeater z = (MonPhanCongNhieuGiangVienRepeater)Component;
			z.DataBind();
    ...
    /// <summary>
    /// A strongly typed repeater control for the <see cref="MonPhanCongNhieuGiangVienRepeater"/> Type.
    /// </summary>
	[Designer(typeof(MonPhanCongNhieuGiangVienRepeaterDesigner))]
	[ParseChildren(true)]
	[ToolboxData("<{0}:MonPhanCongNhieuGiangVienRepeater runat=\"server\"></{0}:MonPhanCongNhieuGiangVienRepeater>")]
	public class MonPhanCongNhieuGiangVienRepeater : CompositeDataBoundControl, System.Web.UI.INamingContainer
	{
	    /// <summary>
        /// Initializes a new instance of the <see cref="T:MonPhanCongNhieuGiangVienRepeater"/> class.
        /// </summary>
		public MonPhanCongNhieuGiangVienRepeater()
		{
		}
		...
		[Browsable(false)]
		[TemplateContainer(typeof(MonPhanCongNhieuGiangVienItem))]
...
//      }
		...
		protected override int CreateChildControls(System.Collections.IEnumerable dataSource, bool dataBinding)
         ...
         if (dataBinding)
         {
			...
			if (dataSource != null)
			{
				...
				{
						PMS.Entities.MonPhanCongNhieuGiangVien entity = o as PMS.Entities.MonPhanCongNhieuGiangVien;
						MonPhanCongNhieuGiangVienItem container = new MonPhanCongNhieuGiangVienItem(entity);
	...
	public class MonPhanCongNhieuGiangVienItem : System.Web.UI.Control, System.Web.UI.INamingContainer
	{
		private PMS.Entities.MonPhanCongNhieuGiangVien _entity;

        /// <summary>
        /// Initializes a new instance of the <see cref="T:MonPhanCongNhieuGiangVienItem"/> class.
        /// </summary>
		public MonPhanCongNhieuGiangVienItem()
			: base()
		{ }
        ...
        /// Initializes a new instance of the <see cref="T:MonPhanCongNhieuGiangVienItem"/> class.
        /// </summary>
		public MonPhanCongNhieuGiangVienItem(PMS.Entities.MonPhanCongNhieuGiangVien entity)
			: base()
		{
			_entity = entity;
		}
        ...
        /// <summary>
        /// Gets a <see cref="T:PMS.Entities.MonPhanCongNhieuGiangVien"></see> object
        /// </summary>
        /// <value></value>
        [System.ComponentModel.Bindable(true)]
        public PMS.Entities.MonPhanCongNhieuGiangVien Entity
        {
            get { return _entity; }
        }
	}
