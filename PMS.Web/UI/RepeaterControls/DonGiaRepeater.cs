...
{
    /// <summary>
    /// A designer class for a strongly typed repeater <c>DonGiaRepeater</c>
    /// </summary>
	public class DonGiaRepeaterDesigner : System.Web.UI.Design.ControlDesigner
	{
	    /// <summary>
        /// Initializes a new instance of the <see cref="T:DonGiaRepeaterDesigner"/> class.
        /// </summary>
		public DonGiaRepeaterDesigner()
		{
		}
		...
		{
			if (!(component is DonGiaRepeater))
			{ 
				throw new ArgumentException("Component is not a DonGiaRepeater."); 
			} 
		...
		public override string GetDesignTimeHtml()
		{
			...
			//
			DonGiaRepeater z = (DonGiaRepeater)Component;
			z.DataBind();
    ...
    /// <summary>
    /// A strongly typed repeater control for the <see cref="DonGiaRepeater"/> Type.
    /// </summary>
	[Designer(typeof(DonGiaRepeaterDesigner))]
	[ParseChildren(true)]
	[ToolboxData("<{0}:DonGiaRepeater runat=\"server\"></{0}:DonGiaRepeater>")]
	public class DonGiaRepeater : CompositeDataBoundControl, System.Web.UI.INamingContainer
	{
	    /// <summary>
        /// Initializes a new instance of the <see cref="T:DonGiaRepeater"/> class.
        /// </summary>
		public DonGiaRepeater()
		{
		}
		...
		[Browsable(false)]
		[TemplateContainer(typeof(DonGiaItem))]
...
//      }
		...
		protected override int CreateChildControls(System.Collections.IEnumerable dataSource, bool dataBinding)
         ...
         if (dataBinding)
         {
			...
			if (dataSource != null)
			{
				...
				{
						PMS.Entities.DonGia entity = o as PMS.Entities.DonGia;
						DonGiaItem container = new DonGiaItem(entity);
	...
	public class DonGiaItem : System.Web.UI.Control, System.Web.UI.INamingContainer
	{
		private PMS.Entities.DonGia _entity;

        /// <summary>
        /// Initializes a new instance of the <see cref="T:DonGiaItem"/> class.
        /// </summary>
		public DonGiaItem()
			: base()
		{ }
        ...
        /// Initializes a new instance of the <see cref="T:DonGiaItem"/> class.
        /// </summary>
		public DonGiaItem(PMS.Entities.DonGia entity)
			: base()
		{
			_entity = entity;
		}
        ...
        /// <summary>
        /// Gets a <see cref="T:PMS.Entities.DonGia"></see> object
        /// </summary>
        /// <value></value>
        [System.ComponentModel.Bindable(true)]
        public PMS.Entities.DonGia Entity
        {
            get { return _entity; }
        }
	}
