...
{
    /// <summary>
    /// A designer class for a strongly typed repeater <c>ThanhToanThinhGiangRepeater</c>
    /// </summary>
	public class ThanhToanThinhGiangRepeaterDesigner : System.Web.UI.Design.ControlDesigner
	{
	    /// <summary>
        /// Initializes a new instance of the <see cref="T:ThanhToanThinhGiangRepeaterDesigner"/> class.
        /// </summary>
		public ThanhToanThinhGiangRepeaterDesigner()
		{
		}
		...
		{
			if (!(component is ThanhToanThinhGiangRepeater))
			{ 
				throw new ArgumentException("Component is not a ThanhToanThinhGiangRepeater."); 
			} 
		...
		public override string GetDesignTimeHtml()
		{
			...
			//
			ThanhToanThinhGiangRepeater z = (ThanhToanThinhGiangRepeater)Component;
			z.DataBind();
    ...
    /// <summary>
    /// A strongly typed repeater control for the <see cref="ThanhToanThinhGiangRepeater"/> Type.
    /// </summary>
	[Designer(typeof(ThanhToanThinhGiangRepeaterDesigner))]
	[ParseChildren(true)]
	[ToolboxData("<{0}:ThanhToanThinhGiangRepeater runat=\"server\"></{0}:ThanhToanThinhGiangRepeater>")]
	public class ThanhToanThinhGiangRepeater : CompositeDataBoundControl, System.Web.UI.INamingContainer
	{
	    /// <summary>
        /// Initializes a new instance of the <see cref="T:ThanhToanThinhGiangRepeater"/> class.
        /// </summary>
		public ThanhToanThinhGiangRepeater()
		{
		}
		...
		[Browsable(false)]
		[TemplateContainer(typeof(ThanhToanThinhGiangItem))]
...
//      }
		...
		protected override int CreateChildControls(System.Collections.IEnumerable dataSource, bool dataBinding)
         ...
         if (dataBinding)
         {
			...
			if (dataSource != null)
			{
				...
				{
						PMS.Entities.ThanhToanThinhGiang entity = o as PMS.Entities.ThanhToanThinhGiang;
						ThanhToanThinhGiangItem container = new ThanhToanThinhGiangItem(entity);
	...
	public class ThanhToanThinhGiangItem : System.Web.UI.Control, System.Web.UI.INamingContainer
	{
		private PMS.Entities.ThanhToanThinhGiang _entity;

        /// <summary>
        /// Initializes a new instance of the <see cref="T:ThanhToanThinhGiangItem"/> class.
        /// </summary>
		public ThanhToanThinhGiangItem()
			: base()
		{ }
        ...
        /// Initializes a new instance of the <see cref="T:ThanhToanThinhGiangItem"/> class.
        /// </summary>
		public ThanhToanThinhGiangItem(PMS.Entities.ThanhToanThinhGiang entity)
			: base()
		{
			_entity = entity;
		}
        ...
        /// Gets the CongHeSo
        /// </summary>
        /// <value>The CongHeSo.</value>
		[System.ComponentModel.Bindable(true)]
		public System.Decimal? CongHeSo
		{
			get { return _entity.CongHeSo; }
		}
        /// <summary>
        /// Gets the DonGia
        /// </summary>
        ...
        /// Gets the ConNhan
        /// </summary>
        /// <value>The ConNhan.</value>
		[System.ComponentModel.Bindable(true)]
		public System.Decimal? ConNhan
		{
			get { return _entity.ConNhan; }
		}
        /// <summary>
        /// Gets the GhiChu
        /// </summary>
        ...
        /// Gets the SoTietTkb
        /// </summary>
        /// <value>The SoTietTkb.</value>
		[System.ComponentModel.Bindable(true)]
		public System.Decimal? SoTietTkb
		{
			get { return _entity.SoTietTkb; }
		}
        /// <summary>
        /// Gets the NgayNhap
        /// </summary>
        ...
        /// <summary>
        /// Gets the SiSoNhomThucHanh
        /// </summary>
        /// <value>The SiSoNhomThucHanh.</value>
		[System.ComponentModel.Bindable(true)]
		public System.Decimal? SiSoNhomThucHanh
		{
			get { return _entity.SiSoNhomThucHanh; }
		}
        /// <summary>
        ...
        /// <summary>
        /// Gets a <see cref="T:PMS.Entities.ThanhToanThinhGiang"></see> object
        /// </summary>
        /// <value></value>
        [System.ComponentModel.Bindable(true)]
        public PMS.Entities.ThanhToanThinhGiang Entity
        {
            get { return _entity; }
        }
	}
