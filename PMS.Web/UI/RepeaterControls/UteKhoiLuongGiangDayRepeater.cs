...
{
    /// <summary>
    /// A designer class for a strongly typed repeater <c>UteKhoiLuongGiangDayRepeater</c>
    /// </summary>
	public class UteKhoiLuongGiangDayRepeaterDesigner : System.Web.UI.Design.ControlDesigner
	{
	    /// <summary>
        /// Initializes a new instance of the <see cref="T:UteKhoiLuongGiangDayRepeaterDesigner"/> class.
        /// </summary>
		public UteKhoiLuongGiangDayRepeaterDesigner()
		{
		}
		...
		{
			if (!(component is UteKhoiLuongGiangDayRepeater))
			{ 
				throw new ArgumentException("Component is not a UteKhoiLuongGiangDayRepeater."); 
			} 
		...
		public override string GetDesignTimeHtml()
		{
			...
			//
			UteKhoiLuongGiangDayRepeater z = (UteKhoiLuongGiangDayRepeater)Component;
			z.DataBind();
    ...
    /// <summary>
    /// A strongly typed repeater control for the <see cref="UteKhoiLuongGiangDayRepeater"/> Type.
    /// </summary>
	[Designer(typeof(UteKhoiLuongGiangDayRepeaterDesigner))]
	[ParseChildren(true)]
	[ToolboxData("<{0}:UteKhoiLuongGiangDayRepeater runat=\"server\"></{0}:UteKhoiLuongGiangDayRepeater>")]
	public class UteKhoiLuongGiangDayRepeater : CompositeDataBoundControl, System.Web.UI.INamingContainer
	{
	    /// <summary>
        /// Initializes a new instance of the <see cref="T:UteKhoiLuongGiangDayRepeater"/> class.
        /// </summary>
		public UteKhoiLuongGiangDayRepeater()
		{
		}
		...
		[Browsable(false)]
		[TemplateContainer(typeof(UteKhoiLuongGiangDayItem))]
...
//      }
		...
		protected override int CreateChildControls(System.Collections.IEnumerable dataSource, bool dataBinding)
         ...
         if (dataBinding)
         {
			...
			if (dataSource != null)
			{
				...
				{
						PMS.Entities.UteKhoiLuongGiangDay entity = o as PMS.Entities.UteKhoiLuongGiangDay;
						UteKhoiLuongGiangDayItem container = new UteKhoiLuongGiangDayItem(entity);
	...
	public class UteKhoiLuongGiangDayItem : System.Web.UI.Control, System.Web.UI.INamingContainer
	{
		private PMS.Entities.UteKhoiLuongGiangDay _entity;

        /// <summary>
        /// Initializes a new instance of the <see cref="T:UteKhoiLuongGiangDayItem"/> class.
        /// </summary>
		public UteKhoiLuongGiangDayItem()
			: base()
		{ }
        ...
        /// Initializes a new instance of the <see cref="T:UteKhoiLuongGiangDayItem"/> class.
        /// </summary>
		public UteKhoiLuongGiangDayItem(PMS.Entities.UteKhoiLuongGiangDay entity)
			: base()
		{
			_entity = entity;
		}
        ...
        /// <summary>
        /// Gets a <see cref="T:PMS.Entities.UteKhoiLuongGiangDay"></see> object
        /// </summary>
        /// <value></value>
        [System.ComponentModel.Bindable(true)]
        public PMS.Entities.UteKhoiLuongGiangDay Entity
        {
            get { return _entity; }
        }
	}
