...
{
    /// <summary>
    /// A designer class for a strongly typed repeater <c>UteKhoiLuongKhacRepeater</c>
    /// </summary>
	public class UteKhoiLuongKhacRepeaterDesigner : System.Web.UI.Design.ControlDesigner
	{
	    /// <summary>
        /// Initializes a new instance of the <see cref="T:UteKhoiLuongKhacRepeaterDesigner"/> class.
        /// </summary>
		public UteKhoiLuongKhacRepeaterDesigner()
		{
		}
		...
		{
			if (!(component is UteKhoiLuongKhacRepeater))
			{ 
				throw new ArgumentException("Component is not a UteKhoiLuongKhacRepeater."); 
			} 
		...
		public override string GetDesignTimeHtml()
		{
			...
			//
			UteKhoiLuongKhacRepeater z = (UteKhoiLuongKhacRepeater)Component;
			z.DataBind();
    ...
    /// <summary>
    /// A strongly typed repeater control for the <see cref="UteKhoiLuongKhacRepeater"/> Type.
    /// </summary>
	[Designer(typeof(UteKhoiLuongKhacRepeaterDesigner))]
	[ParseChildren(true)]
	[ToolboxData("<{0}:UteKhoiLuongKhacRepeater runat=\"server\"></{0}:UteKhoiLuongKhacRepeater>")]
	public class UteKhoiLuongKhacRepeater : CompositeDataBoundControl, System.Web.UI.INamingContainer
	{
	    /// <summary>
        /// Initializes a new instance of the <see cref="T:UteKhoiLuongKhacRepeater"/> class.
        /// </summary>
		public UteKhoiLuongKhacRepeater()
		{
		}
		...
		[Browsable(false)]
		[TemplateContainer(typeof(UteKhoiLuongKhacItem))]
...
//      }
		...
		protected override int CreateChildControls(System.Collections.IEnumerable dataSource, bool dataBinding)
         ...
         if (dataBinding)
         {
			...
			if (dataSource != null)
			{
				...
				{
						PMS.Entities.UteKhoiLuongKhac entity = o as PMS.Entities.UteKhoiLuongKhac;
						UteKhoiLuongKhacItem container = new UteKhoiLuongKhacItem(entity);
	...
	public class UteKhoiLuongKhacItem : System.Web.UI.Control, System.Web.UI.INamingContainer
	{
		private PMS.Entities.UteKhoiLuongKhac _entity;

        /// <summary>
        /// Initializes a new instance of the <see cref="T:UteKhoiLuongKhacItem"/> class.
        /// </summary>
		public UteKhoiLuongKhacItem()
			: base()
		{ }
        ...
        /// Initializes a new instance of the <see cref="T:UteKhoiLuongKhacItem"/> class.
        /// </summary>
		public UteKhoiLuongKhacItem(PMS.Entities.UteKhoiLuongKhac entity)
			: base()
		{
			_entity = entity;
		}
        ...
        /// <summary>
        /// Gets a <see cref="T:PMS.Entities.UteKhoiLuongKhac"></see> object
        /// </summary>
        /// <value></value>
        [System.ComponentModel.Bindable(true)]
        public PMS.Entities.UteKhoiLuongKhac Entity
        {
            get { return _entity; }
        }
	}
