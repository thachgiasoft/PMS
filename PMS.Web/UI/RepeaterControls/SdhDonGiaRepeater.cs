...
{
    /// <summary>
    /// A designer class for a strongly typed repeater <c>SdhDonGiaRepeater</c>
    /// </summary>
	public class SdhDonGiaRepeaterDesigner : System.Web.UI.Design.ControlDesigner
	{
	    /// <summary>
        /// Initializes a new instance of the <see cref="T:SdhDonGiaRepeaterDesigner"/> class.
        /// </summary>
		public SdhDonGiaRepeaterDesigner()
		{
		}
		...
		{
			if (!(component is SdhDonGiaRepeater))
			{ 
				throw new ArgumentException("Component is not a SdhDonGiaRepeater."); 
			} 
		...
		public override string GetDesignTimeHtml()
		{
			...
			//
			SdhDonGiaRepeater z = (SdhDonGiaRepeater)Component;
			z.DataBind();
    ...
    /// <summary>
    /// A strongly typed repeater control for the <see cref="SdhDonGiaRepeater"/> Type.
    /// </summary>
	[Designer(typeof(SdhDonGiaRepeaterDesigner))]
	[ParseChildren(true)]
	[ToolboxData("<{0}:SdhDonGiaRepeater runat=\"server\"></{0}:SdhDonGiaRepeater>")]
	public class SdhDonGiaRepeater : CompositeDataBoundControl, System.Web.UI.INamingContainer
	{
	    /// <summary>
        /// Initializes a new instance of the <see cref="T:SdhDonGiaRepeater"/> class.
        /// </summary>
		public SdhDonGiaRepeater()
		{
		}
		...
		[Browsable(false)]
		[TemplateContainer(typeof(SdhDonGiaItem))]
...
//      }
		...
		protected override int CreateChildControls(System.Collections.IEnumerable dataSource, bool dataBinding)
         ...
         if (dataBinding)
         {
			...
			if (dataSource != null)
			{
				...
				{
						PMS.Entities.SdhDonGia entity = o as PMS.Entities.SdhDonGia;
						SdhDonGiaItem container = new SdhDonGiaItem(entity);
	...
	public class SdhDonGiaItem : System.Web.UI.Control, System.Web.UI.INamingContainer
	{
		private PMS.Entities.SdhDonGia _entity;

        /// <summary>
        /// Initializes a new instance of the <see cref="T:SdhDonGiaItem"/> class.
        /// </summary>
		public SdhDonGiaItem()
			: base()
		{ }
        ...
        /// Initializes a new instance of the <see cref="T:SdhDonGiaItem"/> class.
        /// </summary>
		public SdhDonGiaItem(PMS.Entities.SdhDonGia entity)
			: base()
		{
			_entity = entity;
		}
        ...
        /// <summary>
        /// Gets a <see cref="T:PMS.Entities.SdhDonGia"></see> object
        /// </summary>
        /// <value></value>
        [System.ComponentModel.Bindable(true)]
        public PMS.Entities.SdhDonGia Entity
        {
            get { return _entity; }
        }
	}
