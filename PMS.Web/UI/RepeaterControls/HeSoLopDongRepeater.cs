...
{
    /// <summary>
    /// A designer class for a strongly typed repeater <c>HeSoLopDongRepeater</c>
    /// </summary>
	public class HeSoLopDongRepeaterDesigner : System.Web.UI.Design.ControlDesigner
	{
	    /// <summary>
        /// Initializes a new instance of the <see cref="T:HeSoLopDongRepeaterDesigner"/> class.
        /// </summary>
		public HeSoLopDongRepeaterDesigner()
		{
		}
		...
		{
			if (!(component is HeSoLopDongRepeater))
			{ 
				throw new ArgumentException("Component is not a HeSoLopDongRepeater."); 
			} 
		...
		public override string GetDesignTimeHtml()
		{
			...
			//
			HeSoLopDongRepeater z = (HeSoLopDongRepeater)Component;
			z.DataBind();
    ...
    /// <summary>
    /// A strongly typed repeater control for the <see cref="HeSoLopDongRepeater"/> Type.
    /// </summary>
	[Designer(typeof(HeSoLopDongRepeaterDesigner))]
	[ParseChildren(true)]
	[ToolboxData("<{0}:HeSoLopDongRepeater runat=\"server\"></{0}:HeSoLopDongRepeater>")]
	public class HeSoLopDongRepeater : CompositeDataBoundControl, System.Web.UI.INamingContainer
	{
	    /// <summary>
        /// Initializes a new instance of the <see cref="T:HeSoLopDongRepeater"/> class.
        /// </summary>
		public HeSoLopDongRepeater()
		{
		}
		...
		[Browsable(false)]
		[TemplateContainer(typeof(HeSoLopDongItem))]
...
//      }
		...
		protected override int CreateChildControls(System.Collections.IEnumerable dataSource, bool dataBinding)
         ...
         if (dataBinding)
         {
			...
			if (dataSource != null)
			{
				...
				{
						PMS.Entities.HeSoLopDong entity = o as PMS.Entities.HeSoLopDong;
						HeSoLopDongItem container = new HeSoLopDongItem(entity);
	...
	public class HeSoLopDongItem : System.Web.UI.Control, System.Web.UI.INamingContainer
	{
		private PMS.Entities.HeSoLopDong _entity;

        /// <summary>
        /// Initializes a new instance of the <see cref="T:HeSoLopDongItem"/> class.
        /// </summary>
		public HeSoLopDongItem()
			: base()
		{ }
        ...
        /// Initializes a new instance of the <see cref="T:HeSoLopDongItem"/> class.
        /// </summary>
		public HeSoLopDongItem(PMS.Entities.HeSoLopDong entity)
			: base()
		{
			_entity = entity;
		}
        ...
        /// <summary>
        /// Gets a <see cref="T:PMS.Entities.HeSoLopDong"></see> object
        /// </summary>
        /// <value></value>
        [System.ComponentModel.Bindable(true)]
        public PMS.Entities.HeSoLopDong Entity
        {
            get { return _entity; }
        }
	}
