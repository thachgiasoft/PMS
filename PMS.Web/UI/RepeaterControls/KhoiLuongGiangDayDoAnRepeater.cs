...
{
    /// <summary>
    /// A designer class for a strongly typed repeater <c>KhoiLuongGiangDayDoAnRepeater</c>
    /// </summary>
	public class KhoiLuongGiangDayDoAnRepeaterDesigner : System.Web.UI.Design.ControlDesigner
	{
	    /// <summary>
        /// Initializes a new instance of the <see cref="T:KhoiLuongGiangDayDoAnRepeaterDesigner"/> class.
        /// </summary>
		public KhoiLuongGiangDayDoAnRepeaterDesigner()
		{
		}
		...
		{
			if (!(component is KhoiLuongGiangDayDoAnRepeater))
			{ 
				throw new ArgumentException("Component is not a KhoiLuongGiangDayDoAnRepeater."); 
			} 
		...
		public override string GetDesignTimeHtml()
		{
			...
			//
			KhoiLuongGiangDayDoAnRepeater z = (KhoiLuongGiangDayDoAnRepeater)Component;
			z.DataBind();
    ...
    /// <summary>
    /// A strongly typed repeater control for the <see cref="KhoiLuongGiangDayDoAnRepeater"/> Type.
    /// </summary>
	[Designer(typeof(KhoiLuongGiangDayDoAnRepeaterDesigner))]
	[ParseChildren(true)]
	[ToolboxData("<{0}:KhoiLuongGiangDayDoAnRepeater runat=\"server\"></{0}:KhoiLuongGiangDayDoAnRepeater>")]
	public class KhoiLuongGiangDayDoAnRepeater : CompositeDataBoundControl, System.Web.UI.INamingContainer
	{
	    /// <summary>
        /// Initializes a new instance of the <see cref="T:KhoiLuongGiangDayDoAnRepeater"/> class.
        /// </summary>
		public KhoiLuongGiangDayDoAnRepeater()
		{
		}
		...
		[Browsable(false)]
		[TemplateContainer(typeof(KhoiLuongGiangDayDoAnItem))]
...
//      }
		...
		protected override int CreateChildControls(System.Collections.IEnumerable dataSource, bool dataBinding)
         ...
         if (dataBinding)
         {
			...
			if (dataSource != null)
			{
				...
				{
						PMS.Entities.KhoiLuongGiangDayDoAn entity = o as PMS.Entities.KhoiLuongGiangDayDoAn;
						KhoiLuongGiangDayDoAnItem container = new KhoiLuongGiangDayDoAnItem(entity);
	...
	public class KhoiLuongGiangDayDoAnItem : System.Web.UI.Control, System.Web.UI.INamingContainer
	{
		private PMS.Entities.KhoiLuongGiangDayDoAn _entity;

        /// <summary>
        /// Initializes a new instance of the <see cref="T:KhoiLuongGiangDayDoAnItem"/> class.
        /// </summary>
		public KhoiLuongGiangDayDoAnItem()
			: base()
		{ }
        ...
        /// Initializes a new instance of the <see cref="T:KhoiLuongGiangDayDoAnItem"/> class.
        /// </summary>
		public KhoiLuongGiangDayDoAnItem(PMS.Entities.KhoiLuongGiangDayDoAn entity)
			: base()
		{
			_entity = entity;
		}
        ...
        /// <summary>
        /// Gets a <see cref="T:PMS.Entities.KhoiLuongGiangDayDoAn"></see> object
        /// </summary>
        /// <value></value>
        [System.ComponentModel.Bindable(true)]
        public PMS.Entities.KhoiLuongGiangDayDoAn Entity
        {
            get { return _entity; }
        }
	}
