...
{
    /// <summary>
    /// A designer class for a strongly typed repeater <c>ViewKcqUteKhoiLuongQuyDoi2Repeater</c>
    /// </summary>
	public class ViewKcqUteKhoiLuongQuyDoi2RepeaterDesigner : System.Web.UI.Design.ControlDesigner
	{
	    /// <summary>
        /// Initializes a new instance of the <see cref="T:ViewKcqUteKhoiLuongQuyDoi2RepeaterDesigner"/> class.
        /// </summary>
		public ViewKcqUteKhoiLuongQuyDoi2RepeaterDesigner()
		{
		}
		...
		{
			if (!(component is ViewKcqUteKhoiLuongQuyDoi2Repeater))
			{ 
				throw new ArgumentException("Component is not a ViewKcqUteKhoiLuongQuyDoi2Repeater."); 
			} 
		...
		public override string GetDesignTimeHtml()
		{
			...
			//
			ViewKcqUteKhoiLuongQuyDoi2Repeater z = (ViewKcqUteKhoiLuongQuyDoi2Repeater)Component;
			z.DataBind();
    ...
    /// <summary>
    /// A strongly typed repeater control for the <see cref="ViewKcqUteKhoiLuongQuyDoi2Repeater"/> Type.
    /// </summary>
	[Designer(typeof(ViewKcqUteKhoiLuongQuyDoi2RepeaterDesigner))]
	[ParseChildren(true)]
	[ToolboxData("<{0}:ViewKcqUteKhoiLuongQuyDoi2Repeater runat=\"server\"></{0}:ViewKcqUteKhoiLuongQuyDoi2Repeater>")]
	public class ViewKcqUteKhoiLuongQuyDoi2Repeater : CompositeDataBoundControl, System.Web.UI.INamingContainer
	{
	    /// <summary>
        /// Initializes a new instance of the <see cref="T:ViewKcqUteKhoiLuongQuyDoi2Repeater"/> class.
        /// </summary>
		public ViewKcqUteKhoiLuongQuyDoi2Repeater()
		{
		}
		...
		[Browsable(false)]
		[TemplateContainer(typeof(ViewKcqUteKhoiLuongQuyDoi2Item))]
...
//		}
		...
		protected override int CreateChildControls(System.Collections.IEnumerable dataSource, bool dataBinding)
      {
         ...
         if (dataBinding)
         {
			...
			if (dataSource != null)
			{
				...
				{
						PMS.Entities.ViewKcqUteKhoiLuongQuyDoi2 entity = o as PMS.Entities.ViewKcqUteKhoiLuongQuyDoi2;
						ViewKcqUteKhoiLuongQuyDoi2Item container = new ViewKcqUteKhoiLuongQuyDoi2Item(entity);
	...
	public class ViewKcqUteKhoiLuongQuyDoi2Item : System.Web.UI.Control, System.Web.UI.INamingContainer
	{
		private PMS.Entities.ViewKcqUteKhoiLuongQuyDoi2 _entity;

        /// <summary>
        /// Initializes a new instance of the <see cref="T:ViewKcqUteKhoiLuongQuyDoi2Item"/> class.
        /// </summary>
		public ViewKcqUteKhoiLuongQuyDoi2Item()
			: base()
		{ }
        ...
        /// Initializes a new instance of the <see cref="T:ViewKcqUteKhoiLuongQuyDoi2Item"/> class.
        /// </summary>
		public ViewKcqUteKhoiLuongQuyDoi2Item(PMS.Entities.ViewKcqUteKhoiLuongQuyDoi2 entity)
			: base()
		{
			_entity = entity;
		}
