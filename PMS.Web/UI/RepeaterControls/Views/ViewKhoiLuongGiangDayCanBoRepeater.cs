...
{
    /// <summary>
    /// A designer class for a strongly typed repeater <c>ViewKhoiLuongGiangDayCanBoRepeater</c>
    /// </summary>
	public class ViewKhoiLuongGiangDayCanBoRepeaterDesigner : System.Web.UI.Design.ControlDesigner
	{
	    /// <summary>
        /// Initializes a new instance of the <see cref="T:ViewKhoiLuongGiangDayCanBoRepeaterDesigner"/> class.
        /// </summary>
		public ViewKhoiLuongGiangDayCanBoRepeaterDesigner()
		{
		}
		...
		{
			if (!(component is ViewKhoiLuongGiangDayCanBoRepeater))
			{ 
				throw new ArgumentException("Component is not a ViewKhoiLuongGiangDayCanBoRepeater."); 
			} 
		...
		public override string GetDesignTimeHtml()
		{
			...
			//
			ViewKhoiLuongGiangDayCanBoRepeater z = (ViewKhoiLuongGiangDayCanBoRepeater)Component;
			z.DataBind();
    ...
    /// <summary>
    /// A strongly typed repeater control for the <see cref="ViewKhoiLuongGiangDayCanBoRepeater"/> Type.
    /// </summary>
	[Designer(typeof(ViewKhoiLuongGiangDayCanBoRepeaterDesigner))]
	[ParseChildren(true)]
	[ToolboxData("<{0}:ViewKhoiLuongGiangDayCanBoRepeater runat=\"server\"></{0}:ViewKhoiLuongGiangDayCanBoRepeater>")]
	public class ViewKhoiLuongGiangDayCanBoRepeater : CompositeDataBoundControl, System.Web.UI.INamingContainer
	{
	    /// <summary>
        /// Initializes a new instance of the <see cref="T:ViewKhoiLuongGiangDayCanBoRepeater"/> class.
        /// </summary>
		public ViewKhoiLuongGiangDayCanBoRepeater()
		{
		}
		...
		[Browsable(false)]
		[TemplateContainer(typeof(ViewKhoiLuongGiangDayCanBoItem))]
...
//		}
		...
		protected override int CreateChildControls(System.Collections.IEnumerable dataSource, bool dataBinding)
      {
         ...
         if (dataBinding)
         {
			...
			if (dataSource != null)
			{
				...
				{
						PMS.Entities.ViewKhoiLuongGiangDayCanBo entity = o as PMS.Entities.ViewKhoiLuongGiangDayCanBo;
						ViewKhoiLuongGiangDayCanBoItem container = new ViewKhoiLuongGiangDayCanBoItem(entity);
	...
	public class ViewKhoiLuongGiangDayCanBoItem : System.Web.UI.Control, System.Web.UI.INamingContainer
	{
		private PMS.Entities.ViewKhoiLuongGiangDayCanBo _entity;

        /// <summary>
        /// Initializes a new instance of the <see cref="T:ViewKhoiLuongGiangDayCanBoItem"/> class.
        /// </summary>
		public ViewKhoiLuongGiangDayCanBoItem()
			: base()
		{ }
        ...
        /// Initializes a new instance of the <see cref="T:ViewKhoiLuongGiangDayCanBoItem"/> class.
        /// </summary>
		public ViewKhoiLuongGiangDayCanBoItem(PMS.Entities.ViewKhoiLuongGiangDayCanBo entity)
			: base()
		{
			_entity = entity;
		}
