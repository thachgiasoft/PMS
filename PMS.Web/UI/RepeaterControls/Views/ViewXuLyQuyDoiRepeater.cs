...
{
    /// <summary>
    /// A designer class for a strongly typed repeater <c>ViewXuLyQuyDoiRepeater</c>
    /// </summary>
	public class ViewXuLyQuyDoiRepeaterDesigner : System.Web.UI.Design.ControlDesigner
	{
	    /// <summary>
        /// Initializes a new instance of the <see cref="T:ViewXuLyQuyDoiRepeaterDesigner"/> class.
        /// </summary>
		public ViewXuLyQuyDoiRepeaterDesigner()
		{
		}
		...
		{
			if (!(component is ViewXuLyQuyDoiRepeater))
			{ 
				throw new ArgumentException("Component is not a ViewXuLyQuyDoiRepeater."); 
			} 
		...
		public override string GetDesignTimeHtml()
		{
			...
			//
			ViewXuLyQuyDoiRepeater z = (ViewXuLyQuyDoiRepeater)Component;
			z.DataBind();
    ...
    /// <summary>
    /// A strongly typed repeater control for the <see cref="ViewXuLyQuyDoiRepeater"/> Type.
    /// </summary>
	[Designer(typeof(ViewXuLyQuyDoiRepeaterDesigner))]
	[ParseChildren(true)]
	[ToolboxData("<{0}:ViewXuLyQuyDoiRepeater runat=\"server\"></{0}:ViewXuLyQuyDoiRepeater>")]
	public class ViewXuLyQuyDoiRepeater : CompositeDataBoundControl, System.Web.UI.INamingContainer
	{
	    /// <summary>
        /// Initializes a new instance of the <see cref="T:ViewXuLyQuyDoiRepeater"/> class.
        /// </summary>
		public ViewXuLyQuyDoiRepeater()
		{
		}
		...
		[Browsable(false)]
		[TemplateContainer(typeof(ViewXuLyQuyDoiItem))]
...
//		}
		...
		protected override int CreateChildControls(System.Collections.IEnumerable dataSource, bool dataBinding)
      {
         ...
         if (dataBinding)
         {
			...
			if (dataSource != null)
			{
				...
				{
						PMS.Entities.ViewXuLyQuyDoi entity = o as PMS.Entities.ViewXuLyQuyDoi;
						ViewXuLyQuyDoiItem container = new ViewXuLyQuyDoiItem(entity);
	...
	public class ViewXuLyQuyDoiItem : System.Web.UI.Control, System.Web.UI.INamingContainer
	{
		private PMS.Entities.ViewXuLyQuyDoi _entity;

        /// <summary>
        /// Initializes a new instance of the <see cref="T:ViewXuLyQuyDoiItem"/> class.
        /// </summary>
		public ViewXuLyQuyDoiItem()
			: base()
		{ }
        ...
        /// Initializes a new instance of the <see cref="T:ViewXuLyQuyDoiItem"/> class.
        /// </summary>
		public ViewXuLyQuyDoiItem(PMS.Entities.ViewXuLyQuyDoi entity)
			: base()
		{
			_entity = entity;
		}
