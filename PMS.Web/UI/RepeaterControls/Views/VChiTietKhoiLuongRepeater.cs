...
{
    /// <summary>
    /// A designer class for a strongly typed repeater <c>VChiTietKhoiLuongRepeater</c>
    /// </summary>
	public class VChiTietKhoiLuongRepeaterDesigner : System.Web.UI.Design.ControlDesigner
	{
	    /// <summary>
        /// Initializes a new instance of the <see cref="T:VChiTietKhoiLuongRepeaterDesigner"/> class.
        /// </summary>
		public VChiTietKhoiLuongRepeaterDesigner()
		{
		}
		...
		{
			if (!(component is VChiTietKhoiLuongRepeater))
			{ 
				throw new ArgumentException("Component is not a VChiTietKhoiLuongRepeater."); 
			} 
		...
		public override string GetDesignTimeHtml()
		{
			...
			//
			VChiTietKhoiLuongRepeater z = (VChiTietKhoiLuongRepeater)Component;
			z.DataBind();
    ...
    /// <summary>
    /// A strongly typed repeater control for the <see cref="VChiTietKhoiLuongRepeater"/> Type.
    /// </summary>
	[Designer(typeof(VChiTietKhoiLuongRepeaterDesigner))]
	[ParseChildren(true)]
	[ToolboxData("<{0}:VChiTietKhoiLuongRepeater runat=\"server\"></{0}:VChiTietKhoiLuongRepeater>")]
	public class VChiTietKhoiLuongRepeater : CompositeDataBoundControl, System.Web.UI.INamingContainer
	{
	    /// <summary>
        /// Initializes a new instance of the <see cref="T:VChiTietKhoiLuongRepeater"/> class.
        /// </summary>
		public VChiTietKhoiLuongRepeater()
		{
		}
		...
		[Browsable(false)]
		[TemplateContainer(typeof(VChiTietKhoiLuongItem))]
...
//		}
		...
		protected override int CreateChildControls(System.Collections.IEnumerable dataSource, bool dataBinding)
      {
         ...
         if (dataBinding)
         {
			...
			if (dataSource != null)
			{
				...
				{
						PMS.Entities.VChiTietKhoiLuong entity = o as PMS.Entities.VChiTietKhoiLuong;
						VChiTietKhoiLuongItem container = new VChiTietKhoiLuongItem(entity);
	...
	public class VChiTietKhoiLuongItem : System.Web.UI.Control, System.Web.UI.INamingContainer
	{
		private PMS.Entities.VChiTietKhoiLuong _entity;

        /// <summary>
        /// Initializes a new instance of the <see cref="T:VChiTietKhoiLuongItem"/> class.
        /// </summary>
		public VChiTietKhoiLuongItem()
			: base()
		{ }
        ...
        /// Initializes a new instance of the <see cref="T:VChiTietKhoiLuongItem"/> class.
        /// </summary>
		public VChiTietKhoiLuongItem(PMS.Entities.VChiTietKhoiLuong entity)
			: base()
		{
			_entity = entity;
		}
