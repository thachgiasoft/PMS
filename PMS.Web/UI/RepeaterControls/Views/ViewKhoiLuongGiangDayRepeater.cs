...
{
    /// <summary>
    /// A designer class for a strongly typed repeater <c>ViewKhoiLuongGiangDayRepeater</c>
    /// </summary>
	public class ViewKhoiLuongGiangDayRepeaterDesigner : System.Web.UI.Design.ControlDesigner
	{
	    /// <summary>
        /// Initializes a new instance of the <see cref="T:ViewKhoiLuongGiangDayRepeaterDesigner"/> class.
        /// </summary>
		public ViewKhoiLuongGiangDayRepeaterDesigner()
		{
		}
		...
		{
			if (!(component is ViewKhoiLuongGiangDayRepeater))
			{ 
				throw new ArgumentException("Component is not a ViewKhoiLuongGiangDayRepeater."); 
			} 
		...
		public override string GetDesignTimeHtml()
		{
			...
			//
			ViewKhoiLuongGiangDayRepeater z = (ViewKhoiLuongGiangDayRepeater)Component;
			z.DataBind();
    ...
    /// <summary>
    /// A strongly typed repeater control for the <see cref="ViewKhoiLuongGiangDayRepeater"/> Type.
    /// </summary>
	[Designer(typeof(ViewKhoiLuongGiangDayRepeaterDesigner))]
	[ParseChildren(true)]
	[ToolboxData("<{0}:ViewKhoiLuongGiangDayRepeater runat=\"server\"></{0}:ViewKhoiLuongGiangDayRepeater>")]
	public class ViewKhoiLuongGiangDayRepeater : CompositeDataBoundControl, System.Web.UI.INamingContainer
	{
	    /// <summary>
        /// Initializes a new instance of the <see cref="T:ViewKhoiLuongGiangDayRepeater"/> class.
        /// </summary>
		public ViewKhoiLuongGiangDayRepeater()
		{
		}
		...
		[Browsable(false)]
		[TemplateContainer(typeof(ViewKhoiLuongGiangDayItem))]
...
//		}
		...
		protected override int CreateChildControls(System.Collections.IEnumerable dataSource, bool dataBinding)
      {
         ...
         if (dataBinding)
         {
			...
			if (dataSource != null)
			{
				...
				{
						PMS.Entities.ViewKhoiLuongGiangDay entity = o as PMS.Entities.ViewKhoiLuongGiangDay;
						ViewKhoiLuongGiangDayItem container = new ViewKhoiLuongGiangDayItem(entity);
	...
	public class ViewKhoiLuongGiangDayItem : System.Web.UI.Control, System.Web.UI.INamingContainer
	{
		private PMS.Entities.ViewKhoiLuongGiangDay _entity;

        /// <summary>
        /// Initializes a new instance of the <see cref="T:ViewKhoiLuongGiangDayItem"/> class.
        /// </summary>
		public ViewKhoiLuongGiangDayItem()
			: base()
		{ }
        ...
        /// Initializes a new instance of the <see cref="T:ViewKhoiLuongGiangDayItem"/> class.
        /// </summary>
		public ViewKhoiLuongGiangDayItem(PMS.Entities.ViewKhoiLuongGiangDay entity)
			: base()
		{
			_entity = entity;
		}
