...
{
    /// <summary>
    /// A designer class for a strongly typed repeater <c>ViewGiangVienRepeater</c>
    /// </summary>
	public class ViewGiangVienRepeaterDesigner : System.Web.UI.Design.ControlDesigner
	{
	    /// <summary>
        /// Initializes a new instance of the <see cref="T:ViewGiangVienRepeaterDesigner"/> class.
        /// </summary>
		public ViewGiangVienRepeaterDesigner()
		{
		}
		...
		{
			if (!(component is ViewGiangVienRepeater))
			{ 
				throw new ArgumentException("Component is not a ViewGiangVienRepeater."); 
			} 
		...
		public override string GetDesignTimeHtml()
		{
			...
			//
			ViewGiangVienRepeater z = (ViewGiangVienRepeater)Component;
			z.DataBind();
    ...
    /// <summary>
    /// A strongly typed repeater control for the <see cref="ViewGiangVienRepeater"/> Type.
    /// </summary>
	[Designer(typeof(ViewGiangVienRepeaterDesigner))]
	[ParseChildren(true)]
	[ToolboxData("<{0}:ViewGiangVienRepeater runat=\"server\"></{0}:ViewGiangVienRepeater>")]
	public class ViewGiangVienRepeater : CompositeDataBoundControl, System.Web.UI.INamingContainer
	{
	    /// <summary>
        /// Initializes a new instance of the <see cref="T:ViewGiangVienRepeater"/> class.
        /// </summary>
		public ViewGiangVienRepeater()
		{
		}
		...
		[Browsable(false)]
		[TemplateContainer(typeof(ViewGiangVienItem))]
...
//		}
		...
		protected override int CreateChildControls(System.Collections.IEnumerable dataSource, bool dataBinding)
      {
         ...
         if (dataBinding)
         {
			...
			if (dataSource != null)
			{
				...
				{
						PMS.Entities.ViewGiangVien entity = o as PMS.Entities.ViewGiangVien;
						ViewGiangVienItem container = new ViewGiangVienItem(entity);
	...
	public class ViewGiangVienItem : System.Web.UI.Control, System.Web.UI.INamingContainer
	{
		private PMS.Entities.ViewGiangVien _entity;

        /// <summary>
        /// Initializes a new instance of the <see cref="T:ViewGiangVienItem"/> class.
        /// </summary>
		public ViewGiangVienItem()
			: base()
		{ }
        ...
        /// Initializes a new instance of the <see cref="T:ViewGiangVienItem"/> class.
        /// </summary>
		public ViewGiangVienItem(PMS.Entities.ViewGiangVien entity)
			: base()
		{
			_entity = entity;
		}
