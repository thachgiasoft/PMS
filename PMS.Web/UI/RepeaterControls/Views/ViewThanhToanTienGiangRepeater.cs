...
{
    /// <summary>
    /// A designer class for a strongly typed repeater <c>ViewThanhToanTienGiangRepeater</c>
    /// </summary>
	public class ViewThanhToanTienGiangRepeaterDesigner : System.Web.UI.Design.ControlDesigner
	{
	    /// <summary>
        /// Initializes a new instance of the <see cref="T:ViewThanhToanTienGiangRepeaterDesigner"/> class.
        /// </summary>
		public ViewThanhToanTienGiangRepeaterDesigner()
		{
		}
		...
		{
			if (!(component is ViewThanhToanTienGiangRepeater))
			{ 
				throw new ArgumentException("Component is not a ViewThanhToanTienGiangRepeater."); 
			} 
		...
		public override string GetDesignTimeHtml()
		{
			...
			//
			ViewThanhToanTienGiangRepeater z = (ViewThanhToanTienGiangRepeater)Component;
			z.DataBind();
    ...
    /// <summary>
    /// A strongly typed repeater control for the <see cref="ViewThanhToanTienGiangRepeater"/> Type.
    /// </summary>
	[Designer(typeof(ViewThanhToanTienGiangRepeaterDesigner))]
	[ParseChildren(true)]
	[ToolboxData("<{0}:ViewThanhToanTienGiangRepeater runat=\"server\"></{0}:ViewThanhToanTienGiangRepeater>")]
	public class ViewThanhToanTienGiangRepeater : CompositeDataBoundControl, System.Web.UI.INamingContainer
	{
	    /// <summary>
        /// Initializes a new instance of the <see cref="T:ViewThanhToanTienGiangRepeater"/> class.
        /// </summary>
		public ViewThanhToanTienGiangRepeater()
		{
		}
		...
		[Browsable(false)]
		[TemplateContainer(typeof(ViewThanhToanTienGiangItem))]
...
//		}
		...
		protected override int CreateChildControls(System.Collections.IEnumerable dataSource, bool dataBinding)
      {
         ...
         if (dataBinding)
         {
			...
			if (dataSource != null)
			{
				...
				{
						PMS.Entities.ViewThanhToanTienGiang entity = o as PMS.Entities.ViewThanhToanTienGiang;
						ViewThanhToanTienGiangItem container = new ViewThanhToanTienGiangItem(entity);
	...
	public class ViewThanhToanTienGiangItem : System.Web.UI.Control, System.Web.UI.INamingContainer
	{
		private PMS.Entities.ViewThanhToanTienGiang _entity;

        /// <summary>
        /// Initializes a new instance of the <see cref="T:ViewThanhToanTienGiangItem"/> class.
        /// </summary>
		public ViewThanhToanTienGiangItem()
			: base()
		{ }
        ...
        /// Initializes a new instance of the <see cref="T:ViewThanhToanTienGiangItem"/> class.
        /// </summary>
		public ViewThanhToanTienGiangItem(PMS.Entities.ViewThanhToanTienGiang entity)
			: base()
		{
			_entity = entity;
		}
