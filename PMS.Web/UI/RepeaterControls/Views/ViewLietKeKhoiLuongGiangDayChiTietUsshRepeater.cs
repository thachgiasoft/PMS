...
{
    /// <summary>
    /// A designer class for a strongly typed repeater <c>ViewLietKeKhoiLuongGiangDayChiTietUsshRepeater</c>
    /// </summary>
	public class ViewLietKeKhoiLuongGiangDayChiTietUsshRepeaterDesigner : System.Web.UI.Design.ControlDesigner
	{
	    /// <summary>
        /// Initializes a new instance of the <see cref="T:ViewLietKeKhoiLuongGiangDayChiTietUsshRepeaterDesigner"/> class.
        /// </summary>
		public ViewLietKeKhoiLuongGiangDayChiTietUsshRepeaterDesigner()
		{
		}
		...
		{
			if (!(component is ViewLietKeKhoiLuongGiangDayChiTietUsshRepeater))
			{ 
				throw new ArgumentException("Component is not a ViewLietKeKhoiLuongGiangDayChiTietUsshRepeater."); 
			} 
		...
		public override string GetDesignTimeHtml()
		{
			...
			//
			ViewLietKeKhoiLuongGiangDayChiTietUsshRepeater z = (ViewLietKeKhoiLuongGiangDayChiTietUsshRepeater)Component;
			z.DataBind();
    ...
    /// <summary>
    /// A strongly typed repeater control for the <see cref="ViewLietKeKhoiLuongGiangDayChiTietUsshRepeater"/> Type.
    /// </summary>
	[Designer(typeof(ViewLietKeKhoiLuongGiangDayChiTietUsshRepeaterDesigner))]
	[ParseChildren(true)]
	[ToolboxData("<{0}:ViewLietKeKhoiLuongGiangDayChiTietUsshRepeater runat=\"server\"></{0}:ViewLietKeKhoiLuongGiangDayChiTietUsshRepeater>")]
	public class ViewLietKeKhoiLuongGiangDayChiTietUsshRepeater : CompositeDataBoundControl, System.Web.UI.INamingContainer
	{
	    /// <summary>
        /// Initializes a new instance of the <see cref="T:ViewLietKeKhoiLuongGiangDayChiTietUsshRepeater"/> class.
        /// </summary>
		public ViewLietKeKhoiLuongGiangDayChiTietUsshRepeater()
		{
		}
		...
		[Browsable(false)]
		[TemplateContainer(typeof(ViewLietKeKhoiLuongGiangDayChiTietUsshItem))]
...
//		}
		...
		protected override int CreateChildControls(System.Collections.IEnumerable dataSource, bool dataBinding)
      {
         ...
         if (dataBinding)
         {
			...
			if (dataSource != null)
			{
				...
				{
						PMS.Entities.ViewLietKeKhoiLuongGiangDayChiTietUssh entity = o as PMS.Entities.ViewLietKeKhoiLuongGiangDayChiTietUssh;
						ViewLietKeKhoiLuongGiangDayChiTietUsshItem container = new ViewLietKeKhoiLuongGiangDayChiTietUsshItem(entity);
	...
	public class ViewLietKeKhoiLuongGiangDayChiTietUsshItem : System.Web.UI.Control, System.Web.UI.INamingContainer
	{
		private PMS.Entities.ViewLietKeKhoiLuongGiangDayChiTietUssh _entity;

        /// <summary>
        /// Initializes a new instance of the <see cref="T:ViewLietKeKhoiLuongGiangDayChiTietUsshItem"/> class.
        /// </summary>
		public ViewLietKeKhoiLuongGiangDayChiTietUsshItem()
			: base()
		{ }
        ...
        /// Initializes a new instance of the <see cref="T:ViewLietKeKhoiLuongGiangDayChiTietUsshItem"/> class.
        /// </summary>
		public ViewLietKeKhoiLuongGiangDayChiTietUsshItem(PMS.Entities.ViewLietKeKhoiLuongGiangDayChiTietUssh entity)
			: base()
		{
			_entity = entity;
		}
