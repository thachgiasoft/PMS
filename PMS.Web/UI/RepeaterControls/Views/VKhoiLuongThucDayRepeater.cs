...
{
    /// <summary>
    /// A designer class for a strongly typed repeater <c>VKhoiLuongThucDayRepeater</c>
    /// </summary>
	public class VKhoiLuongThucDayRepeaterDesigner : System.Web.UI.Design.ControlDesigner
	{
	    /// <summary>
        /// Initializes a new instance of the <see cref="T:VKhoiLuongThucDayRepeaterDesigner"/> class.
        /// </summary>
		public VKhoiLuongThucDayRepeaterDesigner()
		{
		}
		...
		{
			if (!(component is VKhoiLuongThucDayRepeater))
			{ 
				throw new ArgumentException("Component is not a VKhoiLuongThucDayRepeater."); 
			} 
		...
		public override string GetDesignTimeHtml()
		{
			...
			//
			VKhoiLuongThucDayRepeater z = (VKhoiLuongThucDayRepeater)Component;
			z.DataBind();
    ...
    /// <summary>
    /// A strongly typed repeater control for the <see cref="VKhoiLuongThucDayRepeater"/> Type.
    /// </summary>
	[Designer(typeof(VKhoiLuongThucDayRepeaterDesigner))]
	[ParseChildren(true)]
	[ToolboxData("<{0}:VKhoiLuongThucDayRepeater runat=\"server\"></{0}:VKhoiLuongThucDayRepeater>")]
	public class VKhoiLuongThucDayRepeater : CompositeDataBoundControl, System.Web.UI.INamingContainer
	{
	    /// <summary>
        /// Initializes a new instance of the <see cref="T:VKhoiLuongThucDayRepeater"/> class.
        /// </summary>
		public VKhoiLuongThucDayRepeater()
		{
		}
		...
		[Browsable(false)]
		[TemplateContainer(typeof(VKhoiLuongThucDayItem))]
...
//		}
		...
		protected override int CreateChildControls(System.Collections.IEnumerable dataSource, bool dataBinding)
      {
         ...
         if (dataBinding)
         {
			...
			if (dataSource != null)
			{
				...
				{
						PMS.Entities.VKhoiLuongThucDay entity = o as PMS.Entities.VKhoiLuongThucDay;
						VKhoiLuongThucDayItem container = new VKhoiLuongThucDayItem(entity);
	...
	public class VKhoiLuongThucDayItem : System.Web.UI.Control, System.Web.UI.INamingContainer
	{
		private PMS.Entities.VKhoiLuongThucDay _entity;

        /// <summary>
        /// Initializes a new instance of the <see cref="T:VKhoiLuongThucDayItem"/> class.
        /// </summary>
		public VKhoiLuongThucDayItem()
			: base()
		{ }
        ...
        /// Initializes a new instance of the <see cref="T:VKhoiLuongThucDayItem"/> class.
        /// </summary>
		public VKhoiLuongThucDayItem(PMS.Entities.VKhoiLuongThucDay entity)
			: base()
		{
			_entity = entity;
		}
