...
{
    /// <summary>
    /// A designer class for a strongly typed repeater <c>ViewChiTietHocPhanRepeater</c>
    /// </summary>
	public class ViewChiTietHocPhanRepeaterDesigner : System.Web.UI.Design.ControlDesigner
	{
	    /// <summary>
        /// Initializes a new instance of the <see cref="T:ViewChiTietHocPhanRepeaterDesigner"/> class.
        /// </summary>
		public ViewChiTietHocPhanRepeaterDesigner()
		{
		}
		...
		{
			if (!(component is ViewChiTietHocPhanRepeater))
			{ 
				throw new ArgumentException("Component is not a ViewChiTietHocPhanRepeater."); 
			} 
		...
		public override string GetDesignTimeHtml()
		{
			...
			//
			ViewChiTietHocPhanRepeater z = (ViewChiTietHocPhanRepeater)Component;
			z.DataBind();
    ...
    /// <summary>
    /// A strongly typed repeater control for the <see cref="ViewChiTietHocPhanRepeater"/> Type.
    /// </summary>
	[Designer(typeof(ViewChiTietHocPhanRepeaterDesigner))]
	[ParseChildren(true)]
	[ToolboxData("<{0}:ViewChiTietHocPhanRepeater runat=\"server\"></{0}:ViewChiTietHocPhanRepeater>")]
	public class ViewChiTietHocPhanRepeater : CompositeDataBoundControl, System.Web.UI.INamingContainer
	{
	    /// <summary>
        /// Initializes a new instance of the <see cref="T:ViewChiTietHocPhanRepeater"/> class.
        /// </summary>
		public ViewChiTietHocPhanRepeater()
		{
		}
		...
		[Browsable(false)]
		[TemplateContainer(typeof(ViewChiTietHocPhanItem))]
...
//		}
		...
		protected override int CreateChildControls(System.Collections.IEnumerable dataSource, bool dataBinding)
      {
         ...
         if (dataBinding)
         {
			...
			if (dataSource != null)
			{
				...
				{
						PMS.Entities.ViewChiTietHocPhan entity = o as PMS.Entities.ViewChiTietHocPhan;
						ViewChiTietHocPhanItem container = new ViewChiTietHocPhanItem(entity);
	...
	public class ViewChiTietHocPhanItem : System.Web.UI.Control, System.Web.UI.INamingContainer
	{
		private PMS.Entities.ViewChiTietHocPhan _entity;

        /// <summary>
        /// Initializes a new instance of the <see cref="T:ViewChiTietHocPhanItem"/> class.
        /// </summary>
		public ViewChiTietHocPhanItem()
			: base()
		{ }
        ...
        /// Initializes a new instance of the <see cref="T:ViewChiTietHocPhanItem"/> class.
        /// </summary>
		public ViewChiTietHocPhanItem(PMS.Entities.ViewChiTietHocPhan entity)
			: base()
		{
			_entity = entity;
		}
