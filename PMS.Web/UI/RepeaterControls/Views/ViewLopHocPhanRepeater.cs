...
{
    /// <summary>
    /// A designer class for a strongly typed repeater <c>ViewLopHocPhanRepeater</c>
    /// </summary>
	public class ViewLopHocPhanRepeaterDesigner : System.Web.UI.Design.ControlDesigner
	{
	    /// <summary>
        /// Initializes a new instance of the <see cref="T:ViewLopHocPhanRepeaterDesigner"/> class.
        /// </summary>
		public ViewLopHocPhanRepeaterDesigner()
		{
		}
		...
		{
			if (!(component is ViewLopHocPhanRepeater))
			{ 
				throw new ArgumentException("Component is not a ViewLopHocPhanRepeater."); 
			} 
		...
		public override string GetDesignTimeHtml()
		{
			...
			//
			ViewLopHocPhanRepeater z = (ViewLopHocPhanRepeater)Component;
			z.DataBind();
    ...
    /// <summary>
    /// A strongly typed repeater control for the <see cref="ViewLopHocPhanRepeater"/> Type.
    /// </summary>
	[Designer(typeof(ViewLopHocPhanRepeaterDesigner))]
	[ParseChildren(true)]
	[ToolboxData("<{0}:ViewLopHocPhanRepeater runat=\"server\"></{0}:ViewLopHocPhanRepeater>")]
	public class ViewLopHocPhanRepeater : CompositeDataBoundControl, System.Web.UI.INamingContainer
	{
	    /// <summary>
        /// Initializes a new instance of the <see cref="T:ViewLopHocPhanRepeater"/> class.
        /// </summary>
		public ViewLopHocPhanRepeater()
		{
		}
		...
		[Browsable(false)]
		[TemplateContainer(typeof(ViewLopHocPhanItem))]
...
//		}
		...
		protected override int CreateChildControls(System.Collections.IEnumerable dataSource, bool dataBinding)
      {
         ...
         if (dataBinding)
         {
			...
			if (dataSource != null)
			{
				...
				{
						PMS.Entities.ViewLopHocPhan entity = o as PMS.Entities.ViewLopHocPhan;
						ViewLopHocPhanItem container = new ViewLopHocPhanItem(entity);
	...
	public class ViewLopHocPhanItem : System.Web.UI.Control, System.Web.UI.INamingContainer
	{
		private PMS.Entities.ViewLopHocPhan _entity;

        /// <summary>
        /// Initializes a new instance of the <see cref="T:ViewLopHocPhanItem"/> class.
        /// </summary>
		public ViewLopHocPhanItem()
			: base()
		{ }
        ...
        /// Initializes a new instance of the <see cref="T:ViewLopHocPhanItem"/> class.
        /// </summary>
		public ViewLopHocPhanItem(PMS.Entities.ViewLopHocPhan entity)
			: base()
		{
			_entity = entity;
		}
