...
{
    /// <summary>
    /// A designer class for a strongly typed repeater <c>ViewKetQuaThanhToanThuLaoRepeater</c>
    /// </summary>
	public class ViewKetQuaThanhToanThuLaoRepeaterDesigner : System.Web.UI.Design.ControlDesigner
	{
	    /// <summary>
        /// Initializes a new instance of the <see cref="T:ViewKetQuaThanhToanThuLaoRepeaterDesigner"/> class.
        /// </summary>
		public ViewKetQuaThanhToanThuLaoRepeaterDesigner()
		{
		}
		...
		{
			if (!(component is ViewKetQuaThanhToanThuLaoRepeater))
			{ 
				throw new ArgumentException("Component is not a ViewKetQuaThanhToanThuLaoRepeater."); 
			} 
		...
		public override string GetDesignTimeHtml()
		{
			...
			//
			ViewKetQuaThanhToanThuLaoRepeater z = (ViewKetQuaThanhToanThuLaoRepeater)Component;
			z.DataBind();
    ...
    /// <summary>
    /// A strongly typed repeater control for the <see cref="ViewKetQuaThanhToanThuLaoRepeater"/> Type.
    /// </summary>
	[Designer(typeof(ViewKetQuaThanhToanThuLaoRepeaterDesigner))]
	[ParseChildren(true)]
	[ToolboxData("<{0}:ViewKetQuaThanhToanThuLaoRepeater runat=\"server\"></{0}:ViewKetQuaThanhToanThuLaoRepeater>")]
	public class ViewKetQuaThanhToanThuLaoRepeater : CompositeDataBoundControl, System.Web.UI.INamingContainer
	{
	    /// <summary>
        /// Initializes a new instance of the <see cref="T:ViewKetQuaThanhToanThuLaoRepeater"/> class.
        /// </summary>
		public ViewKetQuaThanhToanThuLaoRepeater()
		{
		}
		...
		[Browsable(false)]
		[TemplateContainer(typeof(ViewKetQuaThanhToanThuLaoItem))]
...
//		}
		...
		protected override int CreateChildControls(System.Collections.IEnumerable dataSource, bool dataBinding)
      {
         ...
         if (dataBinding)
         {
			...
			if (dataSource != null)
			{
				...
				{
						PMS.Entities.ViewKetQuaThanhToanThuLao entity = o as PMS.Entities.ViewKetQuaThanhToanThuLao;
						ViewKetQuaThanhToanThuLaoItem container = new ViewKetQuaThanhToanThuLaoItem(entity);
	...
	public class ViewKetQuaThanhToanThuLaoItem : System.Web.UI.Control, System.Web.UI.INamingContainer
	{
		private PMS.Entities.ViewKetQuaThanhToanThuLao _entity;

        /// <summary>
        /// Initializes a new instance of the <see cref="T:ViewKetQuaThanhToanThuLaoItem"/> class.
        /// </summary>
		public ViewKetQuaThanhToanThuLaoItem()
			: base()
		{ }
        ...
        /// Initializes a new instance of the <see cref="T:ViewKetQuaThanhToanThuLaoItem"/> class.
        /// </summary>
		public ViewKetQuaThanhToanThuLaoItem(PMS.Entities.ViewKetQuaThanhToanThuLao entity)
			: base()
		{
			_entity = entity;
		}
