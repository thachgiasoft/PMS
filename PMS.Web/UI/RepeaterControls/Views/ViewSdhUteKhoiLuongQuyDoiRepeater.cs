...
{
    /// <summary>
    /// A designer class for a strongly typed repeater <c>ViewSdhUteKhoiLuongQuyDoiRepeater</c>
    /// </summary>
	public class ViewSdhUteKhoiLuongQuyDoiRepeaterDesigner : System.Web.UI.Design.ControlDesigner
	{
	    /// <summary>
        /// Initializes a new instance of the <see cref="T:ViewSdhUteKhoiLuongQuyDoiRepeaterDesigner"/> class.
        /// </summary>
		public ViewSdhUteKhoiLuongQuyDoiRepeaterDesigner()
		{
		}
		...
		{
			if (!(component is ViewSdhUteKhoiLuongQuyDoiRepeater))
			{ 
				throw new ArgumentException("Component is not a ViewSdhUteKhoiLuongQuyDoiRepeater."); 
			} 
		...
		public override string GetDesignTimeHtml()
		{
			...
			//
			ViewSdhUteKhoiLuongQuyDoiRepeater z = (ViewSdhUteKhoiLuongQuyDoiRepeater)Component;
			z.DataBind();
    ...
    /// <summary>
    /// A strongly typed repeater control for the <see cref="ViewSdhUteKhoiLuongQuyDoiRepeater"/> Type.
    /// </summary>
	[Designer(typeof(ViewSdhUteKhoiLuongQuyDoiRepeaterDesigner))]
	[ParseChildren(true)]
	[ToolboxData("<{0}:ViewSdhUteKhoiLuongQuyDoiRepeater runat=\"server\"></{0}:ViewSdhUteKhoiLuongQuyDoiRepeater>")]
	public class ViewSdhUteKhoiLuongQuyDoiRepeater : CompositeDataBoundControl, System.Web.UI.INamingContainer
	{
	    /// <summary>
        /// Initializes a new instance of the <see cref="T:ViewSdhUteKhoiLuongQuyDoiRepeater"/> class.
        /// </summary>
		public ViewSdhUteKhoiLuongQuyDoiRepeater()
		{
		}
		...
		[Browsable(false)]
		[TemplateContainer(typeof(ViewSdhUteKhoiLuongQuyDoiItem))]
...
//		}
		...
		protected override int CreateChildControls(System.Collections.IEnumerable dataSource, bool dataBinding)
      {
         ...
         if (dataBinding)
         {
			...
			if (dataSource != null)
			{
				...
				{
						PMS.Entities.ViewSdhUteKhoiLuongQuyDoi entity = o as PMS.Entities.ViewSdhUteKhoiLuongQuyDoi;
						ViewSdhUteKhoiLuongQuyDoiItem container = new ViewSdhUteKhoiLuongQuyDoiItem(entity);
	...
	public class ViewSdhUteKhoiLuongQuyDoiItem : System.Web.UI.Control, System.Web.UI.INamingContainer
	{
		private PMS.Entities.ViewSdhUteKhoiLuongQuyDoi _entity;

        /// <summary>
        /// Initializes a new instance of the <see cref="T:ViewSdhUteKhoiLuongQuyDoiItem"/> class.
        /// </summary>
		public ViewSdhUteKhoiLuongQuyDoiItem()
			: base()
		{ }
        ...
        /// Initializes a new instance of the <see cref="T:ViewSdhUteKhoiLuongQuyDoiItem"/> class.
        /// </summary>
		public ViewSdhUteKhoiLuongQuyDoiItem(PMS.Entities.ViewSdhUteKhoiLuongQuyDoi entity)
			: base()
		{
			_entity = entity;
		}
