...
{
    /// <summary>
    /// A designer class for a strongly typed repeater <c>ViewUteKhoiLuongQuyDoi2Repeater</c>
    /// </summary>
	public class ViewUteKhoiLuongQuyDoi2RepeaterDesigner : System.Web.UI.Design.ControlDesigner
	{
	    /// <summary>
        /// Initializes a new instance of the <see cref="T:ViewUteKhoiLuongQuyDoi2RepeaterDesigner"/> class.
        /// </summary>
		public ViewUteKhoiLuongQuyDoi2RepeaterDesigner()
		{
		}
		...
		{
			if (!(component is ViewUteKhoiLuongQuyDoi2Repeater))
			{ 
				throw new ArgumentException("Component is not a ViewUteKhoiLuongQuyDoi2Repeater."); 
			} 
		...
		public override string GetDesignTimeHtml()
		{
			...
			//
			ViewUteKhoiLuongQuyDoi2Repeater z = (ViewUteKhoiLuongQuyDoi2Repeater)Component;
			z.DataBind();
    ...
    /// <summary>
    /// A strongly typed repeater control for the <see cref="ViewUteKhoiLuongQuyDoi2Repeater"/> Type.
    /// </summary>
	[Designer(typeof(ViewUteKhoiLuongQuyDoi2RepeaterDesigner))]
	[ParseChildren(true)]
	[ToolboxData("<{0}:ViewUteKhoiLuongQuyDoi2Repeater runat=\"server\"></{0}:ViewUteKhoiLuongQuyDoi2Repeater>")]
	public class ViewUteKhoiLuongQuyDoi2Repeater : CompositeDataBoundControl, System.Web.UI.INamingContainer
	{
	    /// <summary>
        /// Initializes a new instance of the <see cref="T:ViewUteKhoiLuongQuyDoi2Repeater"/> class.
        /// </summary>
		public ViewUteKhoiLuongQuyDoi2Repeater()
		{
		}
		...
		[Browsable(false)]
		[TemplateContainer(typeof(ViewUteKhoiLuongQuyDoi2Item))]
...
//		}
		...
		protected override int CreateChildControls(System.Collections.IEnumerable dataSource, bool dataBinding)
      {
         ...
         if (dataBinding)
         {
			...
			if (dataSource != null)
			{
				...
				{
						PMS.Entities.ViewUteKhoiLuongQuyDoi2 entity = o as PMS.Entities.ViewUteKhoiLuongQuyDoi2;
						ViewUteKhoiLuongQuyDoi2Item container = new ViewUteKhoiLuongQuyDoi2Item(entity);
	...
	public class ViewUteKhoiLuongQuyDoi2Item : System.Web.UI.Control, System.Web.UI.INamingContainer
	{
		private PMS.Entities.ViewUteKhoiLuongQuyDoi2 _entity;

        /// <summary>
        /// Initializes a new instance of the <see cref="T:ViewUteKhoiLuongQuyDoi2Item"/> class.
        /// </summary>
		public ViewUteKhoiLuongQuyDoi2Item()
			: base()
		{ }
        ...
        /// Initializes a new instance of the <see cref="T:ViewUteKhoiLuongQuyDoi2Item"/> class.
        /// </summary>
		public ViewUteKhoiLuongQuyDoi2Item(PMS.Entities.ViewUteKhoiLuongQuyDoi2 entity)
			: base()
		{
			_entity = entity;
		}
