...
{
    /// <summary>
    /// A designer class for a strongly typed repeater <c>ViewThongTinChiTietGiangVienRepeater</c>
    /// </summary>
	public class ViewThongTinChiTietGiangVienRepeaterDesigner : System.Web.UI.Design.ControlDesigner
	{
	    /// <summary>
        /// Initializes a new instance of the <see cref="T:ViewThongTinChiTietGiangVienRepeaterDesigner"/> class.
        /// </summary>
		public ViewThongTinChiTietGiangVienRepeaterDesigner()
		{
		}
		...
		{
			if (!(component is ViewThongTinChiTietGiangVienRepeater))
			{ 
				throw new ArgumentException("Component is not a ViewThongTinChiTietGiangVienRepeater."); 
			} 
		...
		public override string GetDesignTimeHtml()
		{
			...
			//
			ViewThongTinChiTietGiangVienRepeater z = (ViewThongTinChiTietGiangVienRepeater)Component;
			z.DataBind();
    ...
    /// <summary>
    /// A strongly typed repeater control for the <see cref="ViewThongTinChiTietGiangVienRepeater"/> Type.
    /// </summary>
	[Designer(typeof(ViewThongTinChiTietGiangVienRepeaterDesigner))]
	[ParseChildren(true)]
	[ToolboxData("<{0}:ViewThongTinChiTietGiangVienRepeater runat=\"server\"></{0}:ViewThongTinChiTietGiangVienRepeater>")]
	public class ViewThongTinChiTietGiangVienRepeater : CompositeDataBoundControl, System.Web.UI.INamingContainer
	{
	    /// <summary>
        /// Initializes a new instance of the <see cref="T:ViewThongTinChiTietGiangVienRepeater"/> class.
        /// </summary>
		public ViewThongTinChiTietGiangVienRepeater()
		{
		}
		...
		[Browsable(false)]
		[TemplateContainer(typeof(ViewThongTinChiTietGiangVienItem))]
...
//		}
		...
		protected override int CreateChildControls(System.Collections.IEnumerable dataSource, bool dataBinding)
      {
         ...
         if (dataBinding)
         {
			...
			if (dataSource != null)
			{
				...
				{
						PMS.Entities.ViewThongTinChiTietGiangVien entity = o as PMS.Entities.ViewThongTinChiTietGiangVien;
						ViewThongTinChiTietGiangVienItem container = new ViewThongTinChiTietGiangVienItem(entity);
	...
	public class ViewThongTinChiTietGiangVienItem : System.Web.UI.Control, System.Web.UI.INamingContainer
	{
		private PMS.Entities.ViewThongTinChiTietGiangVien _entity;

        /// <summary>
        /// Initializes a new instance of the <see cref="T:ViewThongTinChiTietGiangVienItem"/> class.
        /// </summary>
		public ViewThongTinChiTietGiangVienItem()
			: base()
		{ }
        ...
        /// Initializes a new instance of the <see cref="T:ViewThongTinChiTietGiangVienItem"/> class.
        /// </summary>
		public ViewThongTinChiTietGiangVienItem(PMS.Entities.ViewThongTinChiTietGiangVien entity)
			: base()
		{
			_entity = entity;
		}
