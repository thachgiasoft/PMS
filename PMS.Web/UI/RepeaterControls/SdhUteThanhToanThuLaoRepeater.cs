...
{
    /// <summary>
    /// A designer class for a strongly typed repeater <c>SdhUteThanhToanThuLaoRepeater</c>
    /// </summary>
	public class SdhUteThanhToanThuLaoRepeaterDesigner : System.Web.UI.Design.ControlDesigner
	{
	    /// <summary>
        /// Initializes a new instance of the <see cref="T:SdhUteThanhToanThuLaoRepeaterDesigner"/> class.
        /// </summary>
		public SdhUteThanhToanThuLaoRepeaterDesigner()
		{
		}
		...
		{
			if (!(component is SdhUteThanhToanThuLaoRepeater))
			{ 
				throw new ArgumentException("Component is not a SdhUteThanhToanThuLaoRepeater."); 
			} 
		...
		public override string GetDesignTimeHtml()
		{
			...
			//
			SdhUteThanhToanThuLaoRepeater z = (SdhUteThanhToanThuLaoRepeater)Component;
			z.DataBind();
    ...
    /// <summary>
    /// A strongly typed repeater control for the <see cref="SdhUteThanhToanThuLaoRepeater"/> Type.
    /// </summary>
	[Designer(typeof(SdhUteThanhToanThuLaoRepeaterDesigner))]
	[ParseChildren(true)]
	[ToolboxData("<{0}:SdhUteThanhToanThuLaoRepeater runat=\"server\"></{0}:SdhUteThanhToanThuLaoRepeater>")]
	public class SdhUteThanhToanThuLaoRepeater : CompositeDataBoundControl, System.Web.UI.INamingContainer
	{
	    /// <summary>
        /// Initializes a new instance of the <see cref="T:SdhUteThanhToanThuLaoRepeater"/> class.
        /// </summary>
		public SdhUteThanhToanThuLaoRepeater()
		{
		}
		...
		[Browsable(false)]
		[TemplateContainer(typeof(SdhUteThanhToanThuLaoItem))]
...
//      }
		...
		protected override int CreateChildControls(System.Collections.IEnumerable dataSource, bool dataBinding)
         ...
         if (dataBinding)
         {
			...
			if (dataSource != null)
			{
				...
				{
						PMS.Entities.SdhUteThanhToanThuLao entity = o as PMS.Entities.SdhUteThanhToanThuLao;
						SdhUteThanhToanThuLaoItem container = new SdhUteThanhToanThuLaoItem(entity);
	...
	public class SdhUteThanhToanThuLaoItem : System.Web.UI.Control, System.Web.UI.INamingContainer
	{
		private PMS.Entities.SdhUteThanhToanThuLao _entity;

        /// <summary>
        /// Initializes a new instance of the <see cref="T:SdhUteThanhToanThuLaoItem"/> class.
        /// </summary>
		public SdhUteThanhToanThuLaoItem()
			: base()
		{ }
        ...
        /// Initializes a new instance of the <see cref="T:SdhUteThanhToanThuLaoItem"/> class.
        /// </summary>
		public SdhUteThanhToanThuLaoItem(PMS.Entities.SdhUteThanhToanThuLao entity)
			: base()
		{
			_entity = entity;
		}
        ...
        /// <summary>
        /// Gets a <see cref="T:PMS.Entities.SdhUteThanhToanThuLao"></see> object
        /// </summary>
        /// <value></value>
        [System.ComponentModel.Bindable(true)]
        public PMS.Entities.SdhUteThanhToanThuLao Entity
        {
            get { return _entity; }
        }
	}
