<%@ Page Language="C#" Theme="Default" MasterPageFile="~/MasterPages/admin.master" AutoEventWireup="true"  CodeFile="KcqUteThanhToanThuLao.aspx.cs" Inherits="KcqUteThanhToanThuLao" Title="KcqUteThanhToanThuLao List" %>

<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder2" Runat="Server">Kcq Ute Thanh Toan Thu Lao List</asp:Content>
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
		...
		<data:EntityGridView ID="GridView1" runat="server"			
				...
				DataSourceID="KcqUteThanhToanThuLaoDataSource"
				DataKeyNames="IdKhoiLuongQuyDoi"
				AllowMultiColumnSorting="false"
				DefaultSortColumnName="" 
				DefaultSortDirection="Ascending"	
				ExcelExportFileName="Export_KcqUteThanhToanThuLao.xls"  		
			>
			<Columns>
				...
				<data:HyperLinkField HeaderText="Id Khoi Luong Quy Doi" DataNavigateUrlFormatString="KcqUteKhoiLuongQuyDoiEdit.aspx?Id={0}" DataNavigateUrlFields="Id" DataContainer="IdKhoiLuongQuyDoiSource" DataTextField="HeSoLopDongLyThuyet" />
			...
			<EmptyDataTemplate>
				<b>No KcqUteThanhToanThuLao Found!</b>
			</EmptyDataTemplate>
		</data:EntityGridView>
		<br />
		<asp:Button runat="server" ID="btnKcqUteThanhToanThuLao" OnClientClick="javascript:location.href='KcqUteThanhToanThuLaoEdit.aspx'; return false;" Text="Add New"></asp:Button>
		<data:KcqUteThanhToanThuLaoDataSource ID="KcqUteThanhToanThuLaoDataSource" runat="server"
			...
			<DeepLoadProperties Method="IncludeChildren" Recursive="False">
	            <Types>
					<data:KcqUteThanhToanThuLaoProperty Name="KcqUteKhoiLuongQuyDoi"/> 
				</Types>
			</DeepLoadProperties>
			<Parameters>
