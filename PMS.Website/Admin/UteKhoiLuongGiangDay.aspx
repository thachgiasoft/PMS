<%@ Page Language="C#" Theme="Default" MasterPageFile="~/MasterPages/admin.master" AutoEventWireup="true"  CodeFile="UteKhoiLuongGiangDay.aspx.cs" Inherits="UteKhoiLuongGiangDay" Title="UteKhoiLuongGiangDay List" %>

<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder2" Runat="Server">Ute Khoi Luong Giang Day List</asp:Content>
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
		...
		<data:EntityGridView ID="GridView1" runat="server"			
				...
				DataSourceID="UteKhoiLuongGiangDayDataSource"
				DataKeyNames="Id"
				AllowMultiColumnSorting="false"
				DefaultSortColumnName="" 
				DefaultSortDirection="Ascending"	
				ExcelExportFileName="Export_UteKhoiLuongGiangDay.xls"  		
			>
			<Columns>
			...
			<EmptyDataTemplate>
				<b>No UteKhoiLuongGiangDay Found!</b>
			</EmptyDataTemplate>
		</data:EntityGridView>
		<br />
		<asp:Button runat="server" ID="btnUteKhoiLuongGiangDay" OnClientClick="javascript:location.href='UteKhoiLuongGiangDayEdit.aspx'; return false;" Text="Add New"></asp:Button>
