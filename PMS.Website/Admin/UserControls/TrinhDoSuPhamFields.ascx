<%@ Control Language="C#" ClassName="TrinhDoSuPhamFields" %>
...
<asp:FormView ID="FormView1" runat="server">
	<ItemTemplate>
        ...
        <td>
			...
			<tr>
        <td class="literal"><asp:Label ID="lbldataTenTrinhDoSuPham" runat="server" Text="Ten Trinh Do Su Pham:" AssociatedControlID="dataTenTrinhDoSuPham" /></td>
        <td>
					<asp:TextBox runat="server" ID="dataTenTrinhDoSuPham" Text='<%# Bind("TenTrinhDoSuPham") %>'  TextMode="MultiLine"  Width="250px" Rows="5"></asp:TextBox>
				</td>
			</tr>
