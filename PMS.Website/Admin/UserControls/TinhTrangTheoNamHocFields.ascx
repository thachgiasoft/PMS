<%@ Control Language="C#" ClassName="TinhTrangTheoNamHocFields" %>

<asp:FormView ID="FormView1" runat="server">
	<ItemTemplate>
		<table border="0" cellpadding="3" cellspacing="1">
			<tr>
        <td class="literal"><asp:Label ID="lbldataMaTinhTrangCu" runat="server" Text="Ma Tinh Trang Cu:" AssociatedControlID="dataMaTinhTrangCu" /></td>
        <td>
					<asp:TextBox runat="server" ID="dataMaTinhTrangCu" Text='<%# Bind("MaTinhTrangCu") %>'></asp:TextBox><asp:RangeValidator ID="RangeVal_dataMaTinhTrangCu" runat="server" Display="Dynamic" ControlToValidate="dataMaTinhTrangCu" ErrorMessage="Invalid value" MaximumValue="2147483647" MinimumValue="-2147483648" Type="Integer"></asp:RangeValidator>
				</td>
			</tr>
			<tr>
