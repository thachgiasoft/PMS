<%@ Control Language="C#" ClassName="QuyDoiGioChuanFields" %>
...
<asp:FormView ID="FormView1" runat="server">
	<ItemTemplate>
        ...
        <td>
			...
			<tr>
        <td class="literal"><asp:Label ID="lbldataKhoaNhapLieu" runat="server" Text="Khoa Nhap Lieu:" AssociatedControlID="dataKhoaNhapLieu" /></td>
        <td>
					<asp:RadioButtonList runat="server" ID="dataKhoaNhapLieu" SelectedValue='<%# Bind("KhoaNhapLieu") %>' RepeatDirection="Horizontal"><asp:ListItem Value="True" Text="Yes" Selected="True"></asp:ListItem><asp:ListItem Value="False" Text="No"></asp:ListItem></asp:RadioButtonList>
				</td>
			</tr>
			<tr>
        ...
        <td>
			...
			<tr>
        <td class="literal"><asp:Label ID="lbldataCoSuDungHeSoChucDanh" runat="server" Text="Co Su Dung He So Chuc Danh:" AssociatedControlID="dataCoSuDungHeSoChucDanh" /></td>
        <td>
					<asp:RadioButtonList runat="server" ID="dataCoSuDungHeSoChucDanh" SelectedValue='<%# Bind("CoSuDungHeSoChucDanh") %>' RepeatDirection="Horizontal"><asp:ListItem Value="True" Text="Yes" Selected="True"></asp:ListItem><asp:ListItem Value="False" Text="No"></asp:ListItem></asp:RadioButtonList>
				</td>
			</tr>
			<tr>
        <td class="literal"><asp:Label ID="lbldataNhomMonHoc" runat="server" Text="Nhom Mon Hoc:" AssociatedControlID="dataNhomMonHoc" /></td>
        <td>
					<asp:TextBox runat="server" ID="dataNhomMonHoc" Text='<%# Bind("NhomMonHoc") %>' MaxLength="200"></asp:TextBox>
				</td>
			</tr>
			<tr>
        ...
        <td>
					<data:EntityDropDownList runat="server" ID="dataMaLoaiKhoiLuong" DataSourceID="MaLoaiKhoiLuongLoaiKhoiLuongDataSource" DataTextField="TenLoaiKhoiLuong" DataValueField="MaLoaiKhoiLuong" SelectedValue='<%# Bind("MaLoaiKhoiLuong") %>' AppendNullItem="true" Required="false" NullItemText="< Please Choose ...>" />
					<data:LoaiKhoiLuongDataSource ID="MaLoaiKhoiLuongLoaiKhoiLuongDataSource" runat="server" SelectMethod="GetAll"  />
				</td>
			</tr>
			<tr>
