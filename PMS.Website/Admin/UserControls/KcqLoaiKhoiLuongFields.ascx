<%@ Control Language="C#" ClassName="KcqLoaiKhoiLuongFields" %>
...
<asp:FormView ID="FormView1" runat="server">
	<ItemTemplate>
        ...
        <td>
					<data:EntityDropDownList runat="server" ID="dataMaNhom" DataSourceID="MaNhomKcqNhomKhoiLuongDataSource" DataTextField="MaQuanLy" DataValueField="MaNhom" SelectedValue='<%# Bind("MaNhom") %>' AppendNullItem="true" Required="false" NullItemText="< Please Choose ...>" />
					<data:KcqNhomKhoiLuongDataSource ID="MaNhomKcqNhomKhoiLuongDataSource" runat="server" SelectMethod="GetAll"  />
				</td>
			</tr>
