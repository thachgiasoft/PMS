<%@ Control Language="C#" ClassName="TrinhDoTinHocFields" %>
...
<asp:FormView ID="FormView1" runat="server">
	<ItemTemplate>
        ...
        <td>
			...
			<tr>
        <td class="literal"><asp:Label ID="lbldataTenTrinhDoTinHoc" runat="server" Text="Ten Trinh Do Tin Hoc:" AssociatedControlID="dataTenTrinhDoTinHoc" /></td>
        <td>
					<asp:TextBox runat="server" ID="dataTenTrinhDoTinHoc" Text='<%# Bind("TenTrinhDoTinHoc") %>'  TextMode="MultiLine"  Width="250px" Rows="5"></asp:TextBox>
				</td>
			</tr>
