<%@ Control Language="C#" ClassName="SdhUteThanhToanThuLaoFields" %>
...
<asp:FormView ID="FormView1" runat="server">
	<ItemTemplate>
        ...
        <td>
					<data:EntityDropDownList runat="server" ID="dataIdKhoiLuongQuyDoi" DataSourceID="IdKhoiLuongQuyDoiSdhUteKhoiLuongQuyDoiDataSource" DataTextField="HeSoLopDongLyThuyet" DataValueField="Id" SelectedValue='<%# Bind("IdKhoiLuongQuyDoi") %>' AppendNullItem="true" Required="true" NullItemText="< Please Choose ...>" ErrorText="Required" />
					<data:SdhUteKhoiLuongQuyDoiDataSource ID="IdKhoiLuongQuyDoiSdhUteKhoiLuongQuyDoiDataSource" runat="server" SelectMethod="GetAll"  />
				</td>
			</tr>
			<tr>
