<%@ Control Language="C#" ClassName="TongTienLuongTrongNamCuaGiangVienFields" %>
...
<asp:FormView ID="FormView1" runat="server">
	<ItemTemplate>
        ...
        <td>
			...
			<tr>
        <td class="literal"><asp:Label ID="lbldataTongTienLuong" runat="server" Text="Tong Tien Luong:" AssociatedControlID="dataTongTienLuong" /></td>
        <td>
					<asp:TextBox runat="server" ID="dataTongTienLuong" Text='<%# Bind("TongTienLuong") %>'></asp:TextBox><asp:RangeValidator ID="RangeVal_dataTongTienLuong" runat="server" Display="Dynamic" ControlToValidate="dataTongTienLuong" ErrorMessage="Invalid value" MaximumValue="999999999" MinimumValue="-999999999" Type="Double"></asp:RangeValidator>
				</td>
			</tr>
			<tr>
