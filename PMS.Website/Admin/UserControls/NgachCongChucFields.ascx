<%@ Control Language="C#" ClassName="NgachCongChucFields" %>
...
<asp:FormView ID="FormView1" runat="server">
	<ItemTemplate>
        ...
        <td>
			...
			<tr>
        <td class="literal"><asp:Label ID="lbldataTenNgach" runat="server" Text="Ten Ngach:" AssociatedControlID="dataTenNgach" /></td>
        <td>
					<asp:TextBox runat="server" ID="dataTenNgach" Text='<%# Bind("TenNgach") %>'  TextMode="MultiLine"  Width="250px" Rows="5"></asp:TextBox>
				</td>
			</tr>
			<tr>
        <td class="literal"><asp:Label ID="lbldataNgach" runat="server" Text="Ngach:" AssociatedControlID="dataNgach" /></td>
        <td>
					<asp:TextBox runat="server" ID="dataNgach" Text='<%# Bind("Ngach") %>' MaxLength="50"></asp:TextBox>
				</td>
			</tr>
