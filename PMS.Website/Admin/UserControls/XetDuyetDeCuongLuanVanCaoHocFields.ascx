<%@ Control Language="C#" ClassName="XetDuyetDeCuongLuanVanCaoHocFields" %>
...
<asp:FormView ID="FormView1" runat="server">
	<ItemTemplate>
        ...
        <td>
			...
			<tr>
        <td class="literal"><asp:Label ID="lbldataThucLinh" runat="server" Text="Thuc Linh:" AssociatedControlID="dataThucLinh" /></td>
        <td>
					<asp:TextBox runat="server" ID="dataThucLinh" Text='<%# Bind("ThucLinh") %>'></asp:TextBox><asp:RangeValidator ID="RangeVal_dataThucLinh" runat="server" Display="Dynamic" ControlToValidate="dataThucLinh" ErrorMessage="Invalid value" MaximumValue="999999999" MinimumValue="-999999999" Type="Double"></asp:RangeValidator>
				</td>
			</tr>
			<tr>
