<%@ Control Language="C#" ClassName="KhoiLuongDoAnTotNghiepChiTietFields" %>
...
<asp:FormView ID="FormView1" runat="server">
	<ItemTemplate>
        ...
        <td>
			...
			<tr>
        <td class="literal"><asp:Label ID="lbldataSoLuongDeTai" runat="server" Text="So Luong De Tai:" AssociatedControlID="dataSoLuongDeTai" /></td>
        <td>
					<asp:TextBox runat="server" ID="dataSoLuongDeTai" Text='<%# Bind("SoLuongDeTai") %>'></asp:TextBox><asp:RangeValidator ID="RangeVal_dataSoLuongDeTai" runat="server" Display="Dynamic" ControlToValidate="dataSoLuongDeTai" ErrorMessage="Invalid value" MaximumValue="2147483647" MinimumValue="-2147483648" Type="Integer"></asp:RangeValidator>
				</td>
			</tr>
			<tr>
        <td class="literal"><asp:Label ID="lbldataLoaiThamGia" runat="server" Text="Loai Tham Gia:" AssociatedControlID="dataLoaiThamGia" /></td>
        <td>
					<asp:TextBox runat="server" ID="dataLoaiThamGia" Text='<%# Bind("LoaiThamGia") %>' MaxLength="50"></asp:TextBox>
				</td>
			</tr>
			<tr>
        <td class="literal"><asp:Label ID="lbldataHeSoThamGia" runat="server" Text="He So Tham Gia:" AssociatedControlID="dataHeSoThamGia" /></td>
        <td>
					<asp:TextBox runat="server" ID="dataHeSoThamGia" Text='<%# Bind("HeSoThamGia") %>'></asp:TextBox><asp:RangeValidator ID="RangeVal_dataHeSoThamGia" runat="server" Display="Dynamic" ControlToValidate="dataHeSoThamGia" ErrorMessage="Invalid value" MaximumValue="999999999" MinimumValue="-999999999" Type="Double"></asp:RangeValidator>
				</td>
			</tr>
			<tr>
