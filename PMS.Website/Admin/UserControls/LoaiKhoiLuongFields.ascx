<%@ Control Language="C#" ClassName="LoaiKhoiLuongFields" %>
...
<asp:FormView ID="FormView1" runat="server">
	<ItemTemplate>
        ...
        <td>
					<data:EntityDropDownList runat="server" ID="dataMaNhom" DataSourceID="MaNhomNhomKhoiLuongDataSource" DataTextField="MaQuanLy" DataValueField="MaNhom" SelectedValue='<%# Bind("MaNhom") %>' AppendNullItem="true" Required="false" NullItemText="< Please Choose ...>" />
					<data:NhomKhoiLuongDataSource ID="MaNhomNhomKhoiLuongDataSource" runat="server" SelectMethod="GetAll"  />
				</td>
			</tr>
			<tr>
