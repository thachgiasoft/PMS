<%@ Control Language="C#" ClassName="KhoiLuongGiangDayFields" %>

<asp:FormView ID="FormView1" runat="server">
	<ItemTemplate>
		<table border="0" cellpadding="3" cellspacing="1">
			<tr>
        <td class="literal"><asp:Label ID="lbldataMaKetQua" runat="server" Text="Ma Ket Qua:" AssociatedControlID="dataMaKetQua" /></td>
        <td>
					<data:EntityDropDownList runat="server" ID="dataMaKetQua" DataSourceID="MaKetQuaKetQuaTinhDataSource" DataTextField="HocKy" DataValueField="MaKetQua" SelectedValue='<%# Bind("MaKetQua") %>' AppendNullItem="true" Required="false" NullItemText="< Please Choose ...>" />
					<data:KetQuaTinhDataSource ID="MaKetQuaKetQuaTinhDataSource" runat="server" SelectMethod="GetAll"  />
				</td>
			</tr>
			<tr>
