<%@ Control Language="C#" ClassName="ThuLaoChamThiVhuexFields" %>
...
<asp:FormView ID="FormView1" runat="server">
	<ItemTemplate>
        ...
        <td>
					<asp:TextBox runat="server" ID="dataDoAn" Text='<%# Bind("DoAn") %>'></asp:TextBox><asp:RangeValidator ID="RangeVal_dataDoAn" runat="server" Display="Dynamic" ControlToValidate="dataDoAn" ErrorMessage="Invalid value" MaximumValue="999999999" MinimumValue="-999999999" Type="Double"></asp:RangeValidator>
				</td>
			</tr>
			<tr>
        ...
        <td>
			...
			<tr>
        <td class="literal"><asp:Label ID="lbldataGiuaKy" runat="server" Text="Giua Ky:" AssociatedControlID="dataGiuaKy" /></td>
        <td>
					<asp:TextBox runat="server" ID="dataGiuaKy" Text='<%# Bind("GiuaKy") %>'></asp:TextBox><asp:RangeValidator ID="RangeVal_dataGiuaKy" runat="server" Display="Dynamic" ControlToValidate="dataGiuaKy" ErrorMessage="Invalid value" MaximumValue="999999999" MinimumValue="-999999999" Type="Double"></asp:RangeValidator>
				</td>
			</tr>
			<tr>
        <td class="literal"><asp:Label ID="lbldataTracNghiem" runat="server" Text="Trac Nghiem:" AssociatedControlID="dataTracNghiem" /></td>
        <td>
					<asp:TextBox runat="server" ID="dataTracNghiem" Text='<%# Bind("TracNghiem") %>'></asp:TextBox><asp:RangeValidator ID="RangeVal_dataTracNghiem" runat="server" Display="Dynamic" ControlToValidate="dataTracNghiem" ErrorMessage="Invalid value" MaximumValue="999999999" MinimumValue="-999999999" Type="Double"></asp:RangeValidator>
				</td>
			</tr>
			<tr>
