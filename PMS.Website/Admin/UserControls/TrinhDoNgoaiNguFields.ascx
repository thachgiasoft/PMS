<%@ Control Language="C#" ClassName="TrinhDoNgoaiNguFields" %>
...
<asp:FormView ID="FormView1" runat="server">
	<ItemTemplate>
        ...
        <td>
			...
			<tr>
        <td class="literal"><asp:Label ID="lbldataTenTrinhDoNgoaiNgu" runat="server" Text="Ten Trinh Do Ngoai Ngu:" AssociatedControlID="dataTenTrinhDoNgoaiNgu" /></td>
        <td>
					<asp:TextBox runat="server" ID="dataTenTrinhDoNgoaiNgu" Text='<%# Bind("TenTrinhDoNgoaiNgu") %>'  TextMode="MultiLine"  Width="250px" Rows="5"></asp:TextBox>
				</td>
			</tr>
