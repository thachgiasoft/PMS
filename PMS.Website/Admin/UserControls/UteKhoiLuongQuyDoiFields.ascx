<%@ Control Language="C#" ClassName="UteKhoiLuongQuyDoiFields" %>
...
<asp:FormView ID="FormView1" runat="server">
	<ItemTemplate>
        ...
        <td>
					<data:EntityDropDownList runat="server" ID="dataIdKhoiLuongGiangDay" DataSourceID="IdKhoiLuongGiangDayUteKhoiLuongGiangDayDataSource" DataTextField="MaMonHoc" DataValueField="Id" SelectedValue='<%# Bind("IdKhoiLuongGiangDay") %>' AppendNullItem="true" Required="true" NullItemText="< Please Choose ...>" ErrorText="Required" />
					<data:UteKhoiLuongGiangDayDataSource ID="IdKhoiLuongGiangDayUteKhoiLuongGiangDayDataSource" runat="server" SelectMethod="GetAll"  />
				</td>
			</tr>
			<tr>
