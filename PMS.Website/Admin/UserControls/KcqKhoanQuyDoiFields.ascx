<%@ Control Language="C#" ClassName="KcqKhoanQuyDoiFields" %>
...
<asp:FormView ID="FormView1" runat="server">
	<ItemTemplate>
        ...
        <td>
					<data:EntityDropDownList runat="server" ID="dataMaQuyDoi" DataSourceID="MaQuyDoiKcqQuyDoiGioChuanDataSource" DataTextField="MaQuanLy" DataValueField="MaQuyDoi" SelectedValue='<%# Bind("MaQuyDoi") %>' AppendNullItem="true" Required="false" NullItemText="< Please Choose ...>" />
					<data:KcqQuyDoiGioChuanDataSource ID="MaQuyDoiKcqQuyDoiGioChuanDataSource" runat="server" SelectMethod="GetAll"  />
				</td>
			</tr>
			<tr>
