<%@ Control Language="C#" ClassName="TrinhDoQuanLyNhaNuocFields" %>
...
<asp:FormView ID="FormView1" runat="server">
	<ItemTemplate>
        ...
        <td>
			...
			<tr>
        <td class="literal"><asp:Label ID="lbldataTenTrinhDoQuanLyNhaNuoc" runat="server" Text="Ten Trinh Do Quan Ly Nha Nuoc:" AssociatedControlID="dataTenTrinhDoQuanLyNhaNuoc" /></td>
        <td>
					<asp:TextBox runat="server" ID="dataTenTrinhDoQuanLyNhaNuoc" Text='<%# Bind("TenTrinhDoQuanLyNhaNuoc") %>'  TextMode="MultiLine"  Width="250px" Rows="5"></asp:TextBox>
				</td>
			</tr>
