<%@ Page Language="C#" Theme="Default" MasterPageFile="~/MasterPages/admin.master" AutoEventWireup="true"  CodeFile="SdhKetQuaThanhToanThuLao.aspx.cs" Inherits="SdhKetQuaThanhToanThuLao" Title="SdhKetQuaThanhToanThuLao List" %>

<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder2" Runat="Server">Sdh Ket Qua Thanh Toan Thu Lao List</asp:Content>
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
		...
		<data:EntityGridView ID="GridView1" runat="server"			
				...
				DataSourceID="SdhKetQuaThanhToanThuLaoDataSource"
				DataKeyNames="Id"
				AllowMultiColumnSorting="false"
				DefaultSortColumnName="" 
				DefaultSortDirection="Ascending"	
				ExcelExportFileName="Export_SdhKetQuaThanhToanThuLao.xls"  		
			>
			<Columns>
			...
			<EmptyDataTemplate>
				<b>No SdhKetQuaThanhToanThuLao Found!</b>
			</EmptyDataTemplate>
		</data:EntityGridView>
		<br />
		<asp:Button runat="server" ID="btnSdhKetQuaThanhToanThuLao" OnClientClick="javascript:location.href='SdhKetQuaThanhToanThuLaoEdit.aspx'; return false;" Text="Add New"></asp:Button>
		<data:SdhKetQuaThanhToanThuLaoDataSource ID="SdhKetQuaThanhToanThuLaoDataSource" runat="server"
		...
		</data:SdhKetQuaThanhToanThuLaoDataSource>
