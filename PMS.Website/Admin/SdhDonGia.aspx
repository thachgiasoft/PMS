<%@ Page Language="C#" Theme="Default" MasterPageFile="~/MasterPages/admin.master" AutoEventWireup="true"  CodeFile="SdhDonGia.aspx.cs" Inherits="SdhDonGia" Title="SdhDonGia List" %>

<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder2" Runat="Server">Sdh Don Gia List</asp:Content>
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
		...
		<data:EntityGridView ID="GridView1" runat="server"			
				...
				DataSourceID="SdhDonGiaDataSource"
				DataKeyNames="Id"
				AllowMultiColumnSorting="false"
				DefaultSortColumnName="" 
				DefaultSortDirection="Ascending"	
				ExcelExportFileName="Export_SdhDonGia.xls"  		
			>
			<Columns>
			...
			<EmptyDataTemplate>
				<b>No SdhDonGia Found!</b>
			</EmptyDataTemplate>
		</data:EntityGridView>
		<br />
		<asp:Button runat="server" ID="btnSdhDonGia" OnClientClick="javascript:location.href='SdhDonGiaEdit.aspx'; return false;" Text="Add New"></asp:Button>
