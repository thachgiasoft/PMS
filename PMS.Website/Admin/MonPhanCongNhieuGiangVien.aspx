<%@ Page Language="C#" Theme="Default" MasterPageFile="~/MasterPages/admin.master" AutoEventWireup="true"  CodeFile="MonPhanCongNhieuGiangVien.aspx.cs" Inherits="MonPhanCongNhieuGiangVien" Title="MonPhanCongNhieuGiangVien List" %>

<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder2" Runat="Server">Mon Phan Cong Nhieu Giang Vien List</asp:Content>
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
		...
		<data:EntityGridView ID="GridView1" runat="server"			
				...
				DataSourceID="MonPhanCongNhieuGiangVienDataSource"
				DataKeyNames="Id"
				AllowMultiColumnSorting="false"
				DefaultSortColumnName="" 
				DefaultSortDirection="Ascending"	
				ExcelExportFileName="Export_MonPhanCongNhieuGiangVien.xls"  		
			>
			<Columns>
			...
			<EmptyDataTemplate>
				<b>No MonPhanCongNhieuGiangVien Found!</b>
			</EmptyDataTemplate>
		</data:EntityGridView>
		<br />
		<asp:Button runat="server" ID="btnMonPhanCongNhieuGiangVien" OnClientClick="javascript:location.href='MonPhanCongNhieuGiangVienEdit.aspx'; return false;" Text="Add New"></asp:Button>
