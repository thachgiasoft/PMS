<%@ Page Language="C#" Theme="Default" MasterPageFile="~/MasterPages/admin.master" AutoEventWireup="true"  CodeFile="KcqPhanBienLuanAn.aspx.cs" Inherits="KcqPhanBienLuanAn" Title="KcqPhanBienLuanAn List" %>

<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder2" Runat="Server">Kcq Phan Bien Luan An List</asp:Content>
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
		...
		<data:EntityGridView ID="GridView1" runat="server"			
				...
				DataSourceID="KcqPhanBienLuanAnDataSource"
				DataKeyNames="MaGiangVien, NamHoc, HocKy, Loai"
				AllowMultiColumnSorting="false"
				DefaultSortColumnName="" 
				DefaultSortDirection="Ascending"	
				ExcelExportFileName="Export_KcqPhanBienLuanAn.xls"  		
			>
			<Columns>
			...
			<EmptyDataTemplate>
				<b>No KcqPhanBienLuanAn Found!</b>
			</EmptyDataTemplate>
		</data:EntityGridView>
		<br />
		<asp:Button runat="server" ID="btnKcqPhanBienLuanAn" OnClientClick="javascript:location.href='KcqPhanBienLuanAnEdit.aspx'; return false;" Text="Add New"></asp:Button>
