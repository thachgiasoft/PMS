<%@ Page Language="C#" Theme="Default" MasterPageFile="~/MasterPages/admin.master" AutoEventWireup="true"  CodeFile="SdhPhanLoaiHocPhan.aspx.cs" Inherits="SdhPhanLoaiHocPhan" Title="SdhPhanLoaiHocPhan List" %>

<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder2" Runat="Server">Sdh Phan Loai Hoc Phan List</asp:Content>
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
		...
		<data:EntityGridView ID="GridView1" runat="server"			
				...
				DataSourceID="SdhPhanLoaiHocPhanDataSource"
				DataKeyNames="Id"
				AllowMultiColumnSorting="false"
				DefaultSortColumnName="" 
				DefaultSortDirection="Ascending"	
				ExcelExportFileName="Export_SdhPhanLoaiHocPhan.xls"  		
			>
			<Columns>
			...
			<EmptyDataTemplate>
				<b>No SdhPhanLoaiHocPhan Found!</b>
			</EmptyDataTemplate>
		</data:EntityGridView>
		<br />
		<asp:Button runat="server" ID="btnSdhPhanLoaiHocPhan" OnClientClick="javascript:location.href='SdhPhanLoaiHocPhanEdit.aspx'; return false;" Text="Add New"></asp:Button>
