<%@ Page Language="C#" Theme="Default" MasterPageFile="~/MasterPages/admin.master" AutoEventWireup="true"  CodeFile="PhanCongDoAnTotNghiep.aspx.cs" Inherits="PhanCongDoAnTotNghiep" Title="PhanCongDoAnTotNghiep List" %>

<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder2" Runat="Server">Phan Cong Do An Tot Nghiep List</asp:Content>
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
		...
		<data:EntityGridView ID="GridView1" runat="server"			
				...
				DataSourceID="PhanCongDoAnTotNghiepDataSource"
				DataKeyNames="MaLopHocPhan, MaSinhVien"
				AllowMultiColumnSorting="false"
				DefaultSortColumnName="" 
				DefaultSortDirection="Ascending"	
				ExcelExportFileName="Export_PhanCongDoAnTotNghiep.xls"  		
			>
			<Columns>
			...
			<EmptyDataTemplate>
				<b>No PhanCongDoAnTotNghiep Found!</b>
			</EmptyDataTemplate>
		</data:EntityGridView>
		<br />
		<asp:Button runat="server" ID="btnPhanCongDoAnTotNghiep" OnClientClick="javascript:location.href='PhanCongDoAnTotNghiepEdit.aspx'; return false;" Text="Add New"></asp:Button>
