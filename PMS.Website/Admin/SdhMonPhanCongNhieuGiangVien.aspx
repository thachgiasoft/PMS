<%@ Page Language="C#" Theme="Default" MasterPageFile="~/MasterPages/admin.master" AutoEventWireup="true"  CodeFile="SdhMonPhanCongNhieuGiangVien.aspx.cs" Inherits="SdhMonPhanCongNhieuGiangVien" Title="SdhMonPhanCongNhieuGiangVien List" %>

<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder2" Runat="Server">Sdh Mon Phan Cong Nhieu Giang Vien List</asp:Content>
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
		...
		<data:EntityGridView ID="GridView1" runat="server"			
				...
				DataSourceID="SdhMonPhanCongNhieuGiangVienDataSource"
				DataKeyNames="Id"
				AllowMultiColumnSorting="false"
				DefaultSortColumnName="" 
				DefaultSortDirection="Ascending"	
				ExcelExportFileName="Export_SdhMonPhanCongNhieuGiangVien.xls"  		
			>
			<Columns>
			...
			<EmptyDataTemplate>
				<b>No SdhMonPhanCongNhieuGiangVien Found!</b>
			</EmptyDataTemplate>
		</data:EntityGridView>
		<br />
		<asp:Button runat="server" ID="btnSdhMonPhanCongNhieuGiangVien" OnClientClick="javascript:location.href='SdhMonPhanCongNhieuGiangVienEdit.aspx'; return false;" Text="Add New"></asp:Button>
