/*
	...
	Important: Do not modify this file. Edit the file SqlMonHocKhongTinhKhoiLuongProvider.cs instead.
*/
...
namespace PMS.Data.SqlClient
{
	...
	///</summary>
	public abstract partial class SqlMonHocKhongTinhKhoiLuongProviderBase : MonHocKhongTinhKhoiLuongProviderBase
	{
		#region Declarations
		...
		/// <summary>
		/// Creates a new <see cref="SqlMonHocKhongTinhKhoiLuongProviderBase"/> instance.
		/// </summary>
		public SqlMonHocKhongTinhKhoiLuongProviderBase()
		{
		}
	...
	public SqlMonHocKhongTinhKhoiLuongProviderBase(string connectionString, bool useStoredProcedure, string providerInvariantName)
	{
    ...
    public string ProviderInvariantName
    {
		...
		public override bool Delete(TransactionManager transactionManager, System.Int32 _id)
		{
			...
			DbCommand commandWrapper = StoredProcedureProvider.GetCommandWrapper(database, "dbo.sp_MonHocKhongTinhKhoiLuong_Delete", _useStoredProcedure);
			...
			{
				string entityKey = EntityLocator.ConstructKeyFromPkItems(typeof(MonHocKhongTinhKhoiLuong)
					,_id);
		...
		/// <returns>Returns a typed collection of PMS.Entities.MonHocKhongTinhKhoiLuong objects.</returns>
		public override TList<MonHocKhongTinhKhoiLuong> Find(TransactionManager transactionManager, string whereClause, int start, int pageLength, out int count)
		{
			count = -1;
			if (whereClause.IndexOf(";") > -1)
				return new TList<MonHocKhongTinhKhoiLuong>();
	
			SqlDatabase database = new SqlDatabase(this._connectionString);
			DbCommand commandWrapper = StoredProcedureProvider.GetCommandWrapper(database, "dbo.sp_MonHocKhongTinhKhoiLuong_Find", _useStoredProcedure);
		...
		database.AddInParameter(commandWrapper, "@TenBoMon", DbType.String, DBNull.Value);
		...
		database.AddInParameter(commandWrapper, "@NguoiCapNhat", DbType.String, DBNull.Value);
	   		...
	   		foreach (string clause in clauses)
			{
				...
				if (clause.Trim().StartsWith("tenbomon ") || clause.Trim().StartsWith("tenbomon="))
				{
					database.SetParameterValue(commandWrapper, "@TenBoMon", 
						clause.Trim().Remove(0,8).Trim().TrimStart(equalSign).Trim().Trim(singleQuote));
					continue;
				}
			...
			//Create Collection
			TList<MonHocKhongTinhKhoiLuong> rows = new TList<MonHocKhongTinhKhoiLuong>();
		...
		/// <param name="count">out. The number of rows that match this query.</param>
		/// <returns>Returns a typed collection of PMS.Entities.MonHocKhongTinhKhoiLuong objects.</returns>
		public override TList<MonHocKhongTinhKhoiLuong> Find(TransactionManager transactionManager, IFilterParameterCollection parameters, string orderBy, int start, int pageLength, out int count)
		{
			...
			SqlDatabase database = new SqlDatabase(this._connectionString);
			DbCommand commandWrapper = StoredProcedureProvider.GetCommandWrapper(database, "dbo.sp_MonHocKhongTinhKhoiLuong_Find_Dynamic", typeof(MonHocKhongTinhKhoiLuongColumn), filter, orderBy, start, pageLength);
        ...
        /// <exception cref="System.Data.DataException">The <paramref name="transactionManager"/> is not open.</exception>
        /// <exception cref="System.Data.Common.DbException">The command could not be executed.</exception>
		public override TList<MonHocKhongTinhKhoiLuong> GetAll(TransactionManager transactionManager, int start, int pageLength, out int count)
		{
			SqlDatabase database = new SqlDatabase(this._connectionString);
			DbCommand commandWrapper = StoredProcedureProvider.GetCommandWrapper(database, "dbo.sp_MonHocKhongTinhKhoiLuong_Get_List", _useStoredProcedure);
		...
		/// <remarks></remarks>
		/// <returns>Returns a typed collection of PMS.Entities.MonHocKhongTinhKhoiLuong objects.</returns>
		public override TList<MonHocKhongTinhKhoiLuong> GetPaged(TransactionManager transactionManager, string whereClause, string orderBy, int start, int pageLength, out int count)
		{
			SqlDatabase database = new SqlDatabase(this._connectionString);
			DbCommand commandWrapper = StoredProcedureProvider.GetCommandWrapper(database, "dbo.sp_MonHocKhongTinhKhoiLuong_GetPaged", _useStoredProcedure);
        ...
        /// <exception cref="System.Data.DataException">The <paramref name="transactionManager"/> is not open.</exception>
        /// <exception cref="System.Data.Common.DbException">The command could not be executed.</exception>
		public override PMS.Entities.MonHocKhongTinhKhoiLuong GetById(TransactionManager transactionManager, System.Int32 _id, int start, int pageLength, out int count)
		{
			SqlDatabase database = new SqlDatabase(this._connectionString);
			DbCommand commandWrapper = StoredProcedureProvider.GetCommandWrapper(database, "dbo.sp_MonHocKhongTinhKhoiLuong_GetById", _useStoredProcedure);
			
				database.AddInParameter(commandWrapper, "@Id", DbType.Int32, _id);
			
			IDataReader reader = null;
			TList<MonHocKhongTinhKhoiLuong> tmp = new TList<MonHocKhongTinhKhoiLuong>();
			try
			{
				//Provider Data Requesting Command Event
		...
		/// <remarks>
		///		After inserting into the datasource, the PMS.Entities.MonHocKhongTinhKhoiLuong object will be updated
		/// 	to refelect any changes made by the datasource. (ie: identity or computed columns)
		/// </remarks>	
		public override void BulkInsert(TransactionManager transactionManager, TList<PMS.Entities.MonHocKhongTinhKhoiLuong> entities)
		{
			...
			bulkCopy.DestinationTableName = "MonHocKhongTinhKhoiLuong";
			...
			DataColumn col6 = dataTable.Columns.Add("TenBoMon", typeof(System.String));
			...
			bulkCopy.ColumnMappings.Add("TenBoMon", "TenBoMon");
			bulkCopy.ColumnMappings.Add("NgayCapNhat", "NgayCapNhat");
			bulkCopy.ColumnMappings.Add("NguoiCapNhat", "NguoiCapNhat");
			
			foreach(PMS.Entities.MonHocKhongTinhKhoiLuong entity in entities)
			{
		...
		/// <summary>
		/// 	Inserts a PMS.Entities.MonHocKhongTinhKhoiLuong object into the datasource using a transaction.
		/// </summary>
		/// <param name="transactionManager"><see cref="TransactionManager"/> object</param>
		/// <param name="entity">PMS.Entities.MonHocKhongTinhKhoiLuong object to insert.</param>
		/// <remarks>
		///		After inserting into the datasource, the PMS.Entities.MonHocKhongTinhKhoiLuong object will be updated
		/// 	to refelect any changes made by the datasource. (ie: identity or computed columns)
		/// </remarks>	
        ...
        /// <exception cref="System.Data.DataException">The <paramref name="transactionManager"/> is not open.</exception>
        /// <exception cref="System.Data.Common.DbException">The command could not be executed.</exception>
		public override bool Insert(TransactionManager transactionManager, PMS.Entities.MonHocKhongTinhKhoiLuong entity)
		{
			SqlDatabase database = new SqlDatabase(this._connectionString);
			DbCommand commandWrapper = StoredProcedureProvider.GetCommandWrapper(database, "dbo.sp_MonHocKhongTinhKhoiLuong_Insert", _useStoredProcedure);
            ...
            database.AddInParameter(commandWrapper, "@TenBoMon", DbType.String, entity.TenBoMon );
		...
		/// </summary>
		/// <param name="transactionManager"><see cref="TransactionManager"/> object</param>
		/// <param name="entity">PMS.Entities.MonHocKhongTinhKhoiLuong object to update.</param>
		/// <remarks>
		///		After updating the datasource, the PMS.Entities.MonHocKhongTinhKhoiLuong object will be updated
		/// 	to refelect any changes made by the datasource. (ie: identity or computed columns)
		/// </remarks>
		/// <returns>Returns true if operation is successful.</returns>
        /// <exception cref="System.Exception">The command could not be executed.</exception>
        /// <exception cref="System.Data.DataException">The <paramref name="transactionManager"/> is not open.</exception>
        /// <exception cref="System.Data.Common.DbException">The command could not be executed.</exception>
		public override bool Update(TransactionManager transactionManager, PMS.Entities.MonHocKhongTinhKhoiLuong entity)
		{
			SqlDatabase database = new SqlDatabase(this._connectionString);
			DbCommand commandWrapper = StoredProcedureProvider.GetCommandWrapper(database, "dbo.sp_MonHocKhongTinhKhoiLuong_Update", _useStoredProcedure);
		...
		/// <summary>
		///	This method wraps the 'cust_MonHocKhongTinhKhoiLuong_GetByNamHocHocKy' stored procedure. 
		/// </summary>	
		...
		public override TList<MonHocKhongTinhKhoiLuong> GetByNamHocHocKy(TransactionManager transactionManager, int start, int pageLength , System.String namHoc, System.String hocKy)
		{
			SqlDatabase database = new SqlDatabase(this._connectionString);
			DbCommand commandWrapper = StoredProcedureProvider.GetCommandWrapper(database, "dbo.cust_MonHocKhongTinhKhoiLuong_GetByNamHocHocKy", true);
		...
		/// <summary>
		///	This method wraps the 'cust_MonHocKhongTinhKhoiLuong_SaoChep' stored procedure. 
		/// </summary>	
		...
		{
			SqlDatabase database = new SqlDatabase(this._connectionString);
			DbCommand commandWrapper = StoredProcedureProvider.GetCommandWrapper(database, "dbo.cust_MonHocKhongTinhKhoiLuong_SaoChep", true);
