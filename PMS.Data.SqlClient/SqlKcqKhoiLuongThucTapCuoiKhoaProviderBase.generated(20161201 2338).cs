/*
	...
	Important: Do not modify this file. Edit the file SqlKcqKhoiLuongThucTapCuoiKhoaProvider.cs instead.
*/
...
namespace PMS.Data.SqlClient
{
	...
	///</summary>
	public abstract partial class SqlKcqKhoiLuongThucTapCuoiKhoaProviderBase : KcqKhoiLuongThucTapCuoiKhoaProviderBase
	{
		#region Declarations
		...
		/// <summary>
		/// Creates a new <see cref="SqlKcqKhoiLuongThucTapCuoiKhoaProviderBase"/> instance.
		/// </summary>
		public SqlKcqKhoiLuongThucTapCuoiKhoaProviderBase()
		{
		}
	...
	public SqlKcqKhoiLuongThucTapCuoiKhoaProviderBase(string connectionString, bool useStoredProcedure, string providerInvariantName)
	{
    ...
    public string ProviderInvariantName
    {
		...
		public override bool Delete(TransactionManager transactionManager, System.Int32 _id)
		{
			...
			DbCommand commandWrapper = StoredProcedureProvider.GetCommandWrapper(database, "dbo.sp_KcqKhoiLuongThucTapCuoiKhoa_Delete", _useStoredProcedure);
			...
			{
				string entityKey = EntityLocator.ConstructKeyFromPkItems(typeof(KcqKhoiLuongThucTapCuoiKhoa)
					,_id);
		...
		/// <returns>Returns a typed collection of PMS.Entities.KcqKhoiLuongThucTapCuoiKhoa objects.</returns>
		public override TList<KcqKhoiLuongThucTapCuoiKhoa> Find(TransactionManager transactionManager, string whereClause, int start, int pageLength, out int count)
		{
			count = -1;
			if (whereClause.IndexOf(";") > -1)
				return new TList<KcqKhoiLuongThucTapCuoiKhoa>();
	
			SqlDatabase database = new SqlDatabase(this._connectionString);
			DbCommand commandWrapper = StoredProcedureProvider.GetCommandWrapper(database, "dbo.sp_KcqKhoiLuongThucTapCuoiKhoa_Find", _useStoredProcedure);
		...
		database.AddInParameter(commandWrapper, "@MaDiaDiem", DbType.Int32, DBNull.Value);
		...
		database.AddInParameter(commandWrapper, "@ThanhTienGiangDay", DbType.Decimal, DBNull.Value);
		...
		database.AddInParameter(commandWrapper, "@Loai", DbType.String, DBNull.Value);
	   		...
	   		foreach (string clause in clauses)
			{
				...
				if (clause.Trim().StartsWith("thanhtiengiangday ") || clause.Trim().StartsWith("thanhtiengiangday="))
				{
					database.SetParameterValue(commandWrapper, "@ThanhTienGiangDay", 
			...
			//Create Collection
			TList<KcqKhoiLuongThucTapCuoiKhoa> rows = new TList<KcqKhoiLuongThucTapCuoiKhoa>();
		...
		/// <param name="count">out. The number of rows that match this query.</param>
		/// <returns>Returns a typed collection of PMS.Entities.KcqKhoiLuongThucTapCuoiKhoa objects.</returns>
		public override TList<KcqKhoiLuongThucTapCuoiKhoa> Find(TransactionManager transactionManager, IFilterParameterCollection parameters, string orderBy, int start, int pageLength, out int count)
		{
			...
			SqlDatabase database = new SqlDatabase(this._connectionString);
			DbCommand commandWrapper = StoredProcedureProvider.GetCommandWrapper(database, "dbo.sp_KcqKhoiLuongThucTapCuoiKhoa_Find_Dynamic", typeof(KcqKhoiLuongThucTapCuoiKhoaColumn), filter, orderBy, start, pageLength);
        ...
        /// <exception cref="System.Data.DataException">The <paramref name="transactionManager"/> is not open.</exception>
        /// <exception cref="System.Data.Common.DbException">The command could not be executed.</exception>
		public override TList<KcqKhoiLuongThucTapCuoiKhoa> GetAll(TransactionManager transactionManager, int start, int pageLength, out int count)
		{
			SqlDatabase database = new SqlDatabase(this._connectionString);
			DbCommand commandWrapper = StoredProcedureProvider.GetCommandWrapper(database, "dbo.sp_KcqKhoiLuongThucTapCuoiKhoa_Get_List", _useStoredProcedure);
		...
		/// <remarks></remarks>
		/// <returns>Returns a typed collection of PMS.Entities.KcqKhoiLuongThucTapCuoiKhoa objects.</returns>
		public override TList<KcqKhoiLuongThucTapCuoiKhoa> GetPaged(TransactionManager transactionManager, string whereClause, string orderBy, int start, int pageLength, out int count)
		{
			SqlDatabase database = new SqlDatabase(this._connectionString);
			DbCommand commandWrapper = StoredProcedureProvider.GetCommandWrapper(database, "dbo.sp_KcqKhoiLuongThucTapCuoiKhoa_GetPaged", _useStoredProcedure);
        ...
        /// <exception cref="System.Data.DataException">The <paramref name="transactionManager"/> is not open.</exception>
        /// <exception cref="System.Data.Common.DbException">The command could not be executed.</exception>
		public override PMS.Entities.KcqKhoiLuongThucTapCuoiKhoa GetById(TransactionManager transactionManager, System.Int32 _id, int start, int pageLength, out int count)
		{
			SqlDatabase database = new SqlDatabase(this._connectionString);
			DbCommand commandWrapper = StoredProcedureProvider.GetCommandWrapper(database, "dbo.sp_KcqKhoiLuongThucTapCuoiKhoa_GetById", _useStoredProcedure);
			
				database.AddInParameter(commandWrapper, "@Id", DbType.Int32, _id);
			
			IDataReader reader = null;
			TList<KcqKhoiLuongThucTapCuoiKhoa> tmp = new TList<KcqKhoiLuongThucTapCuoiKhoa>();
			try
			{
				//Provider Data Requesting Command Event
		...
		/// <remarks>
		///		After inserting into the datasource, the PMS.Entities.KcqKhoiLuongThucTapCuoiKhoa object will be updated
		/// 	to refelect any changes made by the datasource. (ie: identity or computed columns)
		/// </remarks>	
		public override void BulkInsert(TransactionManager transactionManager, TList<PMS.Entities.KcqKhoiLuongThucTapCuoiKhoa> entities)
		{
			...
			bulkCopy.DestinationTableName = "KcqKhoiLuongThucTapCuoiKhoa";
			...
			DataColumn col6 = dataTable.Columns.Add("MaLoaiHocPhan", typeof(System.Int32));
			...
			DataColumn col11 = dataTable.Columns.Add("SoTuan", typeof(System.Int32));
			...
			DataColumn col15 = dataTable.Columns.Add("MaDiaDiem", typeof(System.Int32));
			col15.AllowDBNull = true;		
			DataColumn col16 = dataTable.Columns.Add("HeSoDiaDiem", typeof(System.Decimal));
			col16.AllowDBNull = true;		
			DataColumn col17 = dataTable.Columns.Add("DonGiaDiaDiem", typeof(System.Decimal));
			col17.AllowDBNull = true;		
			DataColumn col18 = dataTable.Columns.Add("TienXeDiaDiem", typeof(System.Decimal));
			col18.AllowDBNull = true;		
			DataColumn col19 = dataTable.Columns.Add("ThanhTienGiangDay", typeof(System.Decimal));
			col19.AllowDBNull = true;		
			DataColumn col20 = dataTable.Columns.Add("GhiChu", typeof(System.String));
			col20.AllowDBNull = true;		
			DataColumn col21 = dataTable.Columns.Add("DotThanhToan", typeof(System.String));
			col21.AllowDBNull = true;		
			DataColumn col22 = dataTable.Columns.Add("MaDonVi", typeof(System.String));
			col22.AllowDBNull = true;		
			DataColumn col23 = dataTable.Columns.Add("MaHocHam", typeof(System.Int32));
			col23.AllowDBNull = true;		
			DataColumn col24 = dataTable.Columns.Add("MaHocVi", typeof(System.Int32));
			col24.AllowDBNull = true;		
			DataColumn col25 = dataTable.Columns.Add("MaLoaiGiangVien", typeof(System.Int32));
			col25.AllowDBNull = true;		
			DataColumn col26 = dataTable.Columns.Add("HeSoQuyDoi", typeof(System.Decimal));
			col26.AllowDBNull = true;		
			DataColumn col27 = dataTable.Columns.Add("Loai", typeof(System.String));
			...
			bulkCopy.ColumnMappings.Add("ThanhTienGiangDay", "ThanhTienGiangDay");
			...
			foreach(PMS.Entities.KcqKhoiLuongThucTapCuoiKhoa entity in entities)
			{
				...
				DataRow row = dataTable.NewRow();
					...
					row["MaDiaDiem"] = entity.MaDiaDiem.HasValue ? (object) entity.MaDiaDiem  : System.DBNull.Value;
					...
					row["ThanhTienGiangDay"] = entity.ThanhTienGiangDay.HasValue ? (object) entity.ThanhTienGiangDay  : System.DBNull.Value;
		...
		/// <summary>
		/// 	Inserts a PMS.Entities.KcqKhoiLuongThucTapCuoiKhoa object into the datasource using a transaction.
		/// </summary>
		/// <param name="transactionManager"><see cref="TransactionManager"/> object</param>
		/// <param name="entity">PMS.Entities.KcqKhoiLuongThucTapCuoiKhoa object to insert.</param>
		/// <remarks>
		///		After inserting into the datasource, the PMS.Entities.KcqKhoiLuongThucTapCuoiKhoa object will be updated
		/// 	to refelect any changes made by the datasource. (ie: identity or computed columns)
		/// </remarks>	
        ...
        /// <exception cref="System.Data.DataException">The <paramref name="transactionManager"/> is not open.</exception>
        /// <exception cref="System.Data.Common.DbException">The command could not be executed.</exception>
		public override bool Insert(TransactionManager transactionManager, PMS.Entities.KcqKhoiLuongThucTapCuoiKhoa entity)
		{
			SqlDatabase database = new SqlDatabase(this._connectionString);
			DbCommand commandWrapper = StoredProcedureProvider.GetCommandWrapper(database, "dbo.sp_KcqKhoiLuongThucTapCuoiKhoa_Insert", _useStoredProcedure);
			...
			database.AddInParameter(commandWrapper, "@MaDiaDiem", DbType.Int32, (entity.MaDiaDiem.HasValue ? (object) entity.MaDiaDiem  : System.DBNull.Value));
			...
			database.AddInParameter(commandWrapper, "@ThanhTienGiangDay", DbType.Decimal, (entity.ThanhTienGiangDay.HasValue ? (object) entity.ThanhTienGiangDay  : System.DBNull.Value));
		...
		/// </summary>
		/// <param name="transactionManager"><see cref="TransactionManager"/> object</param>
		/// <param name="entity">PMS.Entities.KcqKhoiLuongThucTapCuoiKhoa object to update.</param>
		/// <remarks>
		///		After updating the datasource, the PMS.Entities.KcqKhoiLuongThucTapCuoiKhoa object will be updated
		/// 	to refelect any changes made by the datasource. (ie: identity or computed columns)
		/// </remarks>
		/// <returns>Returns true if operation is successful.</returns>
        /// <exception cref="System.Exception">The command could not be executed.</exception>
        /// <exception cref="System.Data.DataException">The <paramref name="transactionManager"/> is not open.</exception>
        /// <exception cref="System.Data.Common.DbException">The command could not be executed.</exception>
		public override bool Update(TransactionManager transactionManager, PMS.Entities.KcqKhoiLuongThucTapCuoiKhoa entity)
		{
			SqlDatabase database = new SqlDatabase(this._connectionString);
			DbCommand commandWrapper = StoredProcedureProvider.GetCommandWrapper(database, "dbo.sp_KcqKhoiLuongThucTapCuoiKhoa_Update", _useStoredProcedure);
		...
		/// <summary>
		///	This method wraps the 'cust_KcqKhoiLuongThucTapCuoiKhoa_DongBo' stored procedure. 
		/// </summary>	
		...
		{
			SqlDatabase database = new SqlDatabase(this._connectionString);
			DbCommand commandWrapper = StoredProcedureProvider.GetCommandWrapper(database, "dbo.cust_KcqKhoiLuongThucTapCuoiKhoa_DongBo", true);
		...
		/// <summary>
		///	This method wraps the 'cust_KcqKhoiLuongThucTapCuoiKhoa_GetByNamHocHocKy' stored procedure. 
		/// </summary>	
		/// <param name="namHoc"> A <c>System.String</c> instance.</param>
		/// <param name="hocKy"> A <c>System.String</c> instance.</param>
		/// <param name="start">Row number at which to start reading.</param>
		...
		{
			SqlDatabase database = new SqlDatabase(this._connectionString);
			DbCommand commandWrapper = StoredProcedureProvider.GetCommandWrapper(database, "dbo.cust_KcqKhoiLuongThucTapCuoiKhoa_GetByNamHocHocKy", true);
		...
		/// <summary>
		///	This method wraps the 'cust_KcqKhoiLuongThucTapCuoiKhoa_ThongKeTheoNamHocHocKy' stored procedure. 
		/// </summary>	
		/// <param name="namHoc"> A <c>System.String</c> instance.</param>
		/// <param name="hocKy"> A <c>System.String</c> instance.</param>
		/// <param name="start">Row number at which to start reading.</param>
		...
		/// <remark>This method is generated from a stored procedure.</remark>
		/// <returns>A <see cref="IDataReader"/> instance.</returns>
		public override IDataReader ThongKeTheoNamHocHocKy(TransactionManager transactionManager, int start, int pageLength , System.String namHoc, System.String hocKy)
		{
			SqlDatabase database = new SqlDatabase(this._connectionString);
			DbCommand commandWrapper = StoredProcedureProvider.GetCommandWrapper(database, "dbo.cust_KcqKhoiLuongThucTapCuoiKhoa_ThongKeTheoNamHocHocKy", true);
			...
			IDataReader dr = null;
			//Provider Data Requesting Command Event
			OnDataRequesting(new CommandEventArgs(commandWrapper, "ThongKeTheoNamHocHocKy", (IEntity)null));
			...
			//Provider Data Requested Command Event
			OnDataRequested(new CommandEventArgs(commandWrapper, "ThongKeTheoNamHocHocKy", (IEntity)null));
		...
		/// <summary>
		///	This method wraps the 'cust_KcqKhoiLuongThucTapCuoiKhoa_Luu' stored procedure. 
		/// </summary>	
		...
		{
			SqlDatabase database = new SqlDatabase(this._connectionString);
			DbCommand commandWrapper = StoredProcedureProvider.GetCommandWrapper(database, "dbo.cust_KcqKhoiLuongThucTapCuoiKhoa_Luu", true);
