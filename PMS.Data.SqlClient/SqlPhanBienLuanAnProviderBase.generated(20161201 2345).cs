...
namespace PMS.Data.SqlClient
{
    ...
    public string ProviderInvariantName
    {
        ...
        /// <exception cref="System.Data.DataException">The <paramref name="transactionManager"/> is not open.</exception>
        /// <exception cref="System.Data.Common.DbException">The command could not be executed.</exception>
		public override PMS.Entities.PhanBienLuanAn GetByMaGiangVienNamHocHocKyLoai(TransactionManager transactionManager, System.Int32 _maGiangVien, System.String _namHoc, System.String _hocKy, System.String _loai, int start, int pageLength, out int count)
		{
			SqlDatabase database = new SqlDatabase(this._connectionString);
			DbCommand commandWrapper = StoredProcedureProvider.GetCommandWrapper(database, "dbo.sp_PhanBienLuanAn_GetByMaGiangVienNamHocHocKyLoai", _useStoredProcedure);
