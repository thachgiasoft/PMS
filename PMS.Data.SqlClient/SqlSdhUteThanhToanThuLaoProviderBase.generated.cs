/*
	...
	Important: Do not modify this file. Edit the file SqlSdhUteThanhToanThuLaoProvider.cs instead.
*/
...
namespace PMS.Data.SqlClient
{
	...
	///</summary>
	public abstract partial class SqlSdhUteThanhToanThuLaoProviderBase : SdhUteThanhToanThuLaoProviderBase
	{
		#region Declarations
		...
		/// <summary>
		/// Creates a new <see cref="SqlSdhUteThanhToanThuLaoProviderBase"/> instance.
		/// </summary>
		public SqlSdhUteThanhToanThuLaoProviderBase()
		{
		}
	...
	public SqlSdhUteThanhToanThuLaoProviderBase(string connectionString, bool useStoredProcedure, string providerInvariantName)
	{
    ...
    public string ProviderInvariantName
    {
		...
		public override bool Delete(TransactionManager transactionManager, System.Int32 _idKhoiLuongQuyDoi)
		{
			...
			DbCommand commandWrapper = StoredProcedureProvider.GetCommandWrapper(database, "dbo.sp_SdhUte_ThanhToanThuLao_Delete", _useStoredProcedure);
			...
			{
				string entityKey = EntityLocator.ConstructKeyFromPkItems(typeof(SdhUteThanhToanThuLao)
					,_idKhoiLuongQuyDoi);
		...
		/// <returns>Returns a typed collection of PMS.Entities.SdhUteThanhToanThuLao objects.</returns>
		public override TList<SdhUteThanhToanThuLao> Find(TransactionManager transactionManager, string whereClause, int start, int pageLength, out int count)
		{
			count = -1;
			if (whereClause.IndexOf(";") > -1)
				return new TList<SdhUteThanhToanThuLao>();
	
			SqlDatabase database = new SqlDatabase(this._connectionString);
			DbCommand commandWrapper = StoredProcedureProvider.GetCommandWrapper(database, "dbo.sp_SdhUte_ThanhToanThuLao_Find", _useStoredProcedure);
		...
		database.AddInParameter(commandWrapper, "@MaDiaDiem", DbType.AnsiString, DBNull.Value);
			...
			//Create Collection
			TList<SdhUteThanhToanThuLao> rows = new TList<SdhUteThanhToanThuLao>();
		...
		/// <param name="count">out. The number of rows that match this query.</param>
		/// <returns>Returns a typed collection of PMS.Entities.SdhUteThanhToanThuLao objects.</returns>
		public override TList<SdhUteThanhToanThuLao> Find(TransactionManager transactionManager, IFilterParameterCollection parameters, string orderBy, int start, int pageLength, out int count)
		{
			...
			SqlDatabase database = new SqlDatabase(this._connectionString);
			DbCommand commandWrapper = StoredProcedureProvider.GetCommandWrapper(database, "dbo.sp_SdhUte_ThanhToanThuLao_Find_Dynamic", typeof(SdhUteThanhToanThuLaoColumn), filter, orderBy, start, pageLength);
        ...
        /// <exception cref="System.Data.DataException">The <paramref name="transactionManager"/> is not open.</exception>
        /// <exception cref="System.Data.Common.DbException">The command could not be executed.</exception>
		public override TList<SdhUteThanhToanThuLao> GetAll(TransactionManager transactionManager, int start, int pageLength, out int count)
		{
			SqlDatabase database = new SqlDatabase(this._connectionString);
			DbCommand commandWrapper = StoredProcedureProvider.GetCommandWrapper(database, "dbo.sp_SdhUte_ThanhToanThuLao_Get_List", _useStoredProcedure);
		...
		/// <remarks></remarks>
		/// <returns>Returns a typed collection of PMS.Entities.SdhUteThanhToanThuLao objects.</returns>
		public override TList<SdhUteThanhToanThuLao> GetPaged(TransactionManager transactionManager, string whereClause, string orderBy, int start, int pageLength, out int count)
		{
			SqlDatabase database = new SqlDatabase(this._connectionString);
			DbCommand commandWrapper = StoredProcedureProvider.GetCommandWrapper(database, "dbo.sp_SdhUte_ThanhToanThuLao_GetPaged", _useStoredProcedure);
        ...
        /// <exception cref="System.Data.DataException">The <paramref name="transactionManager"/> is not open.</exception>
        /// <exception cref="System.Data.Common.DbException">The command could not be executed.</exception>
		public override PMS.Entities.SdhUteThanhToanThuLao GetByIdKhoiLuongQuyDoi(TransactionManager transactionManager, System.Int32 _idKhoiLuongQuyDoi, int start, int pageLength, out int count)
		{
			SqlDatabase database = new SqlDatabase(this._connectionString);
			DbCommand commandWrapper = StoredProcedureProvider.GetCommandWrapper(database, "dbo.sp_SdhUte_ThanhToanThuLao_GetByIdKhoiLuongQuyDoi", _useStoredProcedure);
			
				database.AddInParameter(commandWrapper, "@IdKhoiLuongQuyDoi", DbType.Int32, _idKhoiLuongQuyDoi);
			
			IDataReader reader = null;
			TList<SdhUteThanhToanThuLao> tmp = new TList<SdhUteThanhToanThuLao>();
			try
			{
				//Provider Data Requesting Command Event
		...
		/// <remarks>
		///		After inserting into the datasource, the PMS.Entities.SdhUteThanhToanThuLao object will be updated
		/// 	to refelect any changes made by the datasource. (ie: identity or computed columns)
		/// </remarks>	
		public override void BulkInsert(TransactionManager transactionManager, TList<PMS.Entities.SdhUteThanhToanThuLao> entities)
		{
			...
			bulkCopy.DestinationTableName = "SdhUte_ThanhToanThuLao";
			...
			foreach(PMS.Entities.SdhUteThanhToanThuLao entity in entities)
			{
		...
		/// <summary>
		/// 	Inserts a PMS.Entities.SdhUteThanhToanThuLao object into the datasource using a transaction.
		/// </summary>
		/// <param name="transactionManager"><see cref="TransactionManager"/> object</param>
		/// <param name="entity">PMS.Entities.SdhUteThanhToanThuLao object to insert.</param>
		/// <remarks>
		///		After inserting into the datasource, the PMS.Entities.SdhUteThanhToanThuLao object will be updated
		/// 	to refelect any changes made by the datasource. (ie: identity or computed columns)
		/// </remarks>	
        ...
        /// <exception cref="System.Data.DataException">The <paramref name="transactionManager"/> is not open.</exception>
        /// <exception cref="System.Data.Common.DbException">The command could not be executed.</exception>
		public override bool Insert(TransactionManager transactionManager, PMS.Entities.SdhUteThanhToanThuLao entity)
		{
			SqlDatabase database = new SqlDatabase(this._connectionString);
			DbCommand commandWrapper = StoredProcedureProvider.GetCommandWrapper(database, "dbo.sp_SdhUte_ThanhToanThuLao_Insert", _useStoredProcedure);
		...
		/// </summary>
		/// <param name="transactionManager"><see cref="TransactionManager"/> object</param>
		/// <param name="entity">PMS.Entities.SdhUteThanhToanThuLao object to update.</param>
		/// <remarks>
		///		After updating the datasource, the PMS.Entities.SdhUteThanhToanThuLao object will be updated
		/// 	to refelect any changes made by the datasource. (ie: identity or computed columns)
		/// </remarks>
		/// <returns>Returns true if operation is successful.</returns>
        /// <exception cref="System.Exception">The command could not be executed.</exception>
        /// <exception cref="System.Data.DataException">The <paramref name="transactionManager"/> is not open.</exception>
        /// <exception cref="System.Data.Common.DbException">The command could not be executed.</exception>
		public override bool Update(TransactionManager transactionManager, PMS.Entities.SdhUteThanhToanThuLao entity)
		{
			SqlDatabase database = new SqlDatabase(this._connectionString);
			DbCommand commandWrapper = StoredProcedureProvider.GetCommandWrapper(database, "dbo.sp_SdhUte_ThanhToanThuLao_Update", _useStoredProcedure);
		...
		/// <summary>
		///	This method wraps the 'cust_SdhUte_ThanhToanThuLao_ThanhToan' stored procedure. 
		/// </summary>	
		...
		{
			SqlDatabase database = new SqlDatabase(this._connectionString);
			DbCommand commandWrapper = StoredProcedureProvider.GetCommandWrapper(database, "dbo.cust_SdhUte_ThanhToanThuLao_ThanhToan", true);
