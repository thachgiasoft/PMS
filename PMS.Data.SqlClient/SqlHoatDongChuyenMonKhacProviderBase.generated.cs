/*
	...
	Important: Do not modify this file. Edit the file SqlHoatDongChuyenMonKhacProvider.cs instead.
*/
...
namespace PMS.Data.SqlClient
{
	...
	///</summary>
	public abstract partial class SqlHoatDongChuyenMonKhacProviderBase : HoatDongChuyenMonKhacProviderBase
	{
		#region Declarations
		...
		/// <summary>
		/// Creates a new <see cref="SqlHoatDongChuyenMonKhacProviderBase"/> instance.
		/// </summary>
		public SqlHoatDongChuyenMonKhacProviderBase()
		{
		}
	...
	public SqlHoatDongChuyenMonKhacProviderBase(string connectionString, bool useStoredProcedure, string providerInvariantName)
	{
    ...
    public string ProviderInvariantName
    {
		...
		public override bool Delete(TransactionManager transactionManager, System.Int32 _id)
		{
			...
			DbCommand commandWrapper = StoredProcedureProvider.GetCommandWrapper(database, "dbo.sp_HoatDongChuyenMonKhac_Delete", _useStoredProcedure);
			...
			{
				string entityKey = EntityLocator.ConstructKeyFromPkItems(typeof(HoatDongChuyenMonKhac)
					,_id);
		...
		/// <returns>Returns a typed collection of PMS.Entities.HoatDongChuyenMonKhac objects.</returns>
		public override TList<HoatDongChuyenMonKhac> Find(TransactionManager transactionManager, string whereClause, int start, int pageLength, out int count)
		{
			count = -1;
			if (whereClause.IndexOf(";") > -1)
				return new TList<HoatDongChuyenMonKhac>();
	
			SqlDatabase database = new SqlDatabase(this._connectionString);
			DbCommand commandWrapper = StoredProcedureProvider.GetCommandWrapper(database, "dbo.sp_HoatDongChuyenMonKhac_Find", _useStoredProcedure);
		...
		database.AddInParameter(commandWrapper, "@GhiChu", DbType.String, DBNull.Value);
			...
			//Create Collection
			TList<HoatDongChuyenMonKhac> rows = new TList<HoatDongChuyenMonKhac>();
		...
		/// <param name="count">out. The number of rows that match this query.</param>
		/// <returns>Returns a typed collection of PMS.Entities.HoatDongChuyenMonKhac objects.</returns>
		public override TList<HoatDongChuyenMonKhac> Find(TransactionManager transactionManager, IFilterParameterCollection parameters, string orderBy, int start, int pageLength, out int count)
		{
			...
			SqlDatabase database = new SqlDatabase(this._connectionString);
			DbCommand commandWrapper = StoredProcedureProvider.GetCommandWrapper(database, "dbo.sp_HoatDongChuyenMonKhac_Find_Dynamic", typeof(HoatDongChuyenMonKhacColumn), filter, orderBy, start, pageLength);
        ...
        /// <exception cref="System.Data.DataException">The <paramref name="transactionManager"/> is not open.</exception>
        /// <exception cref="System.Data.Common.DbException">The command could not be executed.</exception>
		public override TList<HoatDongChuyenMonKhac> GetAll(TransactionManager transactionManager, int start, int pageLength, out int count)
		{
			SqlDatabase database = new SqlDatabase(this._connectionString);
			DbCommand commandWrapper = StoredProcedureProvider.GetCommandWrapper(database, "dbo.sp_HoatDongChuyenMonKhac_Get_List", _useStoredProcedure);
		...
		/// <remarks></remarks>
		/// <returns>Returns a typed collection of PMS.Entities.HoatDongChuyenMonKhac objects.</returns>
		public override TList<HoatDongChuyenMonKhac> GetPaged(TransactionManager transactionManager, string whereClause, string orderBy, int start, int pageLength, out int count)
		{
			SqlDatabase database = new SqlDatabase(this._connectionString);
			DbCommand commandWrapper = StoredProcedureProvider.GetCommandWrapper(database, "dbo.sp_HoatDongChuyenMonKhac_GetPaged", _useStoredProcedure);
        ...
        /// <exception cref="System.Data.DataException">The <paramref name="transactionManager"/> is not open.</exception>
        /// <exception cref="System.Data.Common.DbException">The command could not be executed.</exception>
		public override PMS.Entities.HoatDongChuyenMonKhac GetById(TransactionManager transactionManager, System.Int32 _id, int start, int pageLength, out int count)
		{
			SqlDatabase database = new SqlDatabase(this._connectionString);
			DbCommand commandWrapper = StoredProcedureProvider.GetCommandWrapper(database, "dbo.sp_HoatDongChuyenMonKhac_GetById", _useStoredProcedure);
			
				database.AddInParameter(commandWrapper, "@Id", DbType.Int32, _id);
			
			IDataReader reader = null;
			TList<HoatDongChuyenMonKhac> tmp = new TList<HoatDongChuyenMonKhac>();
			try
			{
				//Provider Data Requesting Command Event
		...
		/// <remarks>
		///		After inserting into the datasource, the PMS.Entities.HoatDongChuyenMonKhac object will be updated
		/// 	to refelect any changes made by the datasource. (ie: identity or computed columns)
		/// </remarks>	
		public override void BulkInsert(TransactionManager transactionManager, TList<PMS.Entities.HoatDongChuyenMonKhac> entities)
		{
			...
			bulkCopy.DestinationTableName = "HoatDongChuyenMonKhac";
			...
			DataColumn col3 = dataTable.Columns.Add("MaGiangVien", typeof(System.String));
			col3.AllowDBNull = true;		
			DataColumn col4 = dataTable.Columns.Add("TenHoatDong", typeof(System.String));
			...
			foreach(PMS.Entities.HoatDongChuyenMonKhac entity in entities)
			{
		...
		/// <summary>
		/// 	Inserts a PMS.Entities.HoatDongChuyenMonKhac object into the datasource using a transaction.
		/// </summary>
		/// <param name="transactionManager"><see cref="TransactionManager"/> object</param>
		/// <param name="entity">PMS.Entities.HoatDongChuyenMonKhac object to insert.</param>
		/// <remarks>
		///		After inserting into the datasource, the PMS.Entities.HoatDongChuyenMonKhac object will be updated
		/// 	to refelect any changes made by the datasource. (ie: identity or computed columns)
		/// </remarks>	
        ...
        /// <exception cref="System.Data.DataException">The <paramref name="transactionManager"/> is not open.</exception>
        /// <exception cref="System.Data.Common.DbException">The command could not be executed.</exception>
		public override bool Insert(TransactionManager transactionManager, PMS.Entities.HoatDongChuyenMonKhac entity)
		{
			SqlDatabase database = new SqlDatabase(this._connectionString);
			DbCommand commandWrapper = StoredProcedureProvider.GetCommandWrapper(database, "dbo.sp_HoatDongChuyenMonKhac_Insert", _useStoredProcedure);
		...
		/// </summary>
		/// <param name="transactionManager"><see cref="TransactionManager"/> object</param>
		/// <param name="entity">PMS.Entities.HoatDongChuyenMonKhac object to update.</param>
		/// <remarks>
		///		After updating the datasource, the PMS.Entities.HoatDongChuyenMonKhac object will be updated
		/// 	to refelect any changes made by the datasource. (ie: identity or computed columns)
		/// </remarks>
		/// <returns>Returns true if operation is successful.</returns>
        /// <exception cref="System.Exception">The command could not be executed.</exception>
        /// <exception cref="System.Data.DataException">The <paramref name="transactionManager"/> is not open.</exception>
        /// <exception cref="System.Data.Common.DbException">The command could not be executed.</exception>
		public override bool Update(TransactionManager transactionManager, PMS.Entities.HoatDongChuyenMonKhac entity)
		{
			SqlDatabase database = new SqlDatabase(this._connectionString);
			DbCommand commandWrapper = StoredProcedureProvider.GetCommandWrapper(database, "dbo.sp_HoatDongChuyenMonKhac_Update", _useStoredProcedure);
		...
		/// <summary>
		///	This method wraps the 'cust_HoatDongChuyenMonKhac_GetByNamHocHocKy' stored procedure. 
		/// </summary>	
		...
		public override TList<HoatDongChuyenMonKhac> GetByNamHocHocKy(TransactionManager transactionManager, int start, int pageLength , System.String namHoc, System.String hocKy)
		{
			SqlDatabase database = new SqlDatabase(this._connectionString);
			DbCommand commandWrapper = StoredProcedureProvider.GetCommandWrapper(database, "dbo.cust_HoatDongChuyenMonKhac_GetByNamHocHocKy", true);
		...
		/// <summary>
		///	This method wraps the 'cust_HoatDongChuyenMonKhac_SaoChep' stored procedure. 
		/// </summary>	
		...
		{
			SqlDatabase database = new SqlDatabase(this._connectionString);
			DbCommand commandWrapper = StoredProcedureProvider.GetCommandWrapper(database, "dbo.cust_HoatDongChuyenMonKhac_SaoChep", true);
