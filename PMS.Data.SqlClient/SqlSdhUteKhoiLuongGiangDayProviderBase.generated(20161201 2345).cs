/*
	...
	Important: Do not modify this file. Edit the file SqlSdhUteKhoiLuongGiangDayProvider.cs instead.
*/
...
namespace PMS.Data.SqlClient
{
	...
	///</summary>
	public abstract partial class SqlSdhUteKhoiLuongGiangDayProviderBase : SdhUteKhoiLuongGiangDayProviderBase
	{
		#region Declarations
		...
		/// <summary>
		/// Creates a new <see cref="SqlSdhUteKhoiLuongGiangDayProviderBase"/> instance.
		/// </summary>
		public SqlSdhUteKhoiLuongGiangDayProviderBase()
		{
		}
	...
	public SqlSdhUteKhoiLuongGiangDayProviderBase(string connectionString, bool useStoredProcedure, string providerInvariantName)
	{
    ...
    public string ProviderInvariantName
    {
		...
		public override bool Delete(TransactionManager transactionManager, System.Int32 _id)
		{
			...
			DbCommand commandWrapper = StoredProcedureProvider.GetCommandWrapper(database, "dbo.sp_SdhUte_KhoiLuongGiangDay_Delete", _useStoredProcedure);
			...
			{
				string entityKey = EntityLocator.ConstructKeyFromPkItems(typeof(SdhUteKhoiLuongGiangDay)
					,_id);
		...
		/// <returns>Returns a typed collection of PMS.Entities.SdhUteKhoiLuongGiangDay objects.</returns>
		public override TList<SdhUteKhoiLuongGiangDay> Find(TransactionManager transactionManager, string whereClause, int start, int pageLength, out int count)
		{
			count = -1;
			if (whereClause.IndexOf(";") > -1)
				return new TList<SdhUteKhoiLuongGiangDay>();
	
			SqlDatabase database = new SqlDatabase(this._connectionString);
			DbCommand commandWrapper = StoredProcedureProvider.GetCommandWrapper(database, "dbo.sp_SdhUte_KhoiLuongGiangDay_Find", _useStoredProcedure);
		...
		database.AddInParameter(commandWrapper, "@MaDot", DbType.String, DBNull.Value);
			...
			//Create Collection
			TList<SdhUteKhoiLuongGiangDay> rows = new TList<SdhUteKhoiLuongGiangDay>();
		...
		/// <param name="count">out. The number of rows that match this query.</param>
		/// <returns>Returns a typed collection of PMS.Entities.SdhUteKhoiLuongGiangDay objects.</returns>
		public override TList<SdhUteKhoiLuongGiangDay> Find(TransactionManager transactionManager, IFilterParameterCollection parameters, string orderBy, int start, int pageLength, out int count)
		{
			...
			SqlDatabase database = new SqlDatabase(this._connectionString);
			DbCommand commandWrapper = StoredProcedureProvider.GetCommandWrapper(database, "dbo.sp_SdhUte_KhoiLuongGiangDay_Find_Dynamic", typeof(SdhUteKhoiLuongGiangDayColumn), filter, orderBy, start, pageLength);
        ...
        /// <exception cref="System.Data.DataException">The <paramref name="transactionManager"/> is not open.</exception>
        /// <exception cref="System.Data.Common.DbException">The command could not be executed.</exception>
		public override TList<SdhUteKhoiLuongGiangDay> GetAll(TransactionManager transactionManager, int start, int pageLength, out int count)
		{
			SqlDatabase database = new SqlDatabase(this._connectionString);
			DbCommand commandWrapper = StoredProcedureProvider.GetCommandWrapper(database, "dbo.sp_SdhUte_KhoiLuongGiangDay_Get_List", _useStoredProcedure);
		...
		/// <remarks></remarks>
		/// <returns>Returns a typed collection of PMS.Entities.SdhUteKhoiLuongGiangDay objects.</returns>
		public override TList<SdhUteKhoiLuongGiangDay> GetPaged(TransactionManager transactionManager, string whereClause, string orderBy, int start, int pageLength, out int count)
		{
			SqlDatabase database = new SqlDatabase(this._connectionString);
			DbCommand commandWrapper = StoredProcedureProvider.GetCommandWrapper(database, "dbo.sp_SdhUte_KhoiLuongGiangDay_GetPaged", _useStoredProcedure);
        ...
        /// <exception cref="System.Data.DataException">The <paramref name="transactionManager"/> is not open.</exception>
        /// <exception cref="System.Data.Common.DbException">The command could not be executed.</exception>
		public override PMS.Entities.SdhUteKhoiLuongGiangDay GetById(TransactionManager transactionManager, System.Int32 _id, int start, int pageLength, out int count)
		{
			SqlDatabase database = new SqlDatabase(this._connectionString);
			DbCommand commandWrapper = StoredProcedureProvider.GetCommandWrapper(database, "dbo.sp_SdhUte_KhoiLuongGiangDay_GetById", _useStoredProcedure);
			
				database.AddInParameter(commandWrapper, "@Id", DbType.Int32, _id);
			
			IDataReader reader = null;
			TList<SdhUteKhoiLuongGiangDay> tmp = new TList<SdhUteKhoiLuongGiangDay>();
			try
			{
				//Provider Data Requesting Command Event
		...
		/// <remarks>
		///		After inserting into the datasource, the PMS.Entities.SdhUteKhoiLuongGiangDay object will be updated
		/// 	to refelect any changes made by the datasource. (ie: identity or computed columns)
		/// </remarks>	
		public override void BulkInsert(TransactionManager transactionManager, TList<PMS.Entities.SdhUteKhoiLuongGiangDay> entities)
		{
			...
			bulkCopy.DestinationTableName = "SdhUte_KhoiLuongGiangDay";
			...
			foreach(PMS.Entities.SdhUteKhoiLuongGiangDay entity in entities)
			{
		...
		/// <summary>
		/// 	Inserts a PMS.Entities.SdhUteKhoiLuongGiangDay object into the datasource using a transaction.
		/// </summary>
		/// <param name="transactionManager"><see cref="TransactionManager"/> object</param>
		/// <param name="entity">PMS.Entities.SdhUteKhoiLuongGiangDay object to insert.</param>
		/// <remarks>
		///		After inserting into the datasource, the PMS.Entities.SdhUteKhoiLuongGiangDay object will be updated
		/// 	to refelect any changes made by the datasource. (ie: identity or computed columns)
		/// </remarks>	
        ...
        /// <exception cref="System.Data.DataException">The <paramref name="transactionManager"/> is not open.</exception>
        /// <exception cref="System.Data.Common.DbException">The command could not be executed.</exception>
		public override bool Insert(TransactionManager transactionManager, PMS.Entities.SdhUteKhoiLuongGiangDay entity)
		{
			SqlDatabase database = new SqlDatabase(this._connectionString);
			DbCommand commandWrapper = StoredProcedureProvider.GetCommandWrapper(database, "dbo.sp_SdhUte_KhoiLuongGiangDay_Insert", _useStoredProcedure);
		...
		/// </summary>
		/// <param name="transactionManager"><see cref="TransactionManager"/> object</param>
		/// <param name="entity">PMS.Entities.SdhUteKhoiLuongGiangDay object to update.</param>
		/// <remarks>
		///		After updating the datasource, the PMS.Entities.SdhUteKhoiLuongGiangDay object will be updated
		/// 	to refelect any changes made by the datasource. (ie: identity or computed columns)
		/// </remarks>
		/// <returns>Returns true if operation is successful.</returns>
        /// <exception cref="System.Exception">The command could not be executed.</exception>
        /// <exception cref="System.Data.DataException">The <paramref name="transactionManager"/> is not open.</exception>
        /// <exception cref="System.Data.Common.DbException">The command could not be executed.</exception>
		public override bool Update(TransactionManager transactionManager, PMS.Entities.SdhUteKhoiLuongGiangDay entity)
		{
			SqlDatabase database = new SqlDatabase(this._connectionString);
			DbCommand commandWrapper = StoredProcedureProvider.GetCommandWrapper(database, "dbo.sp_SdhUte_KhoiLuongGiangDay_Update", _useStoredProcedure);
		...
		/// <summary>
		///	This method wraps the 'cust_SdhUte_KhoiLuongGiangDay_DongBo' stored procedure. 
		/// </summary>	
		...
		{
			SqlDatabase database = new SqlDatabase(this._connectionString);
			DbCommand commandWrapper = StoredProcedureProvider.GetCommandWrapper(database, "dbo.cust_SdhUte_KhoiLuongGiangDay_DongBo", true);
		...
		/// <summary>
		///	This method wraps the 'cust_SdhUte_KhoiLuongGiangDay_KiemTraDongBo' stored procedure. 
		/// </summary>	
		/// <param name="namHoc"> A <c>System.String</c> instance.</param>
		/// <param name="hocKy"> A <c>System.String</c> instance.</param>
		...
		{
			SqlDatabase database = new SqlDatabase(this._connectionString);
			DbCommand commandWrapper = StoredProcedureProvider.GetCommandWrapper(database, "dbo.cust_SdhUte_KhoiLuongGiangDay_KiemTraDongBo", true);
		...
		/// <summary>
		///	This method wraps the 'cust_SdhUte_KhoiLuongGiangDay_CapNhatSiSo' stored procedure. 
		/// </summary>	
		...
		{
			SqlDatabase database = new SqlDatabase(this._connectionString);
			DbCommand commandWrapper = StoredProcedureProvider.GetCommandWrapper(database, "dbo.cust_SdhUte_KhoiLuongGiangDay_CapNhatSiSo", true);
