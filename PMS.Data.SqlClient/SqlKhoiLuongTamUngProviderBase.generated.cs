/*
	...
	Important: Do not modify this file. Edit the file SqlKhoiLuongTamUngProvider.cs instead.
*/
...
namespace PMS.Data.SqlClient
{
	...
	///</summary>
	public abstract partial class SqlKhoiLuongTamUngProviderBase : KhoiLuongTamUngProviderBase
	{
		#region Declarations
		...
		/// <summary>
		/// Creates a new <see cref="SqlKhoiLuongTamUngProviderBase"/> instance.
		/// </summary>
		public SqlKhoiLuongTamUngProviderBase()
		{
		}
	...
	public SqlKhoiLuongTamUngProviderBase(string connectionString, bool useStoredProcedure, string providerInvariantName)
	{
    ...
    public string ProviderInvariantName
    {
		...
		public override bool Delete(TransactionManager transactionManager, System.Int32 _maKhoiLuong)
		{
			...
			DbCommand commandWrapper = StoredProcedureProvider.GetCommandWrapper(database, "dbo.sp_KhoiLuongTamUng_Delete", _useStoredProcedure);
			...
			{
				string entityKey = EntityLocator.ConstructKeyFromPkItems(typeof(KhoiLuongTamUng)
					,_maKhoiLuong);
		...
		/// <returns>Returns a typed collection of PMS.Entities.KhoiLuongTamUng objects.</returns>
		public override TList<KhoiLuongTamUng> Find(TransactionManager transactionManager, string whereClause, int start, int pageLength, out int count)
		{
			count = -1;
			if (whereClause.IndexOf(";") > -1)
				return new TList<KhoiLuongTamUng>();
	
			SqlDatabase database = new SqlDatabase(this._connectionString);
			DbCommand commandWrapper = StoredProcedureProvider.GetCommandWrapper(database, "dbo.sp_KhoiLuongTamUng_Find", _useStoredProcedure);
		...
		database.AddInParameter(commandWrapper, "@MaQuanLyGv", DbType.AnsiString, DBNull.Value);
		...
		database.AddInParameter(commandWrapper, "@NgonNguGiangDay", DbType.String, DBNull.Value);
	   		...
	   		foreach (string clause in clauses)
			{
				...
				if (clause.Trim().StartsWith("maquanlygv ") || clause.Trim().StartsWith("maquanlygv="))
				{
					database.SetParameterValue(commandWrapper, "@MaQuanLyGv", 
			...
			//Create Collection
			TList<KhoiLuongTamUng> rows = new TList<KhoiLuongTamUng>();
		...
		/// <param name="count">out. The number of rows that match this query.</param>
		/// <returns>Returns a typed collection of PMS.Entities.KhoiLuongTamUng objects.</returns>
		public override TList<KhoiLuongTamUng> Find(TransactionManager transactionManager, IFilterParameterCollection parameters, string orderBy, int start, int pageLength, out int count)
		{
			...
			SqlDatabase database = new SqlDatabase(this._connectionString);
			DbCommand commandWrapper = StoredProcedureProvider.GetCommandWrapper(database, "dbo.sp_KhoiLuongTamUng_Find_Dynamic", typeof(KhoiLuongTamUngColumn), filter, orderBy, start, pageLength);
        ...
        /// <exception cref="System.Data.DataException">The <paramref name="transactionManager"/> is not open.</exception>
        /// <exception cref="System.Data.Common.DbException">The command could not be executed.</exception>
		public override TList<KhoiLuongTamUng> GetAll(TransactionManager transactionManager, int start, int pageLength, out int count)
		{
			SqlDatabase database = new SqlDatabase(this._connectionString);
			DbCommand commandWrapper = StoredProcedureProvider.GetCommandWrapper(database, "dbo.sp_KhoiLuongTamUng_Get_List", _useStoredProcedure);
		...
		/// <remarks></remarks>
		/// <returns>Returns a typed collection of PMS.Entities.KhoiLuongTamUng objects.</returns>
		public override TList<KhoiLuongTamUng> GetPaged(TransactionManager transactionManager, string whereClause, string orderBy, int start, int pageLength, out int count)
		{
			SqlDatabase database = new SqlDatabase(this._connectionString);
			DbCommand commandWrapper = StoredProcedureProvider.GetCommandWrapper(database, "dbo.sp_KhoiLuongTamUng_GetPaged", _useStoredProcedure);
        ...
        /// <exception cref="System.Data.DataException">The <paramref name="transactionManager"/> is not open.</exception>
        /// <exception cref="System.Data.Common.DbException">The command could not be executed.</exception>
		public override PMS.Entities.KhoiLuongTamUng GetByMaKhoiLuong(TransactionManager transactionManager, System.Int32 _maKhoiLuong, int start, int pageLength, out int count)
		{
			SqlDatabase database = new SqlDatabase(this._connectionString);
			DbCommand commandWrapper = StoredProcedureProvider.GetCommandWrapper(database, "dbo.sp_KhoiLuongTamUng_GetByMaKhoiLuong", _useStoredProcedure);
			
				database.AddInParameter(commandWrapper, "@MaKhoiLuong", DbType.Int32, _maKhoiLuong);
			
			IDataReader reader = null;
			TList<KhoiLuongTamUng> tmp = new TList<KhoiLuongTamUng>();
			try
			{
				//Provider Data Requesting Command Event
		...
		/// <remarks>
		///		After inserting into the datasource, the PMS.Entities.KhoiLuongTamUng object will be updated
		/// 	to refelect any changes made by the datasource. (ie: identity or computed columns)
		/// </remarks>	
		public override void BulkInsert(TransactionManager transactionManager, TList<PMS.Entities.KhoiLuongTamUng> entities)
		{
			...
			bulkCopy.DestinationTableName = "KhoiLuongTamUng";
			...
			DataColumn col2 = dataTable.Columns.Add("MaQuanLyGv", typeof(System.String));
			...
			DataColumn col10 = dataTable.Columns.Add("SoLuong", typeof(System.Int32));
			col10.AllowDBNull = true;		
			DataColumn col11 = dataTable.Columns.Add("MaLoaiHocPhan", typeof(System.Byte));
			col11.AllowDBNull = true;		
			DataColumn col12 = dataTable.Columns.Add("LoaiHocPhan", typeof(System.String));
			col12.AllowDBNull = true;		
			DataColumn col13 = dataTable.Columns.Add("MaBuoiHoc", typeof(System.Int32));
			col13.AllowDBNull = true;		
			DataColumn col14 = dataTable.Columns.Add("MaLop", typeof(System.String));
			col14.AllowDBNull = true;		
			DataColumn col15 = dataTable.Columns.Add("TietBatDau", typeof(System.Int32));
			col15.AllowDBNull = true;		
			DataColumn col16 = dataTable.Columns.Add("SoTiet", typeof(System.Decimal));
			col16.AllowDBNull = true;		
			DataColumn col17 = dataTable.Columns.Add("TinhTrang", typeof(System.Int32));
			col17.AllowDBNull = true;		
			DataColumn col18 = dataTable.Columns.Add("NgayDay", typeof(System.DateTime));
			...
			DataColumn col23 = dataTable.Columns.Add("MaKhoaHoc", typeof(System.String));
			col23.AllowDBNull = true;		
			DataColumn col24 = dataTable.Columns.Add("LoaiHocKy", typeof(System.Byte));
			col24.AllowDBNull = true;		
			DataColumn col25 = dataTable.Columns.Add("NamThu", typeof(System.String));
			col25.AllowDBNull = true;		
			DataColumn col26 = dataTable.Columns.Add("MaHocHam", typeof(System.Int32));
			col26.AllowDBNull = true;		
			DataColumn col27 = dataTable.Columns.Add("MaHocVi", typeof(System.Int32));
			col27.AllowDBNull = true;		
			DataColumn col28 = dataTable.Columns.Add("MaLoaiGiangVien", typeof(System.Int32));
			col28.AllowDBNull = true;		
			DataColumn col29 = dataTable.Columns.Add("MaChucVu", typeof(System.Int32));
			col29.AllowDBNull = true;		
			DataColumn col30 = dataTable.Columns.Add("MaHinhThucDaoTao", typeof(System.String));
			col30.AllowDBNull = true;		
			DataColumn col31 = dataTable.Columns.Add("GhiChu", typeof(System.String));
			col31.AllowDBNull = true;		
			DataColumn col32 = dataTable.Columns.Add("LopHocPhanChuyenNganh", typeof(System.Boolean));
			col32.AllowDBNull = true;		
			DataColumn col33 = dataTable.Columns.Add("DotImport", typeof(System.String));
			col33.AllowDBNull = true;		
			DataColumn col34 = dataTable.Columns.Add("DaoTaoTinChi", typeof(System.Boolean));
			col34.AllowDBNull = true;		
			DataColumn col35 = dataTable.Columns.Add("NgonNguGiangDay", typeof(System.String));
			col35.AllowDBNull = true;		
			
			bulkCopy.ColumnMappings.Add("MaKhoiLuong", "MaKhoiLuong");
			bulkCopy.ColumnMappings.Add("MaLichHoc", "MaLichHoc");
			bulkCopy.ColumnMappings.Add("MaQuanLyGv", "MaQuanLyGv");
			...
			foreach(PMS.Entities.KhoiLuongTamUng entity in entities)
			{
				...
				DataRow row = dataTable.NewRow();
					...
					row["MaLichHoc"] = entity.MaLichHoc.HasValue ? (object) entity.MaLichHoc  : System.DBNull.Value;
							
				
					row["MaQuanLyGv"] = entity.MaQuanLyGv;
		...
		/// <summary>
		/// 	Inserts a PMS.Entities.KhoiLuongTamUng object into the datasource using a transaction.
		/// </summary>
		/// <param name="transactionManager"><see cref="TransactionManager"/> object</param>
		/// <param name="entity">PMS.Entities.KhoiLuongTamUng object to insert.</param>
		/// <remarks>
		///		After inserting into the datasource, the PMS.Entities.KhoiLuongTamUng object will be updated
		/// 	to refelect any changes made by the datasource. (ie: identity or computed columns)
		/// </remarks>	
        ...
        /// <exception cref="System.Data.DataException">The <paramref name="transactionManager"/> is not open.</exception>
        /// <exception cref="System.Data.Common.DbException">The command could not be executed.</exception>
		public override bool Insert(TransactionManager transactionManager, PMS.Entities.KhoiLuongTamUng entity)
		{
			SqlDatabase database = new SqlDatabase(this._connectionString);
			DbCommand commandWrapper = StoredProcedureProvider.GetCommandWrapper(database, "dbo.sp_KhoiLuongTamUng_Insert", _useStoredProcedure);
			
			database.AddOutParameter(commandWrapper, "@MaKhoiLuong", DbType.Int32, 4);
			database.AddInParameter(commandWrapper, "@MaLichHoc", DbType.Int32, (entity.MaLichHoc.HasValue ? (object) entity.MaLichHoc  : System.DBNull.Value));
            database.AddInParameter(commandWrapper, "@MaQuanLyGv", DbType.AnsiString, entity.MaQuanLyGv );
		...
		/// </summary>
		/// <param name="transactionManager"><see cref="TransactionManager"/> object</param>
		/// <param name="entity">PMS.Entities.KhoiLuongTamUng object to update.</param>
		/// <remarks>
		///		After updating the datasource, the PMS.Entities.KhoiLuongTamUng object will be updated
		/// 	to refelect any changes made by the datasource. (ie: identity or computed columns)
		/// </remarks>
		/// <returns>Returns true if operation is successful.</returns>
        /// <exception cref="System.Exception">The command could not be executed.</exception>
        /// <exception cref="System.Data.DataException">The <paramref name="transactionManager"/> is not open.</exception>
        /// <exception cref="System.Data.Common.DbException">The command could not be executed.</exception>
		public override bool Update(TransactionManager transactionManager, PMS.Entities.KhoiLuongTamUng entity)
		{
			SqlDatabase database = new SqlDatabase(this._connectionString);
			DbCommand commandWrapper = StoredProcedureProvider.GetCommandWrapper(database, "dbo.sp_KhoiLuongTamUng_Update", _useStoredProcedure);
		...
		/// <summary>
		///	This method wraps the 'cust_KhoiLuongTamUng_KiemTraDongBo' stored procedure. 
		/// </summary>	
		...
		{
			SqlDatabase database = new SqlDatabase(this._connectionString);
			DbCommand commandWrapper = StoredProcedureProvider.GetCommandWrapper(database, "dbo.cust_KhoiLuongTamUng_KiemTraDongBo", true);
		...
		/// <summary>
		///	This method wraps the 'cust_KhoiLuongTamUng_GetDuLieuThanhToanTamUng' stored procedure. 
		/// </summary>	
		/// <param name="namHoc"> A <c>System.String</c> instance.</param>
		/// <param name="hocKy"> A <c>System.String</c> instance.</param>
		...
		public override IDataReader GetDuLieuThanhToanTamUng(TransactionManager transactionManager, int start, int pageLength , System.String namHoc, System.String hocKy, System.String bacDaoTao, System.String loaiHinhDaoTao, System.String khoaDonVi, System.String loaiGiangVien)
		{
			SqlDatabase database = new SqlDatabase(this._connectionString);
			DbCommand commandWrapper = StoredProcedureProvider.GetCommandWrapper(database, "dbo.cust_KhoiLuongTamUng_GetDuLieuThanhToanTamUng", true);
			...
			IDataReader dr = null;
			//Provider Data Requesting Command Event
			OnDataRequesting(new CommandEventArgs(commandWrapper, "GetDuLieuThanhToanTamUng", (IEntity)null));
			...
			//Provider Data Requested Command Event
			OnDataRequested(new CommandEventArgs(commandWrapper, "GetDuLieuThanhToanTamUng", (IEntity)null));
		...
		/// <summary>
		///	This method wraps the 'cust_KhoiLuongTamUng_GetByNamHocHocKy' stored procedure. 
		/// </summary>	
		/// <param name="namHoc"> A <c>System.String</c> instance.</param>
		/// <param name="hocKy"> A <c>System.String</c> instance.</param>
		/// <param name="start">Row number at which to start reading.</param>
		...
		{
			SqlDatabase database = new SqlDatabase(this._connectionString);
			DbCommand commandWrapper = StoredProcedureProvider.GetCommandWrapper(database, "dbo.cust_KhoiLuongTamUng_GetByNamHocHocKy", true);
		...
		/// <summary>
		///	This method wraps the 'cust_KhoiLuongTamUng_GetListByNamHocHocKy' stored procedure. 
		/// </summary>	
		/// <param name="namHoc"> A <c>System.String</c> instance.</param>
		/// <param name="hocKy"> A <c>System.String</c> instance.</param>
		/// <param name="start">Row number at which to start reading.</param>
		...
		public override TList<KhoiLuongTamUng> GetListByNamHocHocKy(TransactionManager transactionManager, int start, int pageLength , System.String namHoc, System.String hocKy)
		{
			SqlDatabase database = new SqlDatabase(this._connectionString);
			DbCommand commandWrapper = StoredProcedureProvider.GetCommandWrapper(database, "dbo.cust_KhoiLuongTamUng_GetListByNamHocHocKy", true);
			...
			//Create Collection
				TList<KhoiLuongTamUng> rows = new TList<KhoiLuongTamUng>();
				//Provider Data Requesting Command Event
				OnDataRequesting(new CommandEventArgs(commandWrapper, "GetListByNamHocHocKy", rows));
				...
				//Provider Data Requested Command Event
				OnDataRequested(new CommandEventArgs(commandWrapper, "GetListByNamHocHocKy", rows));
		...
		/// <summary>
		///	This method wraps the 'cust_KhoiLuongTamUng_GetByNamHocHocKyLoaiGiangVien' stored procedure. 
		/// </summary>	
		/// <param name="namHoc"> A <c>System.String</c> instance.</param>
		/// <param name="hocKy"> A <c>System.String</c> instance.</param>
		/// <param name="loaiGiangVien"> A <c>System.String</c> instance.</param>
		...
		/// <remark>This method is generated from a stored procedure.</remark>
		/// <returns>A <see cref="IDataReader"/> instance.</returns>
		public override IDataReader GetByNamHocHocKyLoaiGiangVien(TransactionManager transactionManager, int start, int pageLength , System.String namHoc, System.String hocKy, System.String loaiGiangVien)
		{
			SqlDatabase database = new SqlDatabase(this._connectionString);
			DbCommand commandWrapper = StoredProcedureProvider.GetCommandWrapper(database, "dbo.cust_KhoiLuongTamUng_GetByNamHocHocKyLoaiGiangVien", true);
			...
			IDataReader dr = null;
			//Provider Data Requesting Command Event
			OnDataRequesting(new CommandEventArgs(commandWrapper, "GetByNamHocHocKyLoaiGiangVien", (IEntity)null));
			...
			//Provider Data Requested Command Event
			OnDataRequested(new CommandEventArgs(commandWrapper, "GetByNamHocHocKyLoaiGiangVien", (IEntity)null));
		...
		/// <summary>
		///	This method wraps the 'cust_KhoiLuongTamUng_DongBo' stored procedure. 
		/// </summary>	
		/// <param name="namHoc"> A <c>System.String</c> instance.</param>
		/// <param name="hocKy"> A <c>System.String</c> instance.</param>
		/// <param name="start">Row number at which to start reading.</param>
		...
		{
			SqlDatabase database = new SqlDatabase(this._connectionString);
			DbCommand commandWrapper = StoredProcedureProvider.GetCommandWrapper(database, "dbo.cust_KhoiLuongTamUng_DongBo", true);
