/*
	...
	Important: Do not modify this file. Edit the file SqlKcqPhanCongDoAnTotNghiepProvider.cs instead.
*/
...
namespace PMS.Data.SqlClient
{
	...
	///</summary>
	public abstract partial class SqlKcqPhanCongDoAnTotNghiepProviderBase : KcqPhanCongDoAnTotNghiepProviderBase
	{
		#region Declarations
		...
		/// <summary>
		/// Creates a new <see cref="SqlKcqPhanCongDoAnTotNghiepProviderBase"/> instance.
		/// </summary>
		public SqlKcqPhanCongDoAnTotNghiepProviderBase()
		{
		}
	...
	public SqlKcqPhanCongDoAnTotNghiepProviderBase(string connectionString, bool useStoredProcedure, string providerInvariantName)
	{
    ...
    public string ProviderInvariantName
    {
		...
		public override bool Delete(TransactionManager transactionManager, System.String _maLopHocPhan, System.String _maSinhVien)
		{
			...
			DbCommand commandWrapper = StoredProcedureProvider.GetCommandWrapper(database, "dbo.sp_KcqPhanCongDoAnTotNghiep_Delete", _useStoredProcedure);
			...
			{
				string entityKey = EntityLocator.ConstructKeyFromPkItems(typeof(KcqPhanCongDoAnTotNghiep)
		...
		/// <returns>Returns a typed collection of PMS.Entities.KcqPhanCongDoAnTotNghiep objects.</returns>
		public override TList<KcqPhanCongDoAnTotNghiep> Find(TransactionManager transactionManager, string whereClause, int start, int pageLength, out int count)
		{
			count = -1;
			if (whereClause.IndexOf(";") > -1)
				return new TList<KcqPhanCongDoAnTotNghiep>();
	
			SqlDatabase database = new SqlDatabase(this._connectionString);
			DbCommand commandWrapper = StoredProcedureProvider.GetCommandWrapper(database, "dbo.sp_KcqPhanCongDoAnTotNghiep_Find", _useStoredProcedure);
		...
		database.AddInParameter(commandWrapper, "@NgayCapNhat", DbType.DateTime, DBNull.Value);
			...
			//Create Collection
			TList<KcqPhanCongDoAnTotNghiep> rows = new TList<KcqPhanCongDoAnTotNghiep>();
		...
		/// <param name="count">out. The number of rows that match this query.</param>
		/// <returns>Returns a typed collection of PMS.Entities.KcqPhanCongDoAnTotNghiep objects.</returns>
		public override TList<KcqPhanCongDoAnTotNghiep> Find(TransactionManager transactionManager, IFilterParameterCollection parameters, string orderBy, int start, int pageLength, out int count)
		{
			...
			SqlDatabase database = new SqlDatabase(this._connectionString);
			DbCommand commandWrapper = StoredProcedureProvider.GetCommandWrapper(database, "dbo.sp_KcqPhanCongDoAnTotNghiep_Find_Dynamic", typeof(KcqPhanCongDoAnTotNghiepColumn), filter, orderBy, start, pageLength);
        ...
        /// <exception cref="System.Data.DataException">The <paramref name="transactionManager"/> is not open.</exception>
        /// <exception cref="System.Data.Common.DbException">The command could not be executed.</exception>
		public override TList<KcqPhanCongDoAnTotNghiep> GetAll(TransactionManager transactionManager, int start, int pageLength, out int count)
		{
			SqlDatabase database = new SqlDatabase(this._connectionString);
			DbCommand commandWrapper = StoredProcedureProvider.GetCommandWrapper(database, "dbo.sp_KcqPhanCongDoAnTotNghiep_Get_List", _useStoredProcedure);
		...
		/// <remarks></remarks>
		/// <returns>Returns a typed collection of PMS.Entities.KcqPhanCongDoAnTotNghiep objects.</returns>
		public override TList<KcqPhanCongDoAnTotNghiep> GetPaged(TransactionManager transactionManager, string whereClause, string orderBy, int start, int pageLength, out int count)
		{
			SqlDatabase database = new SqlDatabase(this._connectionString);
			DbCommand commandWrapper = StoredProcedureProvider.GetCommandWrapper(database, "dbo.sp_KcqPhanCongDoAnTotNghiep_GetPaged", _useStoredProcedure);
        ...
        /// <exception cref="System.Data.DataException">The <paramref name="transactionManager"/> is not open.</exception>
        /// <exception cref="System.Data.Common.DbException">The command could not be executed.</exception>
		public override PMS.Entities.KcqPhanCongDoAnTotNghiep GetByMaLopHocPhanMaSinhVien(TransactionManager transactionManager, System.String _maLopHocPhan, System.String _maSinhVien, int start, int pageLength, out int count)
		{
			SqlDatabase database = new SqlDatabase(this._connectionString);
			DbCommand commandWrapper = StoredProcedureProvider.GetCommandWrapper(database, "dbo.sp_KcqPhanCongDoAnTotNghiep_GetByMaLopHocPhanMaSinhVien", _useStoredProcedure);
			
				database.AddInParameter(commandWrapper, "@MaLopHocPhan", DbType.AnsiString, _maLopHocPhan);
				database.AddInParameter(commandWrapper, "@MaSinhVien", DbType.AnsiString, _maSinhVien);
			
			IDataReader reader = null;
			TList<KcqPhanCongDoAnTotNghiep> tmp = new TList<KcqPhanCongDoAnTotNghiep>();
			try
			{
				//Provider Data Requesting Command Event
		...
		/// <remarks>
		///		After inserting into the datasource, the PMS.Entities.KcqPhanCongDoAnTotNghiep object will be updated
		/// 	to refelect any changes made by the datasource. (ie: identity or computed columns)
		/// </remarks>	
		public override void BulkInsert(TransactionManager transactionManager, TList<PMS.Entities.KcqPhanCongDoAnTotNghiep> entities)
		{
			...
			bulkCopy.DestinationTableName = "KcqPhanCongDoAnTotNghiep";
			...
			foreach(PMS.Entities.KcqPhanCongDoAnTotNghiep entity in entities)
			{
		...
		/// <summary>
		/// 	Inserts a PMS.Entities.KcqPhanCongDoAnTotNghiep object into the datasource using a transaction.
		/// </summary>
		/// <param name="transactionManager"><see cref="TransactionManager"/> object</param>
		/// <param name="entity">PMS.Entities.KcqPhanCongDoAnTotNghiep object to insert.</param>
		/// <remarks>
		///		After inserting into the datasource, the PMS.Entities.KcqPhanCongDoAnTotNghiep object will be updated
		/// 	to refelect any changes made by the datasource. (ie: identity or computed columns)
		/// </remarks>	
        ...
        /// <exception cref="System.Data.DataException">The <paramref name="transactionManager"/> is not open.</exception>
        /// <exception cref="System.Data.Common.DbException">The command could not be executed.</exception>
		public override bool Insert(TransactionManager transactionManager, PMS.Entities.KcqPhanCongDoAnTotNghiep entity)
		{
			SqlDatabase database = new SqlDatabase(this._connectionString);
			DbCommand commandWrapper = StoredProcedureProvider.GetCommandWrapper(database, "dbo.sp_KcqPhanCongDoAnTotNghiep_Insert", _useStoredProcedure);
		...
		/// </summary>
		/// <param name="transactionManager"><see cref="TransactionManager"/> object</param>
		/// <param name="entity">PMS.Entities.KcqPhanCongDoAnTotNghiep object to update.</param>
		/// <remarks>
		///		After updating the datasource, the PMS.Entities.KcqPhanCongDoAnTotNghiep object will be updated
		/// 	to refelect any changes made by the datasource. (ie: identity or computed columns)
		/// </remarks>
		/// <returns>Returns true if operation is successful.</returns>
        /// <exception cref="System.Exception">The command could not be executed.</exception>
        /// <exception cref="System.Data.DataException">The <paramref name="transactionManager"/> is not open.</exception>
        /// <exception cref="System.Data.Common.DbException">The command could not be executed.</exception>
		public override bool Update(TransactionManager transactionManager, PMS.Entities.KcqPhanCongDoAnTotNghiep entity)
		{
			SqlDatabase database = new SqlDatabase(this._connectionString);
			DbCommand commandWrapper = StoredProcedureProvider.GetCommandWrapper(database, "dbo.sp_KcqPhanCongDoAnTotNghiep_Update", _useStoredProcedure);
