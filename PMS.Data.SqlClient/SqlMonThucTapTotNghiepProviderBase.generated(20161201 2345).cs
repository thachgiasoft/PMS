/*
	...
	Important: Do not modify this file. Edit the file SqlMonThucTapTotNghiepProvider.cs instead.
*/
...
namespace PMS.Data.SqlClient
{
	...
	///</summary>
	public abstract partial class SqlMonThucTapTotNghiepProviderBase : MonThucTapTotNghiepProviderBase
	{
		#region Declarations
		...
		/// <summary>
		/// Creates a new <see cref="SqlMonThucTapTotNghiepProviderBase"/> instance.
		/// </summary>
		public SqlMonThucTapTotNghiepProviderBase()
		{
		}
	...
	public SqlMonThucTapTotNghiepProviderBase(string connectionString, bool useStoredProcedure, string providerInvariantName)
	{
    ...
    public string ProviderInvariantName
    {
		...
		public override bool Delete(TransactionManager transactionManager, System.Int32 _id)
		{
			...
			DbCommand commandWrapper = StoredProcedureProvider.GetCommandWrapper(database, "dbo.sp_MonThucTapTotNghiep_Delete", _useStoredProcedure);
			...
			{
				string entityKey = EntityLocator.ConstructKeyFromPkItems(typeof(MonThucTapTotNghiep)
					,_id);
		...
		/// <returns>Returns a typed collection of PMS.Entities.MonThucTapTotNghiep objects.</returns>
		public override TList<MonThucTapTotNghiep> Find(TransactionManager transactionManager, string whereClause, int start, int pageLength, out int count)
		{
			count = -1;
			if (whereClause.IndexOf(";") > -1)
				return new TList<MonThucTapTotNghiep>();
	
			SqlDatabase database = new SqlDatabase(this._connectionString);
			DbCommand commandWrapper = StoredProcedureProvider.GetCommandWrapper(database, "dbo.sp_MonThucTapTotNghiep_Find", _useStoredProcedure);
		...
		database.AddInParameter(commandWrapper, "@NguoiCapNhat", DbType.String, DBNull.Value);
			...
			//Create Collection
			TList<MonThucTapTotNghiep> rows = new TList<MonThucTapTotNghiep>();
		...
		/// <param name="count">out. The number of rows that match this query.</param>
		/// <returns>Returns a typed collection of PMS.Entities.MonThucTapTotNghiep objects.</returns>
		public override TList<MonThucTapTotNghiep> Find(TransactionManager transactionManager, IFilterParameterCollection parameters, string orderBy, int start, int pageLength, out int count)
		{
			...
			SqlDatabase database = new SqlDatabase(this._connectionString);
			DbCommand commandWrapper = StoredProcedureProvider.GetCommandWrapper(database, "dbo.sp_MonThucTapTotNghiep_Find_Dynamic", typeof(MonThucTapTotNghiepColumn), filter, orderBy, start, pageLength);
        ...
        /// <exception cref="System.Data.DataException">The <paramref name="transactionManager"/> is not open.</exception>
        /// <exception cref="System.Data.Common.DbException">The command could not be executed.</exception>
		public override TList<MonThucTapTotNghiep> GetAll(TransactionManager transactionManager, int start, int pageLength, out int count)
		{
			SqlDatabase database = new SqlDatabase(this._connectionString);
			DbCommand commandWrapper = StoredProcedureProvider.GetCommandWrapper(database, "dbo.sp_MonThucTapTotNghiep_Get_List", _useStoredProcedure);
		...
		/// <remarks></remarks>
		/// <returns>Returns a typed collection of PMS.Entities.MonThucTapTotNghiep objects.</returns>
		public override TList<MonThucTapTotNghiep> GetPaged(TransactionManager transactionManager, string whereClause, string orderBy, int start, int pageLength, out int count)
		{
			SqlDatabase database = new SqlDatabase(this._connectionString);
			DbCommand commandWrapper = StoredProcedureProvider.GetCommandWrapper(database, "dbo.sp_MonThucTapTotNghiep_GetPaged", _useStoredProcedure);
        ...
        /// <exception cref="System.Data.DataException">The <paramref name="transactionManager"/> is not open.</exception>
        /// <exception cref="System.Data.Common.DbException">The command could not be executed.</exception>
		public override PMS.Entities.MonThucTapTotNghiep GetById(TransactionManager transactionManager, System.Int32 _id, int start, int pageLength, out int count)
		{
			SqlDatabase database = new SqlDatabase(this._connectionString);
			DbCommand commandWrapper = StoredProcedureProvider.GetCommandWrapper(database, "dbo.sp_MonThucTapTotNghiep_GetById", _useStoredProcedure);
			
				database.AddInParameter(commandWrapper, "@Id", DbType.Int32, _id);
			
			IDataReader reader = null;
			TList<MonThucTapTotNghiep> tmp = new TList<MonThucTapTotNghiep>();
			try
			{
				//Provider Data Requesting Command Event
		...
		/// <remarks>
		///		After inserting into the datasource, the PMS.Entities.MonThucTapTotNghiep object will be updated
		/// 	to refelect any changes made by the datasource. (ie: identity or computed columns)
		/// </remarks>	
		public override void BulkInsert(TransactionManager transactionManager, TList<PMS.Entities.MonThucTapTotNghiep> entities)
		{
			...
			bulkCopy.DestinationTableName = "MonThucTapTotNghiep";
			...
			DataColumn col4 = dataTable.Columns.Add("SoTuan", typeof(System.Int32));
			...
			foreach(PMS.Entities.MonThucTapTotNghiep entity in entities)
			{
		...
		/// <summary>
		/// 	Inserts a PMS.Entities.MonThucTapTotNghiep object into the datasource using a transaction.
		/// </summary>
		/// <param name="transactionManager"><see cref="TransactionManager"/> object</param>
		/// <param name="entity">PMS.Entities.MonThucTapTotNghiep object to insert.</param>
		/// <remarks>
		///		After inserting into the datasource, the PMS.Entities.MonThucTapTotNghiep object will be updated
		/// 	to refelect any changes made by the datasource. (ie: identity or computed columns)
		/// </remarks>	
        ...
        /// <exception cref="System.Data.DataException">The <paramref name="transactionManager"/> is not open.</exception>
        /// <exception cref="System.Data.Common.DbException">The command could not be executed.</exception>
		public override bool Insert(TransactionManager transactionManager, PMS.Entities.MonThucTapTotNghiep entity)
		{
			SqlDatabase database = new SqlDatabase(this._connectionString);
			DbCommand commandWrapper = StoredProcedureProvider.GetCommandWrapper(database, "dbo.sp_MonThucTapTotNghiep_Insert", _useStoredProcedure);
		...
		/// </summary>
		/// <param name="transactionManager"><see cref="TransactionManager"/> object</param>
		/// <param name="entity">PMS.Entities.MonThucTapTotNghiep object to update.</param>
		/// <remarks>
		///		After updating the datasource, the PMS.Entities.MonThucTapTotNghiep object will be updated
		/// 	to refelect any changes made by the datasource. (ie: identity or computed columns)
		/// </remarks>
		/// <returns>Returns true if operation is successful.</returns>
        /// <exception cref="System.Exception">The command could not be executed.</exception>
        /// <exception cref="System.Data.DataException">The <paramref name="transactionManager"/> is not open.</exception>
        /// <exception cref="System.Data.Common.DbException">The command could not be executed.</exception>
		public override bool Update(TransactionManager transactionManager, PMS.Entities.MonThucTapTotNghiep entity)
		{
			SqlDatabase database = new SqlDatabase(this._connectionString);
			DbCommand commandWrapper = StoredProcedureProvider.GetCommandWrapper(database, "dbo.sp_MonThucTapTotNghiep_Update", _useStoredProcedure);
		...
		/// <summary>
		///	This method wraps the 'cust_MonThucTapTotNghiep_GetByNamHocHocKy' stored procedure. 
		/// </summary>	
		...
		public override TList<MonThucTapTotNghiep> GetByNamHocHocKy(TransactionManager transactionManager, int start, int pageLength , System.String namHoc, System.String hocKy)
		{
			SqlDatabase database = new SqlDatabase(this._connectionString);
			DbCommand commandWrapper = StoredProcedureProvider.GetCommandWrapper(database, "dbo.cust_MonThucTapTotNghiep_GetByNamHocHocKy", true);
		...
		/// <summary>
		///	This method wraps the 'cust_MonThucTapTotNghiep_SaoChep' stored procedure. 
		/// </summary>	
		...
		{
			SqlDatabase database = new SqlDatabase(this._connectionString);
			DbCommand commandWrapper = StoredProcedureProvider.GetCommandWrapper(database, "dbo.cust_MonThucTapTotNghiep_SaoChep", true);
		...
		/// <summary>
		///	This method wraps the 'cust_MonThucTapTotNghiep_Luu' stored procedure. 
		/// </summary>	
		...
		{
			SqlDatabase database = new SqlDatabase(this._connectionString);
			DbCommand commandWrapper = StoredProcedureProvider.GetCommandWrapper(database, "dbo.cust_MonThucTapTotNghiep_Luu", true);
