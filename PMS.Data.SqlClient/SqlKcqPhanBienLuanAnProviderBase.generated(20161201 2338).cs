/*
	...
	Important: Do not modify this file. Edit the file SqlKcqPhanBienLuanAnProvider.cs instead.
*/
...
namespace PMS.Data.SqlClient
{
	...
	///</summary>
	public abstract partial class SqlKcqPhanBienLuanAnProviderBase : KcqPhanBienLuanAnProviderBase
	{
		#region Declarations
		...
		/// <summary>
		/// Creates a new <see cref="SqlKcqPhanBienLuanAnProviderBase"/> instance.
		/// </summary>
		public SqlKcqPhanBienLuanAnProviderBase()
		{
		}
	...
	public SqlKcqPhanBienLuanAnProviderBase(string connectionString, bool useStoredProcedure, string providerInvariantName)
	{
    ...
    public string ProviderInvariantName
    {
		...
		public override bool Delete(TransactionManager transactionManager, System.Int32 _maGiangVien, System.String _namHoc, System.String _hocKy, System.String _loai)
		{
			SqlDatabase database = new SqlDatabase(this._connectionString);
			DbCommand commandWrapper = StoredProcedureProvider.GetCommandWrapper(database, "dbo.sp_KcqPhanBienLuanAn_Delete", _useStoredProcedure);
			...
			{
				string entityKey = EntityLocator.ConstructKeyFromPkItems(typeof(KcqPhanBienLuanAn)
					,_maGiangVien,_namHoc,_hocKy,_loai);
		...
		/// <returns>Returns a typed collection of PMS.Entities.KcqPhanBienLuanAn objects.</returns>
		public override TList<KcqPhanBienLuanAn> Find(TransactionManager transactionManager, string whereClause, int start, int pageLength, out int count)
		{
			count = -1;
			if (whereClause.IndexOf(";") > -1)
				return new TList<KcqPhanBienLuanAn>();
	
			SqlDatabase database = new SqlDatabase(this._connectionString);
			DbCommand commandWrapper = StoredProcedureProvider.GetCommandWrapper(database, "dbo.sp_KcqPhanBienLuanAn_Find", _useStoredProcedure);
		...
		database.AddInParameter(commandWrapper, "@MaDot", DbType.String, DBNull.Value);
			...
			//Create Collection
			TList<KcqPhanBienLuanAn> rows = new TList<KcqPhanBienLuanAn>();
		...
		/// <param name="count">out. The number of rows that match this query.</param>
		/// <returns>Returns a typed collection of PMS.Entities.KcqPhanBienLuanAn objects.</returns>
		public override TList<KcqPhanBienLuanAn> Find(TransactionManager transactionManager, IFilterParameterCollection parameters, string orderBy, int start, int pageLength, out int count)
		{
			...
			SqlDatabase database = new SqlDatabase(this._connectionString);
			DbCommand commandWrapper = StoredProcedureProvider.GetCommandWrapper(database, "dbo.sp_KcqPhanBienLuanAn_Find_Dynamic", typeof(KcqPhanBienLuanAnColumn), filter, orderBy, start, pageLength);
        ...
        /// <exception cref="System.Data.DataException">The <paramref name="transactionManager"/> is not open.</exception>
        /// <exception cref="System.Data.Common.DbException">The command could not be executed.</exception>
		public override TList<KcqPhanBienLuanAn> GetAll(TransactionManager transactionManager, int start, int pageLength, out int count)
		{
			SqlDatabase database = new SqlDatabase(this._connectionString);
			DbCommand commandWrapper = StoredProcedureProvider.GetCommandWrapper(database, "dbo.sp_KcqPhanBienLuanAn_Get_List", _useStoredProcedure);
		...
		/// <remarks></remarks>
		/// <returns>Returns a typed collection of PMS.Entities.KcqPhanBienLuanAn objects.</returns>
		public override TList<KcqPhanBienLuanAn> GetPaged(TransactionManager transactionManager, string whereClause, string orderBy, int start, int pageLength, out int count)
		{
			SqlDatabase database = new SqlDatabase(this._connectionString);
			DbCommand commandWrapper = StoredProcedureProvider.GetCommandWrapper(database, "dbo.sp_KcqPhanBienLuanAn_GetPaged", _useStoredProcedure);
		...
		#region GetByMaGiangVienNamHocHocKyLoai
        ...
        /// <exception cref="System.Data.DataException">The <paramref name="transactionManager"/> is not open.</exception>
        /// <exception cref="System.Data.Common.DbException">The command could not be executed.</exception>
		public override PMS.Entities.KcqPhanBienLuanAn GetByMaGiangVienNamHocHocKyLoai(TransactionManager transactionManager, System.Int32 _maGiangVien, System.String _namHoc, System.String _hocKy, System.String _loai, int start, int pageLength, out int count)
		{
			SqlDatabase database = new SqlDatabase(this._connectionString);
			DbCommand commandWrapper = StoredProcedureProvider.GetCommandWrapper(database, "dbo.sp_KcqPhanBienLuanAn_GetByMaGiangVienNamHocHocKyLoai", _useStoredProcedure);
			...
			IDataReader reader = null;
			TList<KcqPhanBienLuanAn> tmp = new TList<KcqPhanBienLuanAn>();
			try
			{
				//Provider Data Requesting Command Event
				OnDataRequesting(new CommandEventArgs(commandWrapper, "GetByMaGiangVienNamHocHocKyLoai", tmp)); 
				...
				//Provider Data Requested Command Event
				OnDataRequested(new CommandEventArgs(commandWrapper, "GetByMaGiangVienNamHocHocKyLoai", tmp));
			}
			finally 
			{
				if (reader != null) 
		...
		/// <remarks>
		///		After inserting into the datasource, the PMS.Entities.KcqPhanBienLuanAn object will be updated
		/// 	to refelect any changes made by the datasource. (ie: identity or computed columns)
		/// </remarks>	
		public override void BulkInsert(TransactionManager transactionManager, TList<PMS.Entities.KcqPhanBienLuanAn> entities)
		{
			...
			bulkCopy.DestinationTableName = "KcqPhanBienLuanAn";
			...
			DataColumn col14 = dataTable.Columns.Add("MaDot", typeof(System.String));
			...
			foreach(PMS.Entities.KcqPhanBienLuanAn entity in entities)
			{
		...
		/// <summary>
		/// 	Inserts a PMS.Entities.KcqPhanBienLuanAn object into the datasource using a transaction.
		/// </summary>
		/// <param name="transactionManager"><see cref="TransactionManager"/> object</param>
		/// <param name="entity">PMS.Entities.KcqPhanBienLuanAn object to insert.</param>
		/// <remarks>
		///		After inserting into the datasource, the PMS.Entities.KcqPhanBienLuanAn object will be updated
		/// 	to refelect any changes made by the datasource. (ie: identity or computed columns)
		/// </remarks>	
        ...
        /// <exception cref="System.Data.DataException">The <paramref name="transactionManager"/> is not open.</exception>
        /// <exception cref="System.Data.Common.DbException">The command could not be executed.</exception>
		public override bool Insert(TransactionManager transactionManager, PMS.Entities.KcqPhanBienLuanAn entity)
		{
			SqlDatabase database = new SqlDatabase(this._connectionString);
			DbCommand commandWrapper = StoredProcedureProvider.GetCommandWrapper(database, "dbo.sp_KcqPhanBienLuanAn_Insert", _useStoredProcedure);
		...
		/// </summary>
		/// <param name="transactionManager"><see cref="TransactionManager"/> object</param>
		/// <param name="entity">PMS.Entities.KcqPhanBienLuanAn object to update.</param>
		/// <remarks>
		///		After updating the datasource, the PMS.Entities.KcqPhanBienLuanAn object will be updated
		/// 	to refelect any changes made by the datasource. (ie: identity or computed columns)
		/// </remarks>
		/// <returns>Returns true if operation is successful.</returns>
        /// <exception cref="System.Exception">The command could not be executed.</exception>
        /// <exception cref="System.Data.DataException">The <paramref name="transactionManager"/> is not open.</exception>
        /// <exception cref="System.Data.Common.DbException">The command could not be executed.</exception>
		public override bool Update(TransactionManager transactionManager, PMS.Entities.KcqPhanBienLuanAn entity)
		{
			SqlDatabase database = new SqlDatabase(this._connectionString);
			DbCommand commandWrapper = StoredProcedureProvider.GetCommandWrapper(database, "dbo.sp_KcqPhanBienLuanAn_Update", _useStoredProcedure);
		...
		/// <summary>
		///	This method wraps the 'cust_KcqPhanBienLuanAn_Luu' stored procedure. 
		/// </summary>	
		...
		{
			SqlDatabase database = new SqlDatabase(this._connectionString);
			DbCommand commandWrapper = StoredProcedureProvider.GetCommandWrapper(database, "dbo.cust_KcqPhanBienLuanAn_Luu", true);
