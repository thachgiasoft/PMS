/*
	...
	Important: Do not modify this file. Edit the file SqlMonPhanCongNhieuGiangVienProvider.cs instead.
*/
...
namespace PMS.Data.SqlClient
{
	...
	///</summary>
	public abstract partial class SqlMonPhanCongNhieuGiangVienProviderBase : MonPhanCongNhieuGiangVienProviderBase
	{
		#region Declarations
		...
		/// <summary>
		/// Creates a new <see cref="SqlMonPhanCongNhieuGiangVienProviderBase"/> instance.
		/// </summary>
		public SqlMonPhanCongNhieuGiangVienProviderBase()
		{
		}
	...
	public SqlMonPhanCongNhieuGiangVienProviderBase(string connectionString, bool useStoredProcedure, string providerInvariantName)
	{
    ...
    public string ProviderInvariantName
    {
		...
		public override bool Delete(TransactionManager transactionManager, System.Int32 _id)
		{
			...
			DbCommand commandWrapper = StoredProcedureProvider.GetCommandWrapper(database, "dbo.sp_MonPhanCongNhieuGiangVien_Delete", _useStoredProcedure);
			...
			{
				string entityKey = EntityLocator.ConstructKeyFromPkItems(typeof(MonPhanCongNhieuGiangVien)
					,_id);
		...
		/// <returns>Returns a typed collection of PMS.Entities.MonPhanCongNhieuGiangVien objects.</returns>
		public override TList<MonPhanCongNhieuGiangVien> Find(TransactionManager transactionManager, string whereClause, int start, int pageLength, out int count)
		{
			count = -1;
			if (whereClause.IndexOf(";") > -1)
				return new TList<MonPhanCongNhieuGiangVien>();
	
			SqlDatabase database = new SqlDatabase(this._connectionString);
			DbCommand commandWrapper = StoredProcedureProvider.GetCommandWrapper(database, "dbo.sp_MonPhanCongNhieuGiangVien_Find", _useStoredProcedure);
		...
		database.AddInParameter(commandWrapper, "@NgayCapNhat", DbType.DateTime, DBNull.Value);
			...
			//Create Collection
			TList<MonPhanCongNhieuGiangVien> rows = new TList<MonPhanCongNhieuGiangVien>();
		...
		/// <param name="count">out. The number of rows that match this query.</param>
		/// <returns>Returns a typed collection of PMS.Entities.MonPhanCongNhieuGiangVien objects.</returns>
		public override TList<MonPhanCongNhieuGiangVien> Find(TransactionManager transactionManager, IFilterParameterCollection parameters, string orderBy, int start, int pageLength, out int count)
		{
			...
			SqlDatabase database = new SqlDatabase(this._connectionString);
			DbCommand commandWrapper = StoredProcedureProvider.GetCommandWrapper(database, "dbo.sp_MonPhanCongNhieuGiangVien_Find_Dynamic", typeof(MonPhanCongNhieuGiangVienColumn), filter, orderBy, start, pageLength);
        ...
        /// <exception cref="System.Data.DataException">The <paramref name="transactionManager"/> is not open.</exception>
        /// <exception cref="System.Data.Common.DbException">The command could not be executed.</exception>
		public override TList<MonPhanCongNhieuGiangVien> GetAll(TransactionManager transactionManager, int start, int pageLength, out int count)
		{
			SqlDatabase database = new SqlDatabase(this._connectionString);
			DbCommand commandWrapper = StoredProcedureProvider.GetCommandWrapper(database, "dbo.sp_MonPhanCongNhieuGiangVien_Get_List", _useStoredProcedure);
		...
		/// <remarks></remarks>
		/// <returns>Returns a typed collection of PMS.Entities.MonPhanCongNhieuGiangVien objects.</returns>
		public override TList<MonPhanCongNhieuGiangVien> GetPaged(TransactionManager transactionManager, string whereClause, string orderBy, int start, int pageLength, out int count)
		{
			SqlDatabase database = new SqlDatabase(this._connectionString);
			DbCommand commandWrapper = StoredProcedureProvider.GetCommandWrapper(database, "dbo.sp_MonPhanCongNhieuGiangVien_GetPaged", _useStoredProcedure);
        ...
        /// <exception cref="System.Data.DataException">The <paramref name="transactionManager"/> is not open.</exception>
        /// <exception cref="System.Data.Common.DbException">The command could not be executed.</exception>
		public override PMS.Entities.MonPhanCongNhieuGiangVien GetById(TransactionManager transactionManager, System.Int32 _id, int start, int pageLength, out int count)
		{
			SqlDatabase database = new SqlDatabase(this._connectionString);
			DbCommand commandWrapper = StoredProcedureProvider.GetCommandWrapper(database, "dbo.sp_MonPhanCongNhieuGiangVien_GetById", _useStoredProcedure);
			
				database.AddInParameter(commandWrapper, "@Id", DbType.Int32, _id);
			
			IDataReader reader = null;
			TList<MonPhanCongNhieuGiangVien> tmp = new TList<MonPhanCongNhieuGiangVien>();
			try
			{
				//Provider Data Requesting Command Event
		...
		/// <remarks>
		///		After inserting into the datasource, the PMS.Entities.MonPhanCongNhieuGiangVien object will be updated
		/// 	to refelect any changes made by the datasource. (ie: identity or computed columns)
		/// </remarks>	
		public override void BulkInsert(TransactionManager transactionManager, TList<PMS.Entities.MonPhanCongNhieuGiangVien> entities)
		{
			...
			bulkCopy.DestinationTableName = "MonPhanCongNhieuGiangVien";
			...
			foreach(PMS.Entities.MonPhanCongNhieuGiangVien entity in entities)
			{
		...
		/// <summary>
		/// 	Inserts a PMS.Entities.MonPhanCongNhieuGiangVien object into the datasource using a transaction.
		/// </summary>
		/// <param name="transactionManager"><see cref="TransactionManager"/> object</param>
		/// <param name="entity">PMS.Entities.MonPhanCongNhieuGiangVien object to insert.</param>
		/// <remarks>
		///		After inserting into the datasource, the PMS.Entities.MonPhanCongNhieuGiangVien object will be updated
		/// 	to refelect any changes made by the datasource. (ie: identity or computed columns)
		/// </remarks>	
        ...
        /// <exception cref="System.Data.DataException">The <paramref name="transactionManager"/> is not open.</exception>
        /// <exception cref="System.Data.Common.DbException">The command could not be executed.</exception>
		public override bool Insert(TransactionManager transactionManager, PMS.Entities.MonPhanCongNhieuGiangVien entity)
		{
			SqlDatabase database = new SqlDatabase(this._connectionString);
			DbCommand commandWrapper = StoredProcedureProvider.GetCommandWrapper(database, "dbo.sp_MonPhanCongNhieuGiangVien_Insert", _useStoredProcedure);
		...
		/// </summary>
		/// <param name="transactionManager"><see cref="TransactionManager"/> object</param>
		/// <param name="entity">PMS.Entities.MonPhanCongNhieuGiangVien object to update.</param>
		/// <remarks>
		///		After updating the datasource, the PMS.Entities.MonPhanCongNhieuGiangVien object will be updated
		/// 	to refelect any changes made by the datasource. (ie: identity or computed columns)
		/// </remarks>
		/// <returns>Returns true if operation is successful.</returns>
        /// <exception cref="System.Exception">The command could not be executed.</exception>
        /// <exception cref="System.Data.DataException">The <paramref name="transactionManager"/> is not open.</exception>
        /// <exception cref="System.Data.Common.DbException">The command could not be executed.</exception>
		public override bool Update(TransactionManager transactionManager, PMS.Entities.MonPhanCongNhieuGiangVien entity)
		{
			SqlDatabase database = new SqlDatabase(this._connectionString);
			DbCommand commandWrapper = StoredProcedureProvider.GetCommandWrapper(database, "dbo.sp_MonPhanCongNhieuGiangVien_Update", _useStoredProcedure);
		...
		/// <summary>
		///	This method wraps the 'cust_MonPhanCongNhieuGiangVien_GetByNamHocHocKy' stored procedure. 
		/// </summary>	
		...
		public override TList<MonPhanCongNhieuGiangVien> GetByNamHocHocKy(TransactionManager transactionManager, int start, int pageLength , System.String namHoc, System.String hocKy)
		{
			SqlDatabase database = new SqlDatabase(this._connectionString);
			DbCommand commandWrapper = StoredProcedureProvider.GetCommandWrapper(database, "dbo.cust_MonPhanCongNhieuGiangVien_GetByNamHocHocKy", true);
