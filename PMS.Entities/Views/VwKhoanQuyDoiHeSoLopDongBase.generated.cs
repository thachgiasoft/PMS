...
namespace PMS.Entities
{
	...
	[Serializable]
	[CLSCompliant(true)]
	[ToolboxItem("VwKhoanQuyDoiHeSoLopDongBase")]
	public abstract partial class VwKhoanQuyDoiHeSoLopDongBase : System.IComparable, System.ICloneable, INotifyPropertyChanged
	{
		...
		#region Constructors
		///<summary>
		/// Creates a new <see cref="VwKhoanQuyDoiHeSoLopDongBase"/> instance.
		///</summary>
		public VwKhoanQuyDoiHeSoLopDongBase()
		{
		}		
		...
		public VwKhoanQuyDoiHeSoLopDongBase(System.Int32? _tuKhoan, System.Int32? _denKhoan, System.Decimal? _heSo, System.Int32? _thuTu)
		{
		...
		{
			VwKhoanQuyDoiHeSoLopDong newVwKhoanQuyDoiHeSoLopDong = new VwKhoanQuyDoiHeSoLopDong();
			newVwKhoanQuyDoiHeSoLopDong.TuKhoan = _tuKhoan;
			newVwKhoanQuyDoiHeSoLopDong.DenKhoan = _denKhoan;
			newVwKhoanQuyDoiHeSoLopDong.HeSo = _heSo;
			newVwKhoanQuyDoiHeSoLopDong.ThuTu = _thuTu;
			return newVwKhoanQuyDoiHeSoLopDong;
		}
		...
		{
			get { return "vw_KhoanQuyDoiHeSoLopDong"; }
		}
		...
		///<summary>
		///  Returns a Typed VwKhoanQuyDoiHeSoLopDongBase Entity 
		///</summary>
		public virtual VwKhoanQuyDoiHeSoLopDongBase Copy()
		{
			//shallow copy entity
			VwKhoanQuyDoiHeSoLopDong copy = new VwKhoanQuyDoiHeSoLopDong();
				copy.TuKhoan = this.TuKhoan;
				copy.DenKhoan = this.DenKhoan;
				copy.HeSo = this.HeSo;
				copy.ThuTu = this.ThuTu;
			copy.AcceptChanges();
			return (VwKhoanQuyDoiHeSoLopDong)copy;
		}
		...
		///<returns>true if toObject is a <see cref="VwKhoanQuyDoiHeSoLopDongBase"/> and has the same value as this instance; otherwise, false.</returns>
		public virtual bool Equals(VwKhoanQuyDoiHeSoLopDongBase toObject)
		{
			if (toObject == null)
				return false;
		...
		///<summary>
		/// Determines whether the specified <see cref="VwKhoanQuyDoiHeSoLopDongBase"/> instances are considered equal.
		///</summary>
		///<param name="Object1">The first <see cref="VwKhoanQuyDoiHeSoLopDongBase"/> to compare.</param>
		///<param name="Object2">The second <see cref="VwKhoanQuyDoiHeSoLopDongBase"/> to compare. </param>
		///<returns>true if Object1 is the same instance as Object2 or if both are null references or if objA.Equals(objB) returns true; otherwise, false.</returns>
		public static bool Equals(VwKhoanQuyDoiHeSoLopDongBase Object1, VwKhoanQuyDoiHeSoLopDongBase Object2)
		{
			// both are null
      ...
      /// <param name="e">PropertyChangedEventArgs</param>
		...
		/// <returns></returns>
		public static object GetPropertyValueByName(VwKhoanQuyDoiHeSoLopDong entity, string propertyName)
		{
			switch (propertyName)
			{
				case "TuKhoan":
		...
		{			
			return GetPropertyValueByName(this as VwKhoanQuyDoiHeSoLopDong, propertyName);
		}
	...
	/// <summary>
	/// Enumerate the VwKhoanQuyDoiHeSoLopDong columns.
	/// </summary>
	[Serializable]
	public enum VwKhoanQuyDoiHeSoLopDongColumn
	{
		/// <summary>
		/// TuKhoan : 
		/// </summary>
