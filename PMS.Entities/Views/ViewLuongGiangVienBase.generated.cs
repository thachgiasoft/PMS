...
{
	///<summary>
	/// An object representation of the 'View_Luong_GiangVien' view. [No description found in the database]	
	///</summary>
	[Serializable]
	[CLSCompliant(true)]
	[ToolboxItem("ViewLuongGiangVienBase")]
	public abstract partial class ViewLuongGiangVienBase : System.IComparable, System.ICloneable, INotifyPropertyChanged
	{
		...
		/// ThueTNCN : 
		/// </summary>
		private System.Decimal?		  _thueTncn = null;
		...
		#region Constructors
		///<summary>
		/// Creates a new <see cref="ViewLuongGiangVienBase"/> instance.
		///</summary>
		public ViewLuongGiangVienBase()
		{
		}		
		...
		{
			ViewLuongGiangVien newViewLuongGiangVien = new ViewLuongGiangVien();
			newViewLuongGiangVien.MaGiangVien = _maGiangVien;
			newViewLuongGiangVien.Ho = _ho;
			newViewLuongGiangVien.Ten = _ten;
			newViewLuongGiangVien.SoTaiKhoan = _soTaiKhoan;
			newViewLuongGiangVien.MaLop = _maLop;
			newViewLuongGiangVien.TenLop = _tenLop;
			newViewLuongGiangVien.MaMonHoc = _maMonHoc;
			newViewLuongGiangVien.TenMonHoc = _tenMonHoc;
			newViewLuongGiangVien.NgayBatDau = _ngayBatDau;
			newViewLuongGiangVien.NgayKetThuc = _ngayKetThuc;
			newViewLuongGiangVien.TietQuyDoi = _tietQuyDoi;
			newViewLuongGiangVien.SiSoLop = _siSoLop;
			newViewLuongGiangVien.SoTien = _soTien;
			newViewLuongGiangVien.ThanhTien = _thanhTien;
			newViewLuongGiangVien.TongTien = _tongTien;
			newViewLuongGiangVien.ThueTncn = _thueTncn;
			newViewLuongGiangVien.TienThucNhan = _tienThucNhan;
			newViewLuongGiangVien.MaBacDaoTao = _maBacDaoTao;
			newViewLuongGiangVien.MaHeDaoTao = _maHeDaoTao;
			newViewLuongGiangVien.MaVaiTroGiangDay = _maVaiTroGiangDay;
			newViewLuongGiangVien.MaLopHocPhan = _maLopHocPhan;
			return newViewLuongGiangVien;
		}
		...
		{
			get { return "View_Luong_GiangVien"; }
		}
		...
		///<summary>
		///  Returns a Typed ViewLuongGiangVienBase Entity 
		///</summary>
		public virtual ViewLuongGiangVienBase Copy()
		{
			//shallow copy entity
			ViewLuongGiangVien copy = new ViewLuongGiangVien();
			...
			copy.AcceptChanges();
			return (ViewLuongGiangVien)copy;
		}
		...
		///<returns>true if toObject is a <see cref="ViewLuongGiangVienBase"/> and has the same value as this instance; otherwise, false.</returns>
		public virtual bool Equals(ViewLuongGiangVienBase toObject)
		{
			if (toObject == null)
				return false;
		...
		///<summary>
		/// Determines whether the specified <see cref="ViewLuongGiangVienBase"/> instances are considered equal.
		///</summary>
		///<param name="Object1">The first <see cref="ViewLuongGiangVienBase"/> to compare.</param>
		///<param name="Object2">The second <see cref="ViewLuongGiangVienBase"/> to compare. </param>
		///<returns>true if Object1 is the same instance as Object2 or if both are null references or if objA.Equals(objB) returns true; otherwise, false.</returns>
		public static bool Equals(ViewLuongGiangVienBase Object1, ViewLuongGiangVienBase Object2)
		{
			// both are null
      ...
      /// <param name="e">PropertyChangedEventArgs</param>
		...
		/// <returns></returns>
		public static object GetPropertyValueByName(ViewLuongGiangVien entity, string propertyName)
		{
			switch (propertyName)
			{
				case "MaGiangVien":
		...
		{			
			return GetPropertyValueByName(this as ViewLuongGiangVien, propertyName);
		}
		...
		public override string ToString()
		{
			return string.Format(System.Globalization.CultureInfo.InvariantCulture,
				"{22}{21}- MaGiangVien: {0}{21}- Ho: {1}{21}- Ten: {2}{21}- SoTaiKhoan: {3}{21}- MaLop: {4}{21}- TenLop: {5}{21}- MaMonHoc: {6}{21}- TenMonHoc: {7}{21}- NgayBatDau: {8}{21}- NgayKetThuc: {9}{21}- TietQuyDoi: {10}{21}- SiSoLop: {11}{21}- SoTien: {12}{21}- ThanhTien: {13}{21}- TongTien: {14}{21}- ThueTncn: {15}{21}- TienThucNhan: {16}{21}- MaBacDaoTao: {17}{21}- MaHeDaoTao: {18}{21}- MaVaiTroGiangDay: {19}{21}- MaLopHocPhan: {20}{21}", 
				this.MaGiangVien,
	...
	/// <summary>
	/// Enumerate the ViewLuongGiangVien columns.
	/// </summary>
	[Serializable]
	public enum ViewLuongGiangVienColumn
	{
		/// <summary>
		/// MaGiangVien : 
		/// </summary>
		...
		[ColumnEnum("ThanhTien", typeof(System.Decimal), System.Data.DbType.Currency, false, false, true)]
		ThanhTien,
		/// <summary>
		/// TongTien : 
		/// </summary>
		[EnumTextValue("TongTien")]
		[ColumnEnum("TongTien", typeof(System.Decimal), System.Data.DbType.Currency, false, false, true)]
		TongTien,
		/// <summary>
		/// ThueTNCN : 
		/// </summary>
		[EnumTextValue("ThueTNCN")]
		[ColumnEnum("ThueTNCN", typeof(System.Decimal), System.Data.DbType.Currency, false, false, true)]
		ThueTncn,
		/// <summary>
		/// TienThucNhan : 
		/// </summary>
		[EnumTextValue("TienThucNhan")]
		[ColumnEnum("TienThucNhan", typeof(System.Decimal), System.Data.DbType.Currency, false, false, true)]
		TienThucNhan,
		/// <summary>
		/// MaBacDaoTao : 
		/// </summary>
