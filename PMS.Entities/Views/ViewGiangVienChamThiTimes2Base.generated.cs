...
{
	///<summary>
	/// An object representation of the 'View_GiangVien_ChamThi_Times2' view. [No description found in the database]	
	///</summary>
	[Serializable]
	[CLSCompliant(true)]
	[ToolboxItem("ViewGiangVienChamThiTimes2Base")]
	public abstract partial class ViewGiangVienChamThiTimes2Base : System.IComparable, System.ICloneable, INotifyPropertyChanged
	{
		...
		/// DonGia : 
		/// </summary>
		private System.String		  _donGia = null;
		...
		#region Constructors
		///<summary>
		/// Creates a new <see cref="ViewGiangVienChamThiTimes2Base"/> instance.
		///</summary>
		public ViewGiangVienChamThiTimes2Base()
		{
		}		
		...
		{
			ViewGiangVienChamThiTimes2 newViewGiangVienChamThiTimes2 = new ViewGiangVienChamThiTimes2();
			newViewGiangVienChamThiTimes2.MaChiTietChamThi = _maChiTietChamThi;
			newViewGiangVienChamThiTimes2.MaKyThi = _maKyThi;
			newViewGiangVienChamThiTimes2.MaLopHocPhan = _maLopHocPhan;
			newViewGiangVienChamThiTimes2.MaGiangVienChamThi = _maGiangVienChamThi;
			newViewGiangVienChamThiTimes2.HoTen = _hoTen;
			newViewGiangVienChamThiTimes2.SoBaiThiDaCham = _soBaiThiDaCham;
			newViewGiangVienChamThiTimes2.SiSoLop = _siSoLop;
			newViewGiangVienChamThiTimes2.HocKy = _hocKy;
			newViewGiangVienChamThiTimes2.NamHoc = _namHoc;
			newViewGiangVienChamThiTimes2.NoiLamViec = _noiLamViec;
			newViewGiangVienChamThiTimes2.MaMonHoc = _maMonHoc;
			newViewGiangVienChamThiTimes2.TenMonHoc = _tenMonHoc;
			newViewGiangVienChamThiTimes2.DonGia = _donGia;
			newViewGiangVienChamThiTimes2.ThanhTienTruocThue = _thanhTienTruocThue;
			newViewGiangVienChamThiTimes2.Thue10 = _thue10;
			newViewGiangVienChamThiTimes2.ThanhTienSauThue = _thanhTienSauThue;
			return newViewGiangVienChamThiTimes2;
		}
		...
		/// </remarks>
		[DescriptionAttribute(""), System.ComponentModel.Bindable( System.ComponentModel.BindableSupport.Yes)]
		public virtual System.String DonGia
		{
			get
			{
				return this._donGia; 
		...
		{
			get { return "View_GiangVien_ChamThi_Times2"; }
		}
		...
		///<summary>
		///  Returns a Typed ViewGiangVienChamThiTimes2Base Entity 
		///</summary>
		public virtual ViewGiangVienChamThiTimes2Base Copy()
		{
			//shallow copy entity
			ViewGiangVienChamThiTimes2 copy = new ViewGiangVienChamThiTimes2();
			...
			copy.AcceptChanges();
			return (ViewGiangVienChamThiTimes2)copy;
		}
		...
		///<returns>true if toObject is a <see cref="ViewGiangVienChamThiTimes2Base"/> and has the same value as this instance; otherwise, false.</returns>
		public virtual bool Equals(ViewGiangVienChamThiTimes2Base toObject)
		{
			if (toObject == null)
				return false;
		...
		///<summary>
		/// Determines whether the specified <see cref="ViewGiangVienChamThiTimes2Base"/> instances are considered equal.
		///</summary>
		///<param name="Object1">The first <see cref="ViewGiangVienChamThiTimes2Base"/> to compare.</param>
		///<param name="Object2">The second <see cref="ViewGiangVienChamThiTimes2Base"/> to compare. </param>
		///<returns>true if Object1 is the same instance as Object2 or if both are null references or if objA.Equals(objB) returns true; otherwise, false.</returns>
		public static bool Equals(ViewGiangVienChamThiTimes2Base Object1, ViewGiangVienChamThiTimes2Base Object2)
		{
			// both are null
      ...
      /// <param name="e">PropertyChangedEventArgs</param>
		...
		/// <returns></returns>
		public static object GetPropertyValueByName(ViewGiangVienChamThiTimes2 entity, string propertyName)
		{
			switch (propertyName)
			{
		...
		{			
			return GetPropertyValueByName(this as ViewGiangVienChamThiTimes2, propertyName);
		}
		...
		public override string ToString()
		{
			return string.Format(System.Globalization.CultureInfo.InvariantCulture,
				"{17}{16}- MaChiTietChamThi: {0}{16}- MaKyThi: {1}{16}- MaLopHocPhan: {2}{16}- MaGiangVienChamThi: {3}{16}- HoTen: {4}{16}- SoBaiThiDaCham: {5}{16}- SiSoLop: {6}{16}- HocKy: {7}{16}- NamHoc: {8}{16}- NoiLamViec: {9}{16}- MaMonHoc: {10}{16}- TenMonHoc: {11}{16}- DonGia: {12}{16}- ThanhTienTruocThue: {13}{16}- Thue10: {14}{16}- ThanhTienSauThue: {15}{16}", 
	...
	/// <summary>
	/// Enumerate the ViewGiangVienChamThiTimes2 columns.
	/// </summary>
	[Serializable]
	public enum ViewGiangVienChamThiTimes2Column
	{
		/// <summary>
		/// MaChiTietChamThi : 
		/// </summary>
		...
		[ColumnEnum("DonGia", typeof(System.String), System.Data.DbType.String, false, false, true, 1024)]
		DonGia,
		/// <summary>
		/// ThanhTienTruocThue : 
		/// </summary>
