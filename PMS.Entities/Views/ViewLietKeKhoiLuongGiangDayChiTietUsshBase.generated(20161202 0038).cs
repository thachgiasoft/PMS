      ...
      /// <param name="e">PropertyChangedEventArgs</param>
		...
		public override string ToString()
		{
			return string.Format(System.Globalization.CultureInfo.InvariantCulture,
				"{49}{48}- MaQuanLy: {0}{48}- Ho: {1}{48}- Ten: {2}{48}- HoTen: {3}{48}- MaHocHam: {4}{48}- MaHocVi: {5}{48}- MaLoaiGiangVien: {6}{48}- MaDonVi: {7}{48}- NamHoc: {8}{48}- HocKy: {9}{48}- LoaiHocPhan: {10}{48}- MaMonHoc: {11}{48}- TenMonHoc: {12}{48}- Nhom: {13}{48}- MaLop: {14}{48}- SiSo: {15}{48}- SoTiet: {16}{48}- TenCoSo: {17}{48}- HeSoLopDong: {18}{48}- HeSoCoSo: {19}{48}- HeSoQuyDoiThucHanhSangLyThuyet: {20}{48}- TietQuyDoi: {21}{48}- MaHinhThucDaoTao: {22}{48}- HeSoChucDanhChuyenMon: {23}{48}- HeSoClcCntn: {24}{48}- HeSoThinhGiangMonChuyenNganh: {25}{48}- MaNhomMonHoc: {26}{48}- LoaiLop: {27}{48}- MaBacDaoTao: {28}{48}- NgonNguGiangDay: {29}{48}- MaLopHocPhan: {30}{48}- MaKhoaHoc: {31}{48}- HeSoTroCap: {32}{48}- HeSoLuong: {33}{48}- HeSoMonMoi: {34}{48}- HeSoNgoaiGio: {35}{48}- PhanLoai: {36}{48}- HeSoNienCheTinChi: {37}{48}- HeSoNgonNgu: {38}{48}- HeSoBacDaoTao: {39}{48}- MaLoaiHocPhan: {40}{48}- HeSoKhoiNganh: {41}{48}- GhiChu: {42}{48}- HeSoCongViec: {43}{48}- SoTietThucTeQuyDoi: {44}{48}- MaCoSo: {45}{48}- MucThanhToan: {46}{48}- MaCauHinhChotGio: {47}{48}", 
				this.MaQuanLy,
