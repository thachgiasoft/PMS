...
namespace PMS.Entities
{
	...
	{		
		...
		public override string[] TableColumns
		{
			get
			{
				return new string[] {"MaCoVan", "MaGiangVien", "NamHoc", "HocKy", "MaLop", "MaKhoaHoc", "SoTiet", "SoTien", "NgayTao", "TrangThai", "SiSo", "DanhGiaHoanThanh", "NgayKetThuc", "GhiChu", "NgayCapNhat", "NguoiCapNhat", "Nhom"};
			}
		}
		#endregion 
        ...
        */
		...
		public override string ToString()
		{
			return string.Format(System.Globalization.CultureInfo.InvariantCulture,
				"{18}{17}- MaCoVan: {0}{17}- MaGiangVien: {1}{17}- NamHoc: {2}{17}- HocKy: {3}{17}- MaLop: {4}{17}- MaKhoaHoc: {5}{17}- SoTiet: {6}{17}- SoTien: {7}{17}- NgayTao: {8}{17}- TrangThai: {9}{17}- SiSo: {10}{17}- DanhGiaHoanThanh: {11}{17}- NgayKetThuc: {12}{17}- GhiChu: {13}{17}- NgayCapNhat: {14}{17}- NguoiCapNhat: {15}{17}- Nhom: {16}{17}{19}", 
				this.MaCoVan,
