...
namespace PMS.Entities
{
	...
	{		
		...
		public KhoiLuongQuyDoiBase(System.Int32? _maKhoiLuongGiangDay, System.String _maGiangVien, 
			...
			System.Decimal? _heSoKhoiNganh, System.String _maKhoaCuaMonHoc)
		{
			this.entityData = new KhoiLuongQuyDoiEntityData();
			this.backupData = null;
        ...
        */
		...
		public override string ToString()
		{
			return string.Format(System.Globalization.CultureInfo.InvariantCulture,
				"{47}{46}- MaKhoiLuongQuyDoi: {0}{46}- MaKhoiLuongGiangDay: {1}{46}- MaGiangVien: {2}{46}- MaLopHocPhan: {3}{46}- NamHoc: {4}{46}- HocKy: {5}{46}- MaMonHoc: {6}{46}- TenMonHoc: {7}{46}- SoTinChi: {8}{46}- SoLuong: {9}{46}- MaLoaiHocPhan: {10}{46}- LoaiHocPhan: {11}{46}- MaBuoiHoc: {12}{46}- MaLop: {13}{46}- TietBatDau: {14}{46}- SoTiet: {15}{46}- TinhTrang: {16}{46}- NgayDay: {17}{46}- MaBacDaoTao: {18}{46}- MaKhoaHoc: {19}{46}- MaKhoa: {20}{46}- MaNhomMonHoc: {21}{46}- MaPhongHoc: {22}{46}- HeSoCongViec: {23}{46}- HeSoBacDaoTao: {24}{46}- HeSoNgonNgu: {25}{46}- HeSoChucDanhChuyenMon: {26}{46}- HeSoLopDong: {27}{46}- HeSoCoSo: {28}{46}- SoTietThucTeQuyDoi: {29}{46}- TietQuyDoi: {30}{46}- HeSoQuyDoiThucHanhSangLyThuyet: {31}{46}- HeSoNgoaiGio: {32}{46}- LoaiLop: {33}{46}- HeSoClcCntn: {34}{46}- HeSoThinhGiangMonChuyenNganh: {35}{46}- NgonNguGiangDay: {36}{46}- HeSoTroCapGiangDay: {37}{46}- HeSoTroCap: {38}{46}- HeSoLuong: {39}{46}- HeSoMonMoi: {40}{46}- HeSoNienCheTinChi: {41}{46}- GhiChu: {42}{46}- MucThanhToan: {43}{46}- HeSoKhoiNganh: {44}{46}- MaKhoaCuaMonHoc: {45}{46}{48}", 
