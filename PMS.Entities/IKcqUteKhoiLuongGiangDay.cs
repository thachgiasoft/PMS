...
{
	/// <summary>
	///		The data structure representation of the 'KcqUte_KhoiLuongGiangDay' table via interface.
	/// </summary>
	/// <remarks>
	/// 	This struct is generated by a tool and should never be modified.
	/// </remarks>
	public interface IKcqUteKhoiLuongGiangDay 
	{
		/// <summary>			
		/// Id : 
		/// </summary>
		...
		/// </summary>	
		TList<KcqUteKhoiLuongQuyDoi> KcqUteKhoiLuongQuyDoiCollection {  get;  set;}	
