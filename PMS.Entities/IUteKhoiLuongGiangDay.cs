...
{
	/// <summary>
	///		The data structure representation of the 'Ute_KhoiLuongGiangDay' table via interface.
	/// </summary>
	/// <remarks>
	/// 	This struct is generated by a tool and should never be modified.
	/// </remarks>
	public interface IUteKhoiLuongGiangDay 
	{
		/// <summary>			
		/// Id : 
		/// </summary>
		...
		/// </summary>	
		TList<UteKhoiLuongQuyDoi> UteKhoiLuongQuyDoiCollection {  get;  set;}	
