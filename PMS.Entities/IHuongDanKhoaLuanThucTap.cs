...
{
	/// <summary>
	///		The data structure representation of the 'HuongDanKhoaLuanThucTap' table via interface.
	/// </summary>
	/// <remarks>
	/// 	This struct is generated by a tool and should never be modified.
	/// </remarks>
	public interface IHuongDanKhoaLuanThucTap 
	{
		/// <summary>			
		/// Id : 
		/// </summary>
