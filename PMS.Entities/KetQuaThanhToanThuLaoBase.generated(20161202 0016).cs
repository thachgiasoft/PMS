...
namespace PMS.Entities
{
	...
	{		
		...
		protected override void AddValidationRules()
		{
			...
			ValidationRules.AddRule( CommonRules.StringMaxLength, 
				new CommonRules.MaxLengthRuleArgs("Nhom", "Nhom", 200));
			ValidationRules.AddRule( CommonRules.StringMaxLength, 
        ...
        */
		...
		public override string ToString()
		{
			return string.Format(System.Globalization.CultureInfo.InvariantCulture,
				"{61}{60}- Id: {0}{60}- MaGiangVien: {1}{60}- NamHoc: {2}{60}- HocKy: {3}{60}- MaHocHam: {4}{60}- MaHocVi: {5}{60}- MaLoaiGiangVien: {6}{60}- MaDonVi: {7}{60}- Loai: {8}{60}- PhanLoai: {9}{60}- MaMonHoc: {10}{60}- TenMonHoc: {11}{60}- LoaiHocPhan: {12}{60}- Nhom: {13}{60}- MaLop: {14}{60}- LopClc: {15}{60}- SiSo: {16}{60}- TietThucDay: {17}{60}- TietChuNhat: {18}{60}- HeSoHocKy: {19}{60}- HeSoLopDong: {20}{60}- TietQuyDoi: {21}{60}- DonGia: {22}{60}- ThanhTien: {23}{60}- LanChot: {24}{60}- NgayCapNhat: {25}{60}- MaHinhThucDaoTao: {26}{60}- DonGiaTrongChuan: {27}{60}- DonGiaNgoaiChuan: {28}{60}- TenCoSo: {29}{60}- HeSoQuyDoiThucHanhSangLyThuyet: {30}{60}- HeSoCoSo: {31}{60}- SoGioThucGiangTrenLop: {32}{60}- SoGioChuanTinhThem: {33}{60}- HeSoChucDanhChuyenMon: {34}{60}- HeSoClcCntn: {35}{60}- HeSoThinhGiangMonChuyenNganh: {36}{60}- MaNhomMonHoc: {37}{60}- LoaiLop: {38}{60}- MaBacDaoTao: {39}{60}- MalopHocPhan: {40}{60}- MaKhoaHoc: {41}{60}- HeSoTroCap: {42}{60}- HeSoNgoaiGio: {43}{60}- HeSoLuong: {44}{60}- HeSoMonMoi: {45}{60}- HeSoNienCheTinChi: {46}{60}- HeSoNgonNgu: {47}{60}- HeSoBacDaoTao: {48}{60}- NgayChiTra: {49}{60}- XacNhanChiTra: {50}{60}- GhiChu: {51}{60}- NguoiCapNhat: {52}{60}- HeSoCongViec: {53}{60}- NgonNguGiangDay: {54}{60}- MaCoSo: {55}{60}- MucThanhToan: {56}{60}- DotChiTra: {57}{60}- HeSoKhoiNganh: {58}{60}- MaCauHinhChotGio: {59}{60}{62}", 
				this.Id,
