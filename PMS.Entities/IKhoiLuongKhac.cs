...
{
	/// <summary>
	///		The data structure representation of the 'KhoiLuongKhac' table via interface.
	/// </summary>
	/// <remarks>
	/// 	This struct is generated by a tool and should never be modified.
	/// </remarks>
	public interface IKhoiLuongKhac 
	{
		/// <summary>			
		/// MaKhoiLuong : 
		/// </summary>
		...
		/// </summary>	
		TList<ChiTietKhoiLuong> ChiTietKhoiLuongCollection {  get;  set;}	
