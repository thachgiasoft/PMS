...
namespace PMS.UI.Forms.NghiepVu
{
    public partial class frmXuLyQuyDoiGioiChuan : XtraForm
    {
        ...
        public frmXuLyQuyDoiGioiChuan(string _namHoc, string _hocKy, int _dotThanhToan, string bac, string he, string _maTruong)
        {
            InitializeComponent();
            _inputParameter.NamHoc = _namHoc;
            _inputParameter.HocKy = _hocKy;
            ...
            try
            {
                ...
                foreach (KhoiLuongGiangDayChiTiet klGiangDay in listKhoiLuong)
                {
                    if (!backgroundWorker.CancellationPending)
                    {
                        ...
                        {
                            string _heso = tblHeSo.Rows[0]["HeSoQuyDoiThucHanhSangLyThuyet"].ToString(); //_listCauHinhChung.Find(p => p.TenCauHinh == "Hệ số quy đổi thực hành sang lý thuyết").GiaTri;
                            if (num.NumberDecimalSeparator == ".")
                            {
                        ...
                        xmlData += "<Input _00MKL=\"" + klQuyDoi.MaKhoiLuongGiangDay
                                   ...
                                   + "\" _07STC=\"" + Common.Globals.ReplaceDotEnviroment(klQuyDoi.SoTinChi, "decimal")
                                   ...
                                   + "\" _14ST=\"" + Common.Globals.ReplaceDotEnviroment(klQuyDoi.SoTiet, "decimal")
                                   ...
                                   + "\" _22HSCD=\"" + Common.Globals.ReplaceDotEnviroment(klQuyDoi.HeSoChucDanhChuyenMon, "decimal")
                                   + "\" _23HSLD=\"" + Common.Globals.ReplaceDotEnviroment(klQuyDoi.HeSoLopDong, "decimal")
                                   + "\" _24HSTG=\"" + Common.Globals.ReplaceDotEnviroment(klQuyDoi.HeSoThinhGiangMonChuyenNganh, "decimal")
                                   + "\" _25HSTH=\"" + Common.Globals.ReplaceDotEnviroment(klQuyDoi.HeSoQuyDoiThucHanhSangLyThuyet, "decimal")
                                   + "\" _26HSTC=\"" + Common.Globals.ReplaceDotEnviroment(klQuyDoi.HeSoTroCap, "decimal")
                                   + "\" _27TQD=\"" + Common.Globals.ReplaceDotEnviroment(klQuyDoi.TietQuyDoi, "decimal")
                                   + "\" />";
                ...
                foreach (KhoiLuongGiangDayChiTiet klGiangDay in listKhoiLuong)
                {
                    if (!backgroundWorker.CancellationPending)
                    {
                        ...
                        xmlData += "<Input _00MKL=\"" + klQuyDoi.MaKhoiLuongGiangDay
                                    ...
                                    + "\" _20MNMH=\"" + klQuyDoi.MaNhomMonHoc
                                    + "\" _21MPH=\"" + klQuyDoi.MaPhongHoc
                                    + "\" _22HSL=\"" + Common.Globals.ReplaceDotEnviroment(klQuyDoi.HeSoLuong,"decimal")
                                    + "\" _23HSLD=\"" + Common.Globals.ReplaceDotEnviroment(klQuyDoi.HeSoLopDong,"decimal")
                                    + "\" _24HSNG=\"" + Common.Globals.ReplaceDotEnviroment(klQuyDoi.HeSoNgoaiGio,"decimal")
                                    + "\" _25HSCD=\"" + Common.Globals.ReplaceDotEnviroment(klQuyDoi.HeSoChucDanhChuyenMon,"decimal")
                                    + "\" _26HSCS=\"" + Common.Globals.ReplaceDotEnviroment(klQuyDoi.HeSoCoSo,"decimal")
                                    + "\" _27HSMM=\"" + Common.Globals.ReplaceDotEnviroment(klQuyDoi.HeSoMonMoi,"decimal")
                ...
                foreach (KhoiLuongGiangDayChiTiet klGiangDay in listKhoiLuong)
                {
                    if (!backgroundWorker.CancellationPending)
                    {
                        ...
                        xmlData += "<Input _01MKL=\"" + klQuyDoi.MaKhoiLuongGiangDay
                                ...
                                + "\" _40HSMM=\"" + 0//PMS.Common.Globals.ReplaceDotEnviroment(0, "decimal")//klQuyDoi.HeSoMonMoi
                                + "\" _41HSNCTC=\"" + 0//PMS.Common.Globals.ReplaceDotEnviroment(klQuyDoi.HeSoNienCheTinChi, "decimal")
                                + "\" _42HSKN=\"" + Common.Globals.ReplaceDotEnviroment(klQuyDoi.HeSoKhoiNganh, "decimal")
            ...
            try
            {
                ...
                foreach (KhoiLuongGiangDayChiTiet klGiangDay in listKhoiLuong)
                {
                    ...
                    if (!backgroundWorker.CancellationPending)
                    {
                        ...
                        //IDataReader idr = DataServices.KhoiLuongGiangDayChiTiet.GetDuLieuDeTinhToan(klGiangDay.MaGiangVien, klGiangDay.MaLopHocPhan, (int)klGiangDay.MaCauHinhChotGio);
                        //DataTable dtKhoiLuong = new DataTable();
                        //dtKhoiLuong.Load(idr);
                        ...
                        {
                            //if (klQuyDoi.MaLopHocPhan.Equals("161CT210505")) //<< test 
                            //{
                            //    string str = "debug";
                            //}
                            ...
                            //{
                                ...
                                decimal _soNhomThucHanh = (int)klQuyDoi.SoLuong / (decimal)_siSoNhomThucHanh; //Common.XuLySo.LamTronLen((int)klQuyDoi.SoLuong * 1.0 / _siSoNhomThucHanh);
                                ...
                                * (klQuyDoi.HeSoLopDong + klQuyDoi.HeSoChucDanhChuyenMon + ("CH;NC".Contains(klQuyDoi.MaBacDaoTao) ? klQuyDoi.HeSoBacDaoTao : 0)); //DLU
                            //}
                        }
                        //now = DateTime.Now;
