...
{
    public partial class ucThongKeDuTruGioGiangTruocLHP : DevExpress.XtraEditors.XtraUserControl
    {
        #region Variable
        TList<CauHinhChung> _cauHinhChung = DataServices.CauHinhChung.GetAll();
        DateTime _ngayIn;
       #endregion
        public ucThongKeDuTruGioGiangTruocLHP()
        {
            InitializeComponent();
            #region Init CauHinh
        ...
        private void ucThongKeDuTruGioGiangTruocLHP_Load(object sender, EventArgs e)
        {
            ...
            AppGridView.AlignHeader(gridViewThongKe, new string[] { "TongTietThucDayHK1", "TongTietQuyDoiHK1", "TongTietThucDayHK2", "TongTietQuyDoiHK2", "TongTietThucDayCN", "TongTietQuyDoiCN" }, DevExpress.Utils.HorzAlignment.Center);
        ...
        private void btnLocDuLieu_Click(object sender, EventArgs e)
        {
            ...
            if (cboNamHoc.EditValue != null)
            {
                ...
                IDataReader reader = DataServices.DuTruGioGiangTruocLopHocPhan.ThongKeTheoNam(cboNamHoc.EditValue.ToString());
                tb.Load(reader);
...
//            int dem = vListBaoCao.Rows.Count;
            ...
            if (vListBaoCao != null && vListBaoCao.Rows.Count > 0) 
            {
                ...
                {
                    frm.InThongKeDuTruTruocGioGiangTruocLHP(PMS.Common.Globals._cauhinh.TenTruong, cboNamHoc.EditValue.ToString(), PMS.Common.Globals._cauhinh.NguoiLapbieu
                        , _ngayIn, vListBaoCao);
                    frm.ShowDialog();
                }
            }
