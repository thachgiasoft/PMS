...
{
    public partial class ucThongKeSoLuongGiangVienThamGiaGiangDayDuTru : DevExpress.XtraEditors.XtraUserControl
    {
        DateTime _ngayIn;
        public ucThongKeSoLuongGiangVienThamGiaGiangDayDuTru()
        {
            InitializeComponent();
        ...
        private void ucThongKeSoLuongGiangVienThamGiaGiangDayDuTru_Load(object sender, EventArgs e)
        {
        ...
        private void btnLoc_Click(object sender, EventArgs e)
        {
            ...
            if (dateEditNgay.EditValue != null)
            {
                ...
                IDataReader reader = DataServices.DuTruGioGiangTruocThoiKhoaBieu.ThongKeSoLuongGiangVienTheoHe(dateEditNgay.DateTime);
                tb.Load(reader);
...
vListBaoCao = Common.XuLyGiaoDien.LayDuLieuIn(gridViewThongKe, bindingSourceThongKe);
            ...
            if (vListBaoCao != null && vListBaoCao.Rows.Count > 0)
            {
                ...
                {
                    frm.InThongKeGiangVienGiangTheoNamHeNganh(PMS.Common.Globals._cauhinh.TenTruong, dateEditNgay.DateTime, _ngayIn, vListBaoCao);
                    frm.ShowDialog();
                }
            }
            Cursor.Current = Cursors.Default;
