...
{
    public partial class ucThongKeSoLuongSinhVienCuaGiangVien_Kcq : DevExpress.XtraEditors.XtraUserControl
    {
        #region Variable
        TList<CauHinhChung> _cauHinhChung = DataServices.CauHinhChung.GetAll();
        #endregion
        public ucThongKeSoLuongSinhVienCuaGiangVien_Kcq()
        {
            InitializeComponent();
        }
        ...
        void InitData()
        {
            ...
            if (cboNamHoc.EditValue != null && cboHocKy.EditValue != null)
            {
                ...
                IDataReader reader = DataServices.ViewKcqKetQuaThanhToanThuLao.ThongKeSiSoSinhVien(cboNamHoc.EditValue.ToString(), cboHocKy.EditValue.ToString());
                tb.Load(reader);
