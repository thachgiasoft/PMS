...
{
    public partial class ucThongKeLopSinhVienCoVanHocTapTheoHocKy_Kcq : DevExpress.XtraEditors.XtraUserControl
    {
        #region Variable
        TList<CauHinhChung> _cauHinhChung = DataServices.CauHinhChung.GetAll();
        #endregion
        public ucThongKeLopSinhVienCoVanHocTapTheoHocKy_Kcq()
        {
            InitializeComponent();
        ...
        private void btnIn_ItemClick(object sender, DevExpress.XtraBars.ItemClickEventArgs e)
        {
            ...
            if (vListBaoCao != null && vListBaoCao.Rows.Count > 0)
            {
                ...
                {
                    frm.InDanhSachLopCoVanHocTapTheoHocKy_Kcq(PMS.Common.Globals._cauhinh.TenTruong, cboNamHoc.EditValue.ToString(), cboHocKy.EditValue.ToString(), _donVi, PMS.Common.Globals._cauhinh.NguoiLapbieu, vListBaoCao);
                    frm.ShowDialog();
                }
            }
            Cursor.Current = Cursors.Default;
