...
{
    public partial class ucThongKeCoVanHocTap_Kcq : DevExpress.XtraEditors.XtraUserControl
    {
        #region Variable
        TList<CauHinhChung> _cauHinhChung = DataServices.CauHinhChung.GetAll();
        #endregion
        public ucThongKeCoVanHocTap_Kcq()
        {
            InitializeComponent();
        ...
        private void btnIn_ItemClick(object sender, DevExpress.XtraBars.ItemClickEventArgs e)
        {
            ...
            if (vListBaoCao != null && vListBaoCao.Rows.Count > 0)
            {
                ...
                {
                    frm.InCoVanHocTapTheoNamHocKhoaDonVi_Kcq(PMS.Common.Globals._cauhinh.TenTruong, cboNamHoc.EditValue.ToString(), _donVi, _tongSoCoVan, _tongSoSinhVien, PMS.Common.Globals._cauhinh.NguoiLapbieu, vListBaoCao);
                    frm.ShowDialog();
                }
            }
            Cursor.Current = Cursors.Default;
