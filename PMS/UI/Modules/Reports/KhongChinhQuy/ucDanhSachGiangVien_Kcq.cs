...
{
    public partial class ucDanhSachGiangVien_Kcq : DevExpress.XtraEditors.XtraUserControl
    {
        #region Variable
        ...
        #region Event Form
        public ucDanhSachGiangVien_Kcq()
        {
            InitializeComponent();
        ...
        private void ucDanhSachGiangVien_Load(object sender, EventArgs e)
        {
            ...
            AppGridView.ShowField(gridViewDanhSachGiangVien, new string[] { "MaQuanLy", "Ho", "Ten", "Khoa", "TenDonVi", "MaHocHam", "TenHocHam", "MaHocVi", "TenHocVi", "TenLoaiGiangVien", "GioiTinh", "NgaySinh", "NoiSinh", "Cmnd", "DiaChi", "DienThoai", "SoDiDong", "Email", "SoHieuCongChuc", "SoTaiKhoan", "MaSoThue", "TenNganHang", "Ngach" }
                    , new string[] { "Mã giảng viên", "Họ", "Tên", "Khoa", "Bộ môn", "Mã học hàm", "Học hàm", "Mã học vị", "Học vị", "Loại giảng viên", "Giới tính", "Ngày Sinh", "Nơi sinh", "CMND", "Địa chỉ", "Số điện thoại", "Di động", "Email", "Số hiệu công chức", "Số tài khoản", "Mã số thuế", "Ngân hàng", "Ngạch" }
                    , new int[] { 90, 120, 70, 130, 150, 80, 150, 80, 150, 100, 70, 90, 100, 100, 150, 100, 100, 100, 120, 90, 90, 150, 90 });
            AppGridView.AlignHeader(gridViewDanhSachGiangVien, new string[] { "MaQuanLy", "SoHieuCongChuc", "Ho", "Ten", "TenDonVi", "TenHocHam", "TenHocVi", "TenLoaiGiangVien", "GioiTinh", "NgaySinh", "NoiSinh", "Cmnd", "DiaChi", "DienThoai", "SoDiDong", "Email", "Khoa", "SoTaiKhoan", "MaSoThue", "TenNganHang", "Ngach" }, DevExpress.Utils.HorzAlignment.Center);
        ...
        private void btnIn_ItemClick(object sender, DevExpress.XtraBars.ItemClickEventArgs e)
        {
            ...
            //string filter = gridViewDanhSachGiangVien.ActiveFilterString;
            ...
            if (vListBaoCao != null && vListBaoCao.Rows.Count > 0)
            {
                ...
                {
                    frm.InDanhSachGiangVien_Kcq(_maTruong, PMS.Common.Globals._cauhinh.TenTruong, khoa, PMS.Common.Globals._cauhinh.NguoiLapbieu, vListBaoCao);
                    frm.ShowDialog();
                }
            }
            Cursor.Current = Cursors.Default;
