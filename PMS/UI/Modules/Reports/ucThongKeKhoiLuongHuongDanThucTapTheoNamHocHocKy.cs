...
{
    public partial class ucThongKeKhoiLuongHuongDanThucTapTheoNamHocHocKy : DevExpress.XtraEditors.XtraUserControl
    {
        #region Variable
        TList<CauHinhChung> _cauHinhChung = DataServices.CauHinhChung.GetAll();
        DateTime _ngayIn;
        #endregion
        public ucThongKeKhoiLuongHuongDanThucTapTheoNamHocHocKy()
        {
            InitializeComponent();
        }

        private void ucThongKeKhoiLuongHuongDanThucTapTheoNamHocHocKy_Load(object sender, EventArgs e)
        {
        ...
        {
            if (cboNamHoc.EditValue != null && cboHocKy.EditValue != null && cboBacDaoTao.EditValue != null && cboDonVi.EditValue != null)
            {
                DataTable tb = new DataTable();
                IDataReader reader = DataServices.KhoiLuongHuongDanThucTap.ThongKeTheoNamHocHocKyBacDaoTaoDonVi(cboNamHoc.EditValue.ToString(), cboHocKy.EditValue.ToString(), cboBacDaoTao.EditValue.ToString(), cboDonVi.EditValue.ToString());
                tb.Load(reader);
