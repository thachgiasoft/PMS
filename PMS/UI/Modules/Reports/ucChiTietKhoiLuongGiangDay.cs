...
{
    public partial class ucChiTietKhoiLuongGiangDay : DevExpress.XtraEditors.XtraUserControl
    {
        #region Variable
        TList<CauHinhChung> _cauHinhChung = DataServices.CauHinhChung.GetAll();
        #endregion

        public ucChiTietKhoiLuongGiangDay()
        {
            InitializeComponent();
        ...
        private void ucChiTietKhoiLuongGiangDay_Load(object sender, EventArgs e)
        {
            ...
            AppGridView.ShowField(gridViewKhoiLuong, new string[] { "MaDonVi", "TenDonVi", "MaQuanLy", "HoTen", "SoHieuCongChuc", "Loai", "MaMonHoc", "TenMonHoc", "Nhom", "MaLop", "SiSo", "TietThucDay", "TietChuNhat", "T7", "Hstp", "HeSoLopDong", "TietQuyDoi", "DonGia", "ThanhTien", "TienCanTren" }
                    , new string[] { "Mã bộ môn", "Bộ môn", "Mã giảng viên", "Họ và tên", "Mã công chức", "Loại", "Mã môn học", "Tên môn học", "Nhóm", "Mã lớp", "Sĩ số", "Tiết", "CN + Tối", "T7", "HSTP", "HSLĐ", "Tiết quy đổi", "Đơn giá", "Số tiền", "Tiền chặn trên" }
                    , new int[] { 80, 150, 90, 145, 90, 100, 90, 150, 50, 90, 60, 60, 70, 50, 50, 50, 80, 100, 80, 80, 80 });
            ...
            AppGridView.SummaryField(gridViewKhoiLuong, "ThanhTien", "{0:n0}", DevExpress.Data.SummaryItemType.Sum);
        ...
        private void btnLocDuLieu_Click(object sender, EventArgs e)
        {
            ...
            if (cboNamHoc.EditValue != null && cboHocKy.EditValue != null && cboGiangVien.EditValue != null)
            {
                ...
                IDataReader reader = DataServices.ViewKetQuaThanhToanThuLao.GetByMaGiangVienNamHocHocKyReader(cboNamHoc.EditValue.ToString(), cboHocKy.EditValue.ToString(), cboGiangVien.EditValue.ToString());
                tb.Load(reader);
