...
namespace PMS.UI.Modules.Reports
{
    public partial class ucThanhToanGiangDayLyThuyetGiangVienCoHuuCTIM : DevExpress.XtraEditors.XtraUserControl
    {
        ...
        private void btnLocDuLieu_Click(object sender, EventArgs e)
        {
            ...
            {
                DataTable dt = new DataTable();
                IDataReader reader = DataServices.KetQuaThanhToanThuLao.ThongKeTienGiangCtim(cboNamHoc.EditValue.ToString(), cboHocKy.EditValue.ToString(), cboKhoaDonVi.EditValue.ToString(), cboBacDaoTao.EditValue.ToString(), cboKhoaHoc.EditValue.ToString(), "1", "LT; Lý thuyết", int.Parse(cboLanChot.EditValue.ToString()));
                dt.Load(reader);
                DataColumn chon = new DataColumn("Chon", typeof(Boolean));
                dt.Columns.Add(chon);
