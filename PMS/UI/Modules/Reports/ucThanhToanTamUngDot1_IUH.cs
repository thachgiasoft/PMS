...
{
    public partial class ucThanhToanTamUngDot1_IUH : DevExpress.XtraEditors.XtraUserControl
    {
        #region Variable
        TList<CauHinhChung> _cauHinhChung = DataServices.CauHinhChung.GetAll();
        DateTime _ngayIn;
        #endregion
        public ucThanhToanTamUngDot1_IUH()
        {
            InitializeComponent();
        }

        private void ucThanhToanTamUngDot1_IUH_Load(object sender, EventArgs e)
        {
            ...
            AppGridView.ShowField(gridViewThongKe, new string[] { "TenDonVi", "MaQuanLy", "HoTen", "TenHocVi", "DonGia", "TenChucVu", "DinhMucGiangDay", "SoTietNoKyTruoc", "TongTietDay", "TietTamUng", "SoTienThanhToan" }
                    , new string[] { "Khoa - Đơn vị", "Mã giảng viên", "Họ tên", "Học vị", "Đơn giá", "Chức vụ", "Định mức giảng dạy", "Số tiết nợ / tồn", "Tổng tiết giảng dạy", "Số tiết tạm ứng", "Số tiền thanh toán" }
                    , new int[] { 99, 100, 160, 100, 80, 110, 80, 80, 90, 80, 100 });
            AppGridView.AlignHeader(gridViewThongKe, new string[] { "TenDonVi", "MaQuanLy", "HoTen", "TenHocVi", "DonGia", "TenChucVu", "DinhMucGiangDay", "SoTietNoKyTruoc", "TongTietDay", "TietTamUng", "SoTienThanhToan" }, DevExpress.Utils.HorzAlignment.Center);
        ...
        private void btnLocDuLieu_Click(object sender, EventArgs e)
        {
            ...
            if (cboNamHoc.EditValue != null)
            {
                ...
                IDataReader reader = DataServices.KetQuaThanhToanThuLao.ThanhToanTamUngDot1(cboNamHoc.EditValue.ToString());
                tbl.Load(reader);
