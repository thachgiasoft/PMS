    ...
    public partial class ucTietNoKyTruoc : DevExpress.XtraEditors.XtraUserControl
    {
        ...
        void InitGridVHU()
        {
            ...
            AppGridView.ShowField(gridViewNoKyTruoc, new string[] { "MaGiangVien", "HoTen", "TenDonVi", "SoTietNoKyTruoc", "TietNoNckh", "TietBaoLuuNckh", "TietNoKhac", "NgayCapNhat", "NguoiCapNhat", "GhiChu", "LayTuDong" },
                                                           new string[] { "Mã giảng viên", "Họ tên", "Đơn vị", "GC nợ giảng dạy", "GC nợ NCKH", "GC bảo lưu NCKH", "GC nợ tham gia quản lý", "NgayCapNhat", "NguoiCapNhat", "Ghi chú", "LayTuDong" },
            ...
            AppGridView.BackColorFieldAppearance(gridViewNoKyTruoc, new string[] { "TietNoNckh", "TietBaoLuuNckh" }, Color.FromArgb(230, 255, 245));
