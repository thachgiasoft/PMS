...
namespace PMS.UI.Modules.DanhMuc
{
    public partial class ucTietNoKyTruoc : DevExpress.XtraEditors.XtraUserControl
    {
        ...
        void InitGridVHU()
        {
            AppGridView.InitGridView(gridViewNoKyTruoc, true, true, DevExpress.XtraGrid.Views.Grid.GridMultiSelectMode.RowSelect, false, false, "Nhấn vào đây để thêm dòng mới");
            AppGridView.ShowEditor(gridViewNoKyTruoc, DevExpress.XtraGrid.Views.Grid.NewItemRowPosition.Top);
            AppGridView.ShowField(gridViewNoKyTruoc, new string[] { "MaGiangVien", "HoTen", "TenDonVi", "SoTietNoKyTruoc", "TietNoNckh", "TietBaoLuuNckh", "TietNoKhac", "NgayCapNhat", "NguoiCapNhat", "GhiChu", "LayTuDong" },
                                                           new string[] { "Mã giảng viên", "Họ tên", "Đơn vị", "Tiết nợ giảng dạy", "Tiết nợ NCKH", "Tiết bảo lưu NCKH", "Tiết nợ tham gia quản lý", "NgayCapNhat", "NguoiCapNhat", "Ghi chú", "LayTuDong" },
                                                           new int[] { 90, 150, 150, 80, 80, 80, 80, 100, 80, 150, 80 });
            AppGridView.AlignHeader(gridViewNoKyTruoc, new string[] { "MaGiangVien", "HoTen", "TenDonVi", "SoTietNoKyTruoc", "TietNoNckh", "TietBaoLuuNckh", "TietNoKhac", "NgayCapNhat", "NguoiCapNhat", "GhiChu", "LayTuDong" }, DevExpress.Utils.HorzAlignment.Center);
            ...
            AppGridView.BackColorFieldAppearance(gridViewNoKyTruoc, new string[] { "SoTietNoKyTruoc" }, Color.FromArgb(0xEF, 0xE2, 0xF3));
            AppGridView.BackColorFieldAppearance(gridViewNoKyTruoc, new string[] { "TietNoNckh", "TietBaoLuuNckh" }, Color.Honeydew);
            AppGridView.BackColorFieldAppearance(gridViewNoKyTruoc, new string[] { "TietNoKhac" }, Color.Ivory);
            ...
            labelControl1.Text = "GHI CHÚ: Tiết nợ đều được ghi lại. Chỉ có NCKH vượt là được bảo lưu, giảng dạy vượt thì tính tiền, TGQL vượt thì không được tính.";
