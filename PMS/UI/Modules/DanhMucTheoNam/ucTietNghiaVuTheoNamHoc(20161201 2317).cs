...
namespace PMS.UI.Modules.DanhMucTheoNam
{
    public partial class ucTietNghiaVuTheoNamHoc : DevExpress.XtraEditors.XtraUserControl
    {
        ...
        void InitGridVHU()
        {
            ...
            AppGridView.BackColorFieldAppearance(gridViewTietNghiaVu, new string[] { "TietNghiaVuGiangDay", "TietGiangDayGiamDoChucVu", "TietNoGiangDay", "SumTietnghiaVuGiangDay" }, Color.FromArgb(0xEF, 0xE2, 0xF3));
            AppGridView.BackColorFieldAppearance(gridViewTietNghiaVu, new string[] { "TietNghiaVuNckh", "TietNoNcKh", "TietBaoLuuNckh", "SumTietNghiaVuNckh" }, Color.Honeydew);
            AppGridView.BackColorFieldAppearance(gridViewTietNghiaVu, new string[] { "TietNghiaVuQuanLy", "TietNoQuanLy", "SumTietNghiaVuQuanLy" }, Color.Ivory);
