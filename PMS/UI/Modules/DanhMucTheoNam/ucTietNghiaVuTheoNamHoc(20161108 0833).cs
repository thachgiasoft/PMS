...
namespace PMS.UI.Modules.DanhMucTheoNam
{
    public partial class ucTietNghiaVuTheoNamHoc : DevExpress.XtraEditors.XtraUserControl
    {
        ...
        void InitGridVHU()
        {
            ...
            AppGridView.ShowField(gridViewTietNghiaVu, new string[] { "TenDonVi", "MaQuanLy", "HoTen", "TenHocHam", "TenHocVi", "TenChucVu", "TietNghiaVuGiangDay", "TietNghiaVuNckh", "TietNghiaVuQuanLy", "DinhMucToiThieuCuaChucVu", "TietGiangDayGiamDoChucVu", "TietNghiaVuQuanLyKiemNhiem", "MaGiamTruKhac", "SoTietGiamTruKhac", "TongTietGiamDoTamNghi", "TietNoGiangDay", "TietNoNcKh", "TietBaoLuuNckh", "TietNoQuanLy", "GioChuanGiangDayChuyenSangNckh", "SumTietnghiaVuGiangDay", "SumTietNghiaVuNckh", "SumTietNghiaVuQuanLy", "GhiChu", "MaGiangVien" }
                , new string[] { "Khoa - Đơn vị", "Mã giảng viên", "Họ và tên", "Học hàm", "Học vị", "Chức vụ", "Định mức GC giảng dạy", "Định mức GC NCKH", "Định mức GC TGQL", "Định mức tối thiểu chức vụ", "GC giảm do chức vụ", "Định mức TGQL kiêm nhiệm", "Giảm trừ khác", "Số GC giảm khác", "Tiết giảm theo thời gian", "GC giảng dạy nợ", "GC NCKH nợ", "GC NCKH bảo lưu", "GC TGQL nợ", "GC giảng dạy chuyển sang NCKH", "Tổng GC giảng dạy", "Tổng GC NCKH", "Tổng GC TGQL", "Ghi chú", "MaGiangVien" }
