...
namespace PMS.UI.Modules.DanhMucTheoNam
{
    public partial class ucTietNghiaVuTheoNamHoc : DevExpress.XtraEditors.XtraUserControl
    {
        ...
        void InitGridVHU()
        {
            ...
            AppGridView.SummaryField(gridViewTietNghiaVu, "SumTietnghiaVuGiangDay", "{0:n2}", DevExpress.Data.SummaryItemType.Sum);
            AppGridView.SummaryField(gridViewTietNghiaVu, "SumTietNghiaVuNckh", "{0:n2}", DevExpress.Data.SummaryItemType.Sum);
            AppGridView.SummaryField(gridViewTietNghiaVu, "SumTietNghiaVuQuanLy", "{0:n2}", DevExpress.Data.SummaryItemType.Sum);
            AppGridView.BackColorFieldAppearance(gridViewTietNghiaVu, new string[] { "TietNghiaVuGiangDay", "TietGiangDayGiamDoChucVu", "TietNoGiangDay", "SumTietnghiaVuGiangDay" }, Color.FromArgb(235, 220, 255));
            AppGridView.BackColorFieldAppearance(gridViewTietNghiaVu, new string[] { "TietNghiaVuNckh", "TietNoNcKh", "TietBaoLuuNckh", "SumTietNghiaVuNckh" }, Color.FromArgb(230, 255, 245));
            AppGridView.BackColorFieldAppearance(gridViewTietNghiaVu, new string[] { "TietNghiaVuQuanLy", "TietNoQuanLy", "SumTietNghiaVuQuanLy" }, Color.FromArgb(255, 250, 240));
