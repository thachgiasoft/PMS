...
namespace PMS.UI.Modules.DanhMucTheoNam
{
    public partial class ucTietNghiaVuTheoNamHoc : DevExpress.XtraEditors.XtraUserControl
    {
        ...
        void InitGridVHU()
        {
            ...
            AppGridView.ShowField(gridViewTietNghiaVu, new string[] { "TenDonVi", "MaQuanLy", "HoTen", "TenHocHam", "TenHocVi", "TenChucVu", "TietNghiaVuGiangDay", "TietNghiaVuNckh", "TietNghiaVuQuanLy", "DinhMucToiThieuCuaChucVu", "TietGiangDayGiamDoChucVu", "TietNghiaVuQuanLyKiemNhiem", "MaGiamTruKhac", "SoTietGiamTruKhac", "TongTietGiamDoTamNghi", "TietNo_BaoLuuGiangDay", "TietNo_BaoLuuNcKh", "TietNo_BaoLuuQuanLy", "GioChuanGiangDayChuyenSangNckh", "SumTietnghiaVuGiangDay", "SumTietNghiaVuNckh", "SumTietNghiaVuQuanLy", "GhiChu", "MaGiangVien" }
                , new string[] { "Khoa - Đơn vị", "Mã giảng viên", "Họ và tên", "Học hàm", "Học vị", "Chức vụ", "Định mức GC giảng dạy", "Định mức GC NCKH", "Định mức GC TGQL", "Định mức tối thiểu chức vụ", "Tiết giảm do chức vụ", "Định mức GC TGQL kiêm nhiệm", "Giảm trừ khác", "Số tiết giảm khác", "Tiết giảm theo thời gian", "GC giảng dạy nợ/bảo lưu", "GC NCKH nợ/bảo lưu", "GC TGQL nợ/bảo lưu", "GC giảng dạy chuyển sang NCKH", "Tổng GC giảng dạy", "Tổng GC NCKH", "Tổng GC TGQL", "Ghi chú", "MaGiangVien" }
                    , new int[] { 90, 90, 140, 100, 100, 100, 90, 90, 90, 90, 90, 100, 100, 90, 90, 90, 90,90, 90, 90, 90, 90, 120, 99 });
