...
{
    public partial class ThongKeChiTietSoTietThucGiangCuaTungGiangVien : DevExpress.XtraReports.UI.XtraReport
    {
        public ThongKeChiTietSoTietThucGiangCuaTungGiangVien()
        {
            InitializeComponent();
        }
        ...
        public void InitData(string _truong, string _tuNgay, string _denNgay, string _nguoiLapBieu, DateTime _ngayIn, DataTable tb)
        {
            ...
            pNguoiLapBang.Value = _nguoiLapBieu;
            DataSource = tb;
        }
    }
}
