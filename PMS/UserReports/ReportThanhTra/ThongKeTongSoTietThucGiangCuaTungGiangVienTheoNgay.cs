...
{
    public partial class ThongKeTongSoTietThucGiangCuaTungGiangVienTheoNgay : DevExpress.XtraReports.UI.XtraReport
    {
        public ThongKeTongSoTietThucGiangCuaTungGiangVienTheoNgay()
        {
            InitializeComponent();
        }
