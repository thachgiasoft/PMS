...
{
    public partial class BangKeThanhToanTienChamBaiCuaCBKiemGiang : DevExpress.XtraReports.UI.XtraReport
    {
        public BangKeThanhToanTienChamBaiCuaCBKiemGiang()
        {
            InitializeComponent();
        }

        public void InitData(string namhoc, string hocky, string khoabomon, string phongdaotao, string phongketoan, string hieutruong, string nguoilapbieu, string khoahoc, string bacdaotao, string loaiGiangVien, DateTime ngayin, DataTable tb)
        {
