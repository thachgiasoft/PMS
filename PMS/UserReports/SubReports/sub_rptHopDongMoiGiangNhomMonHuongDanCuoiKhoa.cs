...
{
    public partial class sub_rptHopDongMoiGiangNhomMonHuongDanCuoiKhoa : DevExpress.XtraReports.UI.XtraReport
    {
        float _tongTien = 0;
        public float Tien;
        public sub_rptHopDongMoiGiangNhomMonHuongDanCuoiKhoa()
        {
            InitializeComponent();
        }
