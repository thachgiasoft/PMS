...
{
    public partial class rptThanhToanGiangDayThucHanhHopDongDaiHanCTIM : DevExpress.XtraReports.UI.XtraReport
    {
        int _sttKhoa = 0;
        public rptThanhToanGiangDayThucHanhHopDongDaiHanCTIM()
        {
            InitializeComponent();
        }
