...
{
    public partial class rptThanhToanGiangDayGDTCCanBoKiemGiangHddhCTIM : DevExpress.XtraReports.UI.XtraReport
    {
        int _sttKhoa = 0;
        public rptThanhToanGiangDayGDTCCanBoKiemGiangHddhCTIM()
        {
            InitializeComponent();
        }
