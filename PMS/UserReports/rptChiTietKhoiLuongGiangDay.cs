...
{
    public partial class rptChiTietKhoiLuongGiangDay : DevExpress.XtraReports.UI.XtraReport
    {
        decimal tietGiangDay, tienGiangDayLTTHKLK, tietDAMH, tienGiangDayDAMH, tietNghiaVu, soTietThieu, tienThieuTiet
                ...
                , tietDuDaiTra, tienDu, tienToiDa;

        public rptChiTietKhoiLuongGiangDay()
        {
            InitializeComponent();
        }
        ...
        private void xrTableCell35_BeforePrint(object sender, System.Drawing.Printing.PrintEventArgs e)
        {
            ...
            xrTableCell45.Text = soTienThucLanh.ToString("n0");
            ...
            xrTableCell70.Text = tienThieuTiet.ToString("n0");//Tiền thiếu tiết
            if (soTienThucLanh >= 0)
        ...
        {
            tienToiDa = decimal.Parse(IsNull(xrTableCell67.Text));
            if (tienToiDa > 0 && soTienThucLanh > tienToiDa)
            {
                xrTableCell47.Text = tienToiDa.ToString("n0");
                xrTableCell58.Text = (soTienThucLanh - tienToiDa).ToString("n0");
            }
            else
            {
                xrTableCell47.Text = soTienThucLanh.ToString("n0");
                xrTableCell58.Text = tienDu.ToString("n0");
            }
        }
