...
{
    public partial class rptThanhToanGiangDayLyThuyetHopDongDaiHanCTIM : DevExpress.XtraReports.UI.XtraReport
    {
        int _sttKhoa = 0;
        public rptThanhToanGiangDayLyThuyetHopDongDaiHanCTIM()
        {
            InitializeComponent();
        }
