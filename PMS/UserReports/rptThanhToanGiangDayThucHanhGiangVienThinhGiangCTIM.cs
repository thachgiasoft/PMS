...
{
    public partial class rptThanhToanGiangDayThucHanhGiangVienThinhGiangCTIM : DevExpress.XtraReports.UI.XtraReport
    {
        int _sttKhoa = 0;
        public rptThanhToanGiangDayThucHanhGiangVienThinhGiangCTIM()
        {
            InitializeComponent();
        }
