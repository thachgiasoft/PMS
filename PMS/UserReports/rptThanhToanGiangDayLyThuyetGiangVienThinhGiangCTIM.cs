...
{
    public partial class rptThanhToanGiangDayLyThuyetGiangVienThinhGiangCTIM : DevExpress.XtraReports.UI.XtraReport
    {
        int _sttKhoa = 0;
        public rptThanhToanGiangDayLyThuyetGiangVienThinhGiangCTIM()
        {
            InitializeComponent();
        }
