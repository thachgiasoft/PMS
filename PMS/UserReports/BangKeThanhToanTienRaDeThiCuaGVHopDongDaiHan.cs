...
{
    public partial class BangKeThanhToanTienRaDeThiCuaGVHopDongDaiHan : DevExpress.XtraReports.UI.XtraReport
    {
        public BangKeThanhToanTienRaDeThiCuaGVHopDongDaiHan()
        {
            InitializeComponent();
        }
