...
{
    public partial class rptThanhToanGiangDayTTTNCanBoKiemGiangHddhCTIM : DevExpress.XtraReports.UI.XtraReport
    {
        int _sttKhoa = 0;
        public rptThanhToanGiangDayTTTNCanBoKiemGiangHddhCTIM()
        {
            InitializeComponent();
        }
