...
{
    public partial class rptThanhToanGiangDayTTTNGiangVienThinhGiangCTIM : DevExpress.XtraReports.UI.XtraReport
    {
        int _sttKhoa = 0;
        public rptThanhToanGiangDayTTTNGiangVienThinhGiangCTIM()
        {
            InitializeComponent();
        }
