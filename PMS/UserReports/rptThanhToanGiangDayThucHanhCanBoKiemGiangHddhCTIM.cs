...
{
    public partial class rptThanhToanGiangDayThucHanhCanBoKiemGiangHddhCTIM : DevExpress.XtraReports.UI.XtraReport
    {
        int _sttKhoa = 0;
        public rptThanhToanGiangDayThucHanhCanBoKiemGiangHddhCTIM()
        {
            InitializeComponent();
        }
